...
export declare class PublicIPPrefix extends pulumi.CustomResource {
     ...
     */
    readonly customIPPrefix: pulumi.Output<outputs.network.v20231101.SubResourceResponse | undefined>;
    /**
     ...
     */
    readonly ipTags: pulumi.Output<outputs.network.v20231101.IpTagResponse[] | undefined>;
    /**
     * The reference to load balancer frontend IP configuration associated with the public IP prefix.
     */
    readonly loadBalancerFrontendIpConfiguration: pulumi.Output<outputs.network.v20231101.SubResourceResponse>;
    /**
     * Resource location.
     */
     ...
     */
    readonly natGateway: pulumi.Output<outputs.network.v20231101.NatGatewayResponse | undefined>;
    /**
     ...
     */
    readonly publicIPAddresses: pulumi.Output<outputs.network.v20231101.ReferencedPublicIpAddressResponse[]>;
    /**
     ...
     */
    readonly sku: pulumi.Output<outputs.network.v20231101.PublicIPPrefixSkuResponse | undefined>;
    /**
     * Resource tags.
     */
...
export interface PublicIPPrefixArgs {
     ...
     * The customIpPrefix that this prefix is associated with.
     */
    customIPPrefix?: pulumi.Input<inputs.network.v20231101.SubResourceArgs>;
    /**
     * The extended location of the public ip address.
     */
     ...
     * The list of tags associated with the public IP prefix.
     */
    ipTags?: pulumi.Input<pulumi.Input<inputs.network.v20231101.IpTagArgs>[]>;
    /**
     * Resource location.
     */
     ...
     * NatGateway of Public IP Prefix.
     */
    natGateway?: pulumi.Input<inputs.network.v20231101.NatGatewayArgs>;
    /**
     * The Length of the Public IP Prefix.
     */
     ...
     * The public IP address version.
     */
    publicIPAddressVersion?: pulumi.Input<string | enums.network.v20231101.IPVersion>;
    /**
     ...
     * The public IP prefix SKU.
     */
    sku?: pulumi.Input<inputs.network.v20231101.PublicIPPrefixSkuArgs>;
    /**
     * Resource tags.
     */
    tags?: pulumi.Input<{
