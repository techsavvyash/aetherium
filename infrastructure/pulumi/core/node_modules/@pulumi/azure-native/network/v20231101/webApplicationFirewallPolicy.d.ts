...
export declare class WebApplicationFirewallPolicy extends pulumi.CustomResource {
     ...
     */
    readonly applicationGateways: pulumi.Output<outputs.network.v20231101.ApplicationGatewayResponse[]>;
    /**
     * The custom rules inside the policy.
     */
    readonly customRules: pulumi.Output<outputs.network.v20231101.WebApplicationFirewallCustomRuleResponse[] | undefined>;
    /**
     ...
     */
    readonly httpListeners: pulumi.Output<outputs.network.v20231101.SubResourceResponse[]>;
    /**
     * Resource location.
     */
     ...
     */
    readonly managedRules: pulumi.Output<outputs.network.v20231101.ManagedRulesDefinitionResponse>;
    /**
     * Resource name.
     */
     ...
     */
    readonly pathBasedRules: pulumi.Output<outputs.network.v20231101.SubResourceResponse[]>;
    /**
     * The PolicySettings for policy.
     */
    readonly policySettings: pulumi.Output<outputs.network.v20231101.PolicySettingsResponse | undefined>;
    /**
...
export interface WebApplicationFirewallPolicyArgs {
     ...
     * The custom rules inside the policy.
     */
    customRules?: pulumi.Input<pulumi.Input<inputs.network.v20231101.WebApplicationFirewallCustomRuleArgs>[]>;
    /**
     * Resource ID.
     */
     ...
     * Describes the managedRules structure.
     */
    managedRules: pulumi.Input<inputs.network.v20231101.ManagedRulesDefinitionArgs>;
    /**
     ...
     * The PolicySettings for policy.
     */
    policySettings?: pulumi.Input<inputs.network.v20231101.PolicySettingsArgs>;
    /**
