...
export declare class AlertRuleResource extends pulumi.CustomResource {
     ...
     */
    readonly systemData: pulumi.Output<outputs.databasewatcher.v20250102.SystemDataResponse>;
    /**
...
export interface AlertRuleResourceArgs {
     ...
     * The properties with which the alert rule resource was created.
     */
    createdWithProperties: pulumi.Input<string | enums.databasewatcher.v20250102.AlertRuleCreationProperties>;
    /**
     * The creation time of the alert rule resource.
     */
