...
export declare class BlobContainer extends pulumi.CustomResource {
     ...
     */
    readonly immutabilityPolicy: pulumi.Output<outputs.storage.v20230501.ImmutabilityPolicyPropertiesResponse>;
    /**
     * The object level immutability property of the container. The property is immutable and can only be set to true at the container creation time. Existing containers must undergo a migration process.
     */
    readonly immutableStorageWithVersioning: pulumi.Output<outputs.storage.v20230501.ImmutableStorageWithVersioningResponse | undefined>;
    /**
     ...
     */
    readonly legalHold: pulumi.Output<outputs.storage.v20230501.LegalHoldPropertiesResponse>;
    /**
