...
export declare class VirtualHubIpConfiguration extends pulumi.CustomResource {
     ...
     */
    readonly publicIPAddress: pulumi.Output<outputs.network.v20230401.PublicIPAddressResponse | undefined>;
    /**
...
export interface VirtualHubIpConfigurationArgs {
     ...
     * The private IP address allocation method.
     */
    privateIPAllocationMethod?: pulumi.Input<string | enums.network.v20230401.IPAllocationMethod>;
    /**
     * The reference to the public IP resource.
     */
    publicIPAddress?: pulumi.Input<inputs.network.v20230401.PublicIPAddressArgs>;
    /**
