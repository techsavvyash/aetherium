...
export declare class VirtualMachineTemplate extends pulumi.CustomResource {
     ...
     */
    readonly disks: pulumi.Output<outputs.connectedvmwarevsphere.v20231001.VirtualDiskResponse[]>;
    /**
     ...
     */
    readonly networkInterfaces: pulumi.Output<outputs.connectedvmwarevsphere.v20231001.NetworkInterfaceResponse[]>;
    /**
