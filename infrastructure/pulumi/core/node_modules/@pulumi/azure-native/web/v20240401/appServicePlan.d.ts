...
export declare class AppServicePlan extends pulumi.CustomResource {
     ...
     */
    readonly kubeEnvironmentProfile: pulumi.Output<outputs.web.v20240401.KubeEnvironmentProfileResponse | undefined>;
    /**
     * Resource Location.
     */
...
export interface AppServicePlanArgs {
     ...
     * Specification for the Kubernetes Environment to use for the App Service plan.
     */
    kubeEnvironmentProfile?: pulumi.Input<inputs.web.v20240401.KubeEnvironmentProfileArgs>;
    /**
     * Resource Location.
     */
