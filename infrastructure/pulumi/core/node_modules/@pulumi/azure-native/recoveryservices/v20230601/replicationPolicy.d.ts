...
export declare class ReplicationPolicy extends pulumi.CustomResource {
     ...
     * The custom data.
     */
    readonly properties: pulumi.Output<outputs.recoveryservices.v20230601.PolicyPropertiesResponse>;
    /**
     * Resource Type
     */
...
export interface ReplicationPolicyArgs {
     ...
     */
    properties?: pulumi.Input<inputs.recoveryservices.v20230601.CreatePolicyInputPropertiesArgs>;
    /**
