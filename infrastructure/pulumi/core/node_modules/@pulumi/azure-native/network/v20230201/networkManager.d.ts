...
export declare class NetworkManager extends pulumi.CustomResource {
     ...
     */
    readonly networkManagerScopes: pulumi.Output<outputs.network.v20230201.NetworkManagerPropertiesResponseNetworkManagerScopes>;
    /**
...
export interface NetworkManagerArgs {
     ...
     * Scope Access.
     */
    networkManagerScopeAccesses: pulumi.Input<pulumi.Input<string | enums.network.v20230201.ConfigurationType>[]>;
    /**
     * Scope of Network Manager.
     */
    networkManagerScopes: pulumi.Input<inputs.network.v20230201.NetworkManagerPropertiesNetworkManagerScopesArgs>;
    /**
