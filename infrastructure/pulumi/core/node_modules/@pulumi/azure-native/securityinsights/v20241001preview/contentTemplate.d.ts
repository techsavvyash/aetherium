...
export declare class ContentTemplate extends pulumi.CustomResource {
     ...
     */
    readonly author: pulumi.Output<outputs.securityinsights.v20241001preview.MetadataAuthorResponse | undefined>;
    /**
     * Categories for the item
     */
    readonly categories: pulumi.Output<outputs.securityinsights.v20241001preview.MetadataCategoriesResponse | undefined>;
    /**
     ...
     */
    readonly dependantTemplates: pulumi.Output<outputs.securityinsights.v20241001preview.TemplatePropertiesResponse[]>;
    /**
     * Dependencies for the content item, what other content items it requires to work.  Can describe more complex dependencies using a recursive/nested structure. For a single dependency an id/kind/version can be supplied or operator/criteria for complex formats.
     */
    readonly dependencies: pulumi.Output<outputs.securityinsights.v20241001preview.MetadataDependenciesResponse | undefined>;
    /**
     ...
     */
    readonly source: pulumi.Output<outputs.securityinsights.v20241001preview.MetadataSourceResponse>;
    /**
     * Support information for the template - type, name, contact information
     */
    readonly support: pulumi.Output<outputs.securityinsights.v20241001preview.MetadataSupportResponse | undefined>;
    /**
...
export interface ContentTemplateArgs {
     ...
     * The creator of the content item.
     */
    author?: pulumi.Input<inputs.securityinsights.v20241001preview.MetadataAuthorArgs>;
    /**
     * Categories for the item
     */
    categories?: pulumi.Input<inputs.securityinsights.v20241001preview.MetadataCategoriesArgs>;
    /**
     * Static ID for the content.  Used to identify dependencies and content from solutions or community.  Hard-coded/static for out of the box content and solutions. Dynamic for user-created.  This is the resource name
     */
     ...
     * The kind of content the template is for.
     */
    contentKind: pulumi.Input<string | enums.securityinsights.v20241001preview.Kind>;
    /**
     * Unique ID for the content. It should be generated based on the contentId of the package, contentId of the template, contentKind of the template and the contentVersion of the template
     */
     ...
     * Dependencies for the content item, what other content items it requires to work.  Can describe more complex dependencies using a recursive/nested structure. For a single dependency an id/kind/version can be supplied or operator/criteria for complex formats.
     */
    dependencies?: pulumi.Input<inputs.securityinsights.v20241001preview.MetadataDependenciesArgs>;
    /**
     * The display name of the template
     */
     ...
     * the packageKind of the package contains this template
     */
    packageKind?: pulumi.Input<string | enums.securityinsights.v20241001preview.PackageKind>;
    /**
     * the name of the package contains this template
     */
     ...
     * Source of the content.  This is where/how it was created.
     */
    source: pulumi.Input<inputs.securityinsights.v20241001preview.MetadataSourceArgs>;
    /**
     * Support information for the template - type, name, contact information
     */
    support?: pulumi.Input<inputs.securityinsights.v20241001preview.MetadataSupportArgs>;
    /**
     * template Id
     */
