 ...
 * ```
 */
export declare function getInstanceSerialPortOutput(args: GetInstanceSerialPortOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetInstanceSerialPortResult>;
/**
 * A collection of arguments for invoking getInstanceSerialPort.
 */
