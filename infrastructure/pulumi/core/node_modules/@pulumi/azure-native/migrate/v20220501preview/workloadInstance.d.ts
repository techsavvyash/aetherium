...
export declare class WorkloadInstance extends pulumi.CustomResource {
     ...
     */
    readonly properties: pulumi.Output<outputs.migrate.v20220501preview.WorkloadInstanceModelPropertiesResponse>;
    readonly systemData: pulumi.Output<outputs.migrate.v20220501preview.WorkloadInstanceModelResponseSystemData>;
    /**
