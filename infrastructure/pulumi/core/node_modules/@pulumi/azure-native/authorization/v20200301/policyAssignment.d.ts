...
export declare class PolicyAssignment extends pulumi.CustomResource {
     ...
     */
    readonly identity: pulumi.Output<outputs.authorization.v20200301.IdentityResponse | undefined>;
    /**
     ...
     */
    readonly sku: pulumi.Output<outputs.authorization.v20200301.PolicySkuResponse | undefined>;
    /**
...
export interface PolicyAssignmentArgs {
     ...
     * The policy assignment enforcement mode. Possible values are Default and DoNotEnforce.
     */
    enforcementMode?: pulumi.Input<string | enums.authorization.v20200301.EnforcementMode>;
    /**
     * The managed identity associated with the policy assignment.
     */
    identity?: pulumi.Input<inputs.authorization.v20200301.IdentityArgs>;
    /**
     * The location of the policy assignment. Only required when utilizing managed identity.
     */
    ...
    parameters?: pulumi.Input<{
        [key: string]: pulumi.Input<inputs.authorization.v20200301.ParameterValuesValueArgs>;
    }>;
    /**
     * The name of the policy assignment.
     */
     ...
     * The policy sku. This property is optional, obsolete, and will be ignored.
     */
    sku?: pulumi.Input<inputs.authorization.v20200301.PolicySkuArgs>;
}
