...
export declare class DevBoxDefinition extends pulumi.CustomResource {
     ...
     */
    readonly activeImageReference: pulumi.Output<outputs.devcenter.v20250201.ImageReferenceResponse>;
    /**
     ...
     */
    readonly imageReference: pulumi.Output<outputs.devcenter.v20250201.ImageReferenceResponse>;
    /**
     * Details for image validator error. Populated when the image validation is not successful.
     */
    readonly imageValidationErrorDetails: pulumi.Output<outputs.devcenter.v20250201.ImageValidationErrorDetailsResponse>;
    /**
     ...
     */
    readonly sku: pulumi.Output<outputs.devcenter.v20250201.SkuResponse>;
    /**
...
export interface DevBoxDefinitionArgs {
     ...
     * Indicates whether Dev Boxes created with this definition are capable of hibernation. Not all images are capable of supporting hibernation. To find out more see https://aka.ms/devbox/hibernate
     */
    hibernateSupport?: pulumi.Input<string | enums.devcenter.v20250201.HibernateSupport>;
    /**
     * Image reference information.
     */
    imageReference: pulumi.Input<inputs.devcenter.v20250201.ImageReferenceArgs>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * The SKU for Dev Boxes created using this definition.
     */
    sku: pulumi.Input<inputs.devcenter.v20250201.SkuArgs>;
    /**
     * Resource tags.
     */
    tags?: pulumi.Input<{
