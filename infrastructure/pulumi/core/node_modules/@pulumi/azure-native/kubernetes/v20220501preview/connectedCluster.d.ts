...
export declare class ConnectedCluster extends pulumi.CustomResource {
     ...
     */
    readonly identity: pulumi.Output<outputs.kubernetes.v20220501preview.ConnectedClusterIdentityResponse>;
    /**
     ...
     */
    readonly systemData: pulumi.Output<outputs.kubernetes.v20220501preview.SystemDataResponse>;
    /**
     * Resource tags.
     */
...
export interface ConnectedClusterArgs {
     ...
     * The identity of the connected cluster.
     */
    identity: pulumi.Input<inputs.kubernetes.v20220501preview.ConnectedClusterIdentityArgs>;
    /**
     * The infrastructure on which the Kubernetes cluster represented by this connected cluster is running on.
     */
     ...
     * Property which describes the state of private link on a connected cluster resource.
     */
    privateLinkState?: pulumi.Input<string | enums.kubernetes.v20220501preview.PrivateLinkState>;
    /**
     * Provisioning state of the connected cluster resource.
     */
    provisioningState?: pulumi.Input<string | enums.kubernetes.v20220501preview.ProvisioningState>;
    /**
