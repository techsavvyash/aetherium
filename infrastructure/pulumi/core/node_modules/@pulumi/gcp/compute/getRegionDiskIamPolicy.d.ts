 ...
 * ```
 */
export declare function getRegionDiskIamPolicyOutput(args: GetRegionDiskIamPolicyOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetRegionDiskIamPolicyResult>;
/**
 * A collection of arguments for invoking getRegionDiskIamPolicy.
 */
