 ...
 */
export declare class DevOpsPolicyAssignment extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): DevOpsPolicyAssignment;
    /**
     * Returns true if the given object is an instance of DevOpsPolicyAssignment.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is DevOpsPolicyAssignment;
    /**
     ...
     */
    readonly properties: pulumi.Output<outputs.security.v20240515preview.DevOpsPolicyAssignmentPropertiesResponse>;
    /**
     * Metadata pertaining to creation and last modification of the resource.
     */
    readonly systemData: pulumi.Output<outputs.security.v20240515preview.SystemDataResponse>;
    /**
...
export interface DevOpsPolicyAssignmentArgs {
     ...
     * Properties of the DevOps policy assignment resource.
     */
    properties?: pulumi.Input<inputs.security.v20240515preview.DevOpsPolicyAssignmentPropertiesArgs>;
    /**
