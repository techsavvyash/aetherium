...
export declare class InboundNatRule extends pulumi.CustomResource {
     ...
     */
    readonly backendAddressPool: pulumi.Output<outputs.network.v20230601.SubResourceResponse | undefined>;
    /**
     * A reference to a private IP address defined on a network interface of a VM. Traffic sent to the frontend port of each of the frontend IP configurations is forwarded to the backend IP.
     */
    readonly backendIPConfiguration: pulumi.Output<outputs.network.v20230601.NetworkInterfaceIPConfigurationResponse>;
    /**
     ...
     */
    readonly frontendIPConfiguration: pulumi.Output<outputs.network.v20230601.SubResourceResponse | undefined>;
    /**
...
export interface InboundNatRuleArgs {
     ...
     * A reference to frontend IP addresses.
     */
    frontendIPConfiguration?: pulumi.Input<inputs.network.v20230601.SubResourceArgs>;
    /**
     * The port for the external endpoint. Port numbers for each rule must be unique within the Load Balancer. Acceptable values range from 1 to 65534.
     */
     ...
     * The reference to the transport protocol used by the load balancing rule.
     */
    protocol?: pulumi.Input<string | enums.network.v20230601.TransportProtocol>;
    /**
