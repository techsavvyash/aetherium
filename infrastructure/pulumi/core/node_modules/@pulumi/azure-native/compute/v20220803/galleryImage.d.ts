...
export declare class GalleryImage extends pulumi.CustomResource {
     ...
     */
    readonly disallowed: pulumi.Output<outputs.compute.v20220803.DisallowedResponse | undefined>;
    /**
     ...
     */
    readonly features: pulumi.Output<outputs.compute.v20220803.GalleryImageFeatureResponse[] | undefined>;
    /**
     ...
     */
    readonly identifier: pulumi.Output<outputs.compute.v20220803.GalleryImageIdentifierResponse>;
    /**
     * Resource location
     */
     ...
     */
    readonly purchasePlan: pulumi.Output<outputs.compute.v20220803.ImagePurchasePlanResponse | undefined>;
    /**
     * The properties describe the recommended machine configuration for this Image Definition. These properties are updatable.
     */
    readonly recommended: pulumi.Output<outputs.compute.v20220803.RecommendedMachineConfigurationResponse | undefined>;
    /**
...
export interface GalleryImageArgs {
     ...
     * The architecture of the image. Applicable to OS disks only.
     */
    architecture?: pulumi.Input<string | enums.compute.v20220803.Architecture>;
    /**
     * The description of this gallery image definition resource. This property is updatable.
     */
     ...
     * Describes the disallowed disk types.
     */
    disallowed?: pulumi.Input<inputs.compute.v20220803.DisallowedArgs>;
    /**
     * The end of life date of the gallery image definition. This property can be used for decommissioning purposes. This property is updatable.
     */
     ...
     * A list of gallery image features.
     */
    features?: pulumi.Input<pulumi.Input<inputs.compute.v20220803.GalleryImageFeatureArgs>[]>;
    /**
     ...
     * The hypervisor generation of the Virtual Machine. Applicable to OS disks only.
     */
    hyperVGeneration?: pulumi.Input<string | enums.compute.v20220803.HyperVGeneration>;
    /**
     * This is the gallery image definition identifier.
     */
    identifier: pulumi.Input<inputs.compute.v20220803.GalleryImageIdentifierArgs>;
    /**
     * Resource location
     */
     ...
     * This property allows the user to specify whether the virtual machines created under this image are 'Generalized' or 'Specialized'.
     */
    osState: pulumi.Input<enums.compute.v20220803.OperatingSystemStateTypes>;
    /**
     * This property allows you to specify the type of the OS that is included in the disk when creating a VM from a managed image. Possible values are: **Windows,** **Linux.**
     */
    osType: pulumi.Input<enums.compute.v20220803.OperatingSystemTypes>;
    /**
     * The privacy statement uri.
     */
     ...
     * Describes the gallery image definition purchase plan. This is used by marketplace images.
     */
    purchasePlan?: pulumi.Input<inputs.compute.v20220803.ImagePurchasePlanArgs>;
    /**
     * The properties describe the recommended machine configuration for this Image Definition. These properties are updatable.
     */
    recommended?: pulumi.Input<inputs.compute.v20220803.RecommendedMachineConfigurationArgs>;
    /**
     * The release note uri.
     */
