...
export declare const ClientConnectionCountRuleDiscriminator: {
    readonly ThrottleByJwtSignatureRule: "ThrottleByJwtSignatureRule";
    readonly ThrottleByUserIdRule: "ThrottleByUserIdRule";
    readonly ThrottleByJwtCustomClaimRule: "ThrottleByJwtCustomClaimRule";
};
...
export declare const ClientTrafficControlRuleDiscriminator: {
    readonly TrafficThrottleByJwtSignatureRule: "TrafficThrottleByJwtSignatureRule";
    readonly TrafficThrottleByUserIdRule: "TrafficThrottleByUserIdRule";
    readonly TrafficThrottleByJwtCustomClaimRule: "TrafficThrottleByJwtCustomClaimRule";
};
