...
export declare class ServiceRunner extends pulumi.CustomResource {
     ...
     */
    readonly identity: pulumi.Output<outputs.devtestlab.v20180915.IdentityPropertiesResponse | undefined>;
    /**
...
export interface ServiceRunnerArgs {
     ...
     * The identity of the resource.
     */
    identity?: pulumi.Input<inputs.devtestlab.v20180915.IdentityPropertiesArgs>;
    /**
     * The name of the lab.
     */
