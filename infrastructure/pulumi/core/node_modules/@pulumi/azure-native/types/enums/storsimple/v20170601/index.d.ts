export declare const BackupType: {
    readonly LocalSnapshot: "LocalSnapshot";
    readonly CloudSnapshot: "CloudSnapshot";
};
/**
...
export declare const Kind: {
    readonly Series8000: "Series8000";
};
/**
 * The Kind of the object. Currently only Series8000 is supported
 */
export type Kind = (typeof Kind)[keyof typeof Kind];
export declare const ManagerSkuType: {
...
export declare const ManagerType: {
    readonly GardaV1: "GardaV1";
    readonly HelsinkiV1: "HelsinkiV1";
};
/**
...
export declare const VolumeType: {
    ...
    readonly LocallyPinned: "LocallyPinned";
};
/**
