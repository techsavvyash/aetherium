...
export declare class Component extends pulumi.CustomResource {
     ...
     */
    readonly privateLinkScopedResources: pulumi.Output<outputs.insights.PrivateLinkScopedResourceResponse[]>;
    /**
...
export interface ComponentArgs {
     ...
     * Type of application being monitored.
     */
    applicationType: pulumi.Input<string | enums.insights.ApplicationType>;
    /**
     * Disable IP masking.
     */
     ...
     * Indicates the flow of the ingestion.
     */
    ingestionMode?: pulumi.Input<string | enums.insights.IngestionMode>;
    /**
     * The kind of application that this component refers to, used to customize UI. This value is a freeform string, values should typically be one of the following: web, ios, other, store, java, phone.
     */
