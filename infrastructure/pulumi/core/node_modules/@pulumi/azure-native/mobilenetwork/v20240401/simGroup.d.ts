...
export declare class SimGroup extends pulumi.CustomResource {
     ...
     */
    readonly encryptionKey: pulumi.Output<outputs.mobilenetwork.v20240401.KeyVaultKeyResponse | undefined>;
    /**
     ...
     */
    readonly mobileNetwork: pulumi.Output<outputs.mobilenetwork.v20240401.MobileNetworkResourceIdResponse | undefined>;
    /**
...
export interface SimGroupArgs {
     ...
     * A key to encrypt the SIM data that belongs to this SIM group.
     */
    encryptionKey?: pulumi.Input<inputs.mobilenetwork.v20240401.KeyVaultKeyArgs>;
    /**
     * The identity used to retrieve the encryption key from Azure key vault.
     */
     ...
     * Mobile network that this SIM group belongs to. The mobile network must be in the same location as the SIM group.
     */
    mobileNetwork?: pulumi.Input<inputs.mobilenetwork.v20240401.MobileNetworkResourceIdArgs>;
    /**
