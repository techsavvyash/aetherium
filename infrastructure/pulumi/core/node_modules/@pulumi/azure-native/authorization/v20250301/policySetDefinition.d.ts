...
export declare class PolicySetDefinition extends pulumi.CustomResource {
    ...
    readonly parameters: pulumi.Output<{
        [key: string]: outputs.authorization.v20250301.ParameterDefinitionsValueResponse;
    } | undefined>;
    /**
     * The metadata describing groups of policy definition references within the policy set definition.
     */
    readonly policyDefinitionGroups: pulumi.Output<outputs.authorization.v20250301.PolicyDefinitionGroupResponse[] | undefined>;
    /**
     * An array of policy definition references.
     */
    readonly policyDefinitions: pulumi.Output<outputs.authorization.v20250301.PolicyDefinitionReferenceResponse[]>;
    /**
     ...
     */
    readonly systemData: pulumi.Output<outputs.authorization.v20250301.SystemDataResponse>;
    /**
...
export interface PolicySetDefinitionArgs {
    ...
    parameters?: pulumi.Input<{
        [key: string]: pulumi.Input<inputs.authorization.v20250301.ParameterDefinitionsValueArgs>;
    }>;
    /**
     * The metadata describing groups of policy definition references within the policy set definition.
     */
