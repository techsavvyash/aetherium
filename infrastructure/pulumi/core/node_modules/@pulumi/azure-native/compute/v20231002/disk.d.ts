...
export declare class Disk extends pulumi.CustomResource {
     ...
     */
    readonly creationData: pulumi.Output<outputs.compute.v20231002.CreationDataResponse>;
    /**
     ...
     */
    readonly encryption: pulumi.Output<outputs.compute.v20231002.EncryptionResponse | undefined>;
    /**
     * Encryption settings collection used for Azure Disk Encryption, can contain multiple encryption settings per disk or snapshot.
     */
    readonly encryptionSettingsCollection: pulumi.Output<outputs.compute.v20231002.EncryptionSettingsCollectionResponse | undefined>;
    /**
     * The extended location where the disk will be created. Extended location cannot be changed.
     */
    readonly extendedLocation: pulumi.Output<outputs.compute.v20231002.ExtendedLocationResponse | undefined>;
    /**
     ...
     */
    readonly propertyUpdatesInProgress: pulumi.Output<outputs.compute.v20231002.PropertyUpdatesInProgressResponse>;
    /**
     ...
     */
    readonly purchasePlan: pulumi.Output<outputs.compute.v20231002.PurchasePlanResponse | undefined>;
    /**
     * Contains the security related information for the resource.
     */
    readonly securityProfile: pulumi.Output<outputs.compute.v20231002.DiskSecurityProfileResponse | undefined>;
    /**
     * Details of the list of all VMs that have the disk attached. maxShares should be set to a value greater than one for disks to allow attaching them to multiple VMs.
     */
    readonly shareInfo: pulumi.Output<outputs.compute.v20231002.ShareInfoElementResponse[]>;
    /**
     * The disks sku name. Can be Standard_LRS, Premium_LRS, StandardSSD_LRS, UltraSSD_LRS, Premium_ZRS, StandardSSD_ZRS, or PremiumV2_LRS.
     */
    readonly sku: pulumi.Output<outputs.compute.v20231002.DiskSkuResponse | undefined>;
    /**
     * List of supported capabilities for the image from which the OS disk was created.
     */
    readonly supportedCapabilities: pulumi.Output<outputs.compute.v20231002.SupportedCapabilitiesResponse | undefined>;
    /**
