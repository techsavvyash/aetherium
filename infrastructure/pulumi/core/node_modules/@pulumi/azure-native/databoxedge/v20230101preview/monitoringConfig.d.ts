...
export declare class MonitoringConfig extends pulumi.CustomResource {
     ...
     */
    readonly metricConfigurations: pulumi.Output<outputs.databoxedge.v20230101preview.MetricConfigurationResponse[]>;
    /**
     * The object name.
     */
...
export interface MonitoringConfigArgs {
     ...
     * The metrics configuration details
     */
    metricConfigurations: pulumi.Input<pulumi.Input<inputs.databoxedge.v20230101preview.MetricConfigurationArgs>[]>;
    /**
