...
export declare class SyncGroup extends pulumi.CustomResource {
     ...
     */
    readonly schema: pulumi.Output<outputs.sql.v20240501preview.SyncGroupSchemaResponse | undefined>;
    /**
...
export interface SyncGroupArgs {
     ...
     * Conflict resolution policy of the sync group.
     */
    conflictResolutionPolicy?: pulumi.Input<string | enums.sql.v20240501preview.SyncConflictResolutionPolicy>;
    /**
     ...
     * Sync schema of the sync group.
     */
    schema?: pulumi.Input<inputs.sql.v20240501preview.SyncGroupSchemaArgs>;
    /**
