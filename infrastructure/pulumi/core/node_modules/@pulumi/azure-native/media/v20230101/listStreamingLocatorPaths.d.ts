...
export interface ListStreamingLocatorPathsResult {
     ...
     */
    readonly streamingPaths?: outputs.media.v20230101.StreamingPathResponse[];
}
/**
 * List Paths supported by this Streaming Locator
 */
export declare function listStreamingLocatorPathsOutput(args: ListStreamingLocatorPathsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<ListStreamingLocatorPathsResult>;
