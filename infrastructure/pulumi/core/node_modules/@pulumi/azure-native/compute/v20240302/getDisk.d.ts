...
export interface GetDiskResult {
     ...
     */
    readonly creationData: outputs.compute.v20240302.CreationDataResponse;
    /**
     ...
     */
    readonly encryption?: outputs.compute.v20240302.EncryptionResponse;
    /**
     * Encryption settings collection used for Azure Disk Encryption, can contain multiple encryption settings per disk or snapshot.
     */
    readonly encryptionSettingsCollection?: outputs.compute.v20240302.EncryptionSettingsCollectionResponse;
    /**
     ...
     */
    readonly propertyUpdatesInProgress: outputs.compute.v20240302.PropertyUpdatesInProgressResponse;
    /**
     ...
     */
    readonly purchasePlan?: outputs.compute.v20240302.PurchasePlanResponse;
    /**
     * Contains the security related information for the resource.
     */
    readonly securityProfile?: outputs.compute.v20240302.DiskSecurityProfileResponse;
    /**
     * Details of the list of all VMs that have the disk attached. maxShares should be set to a value greater than one for disks to allow attaching them to multiple VMs.
     */
    readonly shareInfo: outputs.compute.v20240302.ShareInfoElementResponse[];
    /**
     * The disks sku name. Can be Standard_LRS, Premium_LRS, StandardSSD_LRS, UltraSSD_LRS, Premium_ZRS, StandardSSD_ZRS, or PremiumV2_LRS.
     */
    readonly sku?: outputs.compute.v20240302.DiskSkuResponse;
    /**
     * List of supported capabilities for the image from which the OS disk was created.
     */
    readonly supportedCapabilities?: outputs.compute.v20240302.SupportedCapabilitiesResponse;
    /**
