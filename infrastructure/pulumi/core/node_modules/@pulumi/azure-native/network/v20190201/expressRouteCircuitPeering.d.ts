...
export declare class ExpressRouteCircuitPeering extends pulumi.CustomResource {
     ...
     */
    readonly connections: pulumi.Output<outputs.network.v20190201.ExpressRouteCircuitConnectionResponse[] | undefined>;
    /**
     ...
     */
    readonly expressRouteConnection: pulumi.Output<outputs.network.v20190201.ExpressRouteConnectionIdResponse | undefined>;
    /**
     ...
     */
    readonly ipv6PeeringConfig: pulumi.Output<outputs.network.v20190201.Ipv6ExpressRouteCircuitPeeringConfigResponse | undefined>;
    /**
     ...
     */
    readonly microsoftPeeringConfig: pulumi.Output<outputs.network.v20190201.ExpressRouteCircuitPeeringConfigResponse | undefined>;
    /**
     ...
     */
    readonly peeredConnections: pulumi.Output<outputs.network.v20190201.PeerExpressRouteCircuitConnectionResponse[]>;
    /**
     * The peering type.
     */
     ...
     */
    readonly routeFilter: pulumi.Output<outputs.network.v20190201.RouteFilterResponse | undefined>;
    /**
     * The secondary port.
     */
     ...
     * Gets peering stats.
     */
    readonly stats: pulumi.Output<outputs.network.v20190201.ExpressRouteCircuitStatsResponse | undefined>;
    /**
     * The VLAN ID.
     */
...
export interface ExpressRouteCircuitPeeringArgs {
     ...
     */
    connections?: pulumi.Input<pulumi.Input<inputs.network.v20190201.ExpressRouteCircuitConnectionArgs>[]>;
    /**
     * The GatewayManager Etag.
     */
     ...
     * The IPv6 peering configuration.
     */
    ipv6PeeringConfig?: pulumi.Input<inputs.network.v20190201.Ipv6ExpressRouteCircuitPeeringConfigArgs>;
    /**
     * Gets whether the provider or the customer last modified the peering.
     */
     ...
     * The Microsoft peering configuration.
     */
    microsoftPeeringConfig?: pulumi.Input<inputs.network.v20190201.ExpressRouteCircuitPeeringConfigArgs>;
    /**
     * Gets name of the resource that is unique within a resource group. This name can be used to access the resource.
     */
     ...
     * The peering type.
     */
    peeringType?: pulumi.Input<string | enums.network.v20190201.ExpressRoutePeeringType>;
    /**
     * The primary port.
     */
     ...
     * The reference of the RouteFilter resource.
     */
    routeFilter?: pulumi.Input<inputs.network.v20190201.RouteFilterArgs>;
    /**
     * The secondary port.
     */
     ...
     * The peering state.
     */
    state?: pulumi.Input<string | enums.network.v20190201.ExpressRoutePeeringState>;
    /**
     * Gets peering stats.
     */
    stats?: pulumi.Input<inputs.network.v20190201.ExpressRouteCircuitStatsArgs>;
    /**
     * The VLAN ID.
     */
