...
export declare class AdminRule extends pulumi.CustomResource {
     ...
     */
    readonly destinations: pulumi.Output<outputs.network.v20240301.AddressPrefixItemResponse[] | undefined>;
    /**
     ...
     */
    readonly sources: pulumi.Output<outputs.network.v20240301.AddressPrefixItemResponse[] | undefined>;
    /**
     * The system metadata related to this resource.
     */
    readonly systemData: pulumi.Output<outputs.network.v20240301.SystemDataResponse>;
    /**
     * Resource type.
     */
...
export interface AdminRuleArgs {
     ...
     * Indicates the access allowed for this particular rule
     */
    access: pulumi.Input<string | enums.network.v20240301.SecurityConfigurationRuleAccess>;
    /**
     ...
     * The destination address prefixes. CIDR or destination IP ranges.
     */
    destinations?: pulumi.Input<pulumi.Input<inputs.network.v20240301.AddressPrefixItemArgs>[]>;
    /**
     * Indicates if the traffic matched against the rule in inbound or outbound.
     */
    direction: pulumi.Input<string | enums.network.v20240301.SecurityConfigurationRuleDirection>;
    /**
     * Whether the rule is custom or default.
     * Expected value is 'Custom'.
     */
     ...
     * Network protocol this rule applies to.
     */
    protocol: pulumi.Input<string | enums.network.v20240301.SecurityConfigurationRuleProtocol>;
    /**
     ...
     * The CIDR or source IP ranges.
     */
    sources?: pulumi.Input<pulumi.Input<inputs.network.v20240301.AddressPrefixItemArgs>[]>;
}
