...
export declare class Incident extends pulumi.CustomResource {
     ...
     */
    readonly additionalData: pulumi.Output<outputs.securityinsights.v20231001preview.IncidentAdditionalDataResponse>;
    /**
     ...
     */
    readonly labels: pulumi.Output<outputs.securityinsights.v20231001preview.IncidentLabelResponse[] | undefined>;
    /**
     ...
     */
    readonly owner: pulumi.Output<outputs.securityinsights.v20231001preview.IncidentOwnerInfoResponse | undefined>;
    /**
     ...
     */
    readonly systemData: pulumi.Output<outputs.securityinsights.v20231001preview.SystemDataResponse>;
    /**
     * Describes a team for the incident
     */
    readonly teamInformation: pulumi.Output<outputs.securityinsights.v20231001preview.TeamInformationResponse | undefined>;
    /**
...
export interface IncidentArgs {
     ...
     * The reason the incident was closed
     */
    classification?: pulumi.Input<string | enums.securityinsights.v20231001preview.IncidentClassification>;
    /**
     * Describes the reason the incident was closed
     */
     ...
     * The classification reason the incident was closed with
     */
    classificationReason?: pulumi.Input<string | enums.securityinsights.v20231001preview.IncidentClassificationReason>;
    /**
     * The description of the incident
     */
     ...
     * List of labels relevant to this incident
     */
    labels?: pulumi.Input<pulumi.Input<inputs.securityinsights.v20231001preview.IncidentLabelArgs>[]>;
    /**
     * The time of the last activity in the incident
     */
     ...
     * Describes a user that the incident is assigned to
     */
    owner?: pulumi.Input<inputs.securityinsights.v20231001preview.IncidentOwnerInfoArgs>;
    /**
     ...
     * The severity of the incident
     */
    severity: pulumi.Input<string | enums.securityinsights.v20231001preview.IncidentSeverity>;
    /**
     * The status of the incident
     */
    status: pulumi.Input<string | enums.securityinsights.v20231001preview.IncidentStatus>;
    /**
     * The title of the incident
     */
