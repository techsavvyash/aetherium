...
export declare class MaintenanceConfiguration extends pulumi.CustomResource {
     ...
     */
    readonly maintenanceWindow: pulumi.Output<outputs.containerservice.v20240202preview.MaintenanceWindowResponse | undefined>;
    /**
     ...
     */
    readonly notAllowedTime: pulumi.Output<outputs.containerservice.v20240202preview.TimeSpanResponse[] | undefined>;
    /**
     ...
     */
    readonly timeInWeek: pulumi.Output<outputs.containerservice.v20240202preview.TimeInWeekResponse[] | undefined>;
    /**
     * Resource type
     */
...
export interface MaintenanceConfigurationArgs {
     ...
     * Maintenance window for the maintenance configuration.
     */
    maintenanceWindow?: pulumi.Input<inputs.containerservice.v20240202preview.MaintenanceWindowArgs>;
    /**
     * Time slots on which upgrade is not allowed.
     */
    notAllowedTime?: pulumi.Input<pulumi.Input<inputs.containerservice.v20240202preview.TimeSpanArgs>[]>;
    /**
     ...
     * If two array entries specify the same day of the week, the applied configuration is the union of times in both entries.
     */
    timeInWeek?: pulumi.Input<pulumi.Input<inputs.containerservice.v20240202preview.TimeInWeekArgs>[]>;
}
