 ...
 * ```
 */
export declare function getOrganizationSettingsOutput(args: GetOrganizationSettingsOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetOrganizationSettingsResult>;
/**
 * A collection of arguments for invoking getOrganizationSettings.
 */
