...
export declare class VirtualNetworkTap extends pulumi.CustomResource {
     ...
     */
    readonly destinationLoadBalancerFrontEndIPConfiguration: pulumi.Output<outputs.network.v20230201.FrontendIPConfigurationResponse | undefined>;
    /**
     * The reference to the private IP Address of the collector nic that will receive the tap.
     */
    readonly destinationNetworkInterfaceIPConfiguration: pulumi.Output<outputs.network.v20230201.NetworkInterfaceIPConfigurationResponse | undefined>;
    /**
     ...
     */
    readonly networkInterfaceTapConfigurations: pulumi.Output<outputs.network.v20230201.NetworkInterfaceTapConfigurationResponse[]>;
    /**
...
export interface VirtualNetworkTapArgs {
     ...
     * The reference to the private IP address on the internal Load Balancer that will receive the tap.
     */
    destinationLoadBalancerFrontEndIPConfiguration?: pulumi.Input<inputs.network.v20230201.FrontendIPConfigurationArgs>;
    /**
     * The reference to the private IP Address of the collector nic that will receive the tap.
     */
    destinationNetworkInterfaceIPConfiguration?: pulumi.Input<inputs.network.v20230201.NetworkInterfaceIPConfigurationArgs>;
    /**
     * The VXLAN destination port that will receive the tapped traffic.
     */
