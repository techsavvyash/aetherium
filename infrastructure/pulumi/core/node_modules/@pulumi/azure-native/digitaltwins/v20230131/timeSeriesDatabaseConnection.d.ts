...
export declare class TimeSeriesDatabaseConnection extends pulumi.CustomResource {
     ...
     */
    readonly properties: pulumi.Output<outputs.digitaltwins.v20230131.AzureDataExplorerConnectionPropertiesResponse>;
    /**
...
export interface TimeSeriesDatabaseConnectionArgs {
     ...
     * Properties of a specific time series database connection.
     */
    properties?: pulumi.Input<inputs.digitaltwins.v20230131.AzureDataExplorerConnectionPropertiesArgs>;
    /**
