...
export declare class ExpressRouteGateway extends pulumi.CustomResource {
     ...
     */
    readonly autoScaleConfiguration: pulumi.Output<outputs.network.v20231101.ExpressRouteGatewayPropertiesResponseAutoScaleConfiguration | undefined>;
    /**
     ...
     */
    readonly expressRouteConnections: pulumi.Output<outputs.network.v20231101.ExpressRouteConnectionResponse[] | undefined>;
    /**
     * Resource location.
     */
     ...
     */
    readonly virtualHub: pulumi.Output<outputs.network.v20231101.VirtualHubIdResponse>;
    /**
...
export interface ExpressRouteGatewayArgs {
     ...
     * Configuration for auto scaling.
     */
    autoScaleConfiguration?: pulumi.Input<inputs.network.v20231101.ExpressRouteGatewayPropertiesAutoScaleConfigurationArgs>;
    /**
     * List of ExpressRoute connections to the ExpressRoute gateway.
     * These are also available as standalone resources. Do not mix inline and standalone resource as they will conflict with each other, leading to resources deletion.
     */
    expressRouteConnections?: pulumi.Input<pulumi.Input<inputs.network.v20231101.ExpressRouteConnectionArgs>[]>;
    /**
     ...
     * The Virtual Hub where the ExpressRoute gateway is or will be deployed.
     */
    virtualHub: pulumi.Input<inputs.network.v20231101.VirtualHubIdArgs>;
}
