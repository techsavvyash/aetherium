...
export declare class Spacecraft extends pulumi.CustomResource {
     ...
     */
    readonly links: pulumi.Output<outputs.orbital.v20221101.SpacecraftLinkResponse[]>;
    /**
...
export interface SpacecraftArgs {
     ...
     * Immutable list of Spacecraft links.
     */
    links: pulumi.Input<pulumi.Input<inputs.orbital.v20221101.SpacecraftLinkArgs>[]>;
    /**
     * The geo-location where the resource lives
     */
