...
export declare class Database extends pulumi.CustomResource {
     ...
     */
    readonly currentSku: pulumi.Output<outputs.sql.v20230801.SkuResponse>;
    /**
     ...
     */
    readonly identity: pulumi.Output<outputs.sql.v20230801.DatabaseIdentityResponse | undefined>;
    /**
    ...
    readonly keys: pulumi.Output<{
        [key: string]: outputs.sql.v20230801.DatabaseKeyResponse;
    } | undefined>;
    /**
