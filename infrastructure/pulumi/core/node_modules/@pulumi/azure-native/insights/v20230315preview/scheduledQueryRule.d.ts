...
export declare class ScheduledQueryRule extends pulumi.CustomResource {
     ...
     */
    readonly actions: pulumi.Output<outputs.insights.v20230315preview.ActionsResponse | undefined>;
    /**
     ...
     */
    readonly criteria: pulumi.Output<outputs.insights.v20230315preview.ScheduledQueryRuleCriteriaResponse>;
    /**
     ...
     */
    readonly identity: pulumi.Output<outputs.insights.v20230315preview.IdentityResponse | undefined>;
    /**
     ...
     */
    readonly resolveConfiguration: pulumi.Output<outputs.insights.v20230315preview.RuleResolveConfigurationResponse | undefined>;
    /**
     ...
     */
    readonly systemData: pulumi.Output<outputs.insights.v20230315preview.SystemDataResponse>;
    /**
     * Resource tags.
     */
...
export interface ScheduledQueryRuleArgs {
     ...
     * Actions to invoke when the alert fires.
     */
    actions?: pulumi.Input<inputs.insights.v20230315preview.ActionsArgs>;
    /**
     * The flag that indicates whether the alert should be automatically resolved or not. The default is true. Relevant only for rules of the kind LogAlert.
     */
     ...
     * The rule criteria that defines the conditions of the scheduled query rule.
     */
    criteria: pulumi.Input<inputs.insights.v20230315preview.ScheduledQueryRuleCriteriaArgs>;
    /**
     * The description of the scheduled query rule.
     */
     ...
     * The identity of the resource.
     */
    identity?: pulumi.Input<inputs.insights.v20230315preview.IdentityArgs>;
    /**
     * Indicates the type of scheduled query rule. The default is LogAlert.
     */
    kind?: pulumi.Input<string | enums.insights.v20230315preview.Kind>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * Defines the configuration for resolving fired alerts. Relevant only for rules of the kind LogAlert.
     */
    resolveConfiguration?: pulumi.Input<inputs.insights.v20230315preview.RuleResolveConfigurationArgs>;
    /**
