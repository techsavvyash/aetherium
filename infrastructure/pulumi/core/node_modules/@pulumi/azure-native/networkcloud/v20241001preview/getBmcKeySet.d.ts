...
export interface GetBmcKeySetResult {
     ...
     */
    readonly userList: outputs.networkcloud.v20241001preview.KeySetUserResponse[];
    /**
     * The status evaluation of each user.
     */
    readonly userListStatus: outputs.networkcloud.v20241001preview.KeySetUserStatusResponse[];
}
/**
 * Get baseboard management controller key set of the provided cluster.
 */
