...
export declare class ExpressRouteCircuitPeering extends pulumi.CustomResource {
     ...
     */
    readonly connections: pulumi.Output<outputs.network.v20240501.ExpressRouteCircuitConnectionResponse[] | undefined>;
    /**
     ...
     */
    readonly expressRouteConnection: pulumi.Output<outputs.network.v20240501.ExpressRouteConnectionIdResponse | undefined>;
    /**
     ...
     */
    readonly ipv6PeeringConfig: pulumi.Output<outputs.network.v20240501.Ipv6ExpressRouteCircuitPeeringConfigResponse | undefined>;
    /**
     ...
     */
    readonly microsoftPeeringConfig: pulumi.Output<outputs.network.v20240501.ExpressRouteCircuitPeeringConfigResponse | undefined>;
    /**
     ...
     */
    readonly peeredConnections: pulumi.Output<outputs.network.v20240501.PeerExpressRouteCircuitConnectionResponse[]>;
    /**
     * The peering type.
     */
     ...
     */
    readonly routeFilter: pulumi.Output<outputs.network.v20240501.SubResourceResponse | undefined>;
    /**
     * The secondary port.
     */
     ...
     */
    readonly stats: pulumi.Output<outputs.network.v20240501.ExpressRouteCircuitStatsResponse | undefined>;
    /**
...
export interface ExpressRouteCircuitPeeringArgs {
     ...
     */
    connections?: pulumi.Input<pulumi.Input<inputs.network.v20240501.ExpressRouteCircuitConnectionArgs>[]>;
    /**
     * The GatewayManager Etag.
     */
     ...
     * The IPv6 peering configuration.
     */
    ipv6PeeringConfig?: pulumi.Input<inputs.network.v20240501.Ipv6ExpressRouteCircuitPeeringConfigArgs>;
    /**
     * The Microsoft peering configuration.
     */
    microsoftPeeringConfig?: pulumi.Input<inputs.network.v20240501.ExpressRouteCircuitPeeringConfigArgs>;
    /**
     * The name of the resource that is unique within a resource group. This name can be used to access the resource.
     */
     ...
     * The peering type.
     */
    peeringType?: pulumi.Input<string | enums.network.v20240501.ExpressRoutePeeringType>;
    /**
     * The primary port.
     */
     ...
     * The reference to the RouteFilter resource.
     */
    routeFilter?: pulumi.Input<inputs.network.v20240501.SubResourceArgs>;
    /**
     * The secondary port.
     */
     ...
     * The peering state.
     */
    state?: pulumi.Input<string | enums.network.v20240501.ExpressRoutePeeringState>;
    /**
     * The peering stats of express route circuit.
     */
    stats?: pulumi.Input<inputs.network.v20240501.ExpressRouteCircuitStatsArgs>;
    /**
     * The VLAN ID.
     */
