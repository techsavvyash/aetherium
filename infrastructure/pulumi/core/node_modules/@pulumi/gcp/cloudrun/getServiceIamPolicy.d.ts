 ...
 * ```
 */
export declare function getServiceIamPolicyOutput(args: GetServiceIamPolicyOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetServiceIamPolicyResult>;
/**
 * A collection of arguments for invoking getServiceIamPolicy.
 */
