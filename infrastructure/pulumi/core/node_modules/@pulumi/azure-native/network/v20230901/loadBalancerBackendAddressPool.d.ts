...
export declare class LoadBalancerBackendAddressPool extends pulumi.CustomResource {
     ...
     */
    readonly backendIPConfigurations: pulumi.Output<outputs.network.v20230901.NetworkInterfaceIPConfigurationResponse[]>;
    /**
     ...
     */
    readonly inboundNatRules: pulumi.Output<outputs.network.v20230901.SubResourceResponse[]>;
    /**
     * An array of backend addresses.
     */
    readonly loadBalancerBackendAddresses: pulumi.Output<outputs.network.v20230901.LoadBalancerBackendAddressResponse[] | undefined>;
    /**
     * An array of references to load balancing rules that use this backend address pool.
     */
    readonly loadBalancingRules: pulumi.Output<outputs.network.v20230901.SubResourceResponse[]>;
    /**
     ...
     */
    readonly outboundRule: pulumi.Output<outputs.network.v20230901.SubResourceResponse>;
    /**
     * An array of references to outbound rules that use this backend address pool.
     */
    readonly outboundRules: pulumi.Output<outputs.network.v20230901.SubResourceResponse[]>;
    /**
     ...
     */
    readonly tunnelInterfaces: pulumi.Output<outputs.network.v20230901.GatewayLoadBalancerTunnelInterfaceResponse[] | undefined>;
    /**
     ...
     */
    readonly virtualNetwork: pulumi.Output<outputs.network.v20230901.SubResourceResponse | undefined>;
    /**
