...
export declare class StorageAppliance extends pulumi.CustomResource {
     ...
     */
    readonly administratorCredentials: pulumi.Output<outputs.networkcloud.v20231001preview.AdministrativeCredentialsResponse>;
    /**
...
export interface StorageApplianceArgs {
     ...
     * The credentials of the administrative interface on this storage appliance.
     */
    administratorCredentials: pulumi.Input<inputs.networkcloud.v20231001preview.AdministrativeCredentialsArgs>;
    /**
     * The extended location of the cluster associated with the resource.
     */
