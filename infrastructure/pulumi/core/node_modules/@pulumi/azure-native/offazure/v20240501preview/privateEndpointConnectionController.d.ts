...
export declare class PrivateEndpointConnectionController extends pulumi.CustomResource {
     ...
     * private endpoints
     */
    readonly privateEndpoint: pulumi.Output<outputs.offazure.v20240501preview.ResourceIdResponse>;
    /**
     * private endpoints connection state
     */
    readonly privateLinkServiceConnectionState: pulumi.Output<outputs.offazure.v20240501preview.PrivateLinkServiceConnectionStateResponse | undefined>;
    /**
...
export interface PrivateEndpointConnectionControllerArgs {
     ...
     * private endpoints connection state
     */
    privateLinkServiceConnectionState?: pulumi.Input<inputs.offazure.v20240501preview.PrivateLinkServiceConnectionStateArgs>;
    /**
