...
export declare class Sim extends pulumi.CustomResource {
     ...
     */
    readonly simPolicy: pulumi.Output<outputs.mobilenetwork.v20230901.SimPolicyResourceIdResponse | undefined>;
    /**
     ...
     */
    readonly staticIpConfiguration: pulumi.Output<outputs.mobilenetwork.v20230901.SimStaticIpPropertiesResponse[] | undefined>;
    /**
...
export interface SimArgs {
     ...
     * The SIM policy used by this SIM. The SIM policy must be in the same location as the SIM.
     */
    simPolicy?: pulumi.Input<inputs.mobilenetwork.v20230901.SimPolicyResourceIdArgs>;
    /**
     * A list of static IP addresses assigned to this SIM. Each address is assigned at a defined network scope, made up of {attached data network, slice}.
     */
    staticIpConfiguration?: pulumi.Input<pulumi.Input<inputs.mobilenetwork.v20230901.SimStaticIpPropertiesArgs>[]>;
}
