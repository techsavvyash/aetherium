...
export declare class ReplicationRecoveryServicesProvider extends pulumi.CustomResource {
     ...
     * Provider properties.
     */
    readonly properties: pulumi.Output<outputs.recoveryservices.v20240101.RecoveryServicesProviderPropertiesResponse>;
    /**
     * Resource Type
     */
...
export interface ReplicationRecoveryServicesProviderArgs {
     ...
     */
    properties: pulumi.Input<inputs.recoveryservices.v20240101.AddRecoveryServicesProviderInputPropertiesArgs>;
    /**
