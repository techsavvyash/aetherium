 ...
 * ```
 */
export declare function getSearchAllResourcesOutput(args: GetSearchAllResourcesOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetSearchAllResourcesResult>;
/**
 * A collection of arguments for invoking getSearchAllResources.
 */
