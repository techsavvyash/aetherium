...
export declare const EdgeDevice: typeof import("./edgeDevice").EdgeDevice;
...
export declare const getEdgeDevice: typeof import("./getEdgeDevice").getEdgeDevice;
export declare const getEdgeDeviceOutput: typeof import("./getEdgeDevice").getEdgeDeviceOutput;
