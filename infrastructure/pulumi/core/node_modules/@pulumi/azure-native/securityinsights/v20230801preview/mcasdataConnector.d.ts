...
export declare class MCASDataConnector extends pulumi.CustomResource {
     ...
     */
    readonly dataTypes: pulumi.Output<outputs.securityinsights.v20230801preview.MCASDataConnectorDataTypesResponse>;
    /**
...
export interface MCASDataConnectorArgs {
     ...
     * The available data types for the connector.
     */
    dataTypes: pulumi.Input<inputs.securityinsights.v20230801preview.MCASDataConnectorDataTypesArgs>;
    /**
     * The kind of the data connector
     * Expected value is 'MicrosoftCloudAppSecurity'.
     */
