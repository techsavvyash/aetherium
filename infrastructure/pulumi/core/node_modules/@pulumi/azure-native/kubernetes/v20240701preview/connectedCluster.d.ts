...
export declare class ConnectedCluster extends pulumi.CustomResource {
     ...
     */
    readonly aadProfile: pulumi.Output<outputs.kubernetes.v20240701preview.AadProfileResponse | undefined>;
    /**
     ...
     */
    readonly arcAgentProfile: pulumi.Output<outputs.kubernetes.v20240701preview.ArcAgentProfileResponse | undefined>;
    /**
     * Configuration settings for customizing the behavior of the connected cluster.
     */
    readonly arcAgentryConfigurations: pulumi.Output<outputs.kubernetes.v20240701preview.ArcAgentryConfigurationsResponse[] | undefined>;
    /**
     ...
     */
    readonly gateway: pulumi.Output<outputs.kubernetes.v20240701preview.GatewayResponse | undefined>;
    /**
     * The identity of the connected cluster.
     */
    readonly identity: pulumi.Output<outputs.kubernetes.v20240701preview.ConnectedClusterIdentityResponse>;
    /**
     ...
     */
    readonly oidcIssuerProfile: pulumi.Output<outputs.kubernetes.v20240701preview.OidcIssuerProfileResponse | undefined>;
    /**
     ...
     */
    readonly securityProfile: pulumi.Output<outputs.kubernetes.v20240701preview.SecurityProfileResponse | undefined>;
    /**
     * Metadata pertaining to creation and last modification of the resource
     */
    readonly systemData: pulumi.Output<outputs.kubernetes.v20240701preview.SystemDataResponse>;
    /**
     * Resource tags.
     */
...
export interface ConnectedClusterArgs {
     ...
     * AAD profile for the connected cluster.
     */
    aadProfile?: pulumi.Input<inputs.kubernetes.v20240701preview.AadProfileArgs>;
    /**
     * Base64 encoded public certificate used by the agent to do the initial handshake to the backend services in Azure.
     */
     ...
     * Arc agentry configuration for the provisioned cluster.
     */
    arcAgentProfile?: pulumi.Input<inputs.kubernetes.v20240701preview.ArcAgentProfileArgs>;
    /**
     * Configuration settings for customizing the behavior of the connected cluster.
     */
    arcAgentryConfigurations?: pulumi.Input<pulumi.Input<inputs.kubernetes.v20240701preview.ArcAgentryConfigurationsArgs>[]>;
    /**
     * Indicates whether Azure Hybrid Benefit is opted in
     */
    azureHybridBenefit?: pulumi.Input<string | enums.kubernetes.v20240701preview.AzureHybridBenefit>;
    /**
     ...
     * Details of the gateway used by the Arc router for connectivity.
     */
    gateway?: pulumi.Input<inputs.kubernetes.v20240701preview.GatewayArgs>;
    /**
     * The identity of the connected cluster.
     */
    identity: pulumi.Input<inputs.kubernetes.v20240701preview.ConnectedClusterIdentityArgs>;
    /**
     * The infrastructure on which the Kubernetes cluster represented by this connected cluster is running on.
     */
     ...
     * The kind of connected cluster.
     */
    kind?: pulumi.Input<string | enums.kubernetes.v20240701preview.ConnectedClusterKind>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * Open ID Connect (OIDC) Issuer Profile for the connected cluster.
     */
    oidcIssuerProfile?: pulumi.Input<inputs.kubernetes.v20240701preview.OidcIssuerProfileArgs>;
    /**
     * This is populated only if privateLinkState is enabled. The resource id of the private link scope this connected cluster is assigned to, if any.
     */
     ...
     * Property which describes the state of private link on a connected cluster resource.
     */
    privateLinkState?: pulumi.Input<string | enums.kubernetes.v20240701preview.PrivateLinkState>;
    /**
     * Provisioning state of the connected cluster resource.
     */
    provisioningState?: pulumi.Input<string | enums.kubernetes.v20240701preview.ProvisioningState>;
    /**
     ...
     * Security profile for the connected cluster.
     */
    securityProfile?: pulumi.Input<inputs.kubernetes.v20240701preview.SecurityProfileArgs>;
    /**
     * Resource tags.
     */
    tags?: pulumi.Input<{
