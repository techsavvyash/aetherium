...
export declare class Deployment extends pulumi.CustomResource {
     ...
     */
    readonly server: pulumi.Output<outputs.apicenter.v20240315preview.DeploymentServerResponse | undefined>;
    /**
...
export interface DeploymentArgs {
     ...
     * The deployment server
     */
    server?: pulumi.Input<inputs.apicenter.v20240315preview.DeploymentServerArgs>;
    /**
     ...
     * State of API deployment.
     */
    state?: pulumi.Input<string | enums.apicenter.v20240315preview.DeploymentState>;
    /**
     * API deployment title
     */
