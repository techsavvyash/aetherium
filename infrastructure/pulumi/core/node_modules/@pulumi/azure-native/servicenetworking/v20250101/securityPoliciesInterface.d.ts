...
export declare class SecurityPoliciesInterface extends pulumi.CustomResource {
     ...
     */
    readonly wafPolicy: pulumi.Output<outputs.servicenetworking.v20250101.WafPolicyResponse | undefined>;
    /**
...
export interface SecurityPoliciesInterfaceArgs {
     ...
     * Web Application Firewall Policy of the Traffic Controller Security Policy. Single Security Policy can have only one policy type set.
     */
    wafPolicy?: pulumi.Input<inputs.servicenetworking.v20250101.WafPolicyArgs>;
}
