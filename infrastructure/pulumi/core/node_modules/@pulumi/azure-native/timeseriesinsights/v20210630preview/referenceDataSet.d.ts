...
export declare class ReferenceDataSet extends pulumi.CustomResource {
     ...
     */
    readonly keyProperties: pulumi.Output<outputs.timeseriesinsights.v20210630preview.ReferenceDataSetKeyPropertyResponse[]>;
    /**
     * Resource location
     */
...
export interface ReferenceDataSetArgs {
     ...
     * The reference data set key comparison behavior can be set using this property. By default, the value is 'Ordinal' - which means case sensitive key comparison will be performed while joining reference data with events or while adding new reference data. When 'OrdinalIgnoreCase' is set, case insensitive comparison will be used.
     */
    dataStringComparisonBehavior?: pulumi.Input<string | enums.timeseriesinsights.v20210630preview.DataStringComparisonBehavior>;
    /**
     ...
     * The list of key properties for the reference data set.
     */
    keyProperties: pulumi.Input<pulumi.Input<inputs.timeseriesinsights.v20210630preview.ReferenceDataSetKeyPropertyArgs>[]>;
    /**
