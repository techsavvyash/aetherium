...
export declare class ApplicationGroup extends pulumi.CustomResource {
     ...
     */
    readonly policies: pulumi.Output<outputs.eventhub.v20240501preview.ThrottlingPolicyResponse[] | undefined>;
    /**
...
export interface ApplicationGroupArgs {
     ...
     * List of group policies that define the behavior of application group. The policies can support resource governance scenarios such as limiting ingress or egress traffic.
     */
    policies?: pulumi.Input<pulumi.Input<inputs.eventhub.v20240501preview.ThrottlingPolicyArgs>[]>;
    /**
