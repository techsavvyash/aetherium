...
class DeviceClass extends pulumi.CustomResource {
    ...
    constructor(name, args, opts) {
        ...
        const aliasOpts = { aliases: [{ type: "kubernetes:resource.k8s.io/v1alpha3:DeviceClass" }, { type: "kubernetes:resource.k8s.io/v1beta1:DeviceClass" }] };
...
/** @internal */
DeviceClass.__pulumiType = 'kubernetes:resource.k8s.io/v1beta2:DeviceClass';
