...
export declare class DevCenter extends pulumi.CustomResource {
     ...
     */
    readonly encryption: pulumi.Output<outputs.devcenter.v20231001preview.EncryptionResponse | undefined>;
    /**
...
export interface DevCenterArgs {
     ...
     * Encryption settings to be used for server-side encryption for proprietary content (such as catalogs, logs, customizations).
     */
    encryption?: pulumi.Input<inputs.devcenter.v20231001preview.EncryptionArgs>;
    /**
     * Managed identity properties
     */
