    ...
    async registerTransform(transform) {
        const cb = async (bytes) => {
            ...
            ropts.replacementTrigger = replacementTrigger
                ? rpc_1.deserializeProperty(replacementTrigger.toJavaScript())
                : undefined;
            ...
            if (result === undefined) {
                ...
                if (result.opts !== undefined) {
                    ...
                    if (result.opts.replacementTrigger !== undefined) {
                        const triggerValue = await rpc_1.serializeProperty("replacementTrigger", result.opts.replacementTrigger);
