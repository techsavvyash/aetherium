...
export declare class AttestationProvider extends pulumi.CustomResource {
     ...
     */
    readonly privateEndpointConnections: pulumi.Output<outputs.attestation.v20210601.PrivateEndpointConnectionResponse[]>;
    /**
     ...
     */
    readonly systemData: pulumi.Output<outputs.attestation.v20210601.SystemDataResponse>;
    /**
     * Resource tags.
     */
...
export interface AttestationProviderArgs {
     ...
     */
    properties: pulumi.Input<inputs.attestation.v20210601.AttestationServiceCreationSpecificParamsArgs>;
    /**
