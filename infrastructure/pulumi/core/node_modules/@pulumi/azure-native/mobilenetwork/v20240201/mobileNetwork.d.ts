...
export declare class MobileNetwork extends pulumi.CustomResource {
     ...
     */
    readonly identity: pulumi.Output<outputs.mobilenetwork.v20240201.ManagedServiceIdentityResponse | undefined>;
    /**
     ...
     */
    readonly publicLandMobileNetworkIdentifier: pulumi.Output<outputs.mobilenetwork.v20240201.PlmnIdResponse>;
    /**
     ...
     */
    readonly publicLandMobileNetworks: pulumi.Output<outputs.mobilenetwork.v20240201.PublicLandMobileNetworkResponse[] | undefined>;
    /**
...
export interface MobileNetworkArgs {
     ...
     * The identity used to retrieve any private keys used for SUPI concealment from Azure key vault.
     */
    identity?: pulumi.Input<inputs.mobilenetwork.v20240201.ManagedServiceIdentityArgs>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * The unique public land mobile network identifier for the network. If both 'publicLandMobileNetworks' and 'publicLandMobileNetworkIdentifier' are specified, then the 'publicLandMobileNetworks' will take precedence.
     */
    publicLandMobileNetworkIdentifier: pulumi.Input<inputs.mobilenetwork.v20240201.PlmnIdArgs>;
    /**
     * A list of public land mobile networks including their identifiers. If both 'publicLandMobileNetworks' and 'publicLandMobileNetworkIdentifier' are specified, then the 'publicLandMobileNetworks' will take precedence.
     */
    publicLandMobileNetworks?: pulumi.Input<pulumi.Input<inputs.mobilenetwork.v20240201.PublicLandMobileNetworkArgs>[]>;
    /**
