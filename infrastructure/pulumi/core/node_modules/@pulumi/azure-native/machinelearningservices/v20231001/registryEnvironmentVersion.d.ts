...
export declare class RegistryEnvironmentVersion extends pulumi.CustomResource {
     ...
     */
    readonly environmentVersionProperties: pulumi.Output<outputs.machinelearningservices.v20231001.EnvironmentVersionResponse>;
    /**
...
export interface RegistryEnvironmentVersionArgs {
     ...
     * [Required] Additional attributes of the entity.
     */
    environmentVersionProperties: pulumi.Input<inputs.machinelearningservices.v20231001.EnvironmentVersionArgs>;
    /**
