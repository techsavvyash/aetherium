...
export declare class ProtectionPolicy extends pulumi.CustomResource {
     ...
     */
    readonly properties: pulumi.Output<outputs.recoveryservices.v20230601.AzureFileShareProtectionPolicyResponse | outputs.recoveryservices.v20230601.AzureIaaSVMProtectionPolicyResponse | outputs.recoveryservices.v20230601.AzureSqlProtectionPolicyResponse | outputs.recoveryservices.v20230601.AzureVmWorkloadProtectionPolicyResponse | outputs.recoveryservices.v20230601.GenericProtectionPolicyResponse | outputs.recoveryservices.v20230601.MabProtectionPolicyResponse>;
    /**
     * Resource tags.
     */
...
export interface ProtectionPolicyArgs {
     ...
     * ProtectionPolicyResource properties
     */
    properties?: pulumi.Input<inputs.recoveryservices.v20230601.AzureFileShareProtectionPolicyArgs | inputs.recoveryservices.v20230601.AzureIaaSVMProtectionPolicyArgs | inputs.recoveryservices.v20230601.AzureSqlProtectionPolicyArgs | inputs.recoveryservices.v20230601.AzureVmWorkloadProtectionPolicyArgs | inputs.recoveryservices.v20230601.GenericProtectionPolicyArgs | inputs.recoveryservices.v20230601.MabProtectionPolicyArgs>;
    /**
