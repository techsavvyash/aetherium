...
export declare class BusinessApplicationAgent extends pulumi.CustomResource {
    ...
    readonly agentSystems: pulumi.Output<outputs.securityinsights.v20240401preview.AgentSystemResponse[]>;
    /**
     * Describes the configuration of a Business Application Agent.
     */
    readonly configuration: pulumi.Output<outputs.securityinsights.v20240401preview.SapAgentConfigurationResponse>;
...
export interface BusinessApplicationAgentArgs {
     ...
     * Describes the configuration of a Business Application Agent.
     */
    configuration: pulumi.Input<inputs.securityinsights.v20240401preview.SapAgentConfigurationArgs>;
