...
export declare class PublicCloudConnector extends pulumi.CustomResource {
     ...
     */
    readonly awsCloudProfile: pulumi.Output<outputs.hybridconnectivity.v20241201.AwsCloudProfileResponse>;
    /**
...
export interface PublicCloudConnectorArgs {
     ...
     * Cloud profile for AWS.
     */
    awsCloudProfile: pulumi.Input<inputs.hybridconnectivity.v20241201.AwsCloudProfileArgs>;
    /**
     * Host cloud the public cloud connector.
     */
    hostType: pulumi.Input<string | enums.hybridconnectivity.v20241201.HostType>;
    /**
     * The geo-location where the resource lives
     */
