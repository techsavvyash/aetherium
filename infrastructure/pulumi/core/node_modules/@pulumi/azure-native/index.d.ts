...
export { aad, aadiam, addons, advisor, agfoodplatform, agricultureplatform, alertsmanagement, analysisservices, apicenter, apimanagement, app, appcomplianceautomation, appconfiguration, appplatform, attestation, authorization, automanage, automation, avs, awsconnector, azureactivedirectory, azurearcdata, azuredata, azuredatatransfer, azurefleet, azurelargeinstance, azureplaywrightservice, azuresphere, azurestack, azurestackhci, baremetalinfrastructure, batch, billing, billingbenefits, blueprint, botservice, cache, cdn, certificateregistration, changeanalysis, chaos, cloudngfw, codesigning, cognitiveservices, communication, community, compute, confidentialledger, config, confluent, connectedcache, connectedvmwarevsphere, consumption, containerinstance, containerregistry, containerservice, containerstorage, contoso, costmanagement, customerinsights, customproviders, dashboard, databasefleetmanager, databasewatcher, databox, databoxedge, databricks, datacatalog, datadog, datafactory, datalakeanalytics, datalakestore, datamigration, dataprotection, datareplication, datashare, dbformariadb, dbformysql, dbforpostgresql, delegatednetwork, dependencymap, desktopvirtualization, devcenter, devhub, deviceregistry, devices, deviceupdate, devopsinfrastructure, devspaces, devtestlab, digitaltwins, documentdb, domainregistration, durabletask, dynamics365fraudprotection, easm, edge, edgemarketplace, edgeorder, education, elastic, elasticsan, engagementfabric, enterpriseknowledgegraph, eventgrid, eventhub, extendedlocation, fabric, features, fluidrelay, graphservices, guestconfiguration, hardwaresecuritymodules, hdinsight, healthbot, healthcareapis, healthdataaiservices, hybridcloud, hybridcompute, hybridconnectivity, hybridcontainerservice, hybriddata, hybridnetwork, impact, importexport, insights, integrationspaces, intune, iotcentral, iotfirmwaredefense, iotoperations, iotoperationsdataprocessor, iotoperationsmq, iotoperationsorchestrator, keyvault, kubernetes, kubernetesconfiguration, kubernetesruntime, kusto, labservices, loadtestservice, logic, m365securityandcompliance, machinelearning, machinelearningservices, maintenance, managedidentity, managednetwork, managednetworkfabric, managedservices, management, managementpartner, manufacturingplatform, maps, marketplace, media, migrate, mixedreality, mobilenetwork, monitor, mysqldiscovery, netapp, network, networkcloud, networkfunction, notificationhubs, offazure, offazurespringboot, openenergyplatform, operationalinsights, operationsmanagement, orbital, peering, policyinsights, portal, portalservices, powerbi, powerbidedicated, powerplatform, professionalservice, programmableconnectivity, providerhub, purview, quantum, quota, recommendationsservice, recoveryservices, redhatopenshift, relay, resourceconnector, resourcegraph, resourcehealth, resources, saas, scheduler, scom, scvmm, search, secretsynccontroller, security, securityandcompliance, securityinsights, serialconsole, servicebus, servicefabric, servicefabricmesh, servicelinker, servicenetworking, signalrservice, softwareplan, solutions, sovereign, sql, sqlvirtualmachine, standbypool, storage, storageactions, storagecache, storagemover, storagepool, storagesync, storsimple, streamanalytics, subscription, synapse, syntex, testbase, timeseriesinsights, types, verifiedid, videoanalyzer, videoindexer, virtualmachineimages, vmwarecloudsimple, voiceservices, web, webpubsub, weightsandbiases, windowsesu, windowsiot, workloads, };
