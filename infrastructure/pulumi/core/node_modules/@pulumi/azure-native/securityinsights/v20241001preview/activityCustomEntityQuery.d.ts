...
export declare class ActivityCustomEntityQuery extends pulumi.CustomResource {
     ...
     */
    readonly queryDefinitions: pulumi.Output<outputs.securityinsights.v20241001preview.ActivityEntityQueriesPropertiesResponseQueryDefinitions | undefined>;
    /**
...
export interface ActivityCustomEntityQueryArgs {
     ...
     * The type of the query's source entity
     */
    inputEntityType?: pulumi.Input<string | enums.securityinsights.v20241001preview.EntityType>;
    /**
     ...
     * The Activity query definitions
     */
    queryDefinitions?: pulumi.Input<inputs.securityinsights.v20241001preview.ActivityEntityQueriesPropertiesQueryDefinitionsArgs>;
    /**
     * List of the fields of the source entity that are required to run the query
     */
