...
export interface EventGridDataConnectionArgs {
     ...
     * The name of blob storage event type to process.
     */
    blobStorageEventType?: pulumi.Input<string | enums.kusto.v20221229.BlobStorageEventType>;
    /**
     ...
     * The data format of the message. Optionally the data format can be added to each message.
     */
    dataFormat?: pulumi.Input<string | enums.kusto.v20221229.EventGridDataFormat>;
    /**
     ...
     * Indication for database routing information from the data connection, by default only database routing information is allowed
     */
    databaseRouting?: pulumi.Input<string | enums.kusto.v20221229.DatabaseRouting>;
    /**
     * The resource ID of the event grid that is subscribed to the storage account events.
     */
