...
export declare class Service extends pulumi.CustomResource {
     ...
     */
    readonly pccRules: pulumi.Output<outputs.mobilenetwork.v20230901.PccRuleConfigurationResponse[]>;
    /**
     ...
     */
    readonly serviceQosPolicy: pulumi.Output<outputs.mobilenetwork.v20230901.QosPolicyResponse | undefined>;
    /**
...
export interface ServiceArgs {
     ...
     * The set of data flow policy rules that make up this service.
     */
    pccRules: pulumi.Input<pulumi.Input<inputs.mobilenetwork.v20230901.PccRuleConfigurationArgs>[]>;
    /**
     ...
     * The QoS policy to use for packets matching this service. This can be overridden for particular flows using the ruleQosPolicy field in a PccRuleConfiguration. If this field is null then the UE's SIM policy will define the QoS settings.
     */
    serviceQosPolicy?: pulumi.Input<inputs.mobilenetwork.v20230901.QosPolicyArgs>;
    /**
     * Resource tags.
     */
    tags?: pulumi.Input<{
