...
export declare class Console extends pulumi.CustomResource {
     ...
     */
    readonly sshPublicKey: pulumi.Output<outputs.networkcloud.v20250201.SshPublicKeyResponse>;
    /**
...
export interface ConsoleArgs {
     ...
     * The indicator of whether the console access is enabled.
     */
    enabled: pulumi.Input<string | enums.networkcloud.v20250201.ConsoleEnabled>;
    /**
     * The date and time after which the key will be disallowed access.
     */
     ...
     * The SSH public key that will be provisioned for user access. The user is expected to have the corresponding SSH private key for logging in.
     */
    sshPublicKey: pulumi.Input<inputs.networkcloud.v20250201.SshPublicKeyArgs>;
    /**
     * Resource tags.
     */
    tags?: pulumi.Input<{
