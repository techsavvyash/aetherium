...
export interface GetInboundNatRuleResult {
     ...
     */
    readonly backendAddressPool?: outputs.network.v20240501.SubResourceResponse;
    /**
     * A reference to a private IP address defined on a network interface of a VM. Traffic sent to the frontend port of each of the frontend IP configurations is forwarded to the backend IP.
     */
    readonly backendIPConfiguration: outputs.network.v20240501.NetworkInterfaceIPConfigurationResponse;
    /**
     ...
     */
    readonly frontendIPConfiguration?: outputs.network.v20240501.SubResourceResponse;
    /**
