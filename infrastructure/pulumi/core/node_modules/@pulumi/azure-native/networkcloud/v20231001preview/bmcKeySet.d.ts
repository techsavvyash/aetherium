...
export declare class BmcKeySet extends pulumi.CustomResource {
     ...
     */
    readonly userList: pulumi.Output<outputs.networkcloud.v20231001preview.KeySetUserResponse[]>;
    /**
     * The status evaluation of each user.
     */
    readonly userListStatus: pulumi.Output<outputs.networkcloud.v20231001preview.KeySetUserStatusResponse[]>;
    /**
...
export interface BmcKeySetArgs {
     ...
     * The access level allowed for the users in this key set.
     */
    privilegeLevel: pulumi.Input<string | enums.networkcloud.v20231001preview.BmcKeySetPrivilegeLevel>;
    /**
