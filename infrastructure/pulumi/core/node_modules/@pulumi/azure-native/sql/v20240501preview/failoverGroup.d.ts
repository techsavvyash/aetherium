...
export declare class FailoverGroup extends pulumi.CustomResource {
     ...
     */
    readonly partnerServers: pulumi.Output<outputs.sql.v20240501preview.PartnerInfoResponse[]>;
    /**
     * Read-only endpoint of the failover group instance.
     */
    readonly readOnlyEndpoint: pulumi.Output<outputs.sql.v20240501preview.FailoverGroupReadOnlyEndpointResponse | undefined>;
    /**
     * Read-write endpoint of the failover group instance.
     */
    readonly readWriteEndpoint: pulumi.Output<outputs.sql.v20240501preview.FailoverGroupReadWriteEndpointResponse>;
    /**
...
export interface FailoverGroupArgs {
     ...
     * List of partner server information for the failover group.
     */
    partnerServers: pulumi.Input<pulumi.Input<inputs.sql.v20240501preview.PartnerInfoArgs>[]>;
    /**
     * Read-only endpoint of the failover group instance.
     */
    readOnlyEndpoint?: pulumi.Input<inputs.sql.v20240501preview.FailoverGroupReadOnlyEndpointArgs>;
    /**
     * Read-write endpoint of the failover group instance.
     */
    readWriteEndpoint: pulumi.Input<inputs.sql.v20240501preview.FailoverGroupReadWriteEndpointArgs>;
    /**
     ...
     */
    secondaryType?: pulumi.Input<string | enums.sql.v20240501preview.FailoverGroupDatabasesSecondaryType>;
    /**
