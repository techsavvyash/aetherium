...
export declare class PolicyAssignment extends pulumi.CustomResource {
     ...
     */
    readonly identity: pulumi.Output<outputs.authorization.v20240401.IdentityResponse | undefined>;
    /**
     ...
     */
    readonly nonComplianceMessages: pulumi.Output<outputs.authorization.v20240401.NonComplianceMessageResponse[] | undefined>;
    /**
     ...
     */
    readonly overrides: pulumi.Output<outputs.authorization.v20240401.OverrideResponse[] | undefined>;
    /**
     * The parameter values for the assigned policy rule. The keys are the parameter names.
     */
    readonly parameters: pulumi.Output<{
        [key: string]: outputs.authorization.v20240401.ParameterValuesValueResponse;
    } | undefined>;
    /**
     ...
     */
    readonly resourceSelectors: pulumi.Output<outputs.authorization.v20240401.ResourceSelectorResponse[] | undefined>;
    /**
     ...
     */
    readonly systemData: pulumi.Output<outputs.authorization.v20240401.SystemDataResponse>;
    /**
...
export interface PolicyAssignmentArgs {
     ...
     * The policy assignment enforcement mode. Possible values are Default and DoNotEnforce.
     */
    enforcementMode?: pulumi.Input<string | enums.authorization.v20240401.EnforcementMode>;
    /**
     * The managed identity associated with the policy assignment.
     */
     ...
     * The messages that describe why a resource is non-compliant with the policy.
     */
    nonComplianceMessages?: pulumi.Input<pulumi.Input<inputs.authorization.v20240401.NonComplianceMessageArgs>[]>;
    /**
     * The policy's excluded scopes.
     */
     ...
     * The policy property value override.
     */
    overrides?: pulumi.Input<pulumi.Input<inputs.authorization.v20240401.OverrideArgs>[]>;
    /**
     * The parameter values for the assigned policy rule. The keys are the parameter names.
     */
    parameters?: pulumi.Input<{
        [key: string]: pulumi.Input<inputs.authorization.v20240401.ParameterValuesValueArgs>;
    }>;
    /**
     * The name of the policy assignment.
     */
     ...
     * The resource selector list to filter policies by resource properties.
     */
    resourceSelectors?: pulumi.Input<pulumi.Input<inputs.authorization.v20240401.ResourceSelectorArgs>[]>;
    /**
