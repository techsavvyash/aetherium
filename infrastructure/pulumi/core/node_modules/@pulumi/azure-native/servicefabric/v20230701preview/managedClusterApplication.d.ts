...
export declare class ManagedClusterApplication extends pulumi.CustomResource {
     ...
     */
    readonly identity: pulumi.Output<outputs.servicefabric.v20230701preview.ManagedIdentityResponse | undefined>;
    /**
     ...
     */
    readonly managedIdentities: pulumi.Output<outputs.servicefabric.v20230701preview.ApplicationUserAssignedIdentityResponse[] | undefined>;
    /**
     * Azure resource name.
     */
     ...
     */
    readonly upgradePolicy: pulumi.Output<outputs.servicefabric.v20230701preview.ApplicationUpgradePolicyResponse | undefined>;
    /**
...
export interface ManagedClusterApplicationArgs {
     ...
     * Describes the managed identities for an Azure resource.
     */
    identity?: pulumi.Input<inputs.servicefabric.v20230701preview.ManagedIdentityArgs>;
    /**
     * Resource location depends on the parent resource.
     */
     ...
     * List of user assigned identities for the application, each mapped to a friendly name.
     */
    managedIdentities?: pulumi.Input<pulumi.Input<inputs.servicefabric.v20230701preview.ApplicationUserAssignedIdentityArgs>[]>;
    /**
     * List of application parameters with overridden values from their default values specified in the application manifest.
     */
     ...
     * Describes the policy for a monitored application upgrade.
     */
    upgradePolicy?: pulumi.Input<inputs.servicefabric.v20230701preview.ApplicationUpgradePolicyArgs>;
    /**
     * The version of the application type as defined in the application manifest.
     * This name must be the full Arm Resource ID for the referenced application type version.
     */
