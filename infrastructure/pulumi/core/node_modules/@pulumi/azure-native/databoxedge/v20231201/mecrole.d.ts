...
export declare class MECRole extends pulumi.CustomResource {
     ...
     */
    readonly connectionString: pulumi.Output<outputs.databoxedge.v20231201.AsymmetricEncryptedSecretResponse | undefined>;
    /**
     * Controller Endpoint.
     */
...
export interface MECRoleArgs {
     ...
     * Activation key of the MEC.
     */
    connectionString?: pulumi.Input<inputs.databoxedge.v20231201.AsymmetricEncryptedSecretArgs>;
    /**
     * Controller Endpoint.
     */
