...
export declare class IpExtendedCommunity extends pulumi.CustomResource {
     ...
     */
    readonly ipExtendedCommunityRules: pulumi.Output<outputs.managednetworkfabric.v20230615.IpExtendedCommunityRuleResponse[]>;
    /**
...
export interface IpExtendedCommunityArgs {
     ...
     * List of IP Extended Community Rules.
     */
    ipExtendedCommunityRules: pulumi.Input<pulumi.Input<inputs.managednetworkfabric.v20230615.IpExtendedCommunityRuleArgs>[]>;
    /**
     * The geo-location where the resource lives
     */
