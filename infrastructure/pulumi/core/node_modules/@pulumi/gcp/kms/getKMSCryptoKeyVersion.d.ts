 ...
 * ```
 */
export declare function getKMSCryptoKeyVersionOutput(args: GetKMSCryptoKeyVersionOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetKMSCryptoKeyVersionResult>;
/**
 * A collection of arguments for invoking getKMSCryptoKeyVersion.
 */
