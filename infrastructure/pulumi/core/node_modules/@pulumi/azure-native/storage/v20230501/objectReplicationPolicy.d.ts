...
export declare class ObjectReplicationPolicy extends pulumi.CustomResource {
     ...
     */
    readonly rules: pulumi.Output<outputs.storage.v20230501.ObjectReplicationPolicyRuleResponse[] | undefined>;
    /**
...
export interface ObjectReplicationPolicyArgs {
     ...
     * The storage account object replication rules.
     */
    rules?: pulumi.Input<pulumi.Input<inputs.storage.v20230501.ObjectReplicationPolicyRuleArgs>[]>;
    /**
     * Required. Source account name. It should be full resource id if allowCrossTenantReplication set to false.
     */
