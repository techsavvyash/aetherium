...
export interface ListWorkspaceKeysResult {
    ...
    readonly containerRegistryCredentials: outputs.machinelearningservices.v20230401.RegistryListCredentialsResultResponse;
    readonly notebookAccessKeys: outputs.machinelearningservices.v20230401.ListNotebookKeysResultResponse;
