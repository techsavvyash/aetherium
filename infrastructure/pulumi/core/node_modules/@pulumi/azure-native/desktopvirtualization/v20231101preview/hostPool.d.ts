...
export declare class HostPool extends pulumi.CustomResource {
     ...
     */
    readonly agentUpdate: pulumi.Output<outputs.desktopvirtualization.v20231101preview.AgentUpdatePropertiesResponse | undefined>;
    /**
     ...
     */
    readonly registrationInfo: pulumi.Output<outputs.desktopvirtualization.v20231101preview.RegistrationInfoResponse | undefined>;
    /**
...
export interface HostPoolArgs {
     ...
     * The session host configuration for updating agent, monitoring agent, and stack component.
     */
    agentUpdate?: pulumi.Input<inputs.desktopvirtualization.v20231101preview.AgentUpdatePropertiesArgs>;
    /**
     * Custom rdp property of HostPool.
     */
     ...
     * HostPool type for desktop.
     */
    hostPoolType: pulumi.Input<string | enums.desktopvirtualization.v20231101preview.HostPoolType>;
     ...
     * The type of the load balancer.
     */
    loadBalancerType: pulumi.Input<string | enums.desktopvirtualization.v20231101preview.LoadBalancerType>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * The type of management for this hostpool, Automated or Standard. The default value is Automated.
     */
    managementType?: pulumi.Input<string | enums.desktopvirtualization.v20231101preview.ManagementType>;
    /**
     * The max session limit of HostPool.
     */
     ...
     * PersonalDesktopAssignment type for HostPool.
     */
    personalDesktopAssignmentType?: pulumi.Input<string | enums.desktopvirtualization.v20231101preview.PersonalDesktopAssignmentType>;
    plan?: pulumi.Input<inputs.desktopvirtualization.v20231101preview.ResourceModelWithAllowedPropertySetPlanArgs>;
    /**
     * The type of preferred application group type, default to Desktop Application Group
     */
    preferredAppGroupType: pulumi.Input<string | enums.desktopvirtualization.v20231101preview.PreferredAppGroupType>;
    /**
     * Enabled allows this resource to be accessed from both public and private networks, Disabled allows this resource to only be accessed via private endpoints
     */
    publicNetworkAccess?: pulumi.Input<string | enums.desktopvirtualization.v20231101preview.HostpoolPublicNetworkAccess>;
    /**
     * The registration info of HostPool.
     */
    registrationInfo?: pulumi.Input<inputs.desktopvirtualization.v20231101preview.RegistrationInfoArgs>;
    /**
     ...
     * The type of single sign on Secret Type.
     */
    ssoSecretType?: pulumi.Input<string | enums.desktopvirtualization.v20231101preview.SSOSecretType>;
    /**
     * URL to customer ADFS server for signing WVD SSO certificates.
     */
