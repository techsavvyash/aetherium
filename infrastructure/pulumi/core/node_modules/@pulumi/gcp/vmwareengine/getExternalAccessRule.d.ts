 ...
 * ```
 */
export declare function getExternalAccessRuleOutput(args: GetExternalAccessRuleOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetExternalAccessRuleResult>;
/**
 * A collection of arguments for invoking getExternalAccessRule.
 */
