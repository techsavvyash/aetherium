...
export declare class ProtectionPolicy extends pulumi.CustomResource {
     ...
     */
    readonly properties: pulumi.Output<outputs.recoveryservices.v20230401.AzureFileShareProtectionPolicyResponse | outputs.recoveryservices.v20230401.AzureIaaSVMProtectionPolicyResponse | outputs.recoveryservices.v20230401.AzureSqlProtectionPolicyResponse | outputs.recoveryservices.v20230401.AzureVmWorkloadProtectionPolicyResponse | outputs.recoveryservices.v20230401.GenericProtectionPolicyResponse | outputs.recoveryservices.v20230401.MabProtectionPolicyResponse>;
    /**
     * Resource tags.
     */
...
export interface ProtectionPolicyArgs {
     ...
     * ProtectionPolicyResource properties
     */
    properties?: pulumi.Input<inputs.recoveryservices.v20230401.AzureFileShareProtectionPolicyArgs | inputs.recoveryservices.v20230401.AzureIaaSVMProtectionPolicyArgs | inputs.recoveryservices.v20230401.AzureSqlProtectionPolicyArgs | inputs.recoveryservices.v20230401.AzureVmWorkloadProtectionPolicyArgs | inputs.recoveryservices.v20230401.GenericProtectionPolicyArgs | inputs.recoveryservices.v20230401.MabProtectionPolicyArgs>;
    /**
