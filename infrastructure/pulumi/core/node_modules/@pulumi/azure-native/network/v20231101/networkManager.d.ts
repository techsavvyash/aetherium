...
export declare class NetworkManager extends pulumi.CustomResource {
     ...
     */
    readonly networkManagerScopes: pulumi.Output<outputs.network.v20231101.NetworkManagerPropertiesResponseNetworkManagerScopes>;
    /**
...
export interface NetworkManagerArgs {
     ...
     * Scope Access.
     */
    networkManagerScopeAccesses: pulumi.Input<pulumi.Input<string | enums.network.v20231101.ConfigurationType>[]>;
    /**
     * Scope of Network Manager.
     */
    networkManagerScopes: pulumi.Input<inputs.network.v20231101.NetworkManagerPropertiesNetworkManagerScopesArgs>;
    /**
