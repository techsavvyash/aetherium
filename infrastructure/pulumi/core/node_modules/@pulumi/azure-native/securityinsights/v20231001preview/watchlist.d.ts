...
export declare class Watchlist extends pulumi.CustomResource {
     ...
     */
    readonly createdBy: pulumi.Output<outputs.securityinsights.v20231001preview.WatchlistUserInfoResponse | undefined>;
    /**
     ...
     */
    readonly updatedBy: pulumi.Output<outputs.securityinsights.v20231001preview.WatchlistUserInfoResponse | undefined>;
    /**
...
export interface WatchlistArgs {
     ...
     * Describes a user that created the watchlist
     */
    createdBy?: pulumi.Input<inputs.securityinsights.v20231001preview.WatchlistUserInfoArgs>;
    /**
     * The default duration of a watchlist (in ISO 8601 duration format)
     */
     ...
     * The sourceType of the watchlist
     */
    sourceType?: pulumi.Input<string | enums.securityinsights.v20231001preview.SourceType>;
    /**
     * The tenantId where the watchlist belongs to
     */
     ...
     * Describes a user that updated the watchlist
     */
    updatedBy?: pulumi.Input<inputs.securityinsights.v20231001preview.WatchlistUserInfoArgs>;
    /**
     * The status of the Watchlist upload : New, InProgress or Complete. Pls note : When a Watchlist upload status is equal to InProgress, the Watchlist cannot be deleted
     */
