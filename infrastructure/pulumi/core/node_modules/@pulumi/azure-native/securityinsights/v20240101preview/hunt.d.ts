...
export declare class Hunt extends pulumi.CustomResource {
     ...
     */
    readonly owner: pulumi.Output<outputs.securityinsights.v20240101preview.HuntOwnerResponse | undefined>;
    /**
...
export interface HuntArgs {
     ...
     * A list of mitre attack tactics the hunt is associated with
     */
    attackTactics?: pulumi.Input<pulumi.Input<string | enums.securityinsights.v20240101preview.AttackTactic>[]>;
    /**
     * A list of a mitre attack techniques the hunt is associated with
     */
     ...
     * The hypothesis status of the hunt.
     */
    hypothesisStatus?: pulumi.Input<string | enums.securityinsights.v20240101preview.HypothesisStatus>;
    /**
     * List of labels relevant to this hunt
     */
     ...
     * Describes a user that the hunt is assigned to
     */
    owner?: pulumi.Input<inputs.securityinsights.v20240101preview.HuntOwnerArgs>;
    /**
     ...
     * The status of the hunt.
     */
    status?: pulumi.Input<string | enums.securityinsights.v20240101preview.Status>;
    /**
