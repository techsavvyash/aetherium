...
export declare class ProximityPlacementGroup extends pulumi.CustomResource {
     ...
     */
    readonly availabilitySets: pulumi.Output<outputs.compute.v20240301.SubResourceWithColocationStatusResponse[]>;
    /**
     * Describes colocation status of the Proximity Placement Group.
     */
    readonly colocationStatus: pulumi.Output<outputs.compute.v20240301.InstanceViewStatusResponse | undefined>;
    /**
     * Specifies the user intent of the proximity placement group.
     */
    readonly intent: pulumi.Output<outputs.compute.v20240301.ProximityPlacementGroupPropertiesResponseIntent | undefined>;
    /**
     * Resource location
     */
     ...
     */
    readonly virtualMachineScaleSets: pulumi.Output<outputs.compute.v20240301.SubResourceWithColocationStatusResponse[]>;
    /**
     * A list of references to all virtual machines in the proximity placement group.
     */
    readonly virtualMachines: pulumi.Output<outputs.compute.v20240301.SubResourceWithColocationStatusResponse[]>;
    /**
...
export interface ProximityPlacementGroupArgs {
     ...
     * Describes colocation status of the Proximity Placement Group.
     */
    colocationStatus?: pulumi.Input<inputs.compute.v20240301.InstanceViewStatusArgs>;
    /**
     * Specifies the user intent of the proximity placement group.
     */
    intent?: pulumi.Input<inputs.compute.v20240301.ProximityPlacementGroupPropertiesIntentArgs>;
    /**
     * Resource location
     */
     ...
     * Specifies the type of the proximity placement group. Possible values are: **Standard** : Co-locate resources within an Azure region or Availability Zone. **Ultra** : For future use.
     */
    proximityPlacementGroupType?: pulumi.Input<string | enums.compute.v20240301.ProximityPlacementGroupType>;
    /**
