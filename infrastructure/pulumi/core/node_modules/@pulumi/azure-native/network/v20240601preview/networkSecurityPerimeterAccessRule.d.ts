...
export declare class NetworkSecurityPerimeterAccessRule extends pulumi.CustomResource {
     ...
     */
    readonly networkSecurityPerimeters: pulumi.Output<outputs.network.v20240601preview.PerimeterBasedAccessRuleResponse[]>;
    /**
     ...
     */
    readonly subscriptions: pulumi.Output<outputs.network.v20240601preview.SubscriptionIdResponse[] | undefined>;
    /**
     * Resource tags.
     */
...
export interface NetworkSecurityPerimeterAccessRuleArgs {
     ...
     * Direction that specifies whether the access rules is inbound/outbound.
     */
    direction?: pulumi.Input<string | enums.network.v20240601preview.AccessRuleDirection>;
    /**
     * Outbound rules email address format.
     */
     ...
     * List of subscription ids
     */
    subscriptions?: pulumi.Input<pulumi.Input<inputs.network.v20240601preview.SubscriptionIdArgs>[]>;
    /**
     * Resource tags.
     */
    tags?: pulumi.Input<{
