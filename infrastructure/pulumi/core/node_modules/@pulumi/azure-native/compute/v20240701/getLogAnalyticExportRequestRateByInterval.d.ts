...
export interface GetLogAnalyticExportRequestRateByIntervalArgs {
     ...
     */
    intervalLength: enums.compute.v20240701.IntervalInMins;
    /**
...
export interface GetLogAnalyticExportRequestRateByIntervalResult {
     ...
     * LogAnalyticsOutput
     */
    readonly properties: outputs.compute.v20240701.LogAnalyticsOutputResponse;
}
/**
 * Export logs that show Api requests made by this subscription in the given time window to show throttling activities.
 */
...
export interface GetLogAnalyticExportRequestRateByIntervalOutputArgs {
     ...
     * Interval value in minutes used to create LogAnalytics call rate logs.
     */
    intervalLength: pulumi.Input<enums.compute.v20240701.IntervalInMins>;
    /**
     * The location upon which virtual-machine-sizes is queried.
     */
