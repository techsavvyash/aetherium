...
export interface GetProjectCatalogSyncErrorDetailsResult {
     ...
     */
    readonly conflicts: outputs.devcenter.v20250201.CatalogConflictErrorResponse[];
    /**
     * Errors that occured during synchronization.
     */
    readonly errors: outputs.devcenter.v20250201.CatalogSyncErrorResponse[];
    /**
     * Error information for the overall synchronization operation.
     */
    readonly operationError: outputs.devcenter.v20250201.CatalogErrorDetailsResponse;
}
/**
 * Gets project catalog synchronization error details
 */
