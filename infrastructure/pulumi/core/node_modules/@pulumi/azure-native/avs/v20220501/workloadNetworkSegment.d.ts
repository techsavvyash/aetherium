...
export declare class WorkloadNetworkSegment extends pulumi.CustomResource {
     ...
     */
    readonly portVif: pulumi.Output<outputs.avs.v20220501.WorkloadNetworkSegmentPortVifResponse[]>;
    /**
     ...
     */
    readonly subnet: pulumi.Output<outputs.avs.v20220501.WorkloadNetworkSegmentSubnetResponse | undefined>;
    /**
     * Resource type.
     */
...
export interface WorkloadNetworkSegmentArgs {
     ...
     * Subnet which to connect segment to.
     */
    subnet?: pulumi.Input<inputs.avs.v20220501.WorkloadNetworkSegmentSubnetArgs>;
}
