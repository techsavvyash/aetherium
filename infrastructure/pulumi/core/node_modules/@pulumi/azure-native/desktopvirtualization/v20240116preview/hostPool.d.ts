...
export declare class HostPool extends pulumi.CustomResource {
     ...
     */
    readonly agentUpdate: pulumi.Output<outputs.desktopvirtualization.v20240116preview.AgentUpdatePropertiesResponse | undefined>;
    /**
     ...
     */
    readonly privateEndpointConnections: pulumi.Output<outputs.desktopvirtualization.v20240116preview.PrivateEndpointConnectionResponse[]>;
    /**
     ...
     */
    readonly registrationInfo: pulumi.Output<outputs.desktopvirtualization.v20240116preview.RegistrationInfoResponse | undefined>;
    /**
     * Default: AVD-wide settings are used to determine connection availability, Enabled: UDP will attempt this connection type when making connections. This means that this connection is possible, but is not guaranteed, as there are other factors that may prevent this connection type, Disabled: UDP will not attempt this connection type when making connections
     */
...
export interface HostPoolArgs {
     ...
     * The session host configuration for updating agent, monitoring agent, and stack component.
     */
    agentUpdate?: pulumi.Input<inputs.desktopvirtualization.v20240116preview.AgentUpdatePropertiesArgs>;
    /**
     * Custom rdp property of HostPool.
     */
     ...
     * Default: AVD-wide settings are used to determine connection availability, Enabled: UDP will attempt this connection type when making connections. This means that this connection is possible, but is not guaranteed, as there are other factors that may prevent this connection type, Disabled: UDP will not attempt this connection type when making connections
     */
    directUDP?: pulumi.Input<string | enums.desktopvirtualization.v20240116preview.DirectUDP>;
    /**
     * Friendly name of HostPool.
     */
     ...
     * HostPool type for desktop.
     */
    hostPoolType: pulumi.Input<string | enums.desktopvirtualization.v20240116preview.HostPoolType>;
     ...
     * The type of the load balancer.
     */
    loadBalancerType: pulumi.Input<string | enums.desktopvirtualization.v20240116preview.LoadBalancerType>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * Default: AVD-wide settings are used to determine connection availability, Enabled: UDP will attempt this connection type when making connections. This means that this connection is possible, but is not guaranteed, as there are other factors that may prevent this connection type, Disabled: UDP will not attempt this connection type when making connections
     */
    managedPrivateUDP?: pulumi.Input<string | enums.desktopvirtualization.v20240116preview.ManagedPrivateUDP>;
    /**
     * The type of management for this hostpool, Automated or Standard. The default value is Automated.
     */
    managementType?: pulumi.Input<string | enums.desktopvirtualization.v20240116preview.ManagementType>;
    /**
     * The max session limit of HostPool.
     */
     ...
     * PersonalDesktopAssignment type for HostPool.
     */
    personalDesktopAssignmentType?: pulumi.Input<string | enums.desktopvirtualization.v20240116preview.PersonalDesktopAssignmentType>;
    plan?: pulumi.Input<inputs.desktopvirtualization.v20240116preview.ResourceModelWithAllowedPropertySetPlanArgs>;
    /**
     * The type of preferred application group type, default to Desktop Application Group
     */
    preferredAppGroupType: pulumi.Input<string | enums.desktopvirtualization.v20240116preview.PreferredAppGroupType>;
    /**
     * Enabled allows this resource to be accessed from both public and private networks, Disabled allows this resource to only be accessed via private endpoints
     */
    publicNetworkAccess?: pulumi.Input<string | enums.desktopvirtualization.v20240116preview.HostpoolPublicNetworkAccess>;
    /**
     * Default: AVD-wide settings are used to determine connection availability, Enabled: UDP will attempt this connection type when making connections. This means that this connection is possible, but is not guaranteed, as there are other factors that may prevent this connection type, Disabled: UDP will not attempt this connection type when making connections
     */
    publicUDP?: pulumi.Input<string | enums.desktopvirtualization.v20240116preview.PublicUDP>;
    /**
     * The registration info of HostPool.
     */
    registrationInfo?: pulumi.Input<inputs.desktopvirtualization.v20240116preview.RegistrationInfoArgs>;
    /**
     * Default: AVD-wide settings are used to determine connection availability, Enabled: UDP will attempt this connection type when making connections. This means that this connection is possible, but is not guaranteed, as there are other factors that may prevent this connection type, Disabled: UDP will not attempt this connection type when making connections
     */
    relayUDP?: pulumi.Input<string | enums.desktopvirtualization.v20240116preview.RelayUDP>;
    /**
     ...
     * The type of single sign on Secret Type.
     */
    ssoSecretType?: pulumi.Input<string | enums.desktopvirtualization.v20240116preview.SSOSecretType>;
    /**
     * URL to customer ADFS server for signing WVD SSO certificates.
     */
