...
export interface GetP2sVpnGatewayP2sVpnConnectionHealthResult {
     ...
     */
    readonly p2SConnectionConfigurations?: outputs.network.v20230401.P2SConnectionConfigurationResponse[];
    /**
     ...
     */
    readonly vpnClientConnectionHealth: outputs.network.v20230401.VpnClientConnectionHealthResponse;
    /**
     ...
     */
    readonly vpnServerConfiguration?: outputs.network.v20230401.SubResourceResponse;
}
/**
 * Gets the connection health of P2S clients of the virtual wan P2SVpnGateway in the specified resource group.
 */
