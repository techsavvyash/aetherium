...
export declare const CatalogItemType: {
    ...
    readonly ImageDefinition: "ImageDefinition";
};
/**
...
export declare const DevCenterResourceType: {
    readonly Images: "Images";
    readonly AttachedNetworks: "AttachedNetworks";
    readonly Skus: "Skus";
};
/**
...
export declare const InstallAzureMonitorAgentEnableStatus: {
    readonly Enabled: "Enabled";
    readonly Disabled: "Disabled";
};
/**
...
export declare const MicrosoftHostedNetworkEnableStatus: {
    readonly Enabled: "Enabled";
    readonly Disabled: "Disabled";
};
/**
...
export declare const PoolDevBoxDefinitionType: {
...
export declare const StopOnNoConnectEnableStatus: {
    readonly Enabled: "Enabled";
    readonly Disabled: "Disabled";
};
/**
