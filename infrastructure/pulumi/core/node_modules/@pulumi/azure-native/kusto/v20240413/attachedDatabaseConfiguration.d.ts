...
export declare class AttachedDatabaseConfiguration extends pulumi.CustomResource {
     ...
     */
    readonly tableLevelSharingProperties: pulumi.Output<outputs.kusto.v20240413.TableLevelSharingPropertiesResponse | undefined>;
    /**
...
export interface AttachedDatabaseConfigurationArgs {
     ...
     * The default principals modification kind
     */
    defaultPrincipalsModificationKind: pulumi.Input<string | enums.kusto.v20240413.DefaultPrincipalsModificationKind>;
    /**
     * Resource location.
     */
     ...
     * Table level sharing specifications
     */
    tableLevelSharingProperties?: pulumi.Input<inputs.kusto.v20240413.TableLevelSharingPropertiesArgs>;
}
