...
export declare class DscNodeConfiguration extends pulumi.CustomResource {
     ...
     */
    readonly configuration: pulumi.Output<outputs.automation.v20241023.DscConfigurationAssociationPropertyResponse | undefined>;
    /**
...
export interface DscNodeConfigurationArgs {
     ...
     * Gets or sets the configuration of the node.
     */
    configuration: pulumi.Input<inputs.automation.v20241023.DscConfigurationAssociationPropertyArgs>;
    /**
     * If a new build version of NodeConfiguration is required.
     */
