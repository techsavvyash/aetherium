...
export declare class PolicySetDefinitionAtManagementGroup extends pulumi.CustomResource {
    ...
    readonly parameters: pulumi.Output<{
        [key: string]: outputs.authorization.v20250101.ParameterDefinitionsValueResponse;
    } | undefined>;
    /**
     * The metadata describing groups of policy definition references within the policy set definition.
     */
    readonly policyDefinitionGroups: pulumi.Output<outputs.authorization.v20250101.PolicyDefinitionGroupResponse[] | undefined>;
    /**
     * An array of policy definition references.
     */
    readonly policyDefinitions: pulumi.Output<outputs.authorization.v20250101.PolicyDefinitionReferenceResponse[]>;
    /**
...
export interface PolicySetDefinitionAtManagementGroupArgs {
    ...
    parameters?: pulumi.Input<{
        [key: string]: pulumi.Input<inputs.authorization.v20250101.ParameterDefinitionsValueArgs>;
    }>;
    /**
     * The metadata describing groups of policy definition references within the policy set definition.
     */
