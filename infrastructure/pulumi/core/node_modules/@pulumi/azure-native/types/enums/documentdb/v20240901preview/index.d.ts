...
export declare const AutoReplicate: {
    readonly None: "None";
    readonly SystemKeyspaces: "SystemKeyspaces";
    readonly AllKeyspaces: "AllKeyspaces";
};
/**
 * The form of AutoReplicate that is being used by this cluster.
 */
export type AutoReplicate = (typeof AutoReplicate)[keyof typeof AutoReplicate];
...
export declare const CapacityMode: {
    readonly None: "None";
...
export declare const ScheduledEventStrategy: {
    readonly Ignore: "Ignore";
    readonly StopAny: "StopAny";
    readonly StopByRack: "StopByRack";
};
/**
 * How the nodes in the cluster react to scheduled events
 */
export type ScheduledEventStrategy = (typeof ScheduledEventStrategy)[keyof typeof ScheduledEventStrategy];
