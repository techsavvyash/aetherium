...
export declare class BrokerListener extends pulumi.CustomResource {
     ...
     */
    readonly tls: pulumi.Output<outputs.iotoperationsmq.v20231004preview.TlsCertMethodResponse | undefined>;
    /**
...
export interface BrokerListenerArgs {
     ...
     * The Kubernetes Service type to deploy for Listener.
     */
    serviceType?: pulumi.Input<string | enums.iotoperationsmq.v20231004preview.ServiceType>;
    /**
     * Resource tags.
     */
    tags?: pulumi.Input<{
     ...
     * Defines configuration of a TLS server certificate. NOTE Enum - Only one TLS Cert method is supported
     */
    tls?: pulumi.Input<inputs.iotoperationsmq.v20231004preview.TlsCertMethodArgs>;
}
