...
export declare class LiveEvent extends pulumi.CustomResource {
     ...
     */
    readonly crossSiteAccessPolicies: pulumi.Output<outputs.media.v20221101.CrossSiteAccessPoliciesResponse | undefined>;
    /**
     ...
     */
    readonly encoding: pulumi.Output<outputs.media.v20221101.LiveEventEncodingResponse | undefined>;
    /**
     ...
     */
    readonly input: pulumi.Output<outputs.media.v20221101.LiveEventInputResponse>;
    /**
     ...
     */
    readonly preview: pulumi.Output<outputs.media.v20221101.LiveEventPreviewResponse | undefined>;
    /**
     ...
     */
    readonly transcriptions: pulumi.Output<outputs.media.v20221101.LiveEventTranscriptionResponse[] | undefined>;
    /**
...
export interface LiveEventArgs {
     ...
     * Encoding settings for the live event. It configures whether a live encoder is used for the live event and settings for the live encoder if it is used.
     */
    encoding?: pulumi.Input<inputs.media.v20221101.LiveEventEncodingArgs>;
    /**
     * When useStaticHostname is set to true, the hostnamePrefix specifies the first part of the hostname assigned to the live event preview and ingest endpoints. The final hostname would be a combination of this prefix, the media service account name and a short code for the Azure Media Services data center.
     */
     ...
     * Live event input settings. It defines how the live event receives input from a contribution encoder.
     */
    input: pulumi.Input<inputs.media.v20221101.LiveEventInputArgs>;
    /**
     ...
     * Live event preview settings. Preview allows live event producers to preview the live streaming content without creating any live output.
     */
    preview?: pulumi.Input<inputs.media.v20221101.LiveEventPreviewArgs>;
    /**
     ...
     * The options to use for the LiveEvent. This value is specified at creation time and cannot be updated. The valid values for the array entry values are 'Default' and 'LowLatency'.
     */
    streamOptions?: pulumi.Input<pulumi.Input<string | enums.media.v20221101.StreamOptionsFlag>[]>;
    /**
     * Resource tags.
     */
    tags?: pulumi.Input<{
     ...
     * Live transcription settings for the live event. See https://go.microsoft.com/fwlink/?linkid=2133742 for more information about the live transcription feature.
     */
    transcriptions?: pulumi.Input<pulumi.Input<inputs.media.v20221101.LiveEventTranscriptionArgs>[]>;
    /**
     * Specifies whether a static hostname would be assigned to the live event preview and ingest endpoints. This value can only be updated if the live event is in Standby state
     */
