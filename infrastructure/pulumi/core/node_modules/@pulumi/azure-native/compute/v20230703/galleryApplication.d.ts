...
export declare class GalleryApplication extends pulumi.CustomResource {
     ...
     */
    readonly customActions: pulumi.Output<outputs.compute.v20230703.GalleryApplicationCustomActionResponse[] | undefined>;
    /**
...
export interface GalleryApplicationArgs {
     ...
     * A list of custom actions that can be performed with all of the Gallery Application Versions within this Gallery Application.
     */
    customActions?: pulumi.Input<pulumi.Input<inputs.compute.v20230703.GalleryApplicationCustomActionArgs>[]>;
    /**
     * The description of this gallery Application Definition resource. This property is updatable.
     */
     ...
     * This property allows you to specify the supported type of the OS that application is built for. Possible values are: **Windows,** **Linux.**
     */
    supportedOSType: pulumi.Input<enums.compute.v20230703.OperatingSystemTypes>;
    /**
     * Resource tags
     */
    tags?: pulumi.Input<{
