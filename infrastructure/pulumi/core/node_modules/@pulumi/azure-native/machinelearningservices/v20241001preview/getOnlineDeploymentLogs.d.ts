...
export interface GetOnlineDeploymentLogsArgs {
     ...
     */
    containerType?: string | enums.machinelearningservices.v20241001preview.ContainerType;
    /**
...
export interface GetOnlineDeploymentLogsOutputArgs {
     ...
     * The type of container to retrieve logs from.
     */
    containerType?: pulumi.Input<string | enums.machinelearningservices.v20241001preview.ContainerType>;
    /**
     * The name and identifier for the endpoint.
     */
