...
export declare class SqlResourceSqlRoleDefinition extends pulumi.CustomResource {
     ...
     */
    readonly permissions: pulumi.Output<outputs.documentdb.v20240815.PermissionResponse[] | undefined>;
    /**
...
export interface SqlResourceSqlRoleDefinitionArgs {
     ...
     * The set of operations allowed through this Role Definition.
     */
    permissions?: pulumi.Input<pulumi.Input<inputs.documentdb.v20240815.PermissionArgs>[]>;
    /**
     ...
     */
    type?: pulumi.Input<enums.documentdb.v20240815.RoleDefinitionType>;
}
