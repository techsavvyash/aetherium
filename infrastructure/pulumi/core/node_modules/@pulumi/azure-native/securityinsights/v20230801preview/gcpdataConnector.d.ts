...
export declare class GCPDataConnector extends pulumi.CustomResource {
     ...
     */
    readonly auth: pulumi.Output<outputs.securityinsights.v20230801preview.GCPAuthPropertiesResponse>;
    /**
     ...
     */
    readonly dcrConfig: pulumi.Output<outputs.securityinsights.v20230801preview.DCRConfigurationResponse | undefined>;
    /**
     ...
     */
    readonly request: pulumi.Output<outputs.securityinsights.v20230801preview.GCPRequestPropertiesResponse>;
    /**
...
export interface GCPDataConnectorArgs {
     ...
     * The auth section of the connector.
     */
    auth: pulumi.Input<inputs.securityinsights.v20230801preview.GCPAuthPropertiesArgs>;
    /**
     * The name of the connector definition that represents the UI config.
     */
     ...
     * The configuration of the destination of the data.
     */
    dcrConfig?: pulumi.Input<inputs.securityinsights.v20230801preview.DCRConfigurationArgs>;
    /**
     * The kind of the data connector
     * Expected value is 'GCP'.
     */
     ...
     * The request section of the connector.
     */
    request: pulumi.Input<inputs.securityinsights.v20230801preview.GCPRequestPropertiesArgs>;
    /**
