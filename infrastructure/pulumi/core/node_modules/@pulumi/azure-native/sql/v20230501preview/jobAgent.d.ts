...
export declare class JobAgent extends pulumi.CustomResource {
     ...
     */
    readonly identity: pulumi.Output<outputs.sql.v20230501preview.JobAgentIdentityResponse | undefined>;
    /**
     * Resource location.
     */
...
export interface JobAgentArgs {
     ...
     * The identity of the job agent.
     */
    identity?: pulumi.Input<inputs.sql.v20230501preview.JobAgentIdentityArgs>;
    /**
