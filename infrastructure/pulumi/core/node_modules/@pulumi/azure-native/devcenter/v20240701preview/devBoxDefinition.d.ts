...
export declare class DevBoxDefinition extends pulumi.CustomResource {
     ...
     */
    readonly activeImageReference: pulumi.Output<outputs.devcenter.v20240701preview.ImageReferenceResponse>;
    /**
     ...
     */
    readonly imageReference: pulumi.Output<outputs.devcenter.v20240701preview.ImageReferenceResponse>;
    /**
     * Details for image validator error. Populated when the image validation is not successful.
     */
    readonly imageValidationErrorDetails: pulumi.Output<outputs.devcenter.v20240701preview.ImageValidationErrorDetailsResponse>;
    /**
     ...
     */
    readonly sku: pulumi.Output<outputs.devcenter.v20240701preview.SkuResponse>;
    /**
...
export interface DevBoxDefinitionArgs {
     ...
     * Indicates whether Dev Boxes created with this definition are capable of hibernation. Not all images are capable of supporting hibernation. To find out more see https://aka.ms/devbox/hibernate
     */
    hibernateSupport?: pulumi.Input<string | enums.devcenter.v20240701preview.HibernateSupport>;
    /**
     * Image reference information.
     */
