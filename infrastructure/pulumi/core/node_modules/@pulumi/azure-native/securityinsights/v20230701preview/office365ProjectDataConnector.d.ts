...
export declare class Office365ProjectDataConnector extends pulumi.CustomResource {
     ...
     */
    readonly dataTypes: pulumi.Output<outputs.securityinsights.v20230701preview.Office365ProjectConnectorDataTypesResponse>;
    /**
...
export interface Office365ProjectDataConnectorArgs {
     ...
     * The available data types for the connector.
     */
    dataTypes: pulumi.Input<inputs.securityinsights.v20230701preview.Office365ProjectConnectorDataTypesArgs>;
    /**
     * The kind of the data connector
     * Expected value is 'Office365Project'.
     */
