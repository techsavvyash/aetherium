...
export declare class RestApiPollerDataConnector extends pulumi.CustomResource {
     ...
     */
    readonly dcrConfig: pulumi.Output<outputs.securityinsights.v20250301.DCRConfigurationResponse | undefined>;
    /**
     ...
     */
    readonly paging: pulumi.Output<outputs.securityinsights.v20250301.RestApiPollerRequestPagingConfigResponse | undefined>;
    /**
     * The request configuration.
     */
    readonly request: pulumi.Output<outputs.securityinsights.v20250301.RestApiPollerRequestConfigResponse>;
    /**
     * The response configuration.
     */
    readonly response: pulumi.Output<outputs.securityinsights.v20250301.CcpResponseConfigResponse | undefined>;
    /**
     * Azure Resource Manager metadata containing createdBy and modifiedBy information.
     */
    readonly systemData: pulumi.Output<outputs.securityinsights.v20250301.SystemDataResponse>;
    /**
...
export interface RestApiPollerDataConnectorArgs {
     ...
     * The a authentication model.
     */
    auth: pulumi.Input<inputs.securityinsights.v20250301.AWSAuthModelArgs | inputs.securityinsights.v20250301.ApiKeyAuthModelArgs | inputs.securityinsights.v20250301.BasicAuthModelArgs | inputs.securityinsights.v20250301.GCPAuthModelArgs | inputs.securityinsights.v20250301.GenericBlobSbsAuthModelArgs | inputs.securityinsights.v20250301.GitHubAuthModelArgs | inputs.securityinsights.v20250301.JwtAuthModelArgs | inputs.securityinsights.v20250301.NoneAuthModelArgs | inputs.securityinsights.v20250301.OAuthModelArgs | inputs.securityinsights.v20250301.OracleAuthModelArgs | inputs.securityinsights.v20250301.SessionAuthModelArgs>;
    /**
     * The connector definition name (the dataConnectorDefinition resource id).
     */
     ...
     * The DCR related properties.
     */
    dcrConfig?: pulumi.Input<inputs.securityinsights.v20250301.DCRConfigurationArgs>;
    /**
     * Indicates whether the connector is active or not.
     */
     ...
     * The paging configuration.
     */
    paging?: pulumi.Input<inputs.securityinsights.v20250301.RestApiPollerRequestPagingConfigArgs>;
    /**
     * The request configuration.
     */
    request: pulumi.Input<inputs.securityinsights.v20250301.RestApiPollerRequestConfigArgs>;
    /**
     ...
     * The response configuration.
     */
    response?: pulumi.Input<inputs.securityinsights.v20250301.CcpResponseConfigArgs>;
    /**
