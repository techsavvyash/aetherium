...
export declare class RedisEnterprise extends pulumi.CustomResource {
     ...
     */
    readonly encryption: pulumi.Output<outputs.cache.v20230301preview.ClusterPropertiesResponseEncryption | undefined>;
    /**
     ...
     */
    readonly identity: pulumi.Output<outputs.cache.v20230301preview.ManagedServiceIdentityResponse | undefined>;
    /**
     ...
     */
    readonly privateEndpointConnections: pulumi.Output<outputs.cache.v20230301preview.PrivateEndpointConnectionResponse[]>;
    /**
     ...
     */
    readonly sku: pulumi.Output<outputs.cache.v20230301preview.EnterpriseSkuResponse>;
    /**
...
export interface RedisEnterpriseArgs {
     ...
     * Encryption-at-rest configuration for the cluster.
     */
    encryption?: pulumi.Input<inputs.cache.v20230301preview.ClusterPropertiesEncryptionArgs>;
    /**
     * The identity of the resource.
     */
    identity?: pulumi.Input<inputs.cache.v20230301preview.ManagedServiceIdentityArgs>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * The minimum TLS version for the cluster to support, e.g. '1.2'
     */
    minimumTlsVersion?: pulumi.Input<string | enums.cache.v20230301preview.TlsVersion>;
    /**
     ...
     * The SKU to create, which affects price, performance, and features.
     */
    sku: pulumi.Input<inputs.cache.v20230301preview.EnterpriseSkuArgs>;
    /**
     * Resource tags.
     */
    tags?: pulumi.Input<{
