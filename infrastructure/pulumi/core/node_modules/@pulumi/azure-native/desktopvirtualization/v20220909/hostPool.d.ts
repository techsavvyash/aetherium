...
export declare class HostPool extends pulumi.CustomResource {
     ...
     */
    readonly agentUpdate: pulumi.Output<outputs.desktopvirtualization.v20220909.AgentUpdatePropertiesResponse | undefined>;
    /**
    ...
    readonly identity: pulumi.Output<outputs.desktopvirtualization.v20220909.ResourceModelWithAllowedPropertySetResponseIdentity | undefined>;
    /**
    ...
    readonly plan: pulumi.Output<outputs.desktopvirtualization.v20220909.ResourceModelWithAllowedPropertySetResponsePlan | undefined>;
    /**
     ...
     */
    readonly registrationInfo: pulumi.Output<outputs.desktopvirtualization.v20220909.RegistrationInfoResponse | undefined>;
    /**
     * The ring number of HostPool.
     */
    readonly ring: pulumi.Output<number | undefined>;
    readonly sku: pulumi.Output<outputs.desktopvirtualization.v20220909.ResourceModelWithAllowedPropertySetResponseSku | undefined>;
    /**
     ...
     */
    readonly systemData: pulumi.Output<outputs.desktopvirtualization.v20220909.SystemDataResponse>;
    /**
     * Resource tags.
     */
...
export interface HostPoolArgs {
     ...
     * The session host configuration for updating agent, monitoring agent, and stack component.
     */
    agentUpdate?: pulumi.Input<inputs.desktopvirtualization.v20220909.AgentUpdatePropertiesArgs>;
    /**
     * Custom rdp property of HostPool.
     */
     ...
     * HostPool type for desktop.
     */
    hostPoolType: pulumi.Input<string | enums.desktopvirtualization.v20220909.HostPoolType>;
     ...
     * The type of the load balancer.
     */
    loadBalancerType: pulumi.Input<string | enums.desktopvirtualization.v20220909.LoadBalancerType>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * PersonalDesktopAssignment type for HostPool.
     */
    personalDesktopAssignmentType?: pulumi.Input<string | enums.desktopvirtualization.v20220909.PersonalDesktopAssignmentType>;
    plan?: pulumi.Input<inputs.desktopvirtualization.v20220909.ResourceModelWithAllowedPropertySetPlanArgs>;
    /**
     * The type of preferred application group type, default to Desktop Application Group
     */
    preferredAppGroupType: pulumi.Input<string | enums.desktopvirtualization.v20220909.PreferredAppGroupType>;
    /**
     * The registration info of HostPool.
     */
    registrationInfo?: pulumi.Input<inputs.desktopvirtualization.v20220909.RegistrationInfoArgs>;
    /**
     ...
     * The type of single sign on Secret Type.
     */
    ssoSecretType?: pulumi.Input<string | enums.desktopvirtualization.v20220909.SSOSecretType>;
    /**
     * URL to customer ADFS server for signing WVD SSO certificates.
     */
