...
export declare class MonitoredSubscription extends pulumi.CustomResource {
     ...
     * The request to update subscriptions needed to be monitored by the Elastic monitor resource.
     */
    readonly properties: pulumi.Output<outputs.elastic.v20240615preview.SubscriptionListResponse>;
    /**
...
export interface MonitoredSubscriptionArgs {
     ...
     * The request to update subscriptions needed to be monitored by the Elastic monitor resource.
     */
    properties?: pulumi.Input<inputs.elastic.v20240615preview.SubscriptionListArgs>;
    /**
