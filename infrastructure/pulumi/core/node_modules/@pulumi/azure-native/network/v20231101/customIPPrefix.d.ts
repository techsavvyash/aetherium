...
export declare class CustomIPPrefix extends pulumi.CustomResource {
     ...
     */
    readonly childCustomIpPrefixes: pulumi.Output<outputs.network.v20231101.SubResourceResponse[]>;
    /**
     ...
     */
    readonly customIpPrefixParent: pulumi.Output<outputs.network.v20231101.SubResourceResponse | undefined>;
    /**
     ...
     */
    readonly publicIpPrefixes: pulumi.Output<outputs.network.v20231101.SubResourceResponse[]>;
    /**
