...
export declare class SimPolicy extends pulumi.CustomResource {
     ...
     */
    readonly defaultSlice: pulumi.Output<outputs.mobilenetwork.v20240401.SliceResourceIdResponse>;
    /**
     ...
     */
    readonly sliceConfigurations: pulumi.Output<outputs.mobilenetwork.v20240401.SliceConfigurationResponse[]>;
    /**
     ...
     */
    readonly ueAmbr: pulumi.Output<outputs.mobilenetwork.v20240401.AmbrResponse>;
    /**
...
export interface SimPolicyArgs {
     ...
     * The default slice to use if the UE does not explicitly specify it. This slice must exist in the `sliceConfigurations` map. The slice must be in the same location as the SIM policy.
     */
    defaultSlice: pulumi.Input<inputs.mobilenetwork.v20240401.SliceResourceIdArgs>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * The allowed slices and the settings to use for them. The list must not contain duplicate items and must contain at least one item.
     */
    sliceConfigurations: pulumi.Input<pulumi.Input<inputs.mobilenetwork.v20240401.SliceConfigurationArgs>[]>;
    /**
     * Resource tags.
     */
    tags?: pulumi.Input<{
     ...
     * Aggregate maximum bit rate across all non-GBR QoS flows of all PDU sessions of a given UE. See 3GPP TS23.501 section 5.7.2.6 for a full description of the UE-AMBR.
     */
    ueAmbr: pulumi.Input<inputs.mobilenetwork.v20240401.AmbrArgs>;
}
