...
export declare class VNetPeering extends pulumi.CustomResource {
     ...
     */
    readonly databricksAddressSpace: pulumi.Output<outputs.databricks.v20240501.AddressSpaceResponse | undefined>;
    /**
     *  The remote virtual network should be in the same region. See here to learn more (https://docs.microsoft.com/en-us/azure/databricks/administration-guide/cloud-configurations/azure/vnet-peering).
     */
    readonly databricksVirtualNetwork: pulumi.Output<outputs.databricks.v20240501.VirtualNetworkPeeringPropertiesFormatResponseDatabricksVirtualNetwork | undefined>;
    /**
     ...
     */
    readonly remoteAddressSpace: pulumi.Output<outputs.databricks.v20240501.AddressSpaceResponse | undefined>;
    /**
     *  The remote virtual network should be in the same region. See here to learn more (https://docs.microsoft.com/en-us/azure/databricks/administration-guide/cloud-configurations/azure/vnet-peering).
     */
    readonly remoteVirtualNetwork: pulumi.Output<outputs.databricks.v20240501.VirtualNetworkPeeringPropertiesFormatResponseRemoteVirtualNetwork>;
    /**
...
export interface VNetPeeringArgs {
     ...
     * The reference to the databricks virtual network address space.
     */
    databricksAddressSpace?: pulumi.Input<inputs.databricks.v20240501.AddressSpaceArgs>;
    /**
     *  The remote virtual network should be in the same region. See here to learn more (https://docs.microsoft.com/en-us/azure/databricks/administration-guide/cloud-configurations/azure/vnet-peering).
     */
    databricksVirtualNetwork?: pulumi.Input<inputs.databricks.v20240501.VirtualNetworkPeeringPropertiesFormatDatabricksVirtualNetworkArgs>;
    /**
     ...
     * The reference to the remote virtual network address space.
     */
    remoteAddressSpace?: pulumi.Input<inputs.databricks.v20240501.AddressSpaceArgs>;
    /**
     *  The remote virtual network should be in the same region. See here to learn more (https://docs.microsoft.com/en-us/azure/databricks/administration-guide/cloud-configurations/azure/vnet-peering).
     */
    remoteVirtualNetwork: pulumi.Input<inputs.databricks.v20240501.VirtualNetworkPeeringPropertiesFormatRemoteVirtualNetworkArgs>;
    /**
