...
export declare class UpdateRun extends pulumi.CustomResource {
     ...
     */
    readonly managedClusterUpdate: pulumi.Output<outputs.containerservice.v20230815preview.ManagedClusterUpdateResponse>;
    /**
     ...
     */
    readonly status: pulumi.Output<outputs.containerservice.v20230815preview.UpdateRunStatusResponse>;
    /**
     * The strategy defines the order in which the clusters will be updated.
     * If not set, all members will be updated sequentially. The UpdateRun status will show a single UpdateStage and a single UpdateGroup targeting all members.
     * The strategy of the UpdateRun can be modified until the run is started.
     */
    readonly strategy: pulumi.Output<outputs.containerservice.v20230815preview.UpdateRunStrategyResponse | undefined>;
    /**
