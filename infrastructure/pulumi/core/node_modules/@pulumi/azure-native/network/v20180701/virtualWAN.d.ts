...
export declare class VirtualWAN extends pulumi.CustomResource {
     ...
     */
    readonly virtualHubs: pulumi.Output<outputs.network.v20180701.SubResourceResponse[]>;
    readonly vpnSites: pulumi.Output<outputs.network.v20180701.SubResourceResponse[]>;
    /**
