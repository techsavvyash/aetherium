 ...
 * ```
 */
export declare function getFeatureIamPolicyOutput(args: GetFeatureIamPolicyOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetFeatureIamPolicyResult>;
/**
 * A collection of arguments for invoking getFeatureIamPolicy.
 */
