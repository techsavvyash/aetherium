...
export declare class StartStopManagedInstanceSchedule extends pulumi.CustomResource {
     ...
     * Schedule list.
     */
    readonly scheduleList: pulumi.Output<outputs.sql.v20230801preview.ScheduleItemResponse[]>;
    /**
     * System data of the scheduled resource.
     */
    readonly systemData: pulumi.Output<outputs.sql.v20230801preview.SystemDataResponse>;
    /**
