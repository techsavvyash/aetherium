...
export declare class Profile extends pulumi.CustomResource {
     ...
     */
    readonly identity: pulumi.Output<outputs.cdn.v20240601preview.ManagedServiceIdentityResponse | undefined>;
    /**
     ...
     */
    readonly logScrubbing: pulumi.Output<outputs.cdn.v20240601preview.ProfileLogScrubbingResponse | undefined>;
    /**
     * Resource name.
     */
     ...
     */
    readonly sku: pulumi.Output<outputs.cdn.v20240601preview.SkuResponse>;
    /**
...
export interface ProfileArgs {
     ...
     * Managed service identity (system assigned and/or user assigned identities).
     */
    identity?: pulumi.Input<inputs.cdn.v20240601preview.ManagedServiceIdentityArgs>;
    /**
     * Resource location.
     */
     ...
     * Defines rules that scrub sensitive fields in the Azure Front Door profile logs.
     */
    logScrubbing?: pulumi.Input<inputs.cdn.v20240601preview.ProfileLogScrubbingArgs>;
    /**
     * Send and receive timeout on forwarding request to the origin. When timeout is reached, the request fails and returns.
     */
     ...
     * The pricing tier (defines Azure Front Door Standard or Premium or a CDN provider, feature list and rate) of the profile.
     */
    sku: pulumi.Input<inputs.cdn.v20240601preview.SkuArgs>;
    /**
     * Resource tags.
     */
    tags?: pulumi.Input<{
