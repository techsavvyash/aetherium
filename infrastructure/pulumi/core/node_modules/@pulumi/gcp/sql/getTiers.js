...
exports.getTiersOutput = exports.getTiers = void 0;
 ...
 * ```
 */
function getTiersOutput(args, opts) {
    return pulumi.output(args).apply((a) => getTiers(a, opts));
}
exports.getTiersOutput = getTiersOutput;
//# sourceMappingURL=getTiers.js.map