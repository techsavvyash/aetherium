...
export declare class JobStep extends pulumi.CustomResource {
     ...
     */
    readonly action: pulumi.Output<outputs.sql.v20221101preview.JobStepActionResponse>;
    /**
     ...
     */
    readonly executionOptions: pulumi.Output<outputs.sql.v20221101preview.JobStepExecutionOptionsResponse | undefined>;
    /**
     * Resource name.
     */
     ...
     */
    readonly output: pulumi.Output<outputs.sql.v20221101preview.JobStepOutputResponse | undefined>;
    /**
...
export interface JobStepArgs {
     ...
     * The action payload of the job step.
     */
    action: pulumi.Input<inputs.sql.v20221101preview.JobStepActionArgs>;
    /**
     * The resource ID of the job credential that will be used to connect to the targets.
     */
     ...
     * Execution options for the job step.
     */
    executionOptions?: pulumi.Input<inputs.sql.v20221101preview.JobStepExecutionOptionsArgs>;
    /**
     ...
     * Output destination properties of the job step.
     */
    output?: pulumi.Input<inputs.sql.v20221101preview.JobStepOutputArgs>;
    /**
