...
export declare class Metadata extends pulumi.CustomResource {
     ...
     */
    readonly author: pulumi.Output<outputs.securityinsights.v20230201.MetadataAuthorResponse | undefined>;
    /**
     * Categories for the solution content item
     */
    readonly categories: pulumi.Output<outputs.securityinsights.v20230201.MetadataCategoriesResponse | undefined>;
    /**
     ...
     */
    readonly dependencies: pulumi.Output<outputs.securityinsights.v20230201.MetadataDependenciesResponse | undefined>;
    /**
     ...
     */
    readonly source: pulumi.Output<outputs.securityinsights.v20230201.MetadataSourceResponse | undefined>;
    /**
     * Support information for the metadata - type, name, contact information
     */
    readonly support: pulumi.Output<outputs.securityinsights.v20230201.MetadataSupportResponse | undefined>;
    /**
     * Azure Resource Manager metadata containing createdBy and modifiedBy information.
     */
    readonly systemData: pulumi.Output<outputs.securityinsights.v20230201.SystemDataResponse>;
    /**
...
export interface MetadataArgs {
     ...
     * The creator of the content item.
     */
    author?: pulumi.Input<inputs.securityinsights.v20230201.MetadataAuthorArgs>;
    /**
     * Categories for the solution content item
     */
    categories?: pulumi.Input<inputs.securityinsights.v20230201.MetadataCategoriesArgs>;
    /**
     * Static ID for the content.  Used to identify dependencies and content from solutions or community.  Hard-coded/static for out of the box content and solutions. Dynamic for user-created.  This is the resource name
     */
     ...
     * Dependencies for the content item, what other content items it requires to work.  Can describe more complex dependencies using a recursive/nested structure. For a single dependency an id/kind/version can be supplied or operator/criteria for complex formats.
     */
    dependencies?: pulumi.Input<inputs.securityinsights.v20230201.MetadataDependenciesArgs>;
    /**
     * first publish date solution content item
     */
     ...
     * Source of the content.  This is where/how it was created.
     */
    source?: pulumi.Input<inputs.securityinsights.v20230201.MetadataSourceArgs>;
    /**
     * Support information for the metadata - type, name, contact information
     */
    support?: pulumi.Input<inputs.securityinsights.v20230201.MetadataSupportArgs>;
    /**
     * the tactics the resource covers
     */
