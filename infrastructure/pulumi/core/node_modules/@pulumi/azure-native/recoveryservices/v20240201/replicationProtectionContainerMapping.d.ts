...
export declare class ReplicationProtectionContainerMapping extends pulumi.CustomResource {
     ...
     * The custom data.
     */
    readonly properties: pulumi.Output<outputs.recoveryservices.v20240201.ProtectionContainerMappingPropertiesResponse>;
    /**
     * Resource Type
     */
...
export interface ReplicationProtectionContainerMappingArgs {
     ...
     */
    properties?: pulumi.Input<inputs.recoveryservices.v20240201.CreateProtectionContainerMappingInputPropertiesArgs>;
    /**
