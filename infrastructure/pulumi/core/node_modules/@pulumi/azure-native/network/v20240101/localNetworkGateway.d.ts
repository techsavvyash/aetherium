...
export declare class LocalNetworkGateway extends pulumi.CustomResource {
     ...
     */
    readonly localNetworkAddressSpace: pulumi.Output<outputs.network.v20240101.AddressSpaceResponse | undefined>;
    /**
     * Resource location.
     */
...
export interface LocalNetworkGatewayArgs {
     ...
     * Local network site address space.
     */
    localNetworkAddressSpace?: pulumi.Input<inputs.network.v20240101.AddressSpaceArgs>;
    /**
