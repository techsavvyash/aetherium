...
export declare class StartStopManagedInstanceSchedule extends pulumi.CustomResource {
     ...
     * Schedule list.
     */
    readonly scheduleList: pulumi.Output<outputs.sql.v20221101preview.ScheduleItemResponse[]>;
    /**
     * System data of the scheduled resource.
     */
    readonly systemData: pulumi.Output<outputs.sql.v20221101preview.SystemDataResponse>;
    /**
