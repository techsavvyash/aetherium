...
export declare class CustomerEvent extends pulumi.CustomResource {
     ...
     */
    readonly receivers: pulumi.Output<outputs.testbase.v20220401preview.NotificationEventReceiverResponse[]>;
    /**
...
export interface CustomerEventArgs {
     ...
     * The notification event receivers.
     */
    receivers: pulumi.Input<pulumi.Input<inputs.testbase.v20220401preview.NotificationEventReceiverArgs>[]>;
    /**
