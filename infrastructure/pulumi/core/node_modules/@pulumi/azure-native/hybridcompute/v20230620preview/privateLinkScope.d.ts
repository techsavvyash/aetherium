...
export declare class PrivateLinkScope extends pulumi.CustomResource {
     ...
     */
    readonly properties: pulumi.Output<outputs.hybridcompute.v20230620preview.HybridComputePrivateLinkScopePropertiesResponse>;
    /**
...
export interface PrivateLinkScopeArgs {
     ...
     * Properties that define a Azure Arc PrivateLinkScope resource.
     */
    properties?: pulumi.Input<inputs.hybridcompute.v20230620preview.HybridComputePrivateLinkScopePropertiesArgs>;
    /**
