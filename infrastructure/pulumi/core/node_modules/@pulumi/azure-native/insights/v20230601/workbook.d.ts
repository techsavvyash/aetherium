...
export declare class Workbook extends pulumi.CustomResource {
     ...
     */
    readonly identity: pulumi.Output<outputs.insights.v20230601.WorkbookResourceResponseIdentity | undefined>;
    /**
     ...
     */
    readonly systemData: pulumi.Output<outputs.insights.v20230601.SystemDataResponse>;
    /**
     * Resource tags.
     */
...
export interface WorkbookArgs {
     ...
     * Identity used for BYOS
     */
    identity?: pulumi.Input<inputs.insights.v20230601.WorkbookResourceIdentityArgs>;
    /**
     * The kind of workbook. Only valid value is shared.
     */
    kind?: pulumi.Input<string | enums.insights.v20230601.WorkbookSharedTypeKind>;
    /**
     * The geo-location where the resource lives
     */
