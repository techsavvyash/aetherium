...
export interface GetNetworkSecurityGroupResult {
     ...
     */
    readonly networkInterfaces: outputs.azurestackhci.v20250401preview.NetworkInterfaceArmReferenceResponse[];
    /**
     ...
     */
    readonly status: outputs.azurestackhci.v20250401preview.NetworkSecurityGroupStatusResponse;
    /**
     * A collection of references to logical networks that are currently using this NSG
     */
    readonly subnets: outputs.azurestackhci.v20250401preview.LogicalNetworkArmReferenceResponse[];
    /**
