...
export declare class TagInheritanceSetting extends pulumi.CustomResource {
     ...
     */
    readonly properties: pulumi.Output<outputs.costmanagement.v20231101.TagInheritancePropertiesResponse>;
    /**
...
export interface TagInheritanceSettingArgs {
     ...
     * The properties of the tag inheritance setting.
     */
    properties?: pulumi.Input<inputs.costmanagement.v20231101.TagInheritancePropertiesArgs>;
    /**
