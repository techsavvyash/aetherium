...
export declare class InstanceFailoverGroup extends pulumi.CustomResource {
     ...
     */
    readonly managedInstancePairs: pulumi.Output<outputs.sql.v20230801.ManagedInstancePairInfoResponse[]>;
    /**
     * Resource name.
     */
     ...
     */
    readonly partnerRegions: pulumi.Output<outputs.sql.v20230801.PartnerRegionInfoResponse[]>;
    /**
     * Read-only endpoint of the failover group instance.
     */
    readonly readOnlyEndpoint: pulumi.Output<outputs.sql.v20230801.InstanceFailoverGroupReadOnlyEndpointResponse | undefined>;
    /**
     * Read-write endpoint of the failover group instance.
     */
    readonly readWriteEndpoint: pulumi.Output<outputs.sql.v20230801.InstanceFailoverGroupReadWriteEndpointResponse>;
    /**
...
export interface InstanceFailoverGroupArgs {
     ...
     * List of managed instance pairs in the failover group.
     */
    managedInstancePairs: pulumi.Input<pulumi.Input<inputs.sql.v20230801.ManagedInstancePairInfoArgs>[]>;
    /**
     * Partner region information for the failover group.
     */
    partnerRegions: pulumi.Input<pulumi.Input<inputs.sql.v20230801.PartnerRegionInfoArgs>[]>;
    /**
     * Read-only endpoint of the failover group instance.
     */
    readOnlyEndpoint?: pulumi.Input<inputs.sql.v20230801.InstanceFailoverGroupReadOnlyEndpointArgs>;
    /**
     * Read-write endpoint of the failover group instance.
     */
    readWriteEndpoint: pulumi.Input<inputs.sql.v20230801.InstanceFailoverGroupReadWriteEndpointArgs>;
    /**
     ...
     * Type of the geo-secondary instance. Set 'Standby' if the instance is used as a DR option only.
     */
    secondaryType?: pulumi.Input<string | enums.sql.v20230801.SecondaryInstanceType>;
}
