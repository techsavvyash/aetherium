...
export declare class ExpressRouteCircuit extends pulumi.CustomResource {
     ...
     */
    readonly authorizations: pulumi.Output<outputs.network.v20181201.ExpressRouteCircuitAuthorizationResponse[] | undefined>;
    /**
     ...
     */
    readonly expressRoutePort: pulumi.Output<outputs.network.v20181201.SubResourceResponse | undefined>;
    /**
     ...
     */
    readonly peerings: pulumi.Output<outputs.network.v20181201.ExpressRouteCircuitPeeringResponse[] | undefined>;
    /**
     ...
     */
    readonly serviceProviderProperties: pulumi.Output<outputs.network.v20181201.ExpressRouteCircuitServiceProviderPropertiesResponse | undefined>;
    /**
     ...
     * The SKU.
     */
    readonly sku: pulumi.Output<outputs.network.v20181201.ExpressRouteCircuitSkuResponse | undefined>;
    /**
...
export interface ExpressRouteCircuitArgs {
     ...
     */
    authorizations?: pulumi.Input<pulumi.Input<inputs.network.v20181201.ExpressRouteCircuitAuthorizationArgs>[]>;
    /**
     * The bandwidth of the circuit when the circuit is provisioned on an ExpressRoutePort resource.
     */
     ...
     * The reference to the ExpressRoutePort resource when the circuit is provisioned on an ExpressRoutePort resource.
     */
    expressRoutePort?: pulumi.Input<inputs.network.v20181201.SubResourceArgs>;
    /**
     * The GatewayManager Etag.
     */
     ...
     * These are also available as standalone resources. Do not mix inline and standalone resource as they will conflict with each other, leading to resources deletion.
     */
    peerings?: pulumi.Input<pulumi.Input<inputs.network.v20181201.ExpressRouteCircuitPeeringArgs>[]>;
    /**
     * Gets the provisioning state of the public IP resource. Possible values are: 'Updating', 'Deleting', and 'Failed'.
     */
     ...
     * The ServiceProviderProperties.
     */
    serviceProviderProperties?: pulumi.Input<inputs.network.v20181201.ExpressRouteCircuitServiceProviderPropertiesArgs>;
    /**
     * The ServiceProviderProvisioningState state of the resource. Possible values are 'NotProvisioned', 'Provisioning', 'Provisioned', and 'Deprovisioning'.
     */
    serviceProviderProvisioningState?: pulumi.Input<string | enums.network.v20181201.ServiceProviderProvisioningState>;
    /**
     * The SKU.
     */
    sku?: pulumi.Input<inputs.network.v20181201.ExpressRouteCircuitSkuArgs>;
    /**
     * Resource tags.
     */
    tags?: pulumi.Input<{
