...
exports.getInstanceSerialPortOutput = exports.getInstanceSerialPort = void 0;
 ...
 * ```
 */
function getInstanceSerialPortOutput(args, opts) {
    return pulumi.output(args).apply((a) => getInstanceSerialPort(a, opts));
}
exports.getInstanceSerialPortOutput = getInstanceSerialPortOutput;
