...
export declare class MDATPDataConnector extends pulumi.CustomResource {
     ...
     */
    readonly dataTypes: pulumi.Output<outputs.securityinsights.v20250301.AlertsDataTypeOfDataConnectorResponse | undefined>;
    /**
...
export interface MDATPDataConnectorArgs {
     ...
     * The available data types for the connector.
     */
    dataTypes?: pulumi.Input<inputs.securityinsights.v20250301.AlertsDataTypeOfDataConnectorArgs>;
    /**
     * The kind of the data connector
     * Expected value is 'MicrosoftDefenderAdvancedThreatProtection'.
     */
