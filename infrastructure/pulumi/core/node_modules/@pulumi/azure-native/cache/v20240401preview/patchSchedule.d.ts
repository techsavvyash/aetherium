...
export declare class PatchSchedule extends pulumi.CustomResource {
     ...
     */
    readonly scheduleEntries: pulumi.Output<outputs.cache.v20240401preview.ScheduleEntryResponse[]>;
    /**
...
export interface PatchScheduleArgs {
     ...
     * List of patch schedules for a Redis cache.
     */
    scheduleEntries: pulumi.Input<pulumi.Input<inputs.cache.v20240401preview.ScheduleEntryArgs>[]>;
}
