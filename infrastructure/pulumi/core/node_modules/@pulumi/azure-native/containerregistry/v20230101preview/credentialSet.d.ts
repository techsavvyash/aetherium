...
export declare class CredentialSet extends pulumi.CustomResource {
     ...
     */
    readonly authCredentials: pulumi.Output<outputs.containerregistry.v20230101preview.AuthCredentialResponse[] | undefined>;
    /**
...
export interface CredentialSetArgs {
     ...
     * Usually consists of a primary and an optional secondary credential.
     */
    authCredentials?: pulumi.Input<pulumi.Input<inputs.containerregistry.v20230101preview.AuthCredentialArgs>[]>;
    /**
