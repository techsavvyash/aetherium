...
export declare class RoutingIntent extends pulumi.CustomResource {
     ...
     */
    readonly routingPolicies: pulumi.Output<outputs.network.v20230601.RoutingPolicyResponse[] | undefined>;
    /**
     * Resource type.
     */
...
export interface RoutingIntentArgs {
     ...
     * List of routing policies.
     */
    routingPolicies?: pulumi.Input<pulumi.Input<inputs.network.v20230601.RoutingPolicyArgs>[]>;
    /**
