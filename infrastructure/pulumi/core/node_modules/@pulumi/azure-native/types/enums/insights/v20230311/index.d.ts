export declare const KnownAgentSettingName: {
    readonly MaxDiskQuotaInMB: "MaxDiskQuotaInMB";
    readonly UseTimeReceivedForForwardedEvents: "UseTimeReceivedForForwardedEvents";
};
/**
...
export declare const KnownStorageBlobLookupType: {
    readonly String: "String";
    readonly Cidr: "Cidr";
};
/**
...
export declare const KnownWindowsFirewallLogsDataSourceProfileFilter: {
