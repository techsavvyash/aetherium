...
export declare class RoleManagementPolicy extends pulumi.CustomResource {
     ...
     */
    readonly lastModifiedBy: pulumi.Output<outputs.authorization.v20201001.PrincipalResponse>;
    /**
     ...
     */
    readonly policyProperties: pulumi.Output<outputs.authorization.v20201001.PolicyPropertiesResponse>;
    /**
     * The rule applied to the policy.
     */
    readonly rules: pulumi.Output<(outputs.authorization.v20201001.RoleManagementPolicyApprovalRuleResponse | outputs.authorization.v20201001.RoleManagementPolicyAuthenticationContextRuleResponse | outputs.authorization.v20201001.RoleManagementPolicyEnablementRuleResponse | outputs.authorization.v20201001.RoleManagementPolicyExpirationRuleResponse | outputs.authorization.v20201001.RoleManagementPolicyNotificationRuleResponse)[] | undefined>;
    /**
...
export interface RoleManagementPolicyArgs {
     ...
     * The rule applied to the policy.
     */
    rules?: pulumi.Input<pulumi.Input<inputs.authorization.v20201001.RoleManagementPolicyApprovalRuleArgs | inputs.authorization.v20201001.RoleManagementPolicyAuthenticationContextRuleArgs | inputs.authorization.v20201001.RoleManagementPolicyEnablementRuleArgs | inputs.authorization.v20201001.RoleManagementPolicyExpirationRuleArgs | inputs.authorization.v20201001.RoleManagementPolicyNotificationRuleArgs>[]>;
    /**
     * The role management policy scope.
     */
