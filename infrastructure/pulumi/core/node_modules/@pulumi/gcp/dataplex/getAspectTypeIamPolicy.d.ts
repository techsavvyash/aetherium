 ...
 * ```
 */
export declare function getAspectTypeIamPolicyOutput(args: GetAspectTypeIamPolicyOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetAspectTypeIamPolicyResult>;
/**
 * A collection of arguments for invoking getAspectTypeIamPolicy.
 */
