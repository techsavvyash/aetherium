...
export declare class Watcher extends pulumi.CustomResource {
     ...
     */
    readonly datastore: pulumi.Output<outputs.databasewatcher.v20240719preview.DatastoreResponse | undefined>;
    /**
     ...
     */
    readonly identity: pulumi.Output<outputs.databasewatcher.v20240719preview.ManagedServiceIdentityResponse | undefined>;
    /**
     ...
     */
    readonly systemData: pulumi.Output<outputs.databasewatcher.v20240719preview.SystemDataResponse>;
    /**
     * Resource tags.
     */
...
export interface WatcherArgs {
     ...
     * The data store for collected monitoring data.
     */
    datastore?: pulumi.Input<inputs.databasewatcher.v20240719preview.DatastoreArgs>;
    /**
     * The resource ID of a user-assigned managed identity that will be assigned to a new alert rule.
     */
     ...
     * The managed service identities assigned to this resource.
     */
    identity?: pulumi.Input<inputs.databasewatcher.v20240719preview.ManagedServiceIdentityArgs>;
    /**
     * The geo-location where the resource lives
     */
