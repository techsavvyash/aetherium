...
export declare class P2sVpnGateway extends pulumi.CustomResource {
     ...
     */
    readonly p2SConnectionConfigurations: pulumi.Output<outputs.network.v20240501.P2SConnectionConfigurationResponse[] | undefined>;
    /**
     ...
     */
    readonly vpnClientConnectionHealth: pulumi.Output<outputs.network.v20240501.VpnClientConnectionHealthResponse>;
    /**
     ...
     */
    readonly vpnServerConfiguration: pulumi.Output<outputs.network.v20240501.SubResourceResponse | undefined>;
    /**
...
export interface P2sVpnGatewayArgs {
     ...
     * List of all p2s connection configurations of the gateway.
     */
    p2SConnectionConfigurations?: pulumi.Input<pulumi.Input<inputs.network.v20240501.P2SConnectionConfigurationArgs>[]>;
    /**
     ...
     * The VpnServerConfiguration to which the p2sVpnGateway is attached to.
     */
    vpnServerConfiguration?: pulumi.Input<inputs.network.v20240501.SubResourceArgs>;
}
