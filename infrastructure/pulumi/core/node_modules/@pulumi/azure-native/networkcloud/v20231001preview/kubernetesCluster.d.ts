...
export declare class KubernetesCluster extends pulumi.CustomResource {
     ...
     */
    readonly aadConfiguration: pulumi.Output<outputs.networkcloud.v20231001preview.AadConfigurationResponse | undefined>;
    /**
     ...
     */
    readonly administratorConfiguration: pulumi.Output<outputs.networkcloud.v20231001preview.AdministratorConfigurationResponse | undefined>;
    /**
     ...
     */
    readonly availableUpgrades: pulumi.Output<outputs.networkcloud.v20231001preview.AvailableUpgradeResponse[]>;
    /**
     ...
     */
    readonly controlPlaneNodeConfiguration: pulumi.Output<outputs.networkcloud.v20231001preview.ControlPlaneNodeConfigurationResponse>;
    /**
     ...
     */
    readonly featureStatuses: pulumi.Output<outputs.networkcloud.v20231001preview.FeatureStatusResponse[]>;
    /**
     * The agent pools that are created with this Kubernetes cluster for running critical system services and workloads. This data in this field is only used during creation, and the field will be empty following the creation of the Kubernetes Cluster. After creation, the management of agent pools is done using the agentPools sub-resource.
     */
    readonly initialAgentPoolConfigurations: pulumi.Output<outputs.networkcloud.v20231001preview.InitialAgentPoolConfigurationResponse[]>;
    /**
     ...
     */
    readonly networkConfiguration: pulumi.Output<outputs.networkcloud.v20231001preview.NetworkConfigurationResponse>;
    /**
     * The details of the nodes in this cluster.
     */
    readonly nodes: pulumi.Output<outputs.networkcloud.v20231001preview.KubernetesClusterNodeResponse[]>;
    /**
...
export interface KubernetesClusterArgs {
     ...
     * The Azure Active Directory Integration properties.
     */
    aadConfiguration?: pulumi.Input<inputs.networkcloud.v20231001preview.AadConfigurationArgs>;
    /**
     * The administrative credentials that will be applied to the control plane and agent pool nodes that do not specify their own values.
     */
     ...
     * The defining characteristics of the control plane for this Kubernetes Cluster.
     */
    controlPlaneNodeConfiguration: pulumi.Input<inputs.networkcloud.v20231001preview.ControlPlaneNodeConfigurationArgs>;
    /**
     * The extended location of the cluster associated with the resource.
     */
     ...
     * The agent pools that are created with this Kubernetes cluster for running critical system services and workloads. This data in this field is only used during creation, and the field will be empty following the creation of the Kubernetes Cluster. After creation, the management of agent pools is done using the agentPools sub-resource.
     */
    initialAgentPoolConfigurations: pulumi.Input<pulumi.Input<inputs.networkcloud.v20231001preview.InitialAgentPoolConfigurationArgs>[]>;
    /**
     ...
     * The configuration of the Kubernetes cluster networking, including the attachment of networks that span the cluster.
     */
    networkConfiguration: pulumi.Input<inputs.networkcloud.v20231001preview.NetworkConfigurationArgs>;
    /**
