...
export declare class MaintenanceConfiguration extends pulumi.CustomResource {
     ...
     */
    readonly maintenanceWindow: pulumi.Output<outputs.containerservice.v20240501.MaintenanceWindowResponse | undefined>;
    /**
     ...
     */
    readonly notAllowedTime: pulumi.Output<outputs.containerservice.v20240501.TimeSpanResponse[] | undefined>;
    /**
     ...
     */
    readonly timeInWeek: pulumi.Output<outputs.containerservice.v20240501.TimeInWeekResponse[] | undefined>;
    /**
     * Resource type
     */
...
export interface MaintenanceConfigurationArgs {
     ...
     * Maintenance window for the maintenance configuration.
     */
    maintenanceWindow?: pulumi.Input<inputs.containerservice.v20240501.MaintenanceWindowArgs>;
    /**
     * Time slots on which upgrade is not allowed.
     */
    notAllowedTime?: pulumi.Input<pulumi.Input<inputs.containerservice.v20240501.TimeSpanArgs>[]>;
    /**
     ...
     * If two array entries specify the same day of the week, the applied configuration is the union of times in both entries.
     */
    timeInWeek?: pulumi.Input<pulumi.Input<inputs.containerservice.v20240501.TimeInWeekArgs>[]>;
}
