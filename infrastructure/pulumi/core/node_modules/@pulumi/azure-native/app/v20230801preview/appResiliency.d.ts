...
export declare class AppResiliency extends pulumi.CustomResource {
     ...
     */
    readonly circuitBreakerPolicy: pulumi.Output<outputs.app.v20230801preview.CircuitBreakerPolicyResponse | undefined>;
    /**
     * Defines parameters for http connection pooling
     */
    readonly httpConnectionPool: pulumi.Output<outputs.app.v20230801preview.HttpConnectionPoolResponse | undefined>;
    /**
     * Policy that defines http request retry conditions
     */
    readonly httpRetryPolicy: pulumi.Output<outputs.app.v20230801preview.HttpRetryPolicyResponse | undefined>;
    /**
     ...
     */
    readonly tcpConnectionPool: pulumi.Output<outputs.app.v20230801preview.TcpConnectionPoolResponse | undefined>;
    /**
     * Policy that defines tcp request retry conditions
     */
    readonly tcpRetryPolicy: pulumi.Output<outputs.app.v20230801preview.TcpRetryPolicyResponse | undefined>;
    /**
     * Policy to set request timeouts
     */
    readonly timeoutPolicy: pulumi.Output<outputs.app.v20230801preview.TimeoutPolicyResponse | undefined>;
    /**
