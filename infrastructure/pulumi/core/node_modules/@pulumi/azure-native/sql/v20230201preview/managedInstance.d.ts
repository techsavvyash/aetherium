...
export declare class ManagedInstance extends pulumi.CustomResource {
     ...
     */
    readonly administrators: pulumi.Output<outputs.sql.v20230201preview.ManagedInstanceExternalAdministratorResponse | undefined>;
    /**
     ...
     */
    readonly identity: pulumi.Output<outputs.sql.v20230201preview.ResourceIdentityResponse | undefined>;
    /**
     ...
     */
    readonly privateEndpointConnections: pulumi.Output<outputs.sql.v20230201preview.ManagedInstancePecPropertyResponse[]>;
    /**
     ...
     */
    readonly servicePrincipal: pulumi.Output<outputs.sql.v20230201preview.ServicePrincipalResponse | undefined>;
    /**
     * Managed instance SKU. Allowed values for sku.name: GP_Gen5, GP_G8IM, GP_G8IH, BC_Gen5, BC_G8IM, BC_G8IH
     */
    readonly sku: pulumi.Output<outputs.sql.v20230201preview.SkuResponse | undefined>;
    /**
...
export interface ManagedInstanceArgs {
     ...
     * The Azure Active Directory administrator of the instance. This can only be used at instance create time. If used for instance update, it will be ignored or it will result in an error. For updates individual APIs will need to be used.
     */
    administrators?: pulumi.Input<inputs.sql.v20230201preview.ManagedInstanceExternalAdministratorArgs>;
    /**
     * Collation of the managed instance.
     */
     ...
     * Hybrid secondary usage. Possible values are 'Active' (default value) and 'Passive' (customer uses the secondary as Passive DR).
     */
    hybridSecondaryUsage?: pulumi.Input<string | enums.sql.v20230201preview.HybridSecondaryUsage>;
    /**
     * The Azure Active Directory identity of the managed instance.
     */
     ...
     * The license type. Possible values are 'LicenseIncluded' (regular price inclusive of a new SQL license) and 'BasePrice' (discounted AHB price for bringing your own SQL licenses).
     */
    licenseType?: pulumi.Input<string | enums.sql.v20230201preview.ManagedInstanceLicenseType>;
    /**
     * Resource location.
     */
     ...
     */
    managedInstanceCreateMode?: pulumi.Input<string | enums.sql.v20230201preview.ManagedServerCreateMode>;
    /**
     ...
     * Weather or not Managed Instance is freemium.
     */
    pricingModel?: pulumi.Input<string | enums.sql.v20230201preview.FreemiumType>;
    /**
     * The resource id of a user assigned identity to be used by default.
     */
     ...
     * Connection type used for connecting to the instance.
     */
    proxyOverride?: pulumi.Input<string | enums.sql.v20230201preview.ManagedInstanceProxyOverride>;
    /**
     * Whether or not the public data endpoint is enabled.
     */
     ...
     * The storage account type to be used to store backups for this instance. The options are Local (LocallyRedundantStorage), Zone (ZoneRedundantStorage), Geo (GeoRedundantStorage) and GeoZone(GeoZoneRedundantStorage)
     */
    requestedBackupStorageRedundancy?: pulumi.Input<string | enums.sql.v20230201preview.BackupStorageRedundancy>;
    /**
     ...
     * The managed instance's service principal.
     */
    servicePrincipal?: pulumi.Input<inputs.sql.v20230201preview.ServicePrincipalArgs>;
    /**
     * Managed instance SKU. Allowed values for sku.name: GP_Gen5, GP_G8IM, GP_G8IH, BC_Gen5, BC_G8IM, BC_G8IH
     */
