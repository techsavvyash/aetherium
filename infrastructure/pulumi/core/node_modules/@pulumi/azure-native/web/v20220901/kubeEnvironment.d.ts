...
export declare class KubeEnvironment extends pulumi.CustomResource {
     ...
     * supported
     */
    readonly appLogsConfiguration: pulumi.Output<outputs.web.v20220901.AppLogsConfigurationResponse | undefined>;
    /**
     * Cluster configuration which determines the ARC cluster
     * components types. Eg: Choosing between BuildService kind,
     * FrontEnd Service ArtifactsStorageType etc.
     */
    readonly arcConfiguration: pulumi.Output<outputs.web.v20220901.ArcConfigurationResponse | undefined>;
    /**
     * Cluster configuration for Container Apps Environments to configure Dapr Instrumentation Key and VNET Configuration
     */
    readonly containerAppsConfiguration: pulumi.Output<outputs.web.v20220901.ContainerAppsConfigurationResponse | undefined>;
    /**
...
export interface KubeEnvironmentArgs {
     ...
     * supported
     */
    appLogsConfiguration?: pulumi.Input<inputs.web.v20220901.AppLogsConfigurationArgs>;
    /**
     * Cluster configuration which determines the ARC cluster
     * components types. Eg: Choosing between BuildService kind,
     * FrontEnd Service ArtifactsStorageType etc.
     */
    arcConfiguration?: pulumi.Input<inputs.web.v20220901.ArcConfigurationArgs>;
    /**
     * Cluster configuration for Container Apps Environments to configure Dapr Instrumentation Key and VNET Configuration
     */
    containerAppsConfiguration?: pulumi.Input<inputs.web.v20220901.ContainerAppsConfigurationArgs>;
    /**
     * Type of Kubernetes Environment. Only supported for Container App Environments with value as Managed
     */
