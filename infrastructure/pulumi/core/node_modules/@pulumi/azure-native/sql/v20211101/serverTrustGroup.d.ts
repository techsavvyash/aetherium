...
export declare class ServerTrustGroup extends pulumi.CustomResource {
     ...
     */
    readonly groupMembers: pulumi.Output<outputs.sql.v20211101.ServerInfoResponse[]>;
    /**
     * Resource name.
     */
...
export interface ServerTrustGroupArgs {
     ...
     * Group members information for the server trust group.
     */
    groupMembers: pulumi.Input<pulumi.Input<inputs.sql.v20211101.ServerInfoArgs>[]>;
    /**
