...
export declare class NamespaceNetworkRuleSet extends pulumi.CustomResource {
     ...
     * List of IpRules
     */
    readonly ipRules: pulumi.Output<outputs.eventhub.v20221001preview.NWRuleSetIpRulesResponse[] | undefined>;
    /**
     ...
     */
    readonly virtualNetworkRules: pulumi.Output<outputs.eventhub.v20221001preview.NWRuleSetVirtualNetworkRulesResponse[] | undefined>;
    /**
...
export interface NamespaceNetworkRuleSetArgs {
     ...
     * Default Action for Network Rule Set
     */
    defaultAction?: pulumi.Input<string | enums.eventhub.v20221001preview.DefaultAction>;
    /**
     * List of IpRules
     */
    ipRules?: pulumi.Input<pulumi.Input<inputs.eventhub.v20221001preview.NWRuleSetIpRulesArgs>[]>;
    /**
     * The Namespace name
     */
     ...
     * This determines if traffic is allowed over public network. By default it is enabled. If value is SecuredByPerimeter then Inbound and Outbound communication is controlled by the network security perimeter and profile's access rules.
     */
    publicNetworkAccess?: pulumi.Input<string | enums.eventhub.v20221001preview.PublicNetworkAccessFlag>;
    /**
     ...
     * List VirtualNetwork Rules
     */
    virtualNetworkRules?: pulumi.Input<pulumi.Input<inputs.eventhub.v20221001preview.NWRuleSetVirtualNetworkRulesArgs>[]>;
}
