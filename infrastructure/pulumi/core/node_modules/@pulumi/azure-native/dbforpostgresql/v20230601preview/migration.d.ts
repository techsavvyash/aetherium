...
export declare class Migration extends pulumi.CustomResource {
     ...
     */
    readonly currentStatus: pulumi.Output<outputs.dbforpostgresql.v20230601preview.MigrationStatusResponse>;
    /**
     ...
     */
    readonly sourceDbServerMetadata: pulumi.Output<outputs.dbforpostgresql.v20230601preview.DbServerMetadataResponse>;
    /**
     ...
     */
    readonly systemData: pulumi.Output<outputs.dbforpostgresql.v20230601preview.SystemDataResponse>;
    /**
     * Resource tags.
     */
     ...
     */
    readonly targetDbServerMetadata: pulumi.Output<outputs.dbforpostgresql.v20230601preview.DbServerMetadataResponse>;
    /**
...
export interface MigrationArgs {
     ...
     * To trigger cancel for entire migration we need to send this flag as True
     */
    cancel?: pulumi.Input<string | enums.dbforpostgresql.v20230601preview.CancelEnum>;
    /**
     * When you want to trigger cancel for specific databases send cancel flag as True and database names in this array
     */
     ...
     * There are two types of migration modes Online and Offline
     */
    migrationMode?: pulumi.Input<string | enums.dbforpostgresql.v20230601preview.MigrationMode>;
    /**
     ...
     * This indicates the supported Migration option for the migration
     */
    migrationOption?: pulumi.Input<string | enums.dbforpostgresql.v20230601preview.MigrationOption>;
    /**
     * End time in UTC for migration window
     */
     ...
     * Indicates whether the databases on the target server can be overwritten, if already present. If set to False, the migration workflow will wait for a confirmation, if it detects that the database already exists.
     */
    overwriteDbsInTarget?: pulumi.Input<string | enums.dbforpostgresql.v20230601preview.OverwriteDbsInTargetEnum>;
    /**
     ...
     */
    secretParameters?: pulumi.Input<inputs.dbforpostgresql.v20230601preview.MigrationSecretParametersArgs>;
    /**
     * Indicates whether to setup LogicalReplicationOnSourceDb, if needed
     */
    setupLogicalReplicationOnSourceDbIfNeeded?: pulumi.Input<string | enums.dbforpostgresql.v20230601preview.LogicalReplicationOnSourceDbEnum>;
    /**
     * Source server fully qualified domain name or ip. It is a optional value, if customer provide it, dms will always use it for connection
     */
     ...
     * migration source server type : OnPremises, AWS, GCP, AzureVM or PostgreSQLSingleServer
     */
    sourceType?: pulumi.Input<string | enums.dbforpostgresql.v20230601preview.SourceType>;
    /**
     * SSL modes for migration. Default SSL mode for PostgreSQLSingleServer is VerifyFull and Prefer for other source types
     */
    sslMode?: pulumi.Input<string | enums.dbforpostgresql.v20230601preview.SslMode>;
    /**
     * Indicates whether the data migration should start right away
     */
    startDataMigration?: pulumi.Input<string | enums.dbforpostgresql.v20230601preview.StartDataMigrationEnum>;
    /**
     ...
     * To trigger cutover for entire migration we need to send this flag as True
     */
    triggerCutover?: pulumi.Input<string | enums.dbforpostgresql.v20230601preview.TriggerCutoverEnum>;
}
