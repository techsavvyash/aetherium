...
export declare class BareMetalMachineKeySet extends pulumi.CustomResource {
     ...
     */
    readonly userList: pulumi.Output<outputs.networkcloud.v20241001preview.KeySetUserResponse[]>;
    /**
     * The status evaluation of each user.
     */
    readonly userListStatus: pulumi.Output<outputs.networkcloud.v20241001preview.KeySetUserStatusResponse[]>;
    /**
...
export interface BareMetalMachineKeySetArgs {
     ...
     * The access level allowed for the users in this key set.
     */
    privilegeLevel: pulumi.Input<string | enums.networkcloud.v20241001preview.BareMetalMachineKeySetPrivilegeLevel>;
    /**
     ...
     * The unique list of permitted users.
     */
    userList: pulumi.Input<pulumi.Input<inputs.networkcloud.v20241001preview.KeySetUserArgs>[]>;
}
