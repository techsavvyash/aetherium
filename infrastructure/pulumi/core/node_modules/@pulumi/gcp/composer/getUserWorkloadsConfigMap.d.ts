 ...
 * ```
 */
export declare function getUserWorkloadsConfigMapOutput(args: GetUserWorkloadsConfigMapOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetUserWorkloadsConfigMapResult>;
/**
 * A collection of arguments for invoking getUserWorkloadsConfigMap.
 */
