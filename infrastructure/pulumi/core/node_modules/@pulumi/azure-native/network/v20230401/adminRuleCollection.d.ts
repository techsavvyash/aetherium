...
export declare class AdminRuleCollection extends pulumi.CustomResource {
     ...
     */
    readonly appliesToGroups: pulumi.Output<outputs.network.v20230401.NetworkManagerSecurityGroupItemResponse[]>;
    /**
...
export interface AdminRuleCollectionArgs {
     ...
     * Groups for configuration
     */
    appliesToGroups: pulumi.Input<pulumi.Input<inputs.network.v20230401.NetworkManagerSecurityGroupItemArgs>[]>;
    /**
