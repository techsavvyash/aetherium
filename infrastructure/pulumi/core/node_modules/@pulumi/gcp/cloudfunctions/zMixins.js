...
class CallbackFunction extends pulumi.ComponentResource {
    constructor(name, args, opts = {}) {
        ...
        this.function = new cloudfunctions.Function(functionName, Object.assign(Object.assign({}, argsCopy), { runtime: utils.ifUndefined(args.runtime, "nodejs18"), entryPoint: handlerName, sourceArchiveBucket: this.bucket.name, sourceArchiveObject: this.bucketObject.name }), parentOpts);
