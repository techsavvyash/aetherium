...
export declare class VmmServer extends pulumi.CustomResource {
     ...
     */
    readonly credentials: pulumi.Output<outputs.scvmm.v20220521preview.VMMServerPropertiesResponseCredentials | undefined>;
    /**
...
export interface VmmServerArgs {
     ...
     * Credentials to connect to VMMServer.
     */
    credentials?: pulumi.Input<inputs.scvmm.v20220521preview.VMMServerPropertiesCredentialsArgs>;
    /**
     * The extended location.
     */
