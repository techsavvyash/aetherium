...
export declare class IotConnectorFhirDestination extends pulumi.CustomResource {
     ...
     * FHIR Mappings
     */
    readonly fhirMapping: pulumi.Output<outputs.healthcareapis.v20240331.IotMappingPropertiesResponse>;
    /**
...
export interface IotConnectorFhirDestinationArgs {
     ...
     * FHIR Mappings
     */
    fhirMapping: pulumi.Input<inputs.healthcareapis.v20240331.IotMappingPropertiesArgs>;
    /**
     * Fully qualified resource id of the FHIR service to connect to.
     */
     ...
     * Determines how resource identity is resolved on the destination.
     */
    resourceIdentityResolutionType: pulumi.Input<string | enums.healthcareapis.v20240331.IotIdentityResolutionType>;
    /**
