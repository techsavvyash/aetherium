 ...
 * Gets an order item.
 */
export declare function getOrderItemByNameOutput(args: GetOrderItemByNameOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetOrderItemByNameResult>;
