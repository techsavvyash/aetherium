...
export declare class Watchlist extends pulumi.CustomResource {
     ...
     */
    readonly createdBy: pulumi.Output<outputs.securityinsights.v20250301.WatchlistUserInfoResponse | undefined>;
    /**
     ...
     */
    readonly updatedBy: pulumi.Output<outputs.securityinsights.v20250301.WatchlistUserInfoResponse | undefined>;
    /**
...
export interface WatchlistArgs {
     ...
     * Describes a user that created the watchlist
     */
    createdBy?: pulumi.Input<inputs.securityinsights.v20250301.WatchlistUserInfoArgs>;
    /**
     * The default duration of a watchlist (in ISO 8601 duration format)
     */
     ...
     * The sourceType of the watchlist
     */
    sourceType?: pulumi.Input<string | enums.securityinsights.v20250301.SourceType>;
    /**
     * The tenantId where the watchlist belongs to
     */
     ...
     * Describes a user that updated the watchlist
     */
    updatedBy?: pulumi.Input<inputs.securityinsights.v20250301.WatchlistUserInfoArgs>;
    /**
     * The status of the Watchlist upload : New, InProgress or Complete. **Note** : When a Watchlist upload status is InProgress, the Watchlist cannot be deleted
     */
