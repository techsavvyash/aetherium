...
export declare class VirtualMachine extends pulumi.CustomResource {
     ...
     */
    readonly applicationProfile: pulumi.Output<outputs.compute.v20230901.ApplicationProfileResponse | undefined>;
    /**
     ...
     */
    readonly billingProfile: pulumi.Output<outputs.compute.v20230901.BillingProfileResponse | undefined>;
    /**
     ...
     */
    readonly capacityReservation: pulumi.Output<outputs.compute.v20230901.CapacityReservationProfileResponse | undefined>;
    /**
     ...
     */
    readonly extendedLocation: pulumi.Output<outputs.compute.v20230901.ExtendedLocationResponse | undefined>;
    /**
     ...
     */
    readonly host: pulumi.Output<outputs.compute.v20230901.SubResourceResponse | undefined>;
    /**
     ...
     */
    readonly hostGroup: pulumi.Output<outputs.compute.v20230901.SubResourceResponse | undefined>;
    /**
     ...
     */
    readonly instanceView: pulumi.Output<outputs.compute.v20230901.VirtualMachineInstanceViewResponse>;
    /**
     ...
     */
    readonly proximityPlacementGroup: pulumi.Output<outputs.compute.v20230901.SubResourceResponse | undefined>;
    /**
     ...
     */
    readonly scheduledEventsProfile: pulumi.Output<outputs.compute.v20230901.ScheduledEventsProfileResponse | undefined>;
    /**
     ...
     */
    readonly virtualMachineScaleSet: pulumi.Output<outputs.compute.v20230901.SubResourceResponse | undefined>;
    /**
...
export interface VirtualMachineArgs {
     ...
     * Specifies the gallery applications that should be made available to the VM/VMSS.
     */
    applicationProfile?: pulumi.Input<inputs.compute.v20230901.ApplicationProfileArgs>;
    /**
     * Specifies information about the availability set that the virtual machine should be assigned to. Virtual machines specified in the same availability set are allocated to different nodes to maximize availability. For more information about availability sets, see [Availability sets overview](https://docs.microsoft.com/azure/virtual-machines/availability-set-overview). For more information on Azure planned maintenance, see [Maintenance and updates for Virtual Machines in Azure](https://docs.microsoft.com/azure/virtual-machines/maintenance-and-updates). Currently, a VM can only be added to availability set at creation time. The availability set to which the VM is being added should be under the same resource group as the availability set resource. An existing VM cannot be added to an availability set. This property cannot exist along with a non-null properties.virtualMachineScaleSet reference.
     */
     ...
     * Specifies the billing related details of a Azure Spot virtual machine. Minimum api-version: 2019-03-01.
     */
    billingProfile?: pulumi.Input<inputs.compute.v20230901.BillingProfileArgs>;
    /**
     * Specifies information about the capacity reservation that is used to allocate virtual machine. Minimum api-version: 2021-04-01.
     */
    capacityReservation?: pulumi.Input<inputs.compute.v20230901.CapacityReservationProfileArgs>;
    /**
     * Specifies the boot diagnostic settings state. Minimum api-version: 2015-06-15.
     */
     ...
     * Specifies the eviction policy for the Azure Spot virtual machine and Azure Spot scale set. For Azure Spot virtual machines, both 'Deallocate' and 'Delete' are supported and the minimum api-version is 2019-03-01. For Azure Spot scale sets, both 'Deallocate' and 'Delete' are supported and the minimum api-version is 2017-10-30-preview.
     */
    evictionPolicy?: pulumi.Input<string | enums.compute.v20230901.VirtualMachineEvictionPolicyTypes>;
    /**
     * The extended location of the Virtual Machine.
     */
     ...
     * Specifies information about the dedicated host that the virtual machine resides in. Minimum api-version: 2018-10-01.
     */
    host?: pulumi.Input<inputs.compute.v20230901.SubResourceArgs>;
    /**
     * Specifies information about the dedicated host group that the virtual machine resides in. **Note:** User cannot specify both host and hostGroup properties. Minimum api-version: 2020-06-01.
     */
     ...
     * Specifies the priority for the virtual machine. Minimum api-version: 2019-03-01
     */
    priority?: pulumi.Input<string | enums.compute.v20230901.VirtualMachinePriorityTypes>;
    /**
     * Specifies information about the proximity placement group that the virtual machine should be assigned to. Minimum api-version: 2018-04-01.
     */
     ...
     * Specifies Scheduled Event related configurations.
     */
    scheduledEventsProfile?: pulumi.Input<inputs.compute.v20230901.ScheduledEventsProfileArgs>;
    /**
     * Specifies the Security related profile settings for the virtual machine.
     */
     ...
     * Specifies information about the virtual machine scale set that the virtual machine should be assigned to. Virtual machines specified in the same virtual machine scale set are allocated to different nodes to maximize availability. Currently, a VM can only be added to virtual machine scale set at creation time. An existing VM cannot be added to a virtual machine scale set. This property cannot exist along with a non-null properties.availabilitySet reference. Minimum api‐version: 2019‐03‐01.
     */
    virtualMachineScaleSet?: pulumi.Input<inputs.compute.v20230901.SubResourceArgs>;
    /**
