...
class VolumeAttributesClass extends pulumi.CustomResource {
    ...
    constructor(name, args, opts) {
        ...
        const aliasOpts = { aliases: [{ type: "kubernetes:storage.k8s.io/v1alpha1:VolumeAttributesClass" }] };
...
/** @internal */
VolumeAttributesClass.__pulumiType = 'kubernetes:storage.k8s.io/v1beta1:VolumeAttributesClass';
