...
export declare class Dynamics365DataConnector extends pulumi.CustomResource {
     ...
     */
    readonly dataTypes: pulumi.Output<outputs.securityinsights.v20230901preview.Dynamics365DataConnectorDataTypesResponse>;
    /**
...
export interface Dynamics365DataConnectorArgs {
     ...
     * The available data types for the connector.
     */
    dataTypes: pulumi.Input<inputs.securityinsights.v20230901preview.Dynamics365DataConnectorDataTypesArgs>;
    /**
     * The kind of the data connector
     * Expected value is 'Dynamics365'.
     */
