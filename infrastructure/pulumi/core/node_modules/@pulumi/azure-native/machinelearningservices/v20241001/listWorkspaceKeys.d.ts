...
export interface ListWorkspaceKeysResult {
    ...
    readonly containerRegistryCredentials: outputs.machinelearningservices.v20241001.RegistryListCredentialsResultResponse;
    readonly notebookAccessKeys: outputs.machinelearningservices.v20241001.ListNotebookKeysResultResponse;
