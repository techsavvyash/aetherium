...
export declare class VirtualMachineScaleSetVMExtension extends pulumi.CustomResource {
     ...
     */
    readonly instanceView: pulumi.Output<outputs.compute.v20241101.VirtualMachineExtensionInstanceViewResponse | undefined>;
    /**
     ...
     */
    readonly protectedSettingsFromKeyVault: pulumi.Output<outputs.compute.v20241101.KeyVaultSecretReferenceResponse | undefined>;
    /**
...
export interface VirtualMachineScaleSetVMExtensionArgs {
     ...
     * The virtual machine extension instance view.
     */
    instanceView?: pulumi.Input<inputs.compute.v20241101.VirtualMachineExtensionInstanceViewArgs>;
    /**
     * The location of the extension.
     */
     ...
     * The extensions protected settings that are passed by reference, and consumed from key vault
     */
    protectedSettingsFromKeyVault?: pulumi.Input<inputs.compute.v20241101.KeyVaultSecretReferenceArgs>;
    /**
     * Collection of extension names after which this extension needs to be provisioned.
     */
