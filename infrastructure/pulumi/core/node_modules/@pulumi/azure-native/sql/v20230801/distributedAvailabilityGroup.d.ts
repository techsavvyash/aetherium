...
export declare class DistributedAvailabilityGroup extends pulumi.CustomResource {
     ...
     */
    readonly databases: pulumi.Output<outputs.sql.v20230801.DistributedAvailabilityGroupDatabaseResponse[] | undefined>;
    /**
...
export interface DistributedAvailabilityGroupArgs {
     ...
     * Databases in the distributed availability group
     */
    databases?: pulumi.Input<pulumi.Input<inputs.sql.v20230801.DistributedAvailabilityGroupDatabaseArgs>[]>;
    /**
     ...
     * The link failover mode - can be Manual if intended to be used for two-way failover with a supported SQL Server, or None for one-way failover to Azure.
     */
    failoverMode?: pulumi.Input<string | enums.sql.v20230801.FailoverModeType>;
    /**
     * Managed instance side availability group name
     */
     ...
     * Managed instance side link role
     */
    instanceLinkRole?: pulumi.Input<string | enums.sql.v20230801.LinkRole>;
    /**
     ...
     * Replication mode of the link
     */
    replicationMode?: pulumi.Input<string | enums.sql.v20230801.ReplicationModeType>;
    /**
     ...
     * Database seeding mode – can be Automatic (default), or Manual for supported scenarios.
     */
    seedingMode?: pulumi.Input<string | enums.sql.v20230801.SeedingModeType>;
}
