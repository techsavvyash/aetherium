...
export declare class AdminRule extends pulumi.CustomResource {
     ...
     */
    readonly destinations: pulumi.Output<outputs.network.v20210201preview.AddressPrefixItemResponse[] | undefined>;
    /**
     ...
     */
    readonly sources: pulumi.Output<outputs.network.v20210201preview.AddressPrefixItemResponse[] | undefined>;
    /**
...
export interface AdminRuleArgs {
     ...
     * Indicates the access allowed for this particular rule
     */
    access: pulumi.Input<string | enums.network.v20210201preview.SecurityConfigurationRuleAccess>;
    /**
