...
export declare class ServerTrustGroup extends pulumi.CustomResource {
     ...
     */
    readonly groupMembers: pulumi.Output<outputs.sql.v20240501preview.ServerInfoResponse[]>;
    /**
     * Resource name.
     */
...
export interface ServerTrustGroupArgs {
     ...
     * Group members information for the server trust group.
     */
    groupMembers: pulumi.Input<pulumi.Input<inputs.sql.v20240501preview.ServerInfoArgs>[]>;
    /**
