...
export declare class SharedPrivateLinkResource extends pulumi.CustomResource {
     ...
     */
    readonly properties: pulumi.Output<outputs.search.v20250201preview.SharedPrivateLinkResourcePropertiesResponse>;
    /**
...
export interface SharedPrivateLinkResourceArgs {
     ...
     * Describes the properties of a shared private link resource managed by the Azure AI Search service.
     */
    properties?: pulumi.Input<inputs.search.v20250201preview.SharedPrivateLinkResourcePropertiesArgs>;
    /**
