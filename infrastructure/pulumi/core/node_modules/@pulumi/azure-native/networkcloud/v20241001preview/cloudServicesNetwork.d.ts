...
export declare class CloudServicesNetwork extends pulumi.CustomResource {
     ...
     */
    readonly additionalEgressEndpoints: pulumi.Output<outputs.networkcloud.v20241001preview.EgressEndpointResponse[] | undefined>;
    /**
     ...
     */
    readonly enabledEgressEndpoints: pulumi.Output<outputs.networkcloud.v20241001preview.EgressEndpointResponse[]>;
    /**
...
export interface CloudServicesNetworkArgs {
     ...
     * The list of egress endpoints. This allows for connection from a Hybrid AKS cluster to the specified endpoint.
     */
    additionalEgressEndpoints?: pulumi.Input<pulumi.Input<inputs.networkcloud.v20241001preview.EgressEndpointArgs>[]>;
    /**
     ...
     * The indicator of whether the platform default endpoints are allowed for the egress traffic.
     */
    enableDefaultEgressEndpoints?: pulumi.Input<string | enums.networkcloud.v20241001preview.CloudServicesNetworkEnableDefaultEgressEndpoints>;
    /**
     * The extended location of the cluster associated with the resource.
     */
