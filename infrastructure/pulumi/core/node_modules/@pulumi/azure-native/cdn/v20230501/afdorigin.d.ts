...
export declare class AFDOrigin extends pulumi.CustomResource {
     ...
     */
    readonly azureOrigin: pulumi.Output<outputs.cdn.v20230501.ResourceReferenceResponse | undefined>;
     ...
     */
    readonly sharedPrivateLinkResource: pulumi.Output<outputs.cdn.v20230501.SharedPrivateLinkResourcePropertiesResponse | undefined>;
    /**
...
export interface AFDOriginArgs {
     ...
     * Resource reference to the Azure origin resource.
     */
    azureOrigin?: pulumi.Input<inputs.cdn.v20230501.ResourceReferenceArgs>;
    /**
     * Whether to enable health probes to be made against backends defined under backendPools. Health probes can only be disabled if there is a single enabled backend in single enabled backend pool.
     */
     ...
     * The properties of the private link resource for private origin.
     */
    sharedPrivateLinkResource?: pulumi.Input<inputs.cdn.v20230501.SharedPrivateLinkResourcePropertiesArgs>;
    /**
     * Weight of the origin in given origin group for load balancing. Must be between 1 and 1000
     */
