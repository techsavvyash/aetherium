 ...
 */
export declare class AzureADMetric extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): AzureADMetric;
    /**
     * Returns true if the given object is an instance of AzureADMetric.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is AzureADMetric;
    /**
    ...
    readonly properties: pulumi.Output<outputs.aadiam.v20200701preview.AzureADMetricsPropertiesFormatResponse>;
    /**
     * Resource tags.
     */
