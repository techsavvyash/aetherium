...
export interface GetContentKeyPolicyResult {
     ...
     */
    readonly options: outputs.media.v20230101.ContentKeyPolicyOptionResponse[];
    /**
 ...
 * Get the details of a Content Key Policy in the Media Services account
 */
export declare function getContentKeyPolicyOutput(args: GetContentKeyPolicyOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetContentKeyPolicyResult>;
