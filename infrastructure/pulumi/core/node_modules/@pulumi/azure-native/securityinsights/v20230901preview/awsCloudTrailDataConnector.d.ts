...
export declare class AwsCloudTrailDataConnector extends pulumi.CustomResource {
     ...
     */
    readonly dataTypes: pulumi.Output<outputs.securityinsights.v20230901preview.AwsCloudTrailDataConnectorDataTypesResponse>;
    /**
...
export interface AwsCloudTrailDataConnectorArgs {
     ...
     * The available data types for the connector.
     */
    dataTypes: pulumi.Input<inputs.securityinsights.v20230901preview.AwsCloudTrailDataConnectorDataTypesArgs>;
    /**
     * The kind of the data connector
     * Expected value is 'AmazonWebServicesCloudTrail'.
     */
