...
export declare class DedicatedHost extends pulumi.CustomResource {
     ...
     */
    readonly instanceView: pulumi.Output<outputs.compute.v20230701.DedicatedHostInstanceViewResponse>;
    /**
     ...
     */
    readonly virtualMachines: pulumi.Output<outputs.compute.v20230701.SubResourceReadOnlyResponse[]>;
    /**
...
export interface DedicatedHostArgs {
     ...
     * Specifies the software license type that will be applied to the VMs deployed on the dedicated host. Possible values are: **None,** **Windows_Server_Hybrid,** **Windows_Server_Perpetual.** The default value is: **None.**
     */
    licenseType?: pulumi.Input<enums.compute.v20230701.DedicatedHostLicenseTypes>;
    /**
     * Resource location
     */
