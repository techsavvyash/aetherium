...
export declare class PeerAsn extends pulumi.CustomResource {
     ...
     */
    readonly peerContactDetail: pulumi.Output<outputs.peering.v20221001.ContactDetailResponse[] | undefined>;
    /**
...
export interface PeerAsnArgs {
     ...
     * The contact details of the peer.
     */
    peerContactDetail?: pulumi.Input<pulumi.Input<inputs.peering.v20221001.ContactDetailArgs>[]>;
    /**
     * The name of the peer.
     */
