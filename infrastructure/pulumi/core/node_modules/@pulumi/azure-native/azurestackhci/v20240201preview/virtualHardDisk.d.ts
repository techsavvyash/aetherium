...
export declare class VirtualHardDisk extends pulumi.CustomResource {
     ...
     */
    readonly status: pulumi.Output<outputs.azurestackhci.v20240201preview.VirtualHardDiskStatusResponse>;
    /**
...
export interface VirtualHardDiskArgs {
     ...
     * The format of the actual VHD file [vhd, vhdx]
     */
    diskFileFormat?: pulumi.Input<string | enums.azurestackhci.v20240201preview.DiskFileFormat>;
    /**
     * Size of the disk in GB
     */
