...
export declare class ReplicationRecoveryPlan extends pulumi.CustomResource {
     ...
     * The custom details.
     */
    readonly properties: pulumi.Output<outputs.recoveryservices.v20240101.RecoveryPlanPropertiesResponse>;
    /**
     * Resource Type
     */
...
export interface ReplicationRecoveryPlanArgs {
     ...
     */
    properties: pulumi.Input<inputs.recoveryservices.v20240101.CreateRecoveryPlanInputPropertiesArgs>;
    /**
     * Recovery plan name.
     */
