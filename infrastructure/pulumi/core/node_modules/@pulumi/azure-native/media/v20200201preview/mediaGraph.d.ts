 ...
 * The Media Graph.
 */
export declare class MediaGraph extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): MediaGraph;
    /**
     * Returns true if the given object is an instance of MediaGraph.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is MediaGraph;
    /**
     ...
     * Media Graph sinks.
     */
    readonly sinks: pulumi.Output<outputs.media.v20200201preview.MediaGraphAssetSinkResponse[]>;
    /**
     * Media Graph sources.
     */
    readonly sources: pulumi.Output<outputs.media.v20200201preview.MediaGraphRtspSourceResponse[]>;
    /**
