...
export interface GetSliceResult {
     ...
     */
    readonly snssai: outputs.mobilenetwork.v20240201.SnssaiResponse;
    /**
 ...
 * Gets information about the specified network slice.
 */
export declare function getSliceOutput(args: GetSliceOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSliceResult>;
