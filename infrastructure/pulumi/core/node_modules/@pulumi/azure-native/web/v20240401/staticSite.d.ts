...
export declare class StaticSite extends pulumi.CustomResource {
     ...
     */
    readonly buildProperties: pulumi.Output<outputs.web.v20240401.StaticSiteBuildPropertiesResponse | undefined>;
    /**
     ...
     */
    readonly databaseConnections: pulumi.Output<outputs.web.v20240401.DatabaseConnectionOverviewResponse[]>;
    /**
     ...
     */
    readonly identity: pulumi.Output<outputs.web.v20240401.ManagedServiceIdentityResponse | undefined>;
    /**
     ...
     */
    readonly linkedBackends: pulumi.Output<outputs.web.v20240401.StaticSiteLinkedBackendResponse[]>;
    /**
     * Resource Location.
     */
     ...
     */
    readonly privateEndpointConnections: pulumi.Output<outputs.web.v20240401.ResponseMessageEnvelopeRemotePrivateEndpointConnectionResponse[]>;
    /**
     ...
     */
    readonly sku: pulumi.Output<outputs.web.v20240401.SkuDescriptionResponse | undefined>;
    /**
     ...
     */
    readonly templateProperties: pulumi.Output<outputs.web.v20240401.StaticSiteTemplateOptionsResponse | undefined>;
    /**
     * Resource type.
     */
     ...
     */
    readonly userProvidedFunctionApps: pulumi.Output<outputs.web.v20240401.StaticSiteUserProvidedFunctionAppResponse[]>;
    /**
...
export interface StaticSiteArgs {
     ...
     * Build properties to configure on the repository.
     */
    buildProperties?: pulumi.Input<inputs.web.v20240401.StaticSiteBuildPropertiesArgs>;
    /**
     * State indicating the status of the enterprise grade CDN serving traffic to the static web app.
     */
    enterpriseGradeCdnStatus?: pulumi.Input<string | enums.web.v20240401.EnterpriseGradeCdnStatus>;
    /**
     * Managed service identity.
     */
     ...
     * Description of a SKU for a scalable resource.
     */
    sku?: pulumi.Input<inputs.web.v20240401.SkuDescriptionArgs>;
    /**
     * State indicating whether staging environments are allowed or not allowed for a static web app.
     */
    stagingEnvironmentPolicy?: pulumi.Input<enums.web.v20240401.StagingEnvironmentPolicy>;
    /**
     * Resource tags.
     */
    tags?: pulumi.Input<{
     ...
     * Template options for generating a new repository.
     */
    templateProperties?: pulumi.Input<inputs.web.v20240401.StaticSiteTemplateOptionsArgs>;
}
