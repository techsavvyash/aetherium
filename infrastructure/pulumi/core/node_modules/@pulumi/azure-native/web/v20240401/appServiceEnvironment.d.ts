...
export declare class AppServiceEnvironment extends pulumi.CustomResource {
     ...
     */
    readonly clusterSettings: pulumi.Output<outputs.web.v20240401.NameValuePairResponse[] | undefined>;
    /**
     * Full view of the custom domain suffix configuration for ASEv3.
     */
    readonly customDnsSuffixConfiguration: pulumi.Output<outputs.web.v20240401.CustomDnsSuffixConfigurationResponse | undefined>;
    /**
     ...
     */
    readonly networkingConfiguration: pulumi.Output<outputs.web.v20240401.AseV3NetworkingConfigurationResponse | undefined>;
    /**
     ...
     */
    readonly virtualNetwork: pulumi.Output<outputs.web.v20240401.VirtualNetworkProfileResponse>;
    /**
...
export interface AppServiceEnvironmentArgs {
     ...
     * Custom settings for changing the behavior of the App Service Environment.
     */
    clusterSettings?: pulumi.Input<pulumi.Input<inputs.web.v20240401.NameValuePairArgs>[]>;
    /**
     * Full view of the custom domain suffix configuration for ASEv3.
     */
    customDnsSuffixConfiguration?: pulumi.Input<inputs.web.v20240401.CustomDnsSuffixConfigurationArgs>;
    /**
     * Dedicated Host Count
     */
     ...
     * Specifies which endpoints to serve internally in the Virtual Network for the App Service Environment.
     */
    internalLoadBalancingMode?: pulumi.Input<string | enums.web.v20240401.LoadBalancingMode>;
    /**
     * Number of IP SSL addresses reserved for the App Service Environment.
     */
     ...
     * Full view of networking configuration for an ASE.
     */
    networkingConfiguration?: pulumi.Input<inputs.web.v20240401.AseV3NetworkingConfigurationArgs>;
    /**
     ...
     * Upgrade Preference
     */
    upgradePreference?: pulumi.Input<string | enums.web.v20240401.UpgradePreference>;
    /**
     * User added ip ranges to whitelist on ASE db
     */
     ...
     * Description of the Virtual Network.
     */
    virtualNetwork: pulumi.Input<inputs.web.v20240401.VirtualNetworkProfileArgs>;
    /**
     * Whether or not this App Service Environment is zone-redundant.
     */
