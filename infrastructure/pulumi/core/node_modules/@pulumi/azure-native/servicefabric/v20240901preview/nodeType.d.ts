...
export declare class NodeType extends pulumi.CustomResource {
     ...
     */
    readonly additionalDataDisks: pulumi.Output<outputs.servicefabric.v20240901preview.VmssDataDiskResponse[] | undefined>;
    /**
     * Specifies the settings for any additional secondary network interfaces to attach to the node type.
     */
    readonly additionalNetworkInterfaceConfigurations: pulumi.Output<outputs.servicefabric.v20240901preview.AdditionalNetworkInterfaceConfigurationResponse[] | undefined>;
    /**
     * The range of ports from which cluster assigned port to Service Fabric applications.
     */
    readonly applicationPorts: pulumi.Output<outputs.servicefabric.v20240901preview.EndpointRangeDescriptionResponse | undefined>;
    /**
     ...
     */
    readonly ephemeralPorts: pulumi.Output<outputs.servicefabric.v20240901preview.EndpointRangeDescriptionResponse | undefined>;
    /**
     ...
     */
    readonly frontendConfigurations: pulumi.Output<outputs.servicefabric.v20240901preview.FrontendConfigurationResponse[] | undefined>;
    /**
     ...
     */
    readonly natConfigurations: pulumi.Output<outputs.servicefabric.v20240901preview.NodeTypeNatConfigResponse[] | undefined>;
    /**
     ...
     */
    readonly networkSecurityRules: pulumi.Output<outputs.servicefabric.v20240901preview.NetworkSecurityRuleResponse[] | undefined>;
    /**
     ...
     * The node type sku.
     */
    readonly sku: pulumi.Output<outputs.servicefabric.v20240901preview.NodeTypeSkuResponse | undefined>;
    /**
     ...
     */
    readonly systemData: pulumi.Output<outputs.servicefabric.v20240901preview.SystemDataResponse>;
    /**
     * Azure resource tags.
     */
     ...
     */
    readonly vmApplications: pulumi.Output<outputs.servicefabric.v20240901preview.VmApplicationResponse[] | undefined>;
    /**
     * Set of extensions that should be installed onto the virtual machines.
     */
    readonly vmExtensions: pulumi.Output<outputs.servicefabric.v20240901preview.VMSSExtensionResponse[] | undefined>;
    /**
     ...
     */
    readonly vmImagePlan: pulumi.Output<outputs.servicefabric.v20240901preview.VmImagePlanResponse | undefined>;
    /**
     ...
     */
    readonly vmManagedIdentity: pulumi.Output<outputs.servicefabric.v20240901preview.VmManagedIdentityResponse | undefined>;
    /**
     * The secrets to install in the virtual machines.
     */
    readonly vmSecrets: pulumi.Output<outputs.servicefabric.v20240901preview.VaultSecretGroupResponse[] | undefined>;
    /**
...
export interface NodeTypeArgs {
     ...
     * Additional managed data disks.
     */
    additionalDataDisks?: pulumi.Input<pulumi.Input<inputs.servicefabric.v20240901preview.VmssDataDiskArgs>[]>;
    /**
     * Specifies the settings for any additional secondary network interfaces to attach to the node type.
     */
    additionalNetworkInterfaceConfigurations?: pulumi.Input<pulumi.Input<inputs.servicefabric.v20240901preview.AdditionalNetworkInterfaceConfigurationArgs>[]>;
    /**
     * The range of ports from which cluster assigned port to Service Fabric applications.
     */
    applicationPorts?: pulumi.Input<inputs.servicefabric.v20240901preview.EndpointRangeDescriptionArgs>;
    /**
     * The capacity tags applied to the nodes in the node type, the cluster resource manager uses these tags to understand how much resource a node has.
     */
     ...
     * Managed data disk type. Specifies the storage account type for the managed disk
     */
    dataDiskType?: pulumi.Input<string | enums.servicefabric.v20240901preview.DiskType>;
    /**
     * Specifies the resource id of the DSCP configuration to apply to the node type network interface.
     */
     ...
     * The range of ephemeral ports that nodes in this node type should be configured with.
     */
    ephemeralPorts?: pulumi.Input<inputs.servicefabric.v20240901preview.EndpointRangeDescriptionArgs>;
    /**
     * Specifies the eviction policy for virtual machines in a SPOT node type. Default is Delete.
     */
    evictionPolicy?: pulumi.Input<string | enums.servicefabric.v20240901preview.EvictionPolicyType>;
    /**
     * Indicates the node type uses its own frontend configurations instead of the default one for the cluster. This setting can only be specified for non-primary node types and can not be added or removed after the node type is created.
     */
    frontendConfigurations?: pulumi.Input<pulumi.Input<inputs.servicefabric.v20240901preview.FrontendConfigurationArgs>[]>;
    /**
     * Specifies the full host group resource Id. This property is used for deploying on azure dedicated hosts.
     */
     ...
     * Specifies the NAT configuration on default public Load Balancer for the node type. This is only supported for node types use the default public Load Balancer.
     */
    natConfigurations?: pulumi.Input<pulumi.Input<inputs.servicefabric.v20240901preview.NodeTypeNatConfigArgs>[]>;
    /**
     * Specifies the resource id of a NAT Gateway to attach to the subnet of this node type. Node type must use custom load balancer.
     */
     ...
     * The Network Security Rules for this node type. This setting can only be specified for node types that are configured with frontend configurations.
     */
    networkSecurityRules?: pulumi.Input<pulumi.Input<inputs.servicefabric.v20240901preview.NetworkSecurityRuleArgs>[]>;
    /**
     ...
     * Specifies the security type of the nodeType. Only Standard and TrustedLaunch are currently supported
     */
    securityType?: pulumi.Input<string | enums.servicefabric.v20240901preview.SecurityType>;
    /**
     * Specifies the service artifact reference id used to set same image version for all virtual machines in the scale set when using 'latest' image version.
     */
     ...
     * The node type sku.
     */
    sku?: pulumi.Input<inputs.servicefabric.v20240901preview.NodeTypeSkuArgs>;
    /**
     * Indicates the time duration after which the platform will not try to restore the VMSS SPOT instances specified as ISO 8601.
     */
     ...
     * Specifies the gallery applications that should be made available to the underlying VMSS.
     */
    vmApplications?: pulumi.Input<pulumi.Input<inputs.servicefabric.v20240901preview.VmApplicationArgs>[]>;
    /**
     * Set of extensions that should be installed onto the virtual machines.
     */
    vmExtensions?: pulumi.Input<pulumi.Input<inputs.servicefabric.v20240901preview.VMSSExtensionArgs>[]>;
    /**
     * The offer type of the Azure Virtual Machines Marketplace image. For example, UbuntuServer or WindowsServer.
     */
     ...
     * Specifies information about the marketplace image used to create the virtual machine. This element is only used for marketplace images. Before you can use a marketplace image from an API, you must enable the image for programmatic use. In the Azure portal, find the marketplace image that you want to use and then click Want to deploy programmatically, Get Started ->. Enter any required information and then click Save.
     */
    vmImagePlan?: pulumi.Input<inputs.servicefabric.v20240901preview.VmImagePlanArgs>;
    /**
     * The publisher of the Azure Virtual Machines Marketplace image. For example, Canonical or MicrosoftWindowsServer.
     */
     ...
     * Identities to assign to the virtual machine scale set under the node type.
     */
    vmManagedIdentity?: pulumi.Input<inputs.servicefabric.v20240901preview.VmManagedIdentityArgs>;
    /**
     * The secrets to install in the virtual machines.
     */
    vmSecrets?: pulumi.Input<pulumi.Input<inputs.servicefabric.v20240901preview.VaultSecretGroupArgs>[]>;
    /**
     * Specifies the actions to be performed on the vms before bootstrapping the service fabric runtime.
     */
    vmSetupActions?: pulumi.Input<pulumi.Input<string | enums.servicefabric.v20240901preview.VmSetupAction>[]>;
    /**
     * Indicates the resource id of the vm shared galleries image. This parameter is used for custom vm image.
     */
