...
export declare class DiskAccessAPrivateEndpointConnection extends pulumi.CustomResource {
     ...
     */
    readonly privateEndpoint: pulumi.Output<outputs.compute.v20231002.PrivateEndpointResponse>;
    /**
     * A collection of information about the state of the connection between DiskAccess and Virtual Network.
     */
    readonly privateLinkServiceConnectionState: pulumi.Output<outputs.compute.v20231002.PrivateLinkServiceConnectionStateResponse>;
    /**
...
export interface DiskAccessAPrivateEndpointConnectionArgs {
     ...
     * A collection of information about the state of the connection between DiskAccess and Virtual Network.
     */
    privateLinkServiceConnectionState: pulumi.Input<inputs.compute.v20231002.PrivateLinkServiceConnectionStateArgs>;
    /**
