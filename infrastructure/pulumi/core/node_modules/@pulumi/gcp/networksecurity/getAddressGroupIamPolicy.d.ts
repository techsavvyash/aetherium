 ...
 * Retrieves the current IAM policy data for projectaddressgroup
 */
export declare function getAddressGroupIamPolicyOutput(args: GetAddressGroupIamPolicyOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetAddressGroupIamPolicyResult>;
/**
 * A collection of arguments for invoking getAddressGroupIamPolicy.
 */
