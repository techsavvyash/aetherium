...
export declare class ScheduledQueryRule extends pulumi.CustomResource {
     ...
     */
    readonly actions: pulumi.Output<outputs.insights.ActionsResponse | undefined>;
    /**
     ...
     */
    readonly criteria: pulumi.Output<outputs.insights.ScheduledQueryRuleCriteriaResponse>;
    /**
     ...
     */
    readonly identity: pulumi.Output<outputs.insights.IdentityResponse | undefined>;
    /**
     ...
     */
    readonly resolveConfiguration: pulumi.Output<outputs.insights.RuleResolveConfigurationResponse | undefined>;
    /**
     ...
     */
    readonly systemData: pulumi.Output<outputs.insights.SystemDataResponse>;
    /**
     * Resource tags.
     */
...
export interface ScheduledQueryRuleArgs {
     ...
     * Actions to invoke when the alert fires.
     */
    actions?: pulumi.Input<inputs.insights.ActionsArgs>;
    /**
     * The flag that indicates whether the alert should be automatically resolved or not. The default is true. Relevant only for rules of the kind LogAlert.
     */
     ...
     * The rule criteria that defines the conditions of the scheduled query rule.
     */
    criteria: pulumi.Input<inputs.insights.ScheduledQueryRuleCriteriaArgs>;
    /**
     * The description of the scheduled query rule.
     */
     ...
     * Defines the configuration for resolving fired alerts. Relevant only for rules of the kind LogAlert.
     */
    resolveConfiguration?: pulumi.Input<inputs.insights.RuleResolveConfigurationArgs>;
    /**
