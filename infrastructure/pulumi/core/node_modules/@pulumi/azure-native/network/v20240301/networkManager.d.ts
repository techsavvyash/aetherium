...
export declare class NetworkManager extends pulumi.CustomResource {
     ...
     */
    readonly networkManagerScopes: pulumi.Output<outputs.network.v20240301.NetworkManagerPropertiesResponseNetworkManagerScopes>;
    /**
...
export interface NetworkManagerArgs {
     ...
     * Scope Access.
     */
    networkManagerScopeAccesses: pulumi.Input<pulumi.Input<string | enums.network.v20240301.ConfigurationType>[]>;
    /**
     * Scope of Network Manager.
     */
    networkManagerScopes: pulumi.Input<inputs.network.v20240301.NetworkManagerPropertiesNetworkManagerScopesArgs>;
    /**
