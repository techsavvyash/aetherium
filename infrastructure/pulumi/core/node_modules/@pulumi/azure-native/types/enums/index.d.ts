...
export { aad, aadiam, agfoodplatform, agricultureplatform, alertsmanagement, analysisservices, apicenter, apimanagement, app, appcomplianceautomation, appconfiguration, appplatform, attestation, authorization, automanage, automation, avs, awsconnector, azureactivedirectory, azurearcdata, azuredatatransfer, azurefleet, azurelargeinstance, azureplaywrightservice, azuresphere, azurestack, azurestackhci, baremetalinfrastructure, batch, billing, billingbenefits, blueprint, botservice, cache, cdn, certificateregistration, changeanalysis, chaos, cloudngfw, codesigning, cognitiveservices, communication, community, compute, confidentialledger, confluent, connectedcache, connectedvmwarevsphere, consumption, containerinstance, containerregistry, containerservice, containerstorage, costmanagement, customerinsights, customproviders, dashboard, databasefleetmanager, databasewatcher, databox, databoxedge, databricks, datacatalog, datadog, datafactory, datalakeanalytics, datalakestore, datamigration, dataprotection, datareplication, datashare, dbformariadb, dbformysql, dbforpostgresql, delegatednetwork, dependencymap, desktopvirtualization, devcenter, devhub, deviceregistry, devices, deviceupdate, devopsinfrastructure, devspaces, devtestlab, digitaltwins, documentdb, domainregistration, edgeorder, education, elastic, elasticsan, enterpriseknowledgegraph, eventgrid, eventhub, extendedlocation, fabric, features, fluidrelay, guestconfiguration, hardwaresecuritymodules, hdinsight, healthbot, healthcareapis, healthdataaiservices, hybridcloud, hybridcompute, hybridconnectivity, hybridcontainerservice, hybriddata, hybridnetwork, impact, importexport, insights, iotcentral, iotfirmwaredefense, iotoperations, iotoperationsmq, iotoperationsorchestrator, keyvault, kubernetes, kubernetesconfiguration, kubernetesruntime, kusto, labservices, loadtestservice, logic, m365securityandcompliance, machinelearning, machinelearningservices, maintenance, managedidentity, managednetwork, managednetworkfabric, managedservices, manufacturingplatform, maps, marketplace, media, migrate, mixedreality, mobilenetwork, monitor, mysqldiscovery, netapp, network, networkcloud, networkfunction, notificationhubs, offazure, offazurespringboot, operationalinsights, orbital, peering, policyinsights, portal, powerbi, powerbidedicated, powerplatform, programmableconnectivity, providerhub, purview, quantum, quota, recommendationsservice, recoveryservices, redhatopenshift, relay, resourceconnector, resources, saas, scheduler, scom, scvmm, search, secretsynccontroller, security, securityandcompliance, securityinsights, serialconsole, servicebus, servicefabric, servicefabricmesh, servicelinker, servicenetworking, signalrservice, solutions, sovereign, sql, sqlvirtualmachine, standbypool, storage, storageactions, storagecache, storagemover, storagepool, storagesync, storsimple, streamanalytics, subscription, synapse, testbase, timeseriesinsights, videoanalyzer, videoindexer, virtualmachineimages, vmwarecloudsimple, voiceservices, web, webpubsub, weightsandbiases, windowsesu, workloads, };
