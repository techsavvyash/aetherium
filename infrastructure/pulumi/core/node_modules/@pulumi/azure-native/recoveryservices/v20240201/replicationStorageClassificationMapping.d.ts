...
export declare class ReplicationStorageClassificationMapping extends pulumi.CustomResource {
     ...
     */
    readonly properties: pulumi.Output<outputs.recoveryservices.v20240201.StorageClassificationMappingPropertiesResponse>;
    /**
     * Resource Type
     */
...
export interface ReplicationStorageClassificationMappingArgs {
     ...
     */
    properties?: pulumi.Input<inputs.recoveryservices.v20240201.StorageMappingInputPropertiesArgs>;
    /**
