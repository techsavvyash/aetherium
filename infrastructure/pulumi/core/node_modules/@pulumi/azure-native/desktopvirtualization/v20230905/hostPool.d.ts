...
export declare class HostPool extends pulumi.CustomResource {
     ...
     */
    readonly agentUpdate: pulumi.Output<outputs.desktopvirtualization.v20230905.AgentUpdatePropertiesResponse | undefined>;
    /**
    ...
    readonly identity: pulumi.Output<outputs.desktopvirtualization.v20230905.ResourceModelWithAllowedPropertySetResponseIdentity | undefined>;
    /**
    ...
    readonly plan: pulumi.Output<outputs.desktopvirtualization.v20230905.ResourceModelWithAllowedPropertySetResponsePlan | undefined>;
    /**
     ...
     */
    readonly privateEndpointConnections: pulumi.Output<outputs.desktopvirtualization.v20230905.PrivateEndpointConnectionResponse[]>;
    /**
     ...
     */
    readonly registrationInfo: pulumi.Output<outputs.desktopvirtualization.v20230905.RegistrationInfoResponse | undefined>;
    /**
     * The ring number of HostPool.
     */
    readonly ring: pulumi.Output<number | undefined>;
    readonly sku: pulumi.Output<outputs.desktopvirtualization.v20230905.ResourceModelWithAllowedPropertySetResponseSku | undefined>;
    /**
     ...
     */
    readonly systemData: pulumi.Output<outputs.desktopvirtualization.v20230905.SystemDataResponse>;
    /**
     * Resource tags.
     */
...
export interface HostPoolArgs {
     ...
     * The session host configuration for updating agent, monitoring agent, and stack component.
     */
    agentUpdate?: pulumi.Input<inputs.desktopvirtualization.v20230905.AgentUpdatePropertiesArgs>;
    /**
     * Custom rdp property of HostPool.
     */
     ...
     * HostPool type for desktop.
     */
    hostPoolType: pulumi.Input<string | enums.desktopvirtualization.v20230905.HostPoolType>;
    identity?: pulumi.Input<inputs.desktopvirtualization.v20230905.ResourceModelWithAllowedPropertySetIdentityArgs>;
    /**
     * Metadata used by portal/tooling/etc to render different UX experiences for resources of the same type; e.g. ApiApps are a kind of Microsoft.Web/sites type.  If supported, the resource provider must validate and persist this value.
     */
     ...
     * The type of the load balancer.
     */
    loadBalancerType: pulumi.Input<string | enums.desktopvirtualization.v20230905.LoadBalancerType>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * PersonalDesktopAssignment type for HostPool.
     */
    personalDesktopAssignmentType?: pulumi.Input<string | enums.desktopvirtualization.v20230905.PersonalDesktopAssignmentType>;
    plan?: pulumi.Input<inputs.desktopvirtualization.v20230905.ResourceModelWithAllowedPropertySetPlanArgs>;
    /**
     * The type of preferred application group type, default to Desktop Application Group
     */
    preferredAppGroupType: pulumi.Input<string | enums.desktopvirtualization.v20230905.PreferredAppGroupType>;
    /**
     * Enabled allows this resource to be accessed from both public and private networks, Disabled allows this resource to only be accessed via private endpoints
     */
    publicNetworkAccess?: pulumi.Input<string | enums.desktopvirtualization.v20230905.HostpoolPublicNetworkAccess>;
    /**
     * The registration info of HostPool.
     */
    registrationInfo?: pulumi.Input<inputs.desktopvirtualization.v20230905.RegistrationInfoArgs>;
    /**
    ...
    sku?: pulumi.Input<inputs.desktopvirtualization.v20230905.ResourceModelWithAllowedPropertySetSkuArgs>;
    /**
     * ClientId for the registered Relying Party used to issue WVD SSO certificates.
     */
     ...
     * The type of single sign on Secret Type.
     */
    ssoSecretType?: pulumi.Input<string | enums.desktopvirtualization.v20230905.SSOSecretType>;
    /**
     * URL to customer ADFS server for signing WVD SSO certificates.
     */
