...
export declare class BusinessApplicationAgent extends pulumi.CustomResource {
    ...
    readonly agentSystems: pulumi.Output<outputs.securityinsights.AgentSystemResponse[]>;
    /**
     * Describes the configuration of a Business Application Agent.
     */
    readonly configuration: pulumi.Output<outputs.securityinsights.SapAgentConfigurationResponse>;
