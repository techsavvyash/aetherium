...
export declare class ProtectionIntent extends pulumi.CustomResource {
     ...
     */
    readonly properties: pulumi.Output<outputs.recoveryservices.v20240730preview.AzureRecoveryServiceVaultProtectionIntentResponse | outputs.recoveryservices.v20240730preview.AzureResourceProtectionIntentResponse | outputs.recoveryservices.v20240730preview.AzureWorkloadAutoProtectionIntentResponse | outputs.recoveryservices.v20240730preview.AzureWorkloadContainerAutoProtectionIntentResponse | outputs.recoveryservices.v20240730preview.AzureWorkloadSQLAutoProtectionIntentResponse>;
    /**
     * Resource tags.
     */
...
export interface ProtectionIntentArgs {
     ...
     * ProtectionIntentResource properties
     */
    properties?: pulumi.Input<inputs.recoveryservices.v20240730preview.AzureRecoveryServiceVaultProtectionIntentArgs | inputs.recoveryservices.v20240730preview.AzureResourceProtectionIntentArgs | inputs.recoveryservices.v20240730preview.AzureWorkloadAutoProtectionIntentArgs | inputs.recoveryservices.v20240730preview.AzureWorkloadContainerAutoProtectionIntentArgs | inputs.recoveryservices.v20240730preview.AzureWorkloadSQLAutoProtectionIntentArgs>;
    /**
