...
export declare class BrokerAuthorization extends pulumi.CustomResource {
     ...
     */
    readonly authorizationPolicies: pulumi.Output<outputs.iotoperationsmq.v20231004preview.AuthorizationConfigResponse>;
    /**
     * Extended Location
     */
...
export interface BrokerAuthorizationArgs {
     ...
     * The list of authorization policies supported by the Authorization Resource.
     */
    authorizationPolicies: pulumi.Input<inputs.iotoperationsmq.v20231004preview.AuthorizationConfigArgs>;
    /**
