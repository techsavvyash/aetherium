...
export declare class ScalingPlanPooledSchedule extends pulumi.CustomResource {
     ...
     */
    readonly offPeakStartTime: pulumi.Output<outputs.desktopvirtualization.v20240808preview.TimeResponse>;
    /**
     ...
     */
    readonly peakStartTime: pulumi.Output<outputs.desktopvirtualization.v20240808preview.TimeResponse>;
    /**
     ...
     */
    readonly rampDownStartTime: pulumi.Output<outputs.desktopvirtualization.v20240808preview.TimeResponse>;
    /**
     ...
     */
    readonly rampUpStartTime: pulumi.Output<outputs.desktopvirtualization.v20240808preview.TimeResponse>;
    /**
...
export interface ScalingPlanPooledScheduleArgs {
     ...
     * Load balancing algorithm for off-peak period.
     */
    offPeakLoadBalancingAlgorithm?: pulumi.Input<string | enums.desktopvirtualization.v20240808preview.SessionHostLoadBalancingAlgorithm>;
    /**
     * Starting time for off-peak period.
     */
     ...
     * Load balancing algorithm for peak period.
     */
    peakLoadBalancingAlgorithm?: pulumi.Input<string | enums.desktopvirtualization.v20240808preview.SessionHostLoadBalancingAlgorithm>;
    /**
     * Starting time for peak period.
     */
     ...
     * Load balancing algorithm for ramp down period.
     */
    rampDownLoadBalancingAlgorithm?: pulumi.Input<string | enums.desktopvirtualization.v20240808preview.SessionHostLoadBalancingAlgorithm>;
    /**
     * Minimum host percentage for ramp down period.
     */
     ...
     * Specifies when to stop hosts during ramp down period.
     */
    rampDownStopHostsWhen?: pulumi.Input<string | enums.desktopvirtualization.v20240808preview.StopHostsWhen>;
    /**
     * Number of minutes to wait to stop hosts during ramp down period.
     */
     ...
     * Load balancing algorithm for ramp up period.
     */
    rampUpLoadBalancingAlgorithm?: pulumi.Input<string | enums.desktopvirtualization.v20240808preview.SessionHostLoadBalancingAlgorithm>;
    /**
     * Minimum host percentage for ramp up period.
     */
