...
export declare class AttachedDataNetwork extends pulumi.CustomResource {
     ...
     */
    readonly naptConfiguration: pulumi.Output<outputs.mobilenetwork.v20230601.NaptConfigurationResponse | undefined>;
    /**
     ...
     */
    readonly userPlaneDataInterface: pulumi.Output<outputs.mobilenetwork.v20230601.InterfacePropertiesResponse>;
    /**
...
export interface AttachedDataNetworkArgs {
     ...
     * If this is not specified, the attached data network will use a default NAPT configuration with NAPT enabled.
     */
    naptConfiguration?: pulumi.Input<inputs.mobilenetwork.v20230601.NaptConfigurationArgs>;
    /**
     ...
     * The user plane interface on the data network. For 5G networks, this is the N6 interface. For 4G networks, this is the SGi interface.
     */
    userPlaneDataInterface: pulumi.Input<inputs.mobilenetwork.v20230601.InterfacePropertiesArgs>;
}
