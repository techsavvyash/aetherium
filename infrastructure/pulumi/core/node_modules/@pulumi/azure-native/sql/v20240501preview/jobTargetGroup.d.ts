...
export declare class JobTargetGroup extends pulumi.CustomResource {
     ...
     */
    readonly members: pulumi.Output<outputs.sql.v20240501preview.JobTargetResponse[]>;
    /**
     * Resource name.
     */
...
export interface JobTargetGroupArgs {
     ...
     * Members of the target group.
     */
    members: pulumi.Input<pulumi.Input<inputs.sql.v20240501preview.JobTargetArgs>[]>;
    /**
