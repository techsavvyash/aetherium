...
export declare class Workflow extends pulumi.CustomResource {
     ...
     */
    readonly acr: pulumi.Output<outputs.devhub.v20240501preview.ACRResponse | undefined>;
    /**
    ...
    readonly deploymentProperties: pulumi.Output<outputs.devhub.v20240501preview.DeploymentPropertiesResponse | undefined>;
    /**
    ...
    readonly lastWorkflowRun: pulumi.Output<outputs.devhub.v20240501preview.WorkflowRunResponse | undefined>;
    /**
     ...
     */
    readonly oidcCredentials: pulumi.Output<outputs.devhub.v20240501preview.GitHubWorkflowProfileResponseOidcCredentials | undefined>;
    /**
     ...
     */
    readonly systemData: pulumi.Output<outputs.devhub.v20240501preview.SystemDataResponse>;
    /**
     * Resource tags.
     */
...
export interface WorkflowArgs {
     ...
     * Information on the azure container registry
     */
    acr?: pulumi.Input<inputs.devhub.v20240501preview.ACRArgs>;
    /**
     * The Azure Kubernetes Cluster Resource the application will be deployed to.
     */
    ...
    deploymentProperties?: pulumi.Input<inputs.devhub.v20240501preview.DeploymentPropertiesArgs>;
    /**
     * Path to Dockerfile Build Context within the repository.
     */
     ...
     * The mode of generation to be used for generating Dockerfiles.
     */
    dockerfileGenerationMode?: pulumi.Input<string | enums.devhub.v20240501preview.DockerfileGenerationMode>;
    /**
     * The directory to output the generated Dockerfile to.
     */
     ...
     * The programming language used.
     */
    generationLanguage?: pulumi.Input<string | enums.devhub.v20240501preview.GenerationLanguage>;
    /**
     * The name of the image to be generated.
     */
    ...
    lastWorkflowRun?: pulumi.Input<inputs.devhub.v20240501preview.WorkflowRunArgs>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * The mode of generation to be used for generating Manifest.
     */
    manifestGenerationMode?: pulumi.Input<string | enums.devhub.v20240501preview.ManifestGenerationMode>;
    /**
     * The directory to output the generated manifests to.
     */
     ...
     * Determines the type of manifests to be generated.
     */
    manifestType?: pulumi.Input<string | enums.devhub.v20240501preview.GenerationManifestType>;
    /**
     * Kubernetes namespace the application is deployed to.
     */
     ...
     * The fields needed for OIDC with GitHub.
     */
    oidcCredentials?: pulumi.Input<inputs.devhub.v20240501preview.GitHubWorkflowProfileOidcCredentialsArgs>;
    /**
     * The port the application is exposed on.
     */
