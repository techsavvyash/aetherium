...
export declare class Client extends pulumi.CustomResource {
     ...
     */
    readonly clientCertificateAuthentication: pulumi.Output<outputs.eventgrid.v20250215.ClientCertificateAuthenticationResponse | undefined>;
    /**
...
export interface ClientArgs {
     ...
     * The client certificate authentication information.
     */
    clientCertificateAuthentication?: pulumi.Input<inputs.eventgrid.v20250215.ClientCertificateAuthenticationArgs>;
    /**
     * The client name.
     */
     ...
     * Indicates if the client is enabled or not. Default value is Enabled.
     */
    state?: pulumi.Input<string | enums.eventgrid.v20250215.ClientState>;
}
