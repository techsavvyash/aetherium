...
export interface GetCatalogSyncErrorDetailsResult {
     ...
     */
    readonly conflicts: outputs.devcenter.v20240501preview.CatalogConflictErrorResponse[];
    /**
     * Errors that occured during synchronization.
     */
    readonly errors: outputs.devcenter.v20240501preview.CatalogSyncErrorResponse[];
    /**
     * Error information for the overall synchronization operation.
     */
    readonly operationError: outputs.devcenter.v20240501preview.CatalogErrorDetailsResponse;
}
/**
 * Gets catalog synchronization error details
 */
