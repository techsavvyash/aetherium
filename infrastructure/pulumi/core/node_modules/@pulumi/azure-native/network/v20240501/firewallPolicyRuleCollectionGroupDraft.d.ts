...
export declare class FirewallPolicyRuleCollectionGroupDraft extends pulumi.CustomResource {
     ...
     */
    readonly ruleCollections: pulumi.Output<(outputs.network.v20240501.FirewallPolicyFilterRuleCollectionResponse | outputs.network.v20240501.FirewallPolicyNatRuleCollectionResponse)[] | undefined>;
    /**
...
export interface FirewallPolicyRuleCollectionGroupDraftArgs {
     ...
     * Group of Firewall Policy rule collections.
     */
    ruleCollections?: pulumi.Input<pulumi.Input<inputs.network.v20240501.FirewallPolicyFilterRuleCollectionArgs | inputs.network.v20240501.FirewallPolicyNatRuleCollectionArgs>[]>;
}
