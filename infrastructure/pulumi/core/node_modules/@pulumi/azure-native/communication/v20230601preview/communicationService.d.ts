...
export declare class CommunicationService extends pulumi.CustomResource {
     ...
     */
    readonly identity: pulumi.Output<outputs.communication.v20230601preview.ManagedServiceIdentityResponse | undefined>;
    /**
...
export interface CommunicationServiceArgs {
     ...
     * Managed service identity (system assigned and/or user assigned identities)
     */
    identity?: pulumi.Input<inputs.communication.v20230601preview.ManagedServiceIdentityArgs>;
    /**
     * List of email Domain resource Ids.
     */
