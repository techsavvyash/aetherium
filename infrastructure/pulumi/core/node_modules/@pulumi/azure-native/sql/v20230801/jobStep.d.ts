...
export declare class JobStep extends pulumi.CustomResource {
     ...
     */
    readonly action: pulumi.Output<outputs.sql.v20230801.JobStepActionResponse>;
    /**
     ...
     */
    readonly executionOptions: pulumi.Output<outputs.sql.v20230801.JobStepExecutionOptionsResponse | undefined>;
    /**
     * Resource name.
     */
     ...
     */
    readonly output: pulumi.Output<outputs.sql.v20230801.JobStepOutputResponse | undefined>;
    /**
...
export interface JobStepArgs {
     ...
     * The action payload of the job step.
     */
    action: pulumi.Input<inputs.sql.v20230801.JobStepActionArgs>;
    /**
     * The resource ID of the job credential that will be used to connect to the targets.
     */
     ...
     * Execution options for the job step.
     */
    executionOptions?: pulumi.Input<inputs.sql.v20230801.JobStepExecutionOptionsArgs>;
    /**
     ...
     * Output destination properties of the job step.
     */
    output?: pulumi.Input<inputs.sql.v20230801.JobStepOutputArgs>;
    /**
