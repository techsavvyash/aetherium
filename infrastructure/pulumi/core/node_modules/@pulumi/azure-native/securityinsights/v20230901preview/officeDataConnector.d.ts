...
export declare class OfficeDataConnector extends pulumi.CustomResource {
     ...
     */
    readonly dataTypes: pulumi.Output<outputs.securityinsights.v20230901preview.OfficeDataConnectorDataTypesResponse>;
    /**
...
export interface OfficeDataConnectorArgs {
     ...
     * The available data types for the connector.
     */
    dataTypes: pulumi.Input<inputs.securityinsights.v20230901preview.OfficeDataConnectorDataTypesArgs>;
    /**
     * The kind of the data connector
     * Expected value is 'Office365'.
     */
