...
export declare class MonitoredSubscription extends pulumi.CustomResource {
     ...
     * The request to update subscriptions needed to be monitored by the Datadog monitor resource.
     */
    readonly properties: pulumi.Output<outputs.datadog.v20230707.SubscriptionListResponse>;
    /**
...
export interface MonitoredSubscriptionArgs {
     ...
     * The request to update subscriptions needed to be monitored by the Datadog monitor resource.
     */
    properties?: pulumi.Input<inputs.datadog.v20230707.SubscriptionListArgs>;
    /**
