...
export declare class Redis extends pulumi.CustomResource {
     ...
     */
    readonly accessKeys: pulumi.Output<outputs.cache.v20230401.RedisAccessKeysResponse>;
    /**
     ...
     */
    readonly identity: pulumi.Output<outputs.cache.v20230401.ManagedServiceIdentityResponse | undefined>;
    /**
     * List of the Redis instances associated with the cache
     */
    readonly instances: pulumi.Output<outputs.cache.v20230401.RedisInstanceDetailsResponse[]>;
    /**
     * List of the linked servers associated with the cache
     */
    readonly linkedServers: pulumi.Output<outputs.cache.v20230401.RedisLinkedServerResponse[]>;
    /**
     ...
     */
    readonly privateEndpointConnections: pulumi.Output<outputs.cache.v20230401.PrivateEndpointConnectionResponse[]>;
    /**
     ...
     */
    readonly redisConfiguration: pulumi.Output<outputs.cache.v20230401.RedisCommonPropertiesResponseRedisConfiguration | undefined>;
    /**
     ...
     */
    readonly sku: pulumi.Output<outputs.cache.v20230401.SkuResponse>;
    /**
     * Redis SSL port.
     */
...
export interface RedisArgs {
     ...
     * The identity of the resource.
     */
    identity?: pulumi.Input<inputs.cache.v20230401.ManagedServiceIdentityArgs>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * Optional: requires clients to use a specified TLS version (or higher) to connect (e,g, '1.0', '1.1', '1.2')
     */
    minimumTlsVersion?: pulumi.Input<string | enums.cache.v20230401.TlsVersion>;
    /**
     ...
     * Whether or not public endpoint access is allowed for this cache.  Value is optional, but if passed in, must be 'Enabled' or 'Disabled'. If 'Disabled', private endpoints are the exclusive access method. Default value is 'Enabled'. Note: This setting is important for caches with private endpoints. It has *no effect* on caches that are joined to, or injected into, a virtual network subnet.
     */
    publicNetworkAccess?: pulumi.Input<string | enums.cache.v20230401.PublicNetworkAccess>;
    /**
     * All Redis Settings. Few possible keys: rdb-backup-enabled,rdb-storage-connection-string,rdb-backup-frequency,maxmemory-delta,maxmemory-policy,notify-keyspace-events,maxmemory-samples,slowlog-log-slower-than,slowlog-max-len,list-max-ziplist-entries,list-max-ziplist-value,hash-max-ziplist-entries,hash-max-ziplist-value,set-max-intset-entries,zset-max-ziplist-entries,zset-max-ziplist-value etc.
     */
    redisConfiguration?: pulumi.Input<inputs.cache.v20230401.RedisCommonPropertiesRedisConfigurationArgs>;
    /**
     * Redis version. This should be in the form 'major[.minor]' (only 'major' is required) or the value 'latest' which refers to the latest stable Redis version that is available. Supported versions: 4.0, 6.0 (latest). Default value is 'latest'.
     */
     ...
     * The SKU of the Redis cache to deploy.
     */
    sku: pulumi.Input<inputs.cache.v20230401.SkuArgs>;
    /**
     * Static IP address. Optionally, may be specified when deploying a Redis cache inside an existing Azure Virtual Network; auto assigned by default.
     */
