...
export declare class StorageAccountCredential extends pulumi.CustomResource {
     ...
     */
    readonly accountKey: pulumi.Output<outputs.databoxedge.v20230101preview.AsymmetricEncryptedSecretResponse | undefined>;
    /**
...
export interface StorageAccountCredentialArgs {
     ...
     * Encrypted storage key.
     */
    accountKey?: pulumi.Input<inputs.databoxedge.v20230101preview.AsymmetricEncryptedSecretArgs>;
    /**
     * Type of storage accessed on the storage account.
     */
    accountType: pulumi.Input<string | enums.databoxedge.v20230101preview.AccountType>;
    /**
     * Alias for the storage account.
     */
     ...
     * Signifies whether SSL needs to be enabled or not.
     */
    sslStatus: pulumi.Input<string | enums.databoxedge.v20230101preview.SSLStatus>;
    /**
     * Id of the storage account.
     */
