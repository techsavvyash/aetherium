...
export declare class AssetEndpointProfile extends pulumi.CustomResource {
     ...
     */
    readonly authentication: pulumi.Output<outputs.deviceregistry.v20240901preview.AuthenticationResponse | undefined>;
    /**
     ...
     */
    readonly status: pulumi.Output<outputs.deviceregistry.v20240901preview.AssetEndpointProfileStatusResponse>;
    /**
...
export interface AssetEndpointProfileArgs {
     ...
     * Defines the client authentication mechanism to the server.
     */
    authentication?: pulumi.Input<inputs.deviceregistry.v20240901preview.AuthenticationArgs>;
    /**
     * Reference to a discovered asset endpoint profile. Populated only if the asset endpoint profile has been created from discovery flow. Discovered asset endpoint profile name must be provided.
     */
