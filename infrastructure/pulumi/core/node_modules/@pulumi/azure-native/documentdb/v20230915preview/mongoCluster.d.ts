...
export declare class MongoCluster extends pulumi.CustomResource {
     ...
     */
    readonly nodeGroupSpecs: pulumi.Output<outputs.documentdb.v20230915preview.NodeGroupSpecResponse[] | undefined>;
    /**
...
export interface MongoClusterArgs {
     ...
     * The list of node group specs in the cluster.
     */
    nodeGroupSpecs?: pulumi.Input<pulumi.Input<inputs.documentdb.v20230915preview.NodeGroupSpecArgs>[]>;
    /**
     ...
     */
    restoreParameters?: pulumi.Input<inputs.documentdb.v20230915preview.MongoClusterRestoreParametersArgs>;
    /**
     * The Mongo DB server version. Defaults to the latest available version if not specified.
     */
