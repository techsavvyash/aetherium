...
export declare class FileShare extends pulumi.CustomResource {
     ...
     */
    readonly fileSharePaidBursting: pulumi.Output<outputs.storage.v20240101.FileSharePropertiesResponseFileSharePaidBursting | undefined>;
    /**
     ...
     */
    readonly signedIdentifiers: pulumi.Output<outputs.storage.v20240101.SignedIdentifierResponse[] | undefined>;
    /**
...
export interface FileShareArgs {
     ...
     * Access tier for specific share. GpV2 account can choose between TransactionOptimized (default), Hot, and Cool. FileStorage account can choose Premium.
     */
    accessTier?: pulumi.Input<string | enums.storage.v20240101.ShareAccessTier>;
    /**
     ...
     * The authentication protocol that is used for the file share. Can only be specified when creating a share.
     */
    enabledProtocols?: pulumi.Input<string | enums.storage.v20240101.EnabledProtocols>;
    /**
     ...
     * File Share Paid Bursting properties.
     */
    fileSharePaidBursting?: pulumi.Input<inputs.storage.v20240101.FileSharePropertiesFileSharePaidBurstingArgs>;
    /**
     * A name-value pair to associate with the share as metadata.
     */
     ...
     * The property is for NFS share only. The default is NoRootSquash.
     */
    rootSquash?: pulumi.Input<string | enums.storage.v20240101.RootSquashType>;
    /**
     ...
     * List of stored access policies specified on the share.
     */
    signedIdentifiers?: pulumi.Input<pulumi.Input<inputs.storage.v20240101.SignedIdentifierArgs>[]>;
}
