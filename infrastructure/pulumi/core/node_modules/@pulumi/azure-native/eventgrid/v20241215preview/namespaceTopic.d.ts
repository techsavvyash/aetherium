...
export interface NamespaceTopicArgs {
     ...
     * This determines the format that is expected for incoming events published to the topic.
     */
    inputSchema?: pulumi.Input<string | enums.eventgrid.v20241215preview.EventInputSchema>;
    /**
     ...
     * Publisher type of the namespace topic.
     */
    publisherType?: pulumi.Input<string | enums.eventgrid.v20241215preview.PublisherType>;
    /**
