...
export declare class CustomIPPrefix extends pulumi.CustomResource {
     ...
     */
    readonly childCustomIpPrefixes: pulumi.Output<outputs.network.v20230401.SubResourceResponse[]>;
    /**
     ...
     */
    readonly customIpPrefixParent: pulumi.Output<outputs.network.v20230401.SubResourceResponse | undefined>;
    /**
     ...
     */
    readonly publicIpPrefixes: pulumi.Output<outputs.network.v20230401.SubResourceResponse[]>;
    /**
