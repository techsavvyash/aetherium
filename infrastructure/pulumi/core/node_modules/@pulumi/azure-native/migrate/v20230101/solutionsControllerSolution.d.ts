 ...
 */
export declare class SolutionsControllerSolution extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SolutionsControllerSolution;
    /**
     ...
     */
    static isInstance(obj: any): obj is SolutionsControllerSolution;
    /**
     ...
     */
    readonly properties: pulumi.Output<outputs.migrate.v20230101.SolutionPropertiesResponse>;
    /**
...
export interface SolutionsControllerSolutionArgs {
     ...
     * Gets or sets the properties of the solution.
     */
    properties?: pulumi.Input<inputs.migrate.v20230101.SolutionPropertiesArgs>;
    /**
