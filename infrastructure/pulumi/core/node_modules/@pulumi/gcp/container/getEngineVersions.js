...
exports.getEngineVersionsOutput = exports.getEngineVersions = void 0;
 ...
 * ```
 */
function getEngineVersionsOutput(args, opts) {
    return pulumi.output(args).apply((a) => getEngineVersions(a, opts));
}
exports.getEngineVersionsOutput = getEngineVersionsOutput;
