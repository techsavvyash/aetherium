...
export declare class AppServiceEnvironment extends pulumi.CustomResource {
     ...
     */
    readonly clusterSettings: pulumi.Output<outputs.web.v20210115.NameValuePairResponse[] | undefined>;
    /**
     * Dedicated Host Count
     */
    readonly dedicatedHostCount: pulumi.Output<number>;
    /**
     ...
     */
    readonly virtualNetwork: pulumi.Output<outputs.web.v20210115.VirtualNetworkProfileResponse>;
    /**
...
export interface AppServiceEnvironmentArgs {
     ...
     * Custom settings for changing the behavior of the App Service Environment.
     */
    clusterSettings?: pulumi.Input<pulumi.Input<inputs.web.v20210115.NameValuePairArgs>[]>;
    /**
     * DNS suffix of the App Service Environment.
     */
     ...
     * Specifies which endpoints to serve internally in the Virtual Network for the App Service Environment.
     */
    internalLoadBalancingMode?: pulumi.Input<string | enums.web.v20210115.LoadBalancingMode>;
    /**
     * Number of IP SSL addresses reserved for the App Service Environment.
     */
     ...
     * Description of the Virtual Network.
     */
    virtualNetwork: pulumi.Input<inputs.web.v20210115.VirtualNetworkProfileArgs>;
}
