...
export declare class NetworkSecurityGroup extends pulumi.CustomResource {
     ...
     */
    readonly networkInterfaces: pulumi.Output<outputs.azurestackhci.v20250401preview.NetworkInterfaceArmReferenceResponse[]>;
    /**
     ...
     */
    readonly status: pulumi.Output<outputs.azurestackhci.v20250401preview.NetworkSecurityGroupStatusResponse>;
    /**
     * A collection of references to logical networks that are currently using this NSG
     */
    readonly subnets: pulumi.Output<outputs.azurestackhci.v20250401preview.LogicalNetworkArmReferenceResponse[]>;
    /**
