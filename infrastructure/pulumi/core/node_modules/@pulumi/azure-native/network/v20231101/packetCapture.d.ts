...
export declare class PacketCapture extends pulumi.CustomResource {
     ...
     */
    readonly captureSettings: pulumi.Output<outputs.network.v20231101.PacketCaptureSettingsResponse | undefined>;
    /**
     ...
     */
    readonly filters: pulumi.Output<outputs.network.v20231101.PacketCaptureFilterResponse[] | undefined>;
    /**
     ...
     */
    readonly scope: pulumi.Output<outputs.network.v20231101.PacketCaptureMachineScopeResponse | undefined>;
    /**
     * The storage location for a packet capture session.
     */
    readonly storageLocation: pulumi.Output<outputs.network.v20231101.PacketCaptureStorageLocationResponse>;
    /**
...
export interface PacketCaptureArgs {
     ...
     * The capture setting holds the 'FileCount', 'FileSizeInBytes', 'SessionTimeLimitInSeconds' values.
     */
    captureSettings?: pulumi.Input<inputs.network.v20231101.PacketCaptureSettingsArgs>;
    /**
     * This continuous capture is a nullable boolean, which can hold 'null', 'true' or 'false' value. If we do not pass this parameter, it would be consider as 'null', default value is 'null'.
     */
     ...
     * A list of packet capture filters.
     */
    filters?: pulumi.Input<pulumi.Input<inputs.network.v20231101.PacketCaptureFilterArgs>[]>;
    /**
     ...
     * A list of AzureVMSS instances which can be included or excluded to run packet capture. If both included and excluded are empty, then the packet capture will run on all instances of AzureVMSS.
     */
    scope?: pulumi.Input<inputs.network.v20231101.PacketCaptureMachineScopeArgs>;
    /**
     * The storage location for a packet capture session.
     */
    storageLocation: pulumi.Input<inputs.network.v20231101.PacketCaptureStorageLocationArgs>;
    /**
     * The ID of the targeted resource, only AzureVM and AzureVMSS as target type are currently supported.
     */
     ...
     * Target type of the resource provided.
     */
    targetType?: pulumi.Input<enums.network.v20231101.PacketCaptureTargetType>;
    /**
     * Maximum duration of the capture session in seconds.
     */
