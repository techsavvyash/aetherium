...
export declare class SchemaRegistry extends pulumi.CustomResource {
     ...
     */
    readonly identity: pulumi.Output<outputs.deviceregistry.v20240901preview.SystemAssignedServiceIdentityResponse | undefined>;
    /**
...
export interface SchemaRegistryArgs {
     ...
     * The managed service identities assigned to this resource.
     */
    identity?: pulumi.Input<inputs.deviceregistry.v20240901preview.SystemAssignedServiceIdentityArgs>;
    /**
     * The geo-location where the resource lives
     */
