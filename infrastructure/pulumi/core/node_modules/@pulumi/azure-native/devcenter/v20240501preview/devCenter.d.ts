...
export declare class DevCenter extends pulumi.CustomResource {
     ...
     */
    readonly devBoxProvisioningSettings: pulumi.Output<outputs.devcenter.v20240501preview.DevBoxProvisioningSettingsResponse | undefined>;
    /**
     ...
     */
    readonly encryption: pulumi.Output<outputs.devcenter.v20240501preview.EncryptionResponse | undefined>;
    /**
     ...
     */
    readonly networkSettings: pulumi.Output<outputs.devcenter.v20240501preview.DevCenterNetworkSettingsResponse | undefined>;
    /**
     ...
     */
    readonly projectCatalogSettings: pulumi.Output<outputs.devcenter.v20240501preview.DevCenterProjectCatalogSettingsResponse | undefined>;
    /**
...
export interface DevCenterArgs {
     ...
     * Settings to be used in the provisioning of all Dev Boxes that belong to this dev center.
     */
    devBoxProvisioningSettings?: pulumi.Input<inputs.devcenter.v20240501preview.DevBoxProvisioningSettingsArgs>;
    /**
     ...
     * Encryption settings to be used for server-side encryption for proprietary content (such as catalogs, logs, customizations).
     */
    encryption?: pulumi.Input<inputs.devcenter.v20240501preview.EncryptionArgs>;
    /**
     * Managed identity properties
     */
     ...
     * Network settings that will be enforced on network resources associated with the Dev Center.
     */
    networkSettings?: pulumi.Input<inputs.devcenter.v20240501preview.DevCenterNetworkSettingsArgs>;
    /**
     * Resource Id of an associated Plan
     */
     ...
     * Dev Center settings to be used when associating a project with a catalog.
     */
    projectCatalogSettings?: pulumi.Input<inputs.devcenter.v20240501preview.DevCenterProjectCatalogSettingsArgs>;
    /**
