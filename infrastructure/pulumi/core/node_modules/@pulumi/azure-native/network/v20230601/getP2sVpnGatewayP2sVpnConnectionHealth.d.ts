...
export interface GetP2sVpnGatewayP2sVpnConnectionHealthResult {
     ...
     */
    readonly p2SConnectionConfigurations?: outputs.network.v20230601.P2SConnectionConfigurationResponse[];
    /**
     ...
     */
    readonly vpnClientConnectionHealth: outputs.network.v20230601.VpnClientConnectionHealthResponse;
    /**
     ...
     */
    readonly vpnServerConfiguration?: outputs.network.v20230601.SubResourceResponse;
}
/**
 * Gets the connection health of P2S clients of the virtual wan P2SVpnGateway in the specified resource group.
 */
