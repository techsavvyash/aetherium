 ...
 * ```
 */
export declare function getDatascanIamPolicyOutput(args: GetDatascanIamPolicyOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetDatascanIamPolicyResult>;
/**
 * A collection of arguments for invoking getDatascanIamPolicy.
 */
