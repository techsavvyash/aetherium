...
export declare class ReplicationPolicy extends pulumi.CustomResource {
     ...
     * The custom data.
     */
    readonly properties: pulumi.Output<outputs.recoveryservices.v20240201.PolicyPropertiesResponse>;
    /**
     * Resource Type
     */
...
export interface ReplicationPolicyArgs {
     ...
     */
    properties?: pulumi.Input<inputs.recoveryservices.v20240201.CreatePolicyInputPropertiesArgs>;
    /**
