 ...
 */
export declare class System extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): System;
    /**
     ...
     */
    readonly configuration: pulumi.Output<outputs.securityinsights.v20241001preview.SapSystemsConfigurationResponse>;
...
export interface SystemArgs {
     ...
     * The configuration of the system.
     */
    configuration: pulumi.Input<inputs.securityinsights.v20241001preview.SapSystemsConfigurationArgs>;
     ...
     * The status of the system.
     */
    status?: pulumi.Input<string | enums.securityinsights.v20241001preview.SystemStatusType>;
    /**
