...
export declare class StorageAccountCredential extends pulumi.CustomResource {
     ...
     */
    readonly accountKey: pulumi.Output<outputs.databoxedge.v20231201.AsymmetricEncryptedSecretResponse | undefined>;
    /**
...
export interface StorageAccountCredentialArgs {
     ...
     * Encrypted storage key.
     */
    accountKey?: pulumi.Input<inputs.databoxedge.v20231201.AsymmetricEncryptedSecretArgs>;
    /**
     * Type of storage accessed on the storage account.
     */
    accountType: pulumi.Input<string | enums.databoxedge.v20231201.AccountType>;
    /**
     * Alias for the storage account.
     */
     ...
     * Signifies whether SSL needs to be enabled or not.
     */
    sslStatus: pulumi.Input<string | enums.databoxedge.v20231201.SSLStatus>;
    /**
     * Id of the storage account.
     */
