...
export declare class WorkspaceManagerAssignment extends pulumi.CustomResource {
     ...
     */
    readonly items: pulumi.Output<outputs.securityinsights.v20230901preview.AssignmentItemResponse[]>;
    /**
...
export interface WorkspaceManagerAssignmentArgs {
     ...
     * List of resources included in this workspace manager assignment
     */
    items: pulumi.Input<pulumi.Input<inputs.securityinsights.v20230901preview.AssignmentItemArgs>[]>;
    /**
