...
export declare class Database extends pulumi.CustomResource {
     ...
     */
    readonly currentSku: pulumi.Output<outputs.sql.v20230201preview.SkuResponse>;
    /**
     ...
     */
    readonly identity: pulumi.Output<outputs.sql.v20230201preview.DatabaseIdentityResponse | undefined>;
    /**
    ...
    readonly keys: pulumi.Output<{
        [key: string]: outputs.sql.v20230201preview.DatabaseKeyResponse;
    } | undefined>;
    /**
...
export interface DatabaseArgs {
     ...
     * Specifies the availability zone the database is pinned to.
     */
    availabilityZone?: pulumi.Input<string | enums.sql.v20230201preview.AvailabilityZoneType>;
    /**
     * Collation of the metadata catalog.
     */
     ...
     */
    createMode?: pulumi.Input<string | enums.sql.v20230201preview.CreateMode>;
    /**
     ...
     * BillForUsage: The database will continue to be online upon exhaustion of free limits and any overage will be billed.
     */
    freeLimitExhaustionBehavior?: pulumi.Input<string | enums.sql.v20230201preview.FreeLimitExhaustionBehavior>;
    /**
     * The number of secondary replicas associated with the database that are used to provide high availability. Not applicable to a Hyperscale database within an elastic pool.
     */
     ...
     * The Azure Active Directory identity of the database.
     */
    identity?: pulumi.Input<inputs.sql.v20230201preview.DatabaseIdentityArgs>;
    /**
     * Whether or not this database is a ledger database, which means all tables in the database are ledger tables. Note: the value of this property cannot be changed after the database has been created.
     */
     ...
     * The license type to apply for this database. `LicenseIncluded` if you need a license, or `BasePrice` if you have a license and are eligible for the Azure Hybrid Benefit.
     */
    licenseType?: pulumi.Input<string | enums.sql.v20230201preview.DatabaseLicenseType>;
    /**
     * Resource location.
     */
     ...
     * Type of enclave requested on the database i.e. Default or VBS enclaves.
     */
    preferredEnclaveType?: pulumi.Input<string | enums.sql.v20230201preview.AlwaysEncryptedEnclaveType>;
    /**
     * The state of read-only routing. If enabled, connections that have application intent set to readonly in their connection string may be routed to a readonly secondary replica in the same region. Not applicable to a Hyperscale database within an elastic pool.
     */
    readScale?: pulumi.Input<string | enums.sql.v20230201preview.DatabaseReadScale>;
    /**
     ...
     */
    sampleName?: pulumi.Input<string | enums.sql.v20230201preview.SampleName>;
    /**
     * The secondary type of the database if it is a secondary.  Valid values are Geo, Named and Standby.
     */
    secondaryType?: pulumi.Input<string | enums.sql.v20230201preview.SecondaryType>;
    /**
