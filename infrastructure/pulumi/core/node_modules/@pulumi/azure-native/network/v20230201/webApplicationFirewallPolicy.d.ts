...
export declare class WebApplicationFirewallPolicy extends pulumi.CustomResource {
     ...
     */
    readonly applicationGateways: pulumi.Output<outputs.network.v20230201.ApplicationGatewayResponse[]>;
    /**
     * The custom rules inside the policy.
     */
    readonly customRules: pulumi.Output<outputs.network.v20230201.WebApplicationFirewallCustomRuleResponse[] | undefined>;
    /**
     ...
     */
    readonly httpListeners: pulumi.Output<outputs.network.v20230201.SubResourceResponse[]>;
    /**
     * Resource location.
     */
     ...
     */
    readonly managedRules: pulumi.Output<outputs.network.v20230201.ManagedRulesDefinitionResponse>;
    /**
     * Resource name.
     */
     ...
     */
    readonly pathBasedRules: pulumi.Output<outputs.network.v20230201.SubResourceResponse[]>;
    /**
     * The PolicySettings for policy.
     */
    readonly policySettings: pulumi.Output<outputs.network.v20230201.PolicySettingsResponse | undefined>;
    /**
...
export interface WebApplicationFirewallPolicyArgs {
     ...
     * The custom rules inside the policy.
     */
    customRules?: pulumi.Input<pulumi.Input<inputs.network.v20230201.WebApplicationFirewallCustomRuleArgs>[]>;
    /**
     * Resource ID.
     */
     ...
     * Describes the managedRules structure.
     */
    managedRules: pulumi.Input<inputs.network.v20230201.ManagedRulesDefinitionArgs>;
    /**
     ...
     * The PolicySettings for policy.
     */
    policySettings?: pulumi.Input<inputs.network.v20230201.PolicySettingsArgs>;
    /**
