...
export declare class GroupQuota extends pulumi.CustomResource {
     ...
     * Properties and filters for ShareQuota. The request parameter is optional, if there are no filters specified.
     */
    readonly properties: pulumi.Output<outputs.quota.v20230601preview.GroupQuotasEntityBaseResponse>;
    /**
     * Azure Resource Manager metadata containing createdBy and modifiedBy information.
     */
    readonly systemData: pulumi.Output<outputs.quota.v20230601preview.SystemDataResponse>;
    /**
...
export interface GroupQuotaArgs {
     ...
     * Properties and filters for ShareQuota. The request parameter is optional, if there are no filters specified.
     */
    properties?: pulumi.Input<inputs.quota.v20230601preview.GroupQuotasEntityBaseArgs>;
}
