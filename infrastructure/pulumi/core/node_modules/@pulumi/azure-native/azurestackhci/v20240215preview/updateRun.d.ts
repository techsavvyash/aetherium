...
export declare class UpdateRun extends pulumi.CustomResource {
     ...
     */
    readonly steps: pulumi.Output<outputs.azurestackhci.v20240215preview.StepResponse[] | undefined>;
    /**
...
export interface UpdateRunArgs {
     ...
     * State of the update run.
     */
    state?: pulumi.Input<string | enums.azurestackhci.v20240215preview.UpdateRunPropertiesState>;
    /**
     * Status of the step, bubbled up from the ECE action plan for installation attempts. Values are: 'Success', 'Error', 'InProgress', and 'Unknown status'.
     */
     ...
     * Recursive model for child steps of this step.
     */
    steps?: pulumi.Input<pulumi.Input<inputs.azurestackhci.v20240215preview.StepArgs>[]>;
    /**
     * Timestamp of the update run was started.
     */
