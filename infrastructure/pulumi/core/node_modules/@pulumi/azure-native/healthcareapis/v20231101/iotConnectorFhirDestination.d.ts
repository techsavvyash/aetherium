...
export declare class IotConnectorFhirDestination extends pulumi.CustomResource {
     ...
     * FHIR Mappings
     */
    readonly fhirMapping: pulumi.Output<outputs.healthcareapis.v20231101.IotMappingPropertiesResponse>;
    /**
...
export interface IotConnectorFhirDestinationArgs {
     ...
     * FHIR Mappings
     */
    fhirMapping: pulumi.Input<inputs.healthcareapis.v20231101.IotMappingPropertiesArgs>;
    /**
     * Fully qualified resource id of the FHIR service to connect to.
     */
     ...
     * Determines how resource identity is resolved on the destination.
     */
    resourceIdentityResolutionType: pulumi.Input<string | enums.healthcareapis.v20231101.IotIdentityResolutionType>;
    /**
