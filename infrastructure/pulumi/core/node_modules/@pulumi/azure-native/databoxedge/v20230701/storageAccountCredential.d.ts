...
export declare class StorageAccountCredential extends pulumi.CustomResource {
     ...
     */
    readonly accountKey: pulumi.Output<outputs.databoxedge.v20230701.AsymmetricEncryptedSecretResponse | undefined>;
    /**
...
export interface StorageAccountCredentialArgs {
     ...
     * Encrypted storage key.
     */
    accountKey?: pulumi.Input<inputs.databoxedge.v20230701.AsymmetricEncryptedSecretArgs>;
    /**
     * Type of storage accessed on the storage account.
     */
    accountType: pulumi.Input<string | enums.databoxedge.v20230701.AccountType>;
    /**
     * Alias for the storage account.
     */
     ...
     * Signifies whether SSL needs to be enabled or not.
     */
    sslStatus: pulumi.Input<string | enums.databoxedge.v20230701.SSLStatus>;
    /**
     * Id of the storage account.
     */
