...
export declare const SourceType: {
    ...
    readonly EDB: "EDB";
    readonly EDB_Oracle_Server: "EDB_Oracle_Server";
    readonly EDB_PostgreSQL: "EDB_PostgreSQL";
    readonly PostgreSQLFlexibleServer: "PostgreSQLFlexibleServer";
    readonly PostgreSQLCosmosDB: "PostgreSQLCosmosDB";
    readonly Huawei_RDS: "Huawei_RDS";
    readonly Huawei_Compute: "Huawei_Compute";
    readonly Heroku_PostgreSQL: "Heroku_PostgreSQL";
    readonly Crunchy_PostgreSQL: "Crunchy_PostgreSQL";
    readonly ApsaraDB_RDS: "ApsaraDB_RDS";
    readonly Digital_Ocean_Droplets: "Digital_Ocean_Droplets";
    readonly Digital_Ocean_PostgreSQL: "Digital_Ocean_PostgreSQL";
    readonly Supabase_PostgreSQL: "Supabase_PostgreSQL";
};
/**
