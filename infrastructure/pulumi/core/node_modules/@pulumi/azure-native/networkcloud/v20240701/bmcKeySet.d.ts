...
export declare class BmcKeySet extends pulumi.CustomResource {
     ...
     */
    readonly userList: pulumi.Output<outputs.networkcloud.v20240701.KeySetUserResponse[]>;
    /**
     * The status evaluation of each user.
     */
    readonly userListStatus: pulumi.Output<outputs.networkcloud.v20240701.KeySetUserStatusResponse[]>;
    /**
...
export interface BmcKeySetArgs {
     ...
     * The access level allowed for the users in this key set.
     */
    privilegeLevel: pulumi.Input<string | enums.networkcloud.v20240701.BmcKeySetPrivilegeLevel>;
    /**
     ...
     * The unique list of permitted users.
     */
    userList: pulumi.Input<pulumi.Input<inputs.networkcloud.v20240701.KeySetUserArgs>[]>;
}
