...
export declare class SqlAssessmentV2Operation extends pulumi.CustomResource {
     ...
     */
    readonly azureSqlDatabaseSettings: pulumi.Output<outputs.migrate.v20230909preview.SqlDbSettingsResponse | undefined>;
    /**
     * Gets or sets user configurable SQL managed instance settings.
     */
    readonly azureSqlManagedInstanceSettings: pulumi.Output<outputs.migrate.v20230909preview.SqlMiSettingsResponse | undefined>;
    /**
     * Gets or sets user configurable SQL VM settings.
     */
    readonly azureSqlVmSettings: pulumi.Output<outputs.migrate.v20230909preview.SqlVmSettingsResponse | undefined>;
    /**
     ...
     */
    readonly entityUptime: pulumi.Output<outputs.migrate.v20230909preview.EntityUptimeResponse | undefined>;
    /**
     ...
     */
    readonly systemData: pulumi.Output<outputs.migrate.v20230909preview.SystemDataResponse>;
    /**
...
export interface SqlAssessmentV2OperationArgs {
     ...
     * Gets or sets user preference indicating intent of async commit mode.
     */
    asyncCommitModeIntent?: pulumi.Input<string | enums.migrate.v20230909preview.AsyncCommitModeIntent>;
    /**
     * Azure Location or Azure region where to which the machines will be migrated.
     */
     ...
     * Gets or sets Azure Offer Code for VM.
     */
    azureOfferCodeForVm?: pulumi.Input<string | enums.migrate.v20230909preview.AzureOfferCode>;
    /**
     * Gets or sets a value indicating azure security offering type.
     */
     ...
     * Gets or sets user configurable SQL database settings.
     */
    azureSqlDatabaseSettings?: pulumi.Input<inputs.migrate.v20230909preview.SqlDbSettingsArgs>;
    /**
     * Gets or sets user configurable SQL managed instance settings.
     */
    azureSqlManagedInstanceSettings?: pulumi.Input<inputs.migrate.v20230909preview.SqlMiSettingsArgs>;
    /**
     * Gets or sets user configurable SQL VM settings.
     */
    azureSqlVmSettings?: pulumi.Input<inputs.migrate.v20230909preview.SqlVmSettingsArgs>;
    /**
     * Confidence Rating in Percentage.
     */
     ...
     * will be migrated.
     */
    disasterRecoveryLocation?: pulumi.Input<string | enums.migrate.v20230909preview.AzureLocation>;
    /**
     * Custom discount percentage.
     */
     ...
     * Gets or sets user preference indicating intent of multi-subnet configuration.
     */
    multiSubnetIntent?: pulumi.Input<string | enums.migrate.v20230909preview.MultiSubnetIntent>;
    /**
     * Gets or sets SQL optimization logic.
     */
    optimizationLogic?: pulumi.Input<string | enums.migrate.v20230909preview.OptimizationLogic>;
    /**
     * Gets or sets user configurable setting to display the azure hybrid use benefit.
     */
    osLicense?: pulumi.Input<string | enums.migrate.v20230909preview.OsLicense>;
    /**
     * Percentile of the utilization data values to be considered while assessing
     * machines.
     */
     ...
     * Gets or sets azure reserved instance for VM.
     */
    reservedInstanceForVm?: pulumi.Input<string | enums.migrate.v20230909preview.AzureReservedInstance>;
    /**
     ...
     * SQL server license.
     */
    sqlServerLicense?: pulumi.Input<string | enums.migrate.v20230909preview.SqlServerLicense>;
    /**
     * Time Range for which the historic utilization data should be considered for
     * assessment.
     */
