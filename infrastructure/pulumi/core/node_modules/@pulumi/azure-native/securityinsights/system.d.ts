...
export declare class System extends pulumi.CustomResource {
     ...
     */
    readonly configuration: pulumi.Output<outputs.securityinsights.SapSystemsConfigurationResponse>;
...
export interface SystemArgs {
     ...
     * The configuration of the system.
     */
    configuration: pulumi.Input<inputs.securityinsights.SapSystemsConfigurationArgs>;
     ...
     * The status of the system.
     */
    status?: pulumi.Input<string | enums.securityinsights.SystemStatusType>;
    /**
