...
export declare class PatchSchedule extends pulumi.CustomResource {
     ...
     */
    readonly scheduleEntries: pulumi.Output<outputs.cache.v20230801.ScheduleEntryResponse[]>;
    /**
...
export interface PatchScheduleArgs {
     ...
     * List of patch schedules for a Redis cache.
     */
    scheduleEntries: pulumi.Input<pulumi.Input<inputs.cache.v20230801.ScheduleEntryArgs>[]>;
}
