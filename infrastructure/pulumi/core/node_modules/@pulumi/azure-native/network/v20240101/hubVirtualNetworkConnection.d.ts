...
export declare class HubVirtualNetworkConnection extends pulumi.CustomResource {
     ...
     */
    readonly routingConfiguration: pulumi.Output<outputs.network.v20240101.RoutingConfigurationResponse | undefined>;
    /**
...
export interface HubVirtualNetworkConnectionArgs {
     ...
     * The Routing Configuration indicating the associated and propagated route tables on this connection.
     */
    routingConfiguration?: pulumi.Input<inputs.network.v20240101.RoutingConfigurationArgs>;
    /**
