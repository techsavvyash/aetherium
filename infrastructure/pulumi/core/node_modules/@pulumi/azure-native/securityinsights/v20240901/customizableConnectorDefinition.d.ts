...
export declare class CustomizableConnectorDefinition extends pulumi.CustomResource {
     ...
     */
    readonly connectionsConfig: pulumi.Output<outputs.securityinsights.v20240901.CustomizableConnectionsConfigResponse | undefined>;
    /**
     * The UiConfig for 'Customizable' connector definition kind.
     */
    readonly connectorUiConfig: pulumi.Output<outputs.securityinsights.v20240901.CustomizableConnectorUiConfigResponse>;
    /**
...
export interface CustomizableConnectorDefinitionArgs {
     ...
     * The UiConfig for 'Customizable' connector definition kind.
     */
    connectionsConfig?: pulumi.Input<inputs.securityinsights.v20240901.CustomizableConnectionsConfigArgs>;
    /**
     * The UiConfig for 'Customizable' connector definition kind.
     */
    connectorUiConfig: pulumi.Input<inputs.securityinsights.v20240901.CustomizableConnectorUiConfigArgs>;
    /**
     * Gets or sets the connector definition created date in UTC format.
     */
