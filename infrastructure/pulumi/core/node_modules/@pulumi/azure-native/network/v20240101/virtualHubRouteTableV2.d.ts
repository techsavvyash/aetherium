...
export declare class VirtualHubRouteTableV2 extends pulumi.CustomResource {
     ...
     * List of all routes.
     */
    readonly routes: pulumi.Output<outputs.network.v20240101.VirtualHubRouteV2Response[] | undefined>;
    /**
...
export interface VirtualHubRouteTableV2Args {
     ...
     * List of all routes.
     */
    routes?: pulumi.Input<pulumi.Input<inputs.network.v20240101.VirtualHubRouteV2Args>[]>;
    /**
