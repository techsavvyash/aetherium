...
export declare class AppServiceCertificateOrder extends pulumi.CustomResource {
    ...
    readonly certificates: pulumi.Output<{
        [key: string]: outputs.certificateregistration.v20231201.AppServiceCertificateResponse;
    } | undefined>;
    /**
     * Contact info
     */
    readonly contact: pulumi.Output<outputs.certificateregistration.v20231201.CertificateOrderContactResponse>;
    /**
     ...
     */
    readonly intermediate: pulumi.Output<outputs.certificateregistration.v20231201.CertificateDetailsResponse>;
    /**
     ...
     * Root certificate.
     */
    readonly root: pulumi.Output<outputs.certificateregistration.v20231201.CertificateDetailsResponse>;
    /**
     ...
     * Signed certificate.
     */
    readonly signedCertificate: pulumi.Output<outputs.certificateregistration.v20231201.CertificateDetailsResponse>;
    /**
...
export interface AppServiceCertificateOrderArgs {
    ...
    certificates?: pulumi.Input<{
        [key: string]: pulumi.Input<inputs.certificateregistration.v20231201.AppServiceCertificateArgs>;
    }>;
    /**
     * Last CSR that was created for this order.
     */
     ...
     * Certificate product type.
     */
    productType: pulumi.Input<enums.certificateregistration.v20231201.CertificateProductType>;
    /**
