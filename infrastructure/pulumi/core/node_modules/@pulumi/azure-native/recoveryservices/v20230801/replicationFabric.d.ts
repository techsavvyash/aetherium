...
export declare class ReplicationFabric extends pulumi.CustomResource {
     ...
     * Fabric related data.
     */
    readonly properties: pulumi.Output<outputs.recoveryservices.v20230801.FabricPropertiesResponse>;
    /**
     * Resource Type
     */
...
export interface ReplicationFabricArgs {
     ...
     */
    properties?: pulumi.Input<inputs.recoveryservices.v20230801.FabricCreationInputPropertiesArgs>;
    /**
