...
export declare class ContainerAppsSessionPool extends pulumi.CustomResource {
     ...
     */
    readonly customContainerTemplate: pulumi.Output<outputs.app.v20240202preview.CustomContainerTemplateResponse | undefined>;
    /**
     * The pool configuration if the poolManagementType is dynamic.
     */
    readonly dynamicPoolConfiguration: pulumi.Output<outputs.app.v20240202preview.DynamicPoolConfigurationResponse | undefined>;
    /**
     ...
     */
    readonly scaleConfiguration: pulumi.Output<outputs.app.v20240202preview.ScaleConfigurationResponse | undefined>;
    /**
     * The secrets of the session pool.
     */
    readonly secrets: pulumi.Output<outputs.app.v20240202preview.SessionPoolSecretResponse[] | undefined>;
    /**
     * The network configuration of the sessions in the session pool.
     */
    readonly sessionNetworkConfiguration: pulumi.Output<outputs.app.v20240202preview.SessionNetworkConfigurationResponse | undefined>;
    /**
...
export interface ContainerAppsSessionPoolArgs {
     ...
     * The container type of the sessions.
     */
    containerType?: pulumi.Input<string | enums.app.v20240202preview.ContainerType>;
    /**
     * The custom container configuration if the containerType is CustomContainer.
     */
    customContainerTemplate?: pulumi.Input<inputs.app.v20240202preview.CustomContainerTemplateArgs>;
    /**
     * The pool configuration if the poolManagementType is dynamic.
     */
    dynamicPoolConfiguration?: pulumi.Input<inputs.app.v20240202preview.DynamicPoolConfigurationArgs>;
    /**
     * Resource ID of the session pool's environment.
     */
     ...
     * The pool management type of the session pool.
     */
    poolManagementType?: pulumi.Input<string | enums.app.v20240202preview.PoolManagementType>;
    /**
     ...
     * The scale configuration of the session pool.
     */
    scaleConfiguration?: pulumi.Input<inputs.app.v20240202preview.ScaleConfigurationArgs>;
    /**
     * The secrets of the session pool.
     */
    secrets?: pulumi.Input<pulumi.Input<inputs.app.v20240202preview.SessionPoolSecretArgs>[]>;
    /**
     * The network configuration of the sessions in the session pool.
     */
    sessionNetworkConfiguration?: pulumi.Input<inputs.app.v20240202preview.SessionNetworkConfigurationArgs>;
    /**
