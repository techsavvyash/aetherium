...
export declare class ScheduledAlertRule extends pulumi.CustomResource {
     ...
     */
    readonly alertDetailsOverride: pulumi.Output<outputs.securityinsights.v20240301.AlertDetailsOverrideResponse | undefined>;
    /**
     ...
     */
    readonly entityMappings: pulumi.Output<outputs.securityinsights.v20240301.EntityMappingResponse[] | undefined>;
    /**
     ...
     */
    readonly eventGroupingSettings: pulumi.Output<outputs.securityinsights.v20240301.EventGroupingSettingsResponse | undefined>;
    /**
     * The settings of the incidents that created from alerts triggered by this analytics rule
     */
    readonly incidentConfiguration: pulumi.Output<outputs.securityinsights.v20240301.IncidentConfigurationResponse | undefined>;
    /**
     ...
     */
    readonly systemData: pulumi.Output<outputs.securityinsights.v20240301.SystemDataResponse>;
    /**
...
export interface ScheduledAlertRuleArgs {
     ...
     * The alert details override settings
     */
    alertDetailsOverride?: pulumi.Input<inputs.securityinsights.v20240301.AlertDetailsOverrideArgs>;
    /**
     * The Name of the alert rule template used to create this rule.
     */
     ...
     * Array of the entity mappings of the alert rule
     */
    entityMappings?: pulumi.Input<pulumi.Input<inputs.securityinsights.v20240301.EntityMappingArgs>[]>;
    /**
     * The event grouping settings.
     */
    eventGroupingSettings?: pulumi.Input<inputs.securityinsights.v20240301.EventGroupingSettingsArgs>;
    /**
     * The settings of the incidents that created from alerts triggered by this analytics rule
     */
    incidentConfiguration?: pulumi.Input<inputs.securityinsights.v20240301.IncidentConfigurationArgs>;
    /**
     * The kind of the alert rule
     * Expected value is 'Scheduled'.
     */
     ...
     * The severity for alerts created by this alert rule.
     */
    severity: pulumi.Input<string | enums.securityinsights.v20240301.AlertSeverity>;
    /**
     * The suppression (in ISO 8601 duration format) to wait since last time this alert rule been triggered.
     */
     ...
     * The operation against the threshold that triggers alert rule.
     */
    triggerOperator: pulumi.Input<enums.securityinsights.v20240301.TriggerOperator>;
    /**
     * The threshold triggers this alert rule.
     */
