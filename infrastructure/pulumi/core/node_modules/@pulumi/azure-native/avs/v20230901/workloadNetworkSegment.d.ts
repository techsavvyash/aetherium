...
export declare class WorkloadNetworkSegment extends pulumi.CustomResource {
     ...
     */
    readonly portVif: pulumi.Output<outputs.avs.v20230901.WorkloadNetworkSegmentPortVifResponse[]>;
    /**
     ...
     */
    readonly subnet: pulumi.Output<outputs.avs.v20230901.WorkloadNetworkSegmentSubnetResponse | undefined>;
    /**
...
export interface WorkloadNetworkSegmentArgs {
     ...
     * Subnet which to connect segment to.
     */
    subnet?: pulumi.Input<inputs.avs.v20230901.WorkloadNetworkSegmentSubnetArgs>;
}
