...
export declare class ActionRequest extends pulumi.CustomResource {
    ...
    readonly preReleaseAccessRequestSpec: pulumi.Output<outputs.testbase.v20231101preview.PreReleaseAccessRequestSpecResponse | undefined>;
    /**
...
export interface ActionRequestArgs {
    ...
    preReleaseAccessRequestSpec?: pulumi.Input<inputs.testbase.v20231101preview.PreReleaseAccessRequestSpecArgs>;
    requestType: pulumi.Input<string | enums.testbase.v20231101preview.RequestTypes>;
    /**
