...
export interface ListSourceControlRepositoriesArgs {
     ...
     */
    kind: string | enums.securityinsights.v20250101preview.RepositoryAccessKind;
    /**
...
export interface ListSourceControlRepositoriesResult {
     ...
     */
    readonly value: outputs.securityinsights.v20250101preview.RepoResponse[];
}
/**
 * Gets a list of repositories metadata.
 */
...
export interface ListSourceControlRepositoriesOutputArgs {
     ...
     * The kind of repository access credentials
     */
    kind: pulumi.Input<string | enums.securityinsights.v20250101preview.RepositoryAccessKind>;
    /**
     * The name of the resource group. The name is case insensitive.
     */
