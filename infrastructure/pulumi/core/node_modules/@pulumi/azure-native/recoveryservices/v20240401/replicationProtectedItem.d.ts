...
export declare class ReplicationProtectedItem extends pulumi.CustomResource {
     ...
     * The custom data.
     */
    readonly properties: pulumi.Output<outputs.recoveryservices.v20240401.ReplicationProtectedItemPropertiesResponse>;
    /**
     * Resource Type
     */
...
export interface ReplicationProtectedItemArgs {
     ...
     */
    properties?: pulumi.Input<inputs.recoveryservices.v20240401.EnableProtectionInputPropertiesArgs>;
    /**
