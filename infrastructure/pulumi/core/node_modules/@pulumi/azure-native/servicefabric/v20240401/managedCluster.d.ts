...
export declare class ManagedCluster extends pulumi.CustomResource {
     ...
     */
    readonly applicationTypeVersionsCleanupPolicy: pulumi.Output<outputs.servicefabric.v20240401.ApplicationTypeVersionsCleanupPolicyResponse | undefined>;
    /**
     * Auxiliary subnets for the cluster.
     */
    readonly auxiliarySubnets: pulumi.Output<outputs.servicefabric.v20240401.SubnetResponse[] | undefined>;
    /**
     * The AAD authentication settings of the cluster.
     */
    readonly azureActiveDirectory: pulumi.Output<outputs.servicefabric.v20240401.AzureActiveDirectoryResponse | undefined>;
    /**
     ...
     */
    readonly clients: pulumi.Output<outputs.servicefabric.v20240401.ClientCertificateResponse[] | undefined>;
    /**
     ...
     */
    readonly fabricSettings: pulumi.Output<outputs.servicefabric.v20240401.SettingsSectionDescriptionResponse[] | undefined>;
    /**
     ...
     */
    readonly ipTags: pulumi.Output<outputs.servicefabric.v20240401.IpTagResponse[] | undefined>;
    /**
     ...
     */
    readonly loadBalancingRules: pulumi.Output<outputs.servicefabric.v20240401.LoadBalancingRuleResponse[] | undefined>;
    /**
     ...
     */
    readonly serviceEndpoints: pulumi.Output<outputs.servicefabric.v20240401.ServiceEndpointResponse[] | undefined>;
    /**
     * The sku of the managed cluster
     */
    readonly sku: pulumi.Output<outputs.servicefabric.v20240401.SkuResponse>;
    /**
     ...
     */
    readonly upgradeDescription: pulumi.Output<outputs.servicefabric.v20240401.ClusterUpgradePolicyResponse | undefined>;
    /**
...
export interface ManagedClusterArgs {
     ...
     * List of add-on features to enable on the cluster.
     */
    addonFeatures?: pulumi.Input<pulumi.Input<string | enums.servicefabric.v20240401.ManagedClusterAddOnFeature>[]>;
    /**
     * VM admin user password.
     */
     ...
     * The policy used to clean up unused versions.
     */
    applicationTypeVersionsCleanupPolicy?: pulumi.Input<inputs.servicefabric.v20240401.ApplicationTypeVersionsCleanupPolicyArgs>;
    /**
     * Auxiliary subnets for the cluster.
     */
    auxiliarySubnets?: pulumi.Input<pulumi.Input<inputs.servicefabric.v20240401.SubnetArgs>[]>;
    /**
     * The AAD authentication settings of the cluster.
     */
    azureActiveDirectory?: pulumi.Input<inputs.servicefabric.v20240401.AzureActiveDirectoryArgs>;
    /**
     * The port used for client connections to the cluster.
     */
     ...
     * Client certificates that are allowed to manage the cluster.
     */
    clients?: pulumi.Input<pulumi.Input<inputs.servicefabric.v20240401.ClientCertificateArgs>[]>;
    /**
     * The Service Fabric runtime version of the cluster. This property is required when **clusterUpgradeMode** is set to 'Manual'. To get list of available Service Fabric versions for new clusters use [ClusterVersion API](./ClusterVersion.md). To get the list of available version for existing clusters use **availableClusterVersions**.
     */
     ...
     * Indicates when new cluster runtime version upgrades will be applied after they are released. By default is Wave0. Only applies when **clusterUpgradeMode** is set to 'Automatic'.
     */
    clusterUpgradeCadence?: pulumi.Input<string | enums.servicefabric.v20240401.ClusterUpgradeCadence>;
    /**
     * The upgrade mode of the cluster when new Service Fabric runtime version is available.
     */
    clusterUpgradeMode?: pulumi.Input<string | enums.servicefabric.v20240401.ClusterUpgradeMode>;
    /**
     * Specify the resource id of a DDoS network protection plan that will be associated with the virtual network of the cluster.
     */
     ...
     * The list of custom fabric settings to configure the cluster.
     */
    fabricSettings?: pulumi.Input<pulumi.Input<inputs.servicefabric.v20240401.SettingsSectionDescriptionArgs>[]>;
    /**
     * The port used for HTTP connections to the cluster.
     */
     ...
     * The list of IP tags associated with the default public IP address of the cluster.
     */
    ipTags?: pulumi.Input<pulumi.Input<inputs.servicefabric.v20240401.IpTagArgs>[]>;
    /**
     * Load balancing rules that are applied to the public load balancer of the cluster.
     */
    loadBalancingRules?: pulumi.Input<pulumi.Input<inputs.servicefabric.v20240401.LoadBalancingRuleArgs>[]>;
    /**
     * Azure resource location.
     */
     ...
     * Service endpoints for subnets in the cluster.
     */
    serviceEndpoints?: pulumi.Input<pulumi.Input<inputs.servicefabric.v20240401.ServiceEndpointArgs>[]>;
    /**
     * The sku of the managed cluster
     */
    sku: pulumi.Input<inputs.servicefabric.v20240401.SkuArgs>;
    /**
     * If specified, the node types for the cluster are created in this subnet instead of the default VNet. The **networkSecurityRules** specified for the cluster are also applied to this subnet. This setting cannot be changed once the cluster is created.
     */
     ...
     * The policy to use when upgrading the cluster.
     */
    upgradeDescription?: pulumi.Input<inputs.servicefabric.v20240401.ClusterUpgradePolicyArgs>;
    /**
     * For new clusters, this parameter indicates that it uses Bring your own VNet, but the subnet is specified at node type level; and for such clusters, the subnetId property is required for node types.
     */
     ...
     * Indicates the update mode for Cross Az clusters.
     */
    zonalUpdateMode?: pulumi.Input<string | enums.servicefabric.v20240401.ZonalUpdateMode>;
}
