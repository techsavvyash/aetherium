...
export declare class DataCollectionRule extends pulumi.CustomResource {
     ...
     */
    readonly agentSettings: pulumi.Output<outputs.insights.v20230311.DataCollectionRuleResponseAgentSettings | undefined>;
    /**
     ...
     */
    readonly dataFlows: pulumi.Output<outputs.insights.v20230311.DataFlowResponse[] | undefined>;
    /**
     * The specification of data sources.
     * This property is optional and can be omitted if the rule is meant to be used via direct calls to the provisioned endpoint.
     */
    readonly dataSources: pulumi.Output<outputs.insights.v20230311.DataCollectionRuleResponseDataSources | undefined>;
    /**
     ...
     */
    readonly destinations: pulumi.Output<outputs.insights.v20230311.DataCollectionRuleResponseDestinations | undefined>;
    /**
     * Defines the ingestion endpoints to send data to via this rule.
     */
    readonly endpoints: pulumi.Output<outputs.insights.v20230311.DataCollectionRuleResponseEndpoints>;
    /**
     ...
     */
    readonly identity: pulumi.Output<outputs.insights.v20230311.DataCollectionRuleResourceResponseIdentity | undefined>;
    /**
     ...
     */
    readonly metadata: pulumi.Output<outputs.insights.v20230311.DataCollectionRuleResponseMetadata>;
    /**
     ...
     */
    readonly references: pulumi.Output<outputs.insights.v20230311.DataCollectionRuleResponseReferences | undefined>;
    /**
     ...
     */
    readonly systemData: pulumi.Output<outputs.insights.v20230311.DataCollectionRuleResourceResponseSystemData>;
    /**
     * Resource tags.
     */
...
export interface DataCollectionRuleArgs {
    ...
    streamDeclarations?: pulumi.Input<{
        [key: string]: pulumi.Input<inputs.insights.v20230311.StreamDeclarationArgs>;
    }>;
    /**
     * Resource tags.
     */
