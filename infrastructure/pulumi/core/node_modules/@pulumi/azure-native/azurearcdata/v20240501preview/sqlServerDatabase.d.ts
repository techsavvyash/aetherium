...
export declare class SqlServerDatabase extends pulumi.CustomResource {
     ...
     */
    readonly properties: pulumi.Output<outputs.azurearcdata.v20240501preview.SqlServerDatabaseResourcePropertiesResponse>;
    /**
...
export interface SqlServerDatabaseArgs {
     ...
     * Properties of Arc Sql Server database
     */
    properties: pulumi.Input<inputs.azurearcdata.v20240501preview.SqlServerDatabaseResourcePropertiesArgs>;
    /**
