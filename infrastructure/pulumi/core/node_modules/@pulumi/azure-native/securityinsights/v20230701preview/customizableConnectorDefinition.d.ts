...
export declare class CustomizableConnectorDefinition extends pulumi.CustomResource {
     ...
     */
    readonly connectionsConfig: pulumi.Output<outputs.securityinsights.v20230701preview.CustomizableConnectionsConfigResponse | undefined>;
    /**
     * The UiConfig for 'Customizable' connector definition kind.
     */
    readonly connectorUiConfig: pulumi.Output<outputs.securityinsights.v20230701preview.CustomizableConnectorUiConfigResponse>;
    /**
