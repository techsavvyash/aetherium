...
export declare class FirewallPolicyRuleCollectionGroup extends pulumi.CustomResource {
     ...
     */
    readonly ruleCollections: pulumi.Output<(outputs.network.v20230401.FirewallPolicyFilterRuleCollectionResponse | outputs.network.v20230401.FirewallPolicyNatRuleCollectionResponse)[] | undefined>;
    /**
     * Rule Group type.
     */
...
export interface FirewallPolicyRuleCollectionGroupArgs {
     ...
     * Group of Firewall Policy rule collections.
     */
    ruleCollections?: pulumi.Input<pulumi.Input<inputs.network.v20230401.FirewallPolicyFilterRuleCollectionArgs | inputs.network.v20230401.FirewallPolicyNatRuleCollectionArgs>[]>;
}
