...
export declare class ApplicationGatewayPrivateEndpointConnection extends pulumi.CustomResource {
     ...
     */
    readonly privateEndpoint: pulumi.Output<outputs.network.v20230601.PrivateEndpointResponse>;
    /**
     * A collection of information about the state of the connection between service consumer and provider.
     */
    readonly privateLinkServiceConnectionState: pulumi.Output<outputs.network.v20230601.PrivateLinkServiceConnectionStateResponse | undefined>;
    /**
...
export interface ApplicationGatewayPrivateEndpointConnectionArgs {
     ...
     * A collection of information about the state of the connection between service consumer and provider.
     */
    privateLinkServiceConnectionState?: pulumi.Input<inputs.network.v20230601.PrivateLinkServiceConnectionStateArgs>;
    /**
