...
export declare class AvsAssessmentsOperation extends pulumi.CustomResource {
     ...
     */
    readonly avsEstimatedExternalStorages: pulumi.Output<outputs.migrate.v20230909preview.AvsEstimatedExternalStorageResponse[]>;
    /**
     * Estimated External Storage for Assessment.
     */
    readonly avsEstimatedNetworks: pulumi.Output<outputs.migrate.v20230909preview.AvsEstimatedNetworkResponse[]>;
    /**
     * Estimated AVS SKU for Assessment.
     */
    readonly avsEstimatedNodes: pulumi.Output<outputs.migrate.v20230909preview.AvsEstimatedNodeResponse[]>;
    /**
     ...
     */
    readonly costComponents: pulumi.Output<outputs.migrate.v20230909preview.CostComponentResponse[]>;
    /**
...
export interface AvsAssessmentsOperationArgs {
     ...
     * AVS Assessment Scenario.
     */
    avsAssessmentScenario?: pulumi.Input<string | enums.migrate.v20230909preview.AvsAssessmentScenario>;
    /**
     * Azure Location or Azure region where to which the machines will be migrated.
     */
    azureLocation?: pulumi.Input<string | enums.migrate.v20230909preview.AzureLocation>;
    /**
     * Azure Offer code according to which cost estimation is done.
     */
     ...
     * List of AVS external storage types.
     */
    externalStorageTypes?: pulumi.Input<pulumi.Input<string | enums.migrate.v20230909preview.ExternalStorageType>[]>;
    /**
     * Failures to tolerate and RAID level in a common property.
     */
    failuresToTolerateAndRaidLevel?: pulumi.Input<string | enums.migrate.v20230909preview.FttAndRaidLevel>;
    /**
     * List of Failures to tolerate and RAID levels in a common property.
     */
    failuresToTolerateAndRaidLevelList?: pulumi.Input<pulumi.Input<string | enums.migrate.v20230909preview.FttAndRaidLevel>[]>;
    /**
     * Group ARM name
     */
     ...
     * AVS node type.
     */
    nodeType?: pulumi.Input<string | enums.migrate.v20230909preview.AzureAvsNodeType>;
    /**
     * AVS node types.
     */
    nodeTypes?: pulumi.Input<pulumi.Input<string | enums.migrate.v20230909preview.AzureAvsNodeType>[]>;
    /**
     * Percentile of the utilization data values to be considered while assessing
     * machines.
     */
