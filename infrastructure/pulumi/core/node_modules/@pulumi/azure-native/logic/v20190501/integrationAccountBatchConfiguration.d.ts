...
export declare class IntegrationAccountBatchConfiguration extends pulumi.CustomResource {
     ...
     */
    readonly properties: pulumi.Output<outputs.logic.v20190501.BatchConfigurationPropertiesResponse>;
    /**
     * The resource tags.
     */
...
export interface IntegrationAccountBatchConfigurationArgs {
     ...
     * The batch configuration properties.
     */
    properties: pulumi.Input<inputs.logic.v20190501.BatchConfigurationPropertiesArgs>;
    /**
