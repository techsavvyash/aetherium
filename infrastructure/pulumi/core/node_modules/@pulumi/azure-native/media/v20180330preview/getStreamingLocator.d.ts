 ...
 * Get the details of a Streaming Locator in the Media Services account
 */
export declare function getStreamingLocatorOutput(args: GetStreamingLocatorOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetStreamingLocatorResult>;
