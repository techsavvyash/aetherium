...
export declare class ManagedCluster extends pulumi.CustomResource {
     ...
     */
    readonly applicationTypeVersionsCleanupPolicy: pulumi.Output<outputs.servicefabric.v20230901preview.ApplicationTypeVersionsCleanupPolicyResponse | undefined>;
    /**
     * Auxiliary subnets for the cluster.
     */
    readonly auxiliarySubnets: pulumi.Output<outputs.servicefabric.v20230901preview.SubnetResponse[] | undefined>;
    /**
     * The AAD authentication settings of the cluster.
     */
    readonly azureActiveDirectory: pulumi.Output<outputs.servicefabric.v20230901preview.AzureActiveDirectoryResponse | undefined>;
    /**
     ...
     */
    readonly clients: pulumi.Output<outputs.servicefabric.v20230901preview.ClientCertificateResponse[] | undefined>;
    /**
     ...
     */
    readonly fabricSettings: pulumi.Output<outputs.servicefabric.v20230901preview.SettingsSectionDescriptionResponse[] | undefined>;
    /**
     ...
     */
    readonly ipTags: pulumi.Output<outputs.servicefabric.v20230901preview.IPTagResponse[] | undefined>;
    /**
     ...
     */
    readonly loadBalancingRules: pulumi.Output<outputs.servicefabric.v20230901preview.LoadBalancingRuleResponse[] | undefined>;
    /**
     ...
     */
    readonly serviceEndpoints: pulumi.Output<outputs.servicefabric.v20230901preview.ServiceEndpointResponse[] | undefined>;
    /**
     * The sku of the managed cluster
     */
    readonly sku: pulumi.Output<outputs.servicefabric.v20230901preview.SkuResponse>;
    /**
...
export interface ManagedClusterArgs {
     ...
     * List of add-on features to enable on the cluster.
     */
    addonFeatures?: pulumi.Input<pulumi.Input<string | enums.servicefabric.v20230901preview.ManagedClusterAddOnFeature>[]>;
    /**
     * VM admin user password.
     */
     ...
     * The policy used to clean up unused versions.
     */
    applicationTypeVersionsCleanupPolicy?: pulumi.Input<inputs.servicefabric.v20230901preview.ApplicationTypeVersionsCleanupPolicyArgs>;
    /**
     * Auxiliary subnets for the cluster.
     */
    auxiliarySubnets?: pulumi.Input<pulumi.Input<inputs.servicefabric.v20230901preview.SubnetArgs>[]>;
    /**
     * The AAD authentication settings of the cluster.
     */
    azureActiveDirectory?: pulumi.Input<inputs.servicefabric.v20230901preview.AzureActiveDirectoryArgs>;
    /**
     * The port used for client connections to the cluster.
     */
     ...
     * Client certificates that are allowed to manage the cluster.
     */
    clients?: pulumi.Input<pulumi.Input<inputs.servicefabric.v20230901preview.ClientCertificateArgs>[]>;
    /**
     * The Service Fabric runtime version of the cluster. This property is required when **clusterUpgradeMode** is set to 'Manual'. To get list of available Service Fabric versions for new clusters use [ClusterVersion API](./ClusterVersion.md). To get the list of available version for existing clusters use **availableClusterVersions**.
     */
     ...
     * Indicates when new cluster runtime version upgrades will be applied after they are released. By default is Wave0. Only applies when **clusterUpgradeMode** is set to 'Automatic'.
     */
    clusterUpgradeCadence?: pulumi.Input<string | enums.servicefabric.v20230901preview.ClusterUpgradeCadence>;
    /**
     * The upgrade mode of the cluster when new Service Fabric runtime version is available.
     */
    clusterUpgradeMode?: pulumi.Input<string | enums.servicefabric.v20230901preview.ClusterUpgradeMode>;
    /**
     * Specify the resource id of a DDoS network protection plan that will be associated with the virtual network of the cluster.
     */
     ...
     * The list of custom fabric settings to configure the cluster.
     */
    fabricSettings?: pulumi.Input<pulumi.Input<inputs.servicefabric.v20230901preview.SettingsSectionDescriptionArgs>[]>;
    /**
     * The port used for HTTP connections to the cluster.
     */
     ...
     * The list of IP tags associated with the default public IP address of the cluster.
     */
    ipTags?: pulumi.Input<pulumi.Input<inputs.servicefabric.v20230901preview.IPTagArgs>[]>;
    /**
     * Load balancing rules that are applied to the public load balancer of the cluster.
     */
    loadBalancingRules?: pulumi.Input<pulumi.Input<inputs.servicefabric.v20230901preview.LoadBalancingRuleArgs>[]>;
    /**
     * Azure resource location.
     */
     ...
     * Service endpoints for subnets in the cluster.
     */
    serviceEndpoints?: pulumi.Input<pulumi.Input<inputs.servicefabric.v20230901preview.ServiceEndpointArgs>[]>;
    /**
     * The sku of the managed cluster
     */
    sku: pulumi.Input<inputs.servicefabric.v20230901preview.SkuArgs>;
    /**
     * If specified, the node types for the cluster are created in this subnet instead of the default VNet. The **networkSecurityRules** specified for the cluster are also applied to this subnet. This setting cannot be changed once the cluster is created.
     */
     ...
     * Indicates the update mode for Cross Az clusters.
     */
    zonalUpdateMode?: pulumi.Input<string | enums.servicefabric.v20230901preview.ZonalUpdateMode>;
}
