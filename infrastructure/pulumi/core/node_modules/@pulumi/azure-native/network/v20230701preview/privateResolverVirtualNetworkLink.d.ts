...
export declare class PrivateResolverVirtualNetworkLink extends pulumi.CustomResource {
     ...
     */
    readonly virtualNetwork: pulumi.Output<outputs.network.v20230701preview.SubResourceResponse>;
    /**
...
export interface PrivateResolverVirtualNetworkLinkArgs {
     ...
     * The reference to the virtual network. This cannot be changed after creation.
     */
    virtualNetwork: pulumi.Input<inputs.network.v20230701preview.SubResourceArgs>;
    /**
