...
export declare class Channel extends pulumi.CustomResource {
     ...
     */
    readonly partnerDestinationInfo: pulumi.Output<outputs.eventgrid.v20231215preview.WebhookPartnerDestinationInfoResponse | undefined>;
    /**
     * This property should be populated when channelType is PartnerTopic and represents information about the partner topic resource corresponding to the channel.
     */
    readonly partnerTopicInfo: pulumi.Output<outputs.eventgrid.v20231215preview.PartnerTopicInfoResponse | undefined>;
    /**
...
export interface ChannelArgs {
     ...
     * The type of the event channel which represents the direction flow of events.
     */
    channelType?: pulumi.Input<string | enums.eventgrid.v20231215preview.ChannelType>;
    /**
     * Expiration time of the channel. If this timer expires while the corresponding partner topic is never activated,
     * the channel and corresponding partner topic are deleted.
     */
     ...
     * This property should be populated when channelType is PartnerDestination and represents information about the partner destination resource corresponding to the channel.
     */
    partnerDestinationInfo?: pulumi.Input<inputs.eventgrid.v20231215preview.WebhookPartnerDestinationInfoArgs>;
    /**
     ...
     * This property should be populated when channelType is PartnerTopic and represents information about the partner topic resource corresponding to the channel.
     */
    partnerTopicInfo?: pulumi.Input<inputs.eventgrid.v20231215preview.PartnerTopicInfoArgs>;
    /**
     * Provisioning state of the channel.
     */
    provisioningState?: pulumi.Input<string | enums.eventgrid.v20231215preview.ChannelProvisioningState>;
    /**
     * The readiness state of the corresponding partner topic.
     */
    readinessState?: pulumi.Input<string | enums.eventgrid.v20231215preview.ReadinessState>;
    /**
