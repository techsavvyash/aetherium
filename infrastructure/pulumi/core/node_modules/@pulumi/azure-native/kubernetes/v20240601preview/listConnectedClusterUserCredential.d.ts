...
export interface ListConnectedClusterUserCredentialArgs {
     ...
     */
    authenticationMethod: string | enums.kubernetes.v20240601preview.AuthenticationMethod;
    /**
...
export interface ListConnectedClusterUserCredentialResult {
     ...
     */
    readonly hybridConnectionConfig: outputs.kubernetes.v20240601preview.HybridConnectionConfigResponse;
    /**
     * Base64-encoded Kubernetes configuration file.
     */
    readonly kubeconfigs: outputs.kubernetes.v20240601preview.CredentialResultResponse[];
}
/**
 * Gets cluster user credentials of the connected cluster with a specified resource group and name.
 */
...
export interface ListConnectedClusterUserCredentialOutputArgs {
     ...
     * The mode of client authentication.
     */
    authenticationMethod: pulumi.Input<string | enums.kubernetes.v20240601preview.AuthenticationMethod>;
    /**
     * Boolean value to indicate whether the request is for client side proxy or not
     */
