...
export declare class Builder extends pulumi.CustomResource {
     ...
     */
    readonly containerRegistries: pulumi.Output<outputs.app.v20230801preview.ContainerRegistryResponse[] | undefined>;
    /**
...
export interface BuilderArgs {
     ...
     * List of mappings of container registries and the managed identity used to connect to it.
     */
    containerRegistries?: pulumi.Input<pulumi.Input<inputs.app.v20230801preview.ContainerRegistryArgs>[]>;
    /**
     * Resource ID of the container apps environment that the builder is associated with.
     */
