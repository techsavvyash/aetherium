...
export declare class ManagedInstance extends pulumi.CustomResource {
     ...
     */
    readonly administrators: pulumi.Output<outputs.sql.v20230801.ManagedInstanceExternalAdministratorResponse | undefined>;
    /**
     ...
     */
    readonly identity: pulumi.Output<outputs.sql.v20230801.ResourceIdentityResponse | undefined>;
    /**
     ...
     */
    readonly privateEndpointConnections: pulumi.Output<outputs.sql.v20230801.ManagedInstancePecPropertyResponse[]>;
    /**
     ...
     */
    readonly servicePrincipal: pulumi.Output<outputs.sql.v20230801.ServicePrincipalResponse | undefined>;
    /**
     * Managed instance SKU. Allowed values for sku.name: GP_Gen5, GP_G8IM, GP_G8IH, BC_Gen5, BC_G8IM, BC_G8IH
     */
    readonly sku: pulumi.Output<outputs.sql.v20230801.SkuResponse | undefined>;
    /**
...
export interface ManagedInstanceArgs {
     ...
     * The Azure Active Directory administrator of the instance. This can only be used at instance create time. If used for instance update, it will be ignored or it will result in an error. For updates individual APIs will need to be used.
     */
    administrators?: pulumi.Input<inputs.sql.v20230801.ManagedInstanceExternalAdministratorArgs>;
    /**
     * The managed instance's authentication metadata lookup mode.
     */
    authenticationMetadata?: pulumi.Input<string | enums.sql.v20230801.AuthMetadataLookupModes>;
    /**
     * Collation of the managed instance.
     */
     ...
     * Specifies the internal format of instance databases specific to the SQL engine version.
     */
    databaseFormat?: pulumi.Input<string | enums.sql.v20230801.ManagedInstanceDatabaseFormat>;
    /**
     ...
     * Hybrid secondary usage. Possible values are 'Active' (default value) and 'Passive' (customer uses the secondary as Passive DR).
     */
    hybridSecondaryUsage?: pulumi.Input<string | enums.sql.v20230801.HybridSecondaryUsage>;
    /**
     * The Azure Active Directory identity of the managed instance.
     */
    identity?: pulumi.Input<inputs.sql.v20230801.ResourceIdentityArgs>;
    /**
     * The Id of the instance pool this managed server belongs to.
     */
     ...
     * The license type. Possible values are 'LicenseIncluded' (regular price inclusive of a new SQL license) and 'BasePrice' (discounted AHB price for bringing your own SQL licenses).
     */
    licenseType?: pulumi.Input<string | enums.sql.v20230801.ManagedInstanceLicenseType>;
    /**
     * Resource location.
     */
     ...
     */
    managedInstanceCreateMode?: pulumi.Input<string | enums.sql.v20230801.ManagedServerCreateMode>;
    /**
     ...
     * Pricing model of Managed Instance.
     */
    pricingModel?: pulumi.Input<string | enums.sql.v20230801.PricingModel>;
    /**
     * The resource id of a user assigned identity to be used by default.
     */
     ...
     * Connection type used for connecting to the instance.
     */
    proxyOverride?: pulumi.Input<string | enums.sql.v20230801.ManagedInstanceProxyOverride>;
    /**
     * Whether or not the public data endpoint is enabled.
     */
     ...
     * The managed instance's service principal.
     */
    servicePrincipal?: pulumi.Input<inputs.sql.v20230801.ServicePrincipalArgs>;
    /**
     * Managed instance SKU. Allowed values for sku.name: GP_Gen5, GP_G8IM, GP_G8IH, BC_Gen5, BC_G8IM, BC_G8IH
     */
