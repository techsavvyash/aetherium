...
export declare class MaintenanceConfiguration extends pulumi.CustomResource {
     ...
     */
    readonly installPatches: pulumi.Output<outputs.maintenance.v20230901preview.InputPatchConfigurationResponse | undefined>;
    /**
     ...
     */
    readonly systemData: pulumi.Output<outputs.maintenance.v20230901preview.SystemDataResponse>;
    /**
...
export interface MaintenanceConfigurationArgs {
     ...
     * The input parameters to be passed to the patch run operation.
     */
    installPatches?: pulumi.Input<inputs.maintenance.v20230901preview.InputPatchConfigurationArgs>;
    /**
     * Gets or sets location of the resource
     */
     ...
     * Gets or sets maintenanceScope of the configuration
     */
    maintenanceScope?: pulumi.Input<string | enums.maintenance.v20230901preview.MaintenanceScope>;
    /**
     * Gets or sets namespace of the resource
     */
     ...
     * Gets or sets the visibility of the configuration. The default value is 'Custom'
     */
    visibility?: pulumi.Input<string | enums.maintenance.v20230901preview.Visibility>;
}
