...
export declare class VirtualHubBgpConnection extends pulumi.CustomResource {
     ...
     */
    readonly hubVirtualNetworkConnection: pulumi.Output<outputs.network.v20231101.SubResourceResponse | undefined>;
    /**
...
export interface VirtualHubBgpConnectionArgs {
     ...
     * The reference to the HubVirtualNetworkConnection resource.
     */
    hubVirtualNetworkConnection?: pulumi.Input<inputs.network.v20231101.SubResourceArgs>;
    /**
     * Resource ID.
     */
