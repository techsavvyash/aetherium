 ...
 * ```
 */
export declare function getAppEngineServiceOutput(args: GetAppEngineServiceOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetAppEngineServiceResult>;
/**
 * A collection of arguments for invoking getAppEngineService.
 */
