...
export declare class Volume extends pulumi.CustomResource {
     ...
     */
    readonly acceptGrowCapacityPoolForShortTermCloneSplit: pulumi.Output<string | undefined>;
    /**
     ...
     */
    readonly dataProtection: pulumi.Output<outputs.netapp.v20240301preview.VolumePropertiesResponseDataProtection | undefined>;
    /**
     ...
     */
    readonly exportPolicy: pulumi.Output<outputs.netapp.v20240301preview.VolumePropertiesResponseExportPolicy | undefined>;
    /**
     ...
     */
    readonly mountTargets: pulumi.Output<outputs.netapp.v20240301preview.MountTargetPropertiesResponse[]>;
    /**
     ...
     */
    readonly placementRules: pulumi.Output<outputs.netapp.v20240301preview.PlacementKeyValuePairsResponse[] | undefined>;
    /**
     ...
     */
    readonly systemData: pulumi.Output<outputs.netapp.v20240301preview.SystemDataResponse>;
    /**
...
export interface VolumeArgs {
     ...
     * While auto splitting the short term clone volume, if the parent pool does not have enough space to accommodate the volume after split, it will be automatically resized, which will lead to increased billing. To accept capacity pool size auto grow and create a short term clone volume, set the property as accepted.
     */
    acceptGrowCapacityPoolForShortTermCloneSplit?: pulumi.Input<string | enums.netapp.v20240301preview.AcceptGrowCapacityPoolForShortTermCloneSplit>;
    /**
     ...
     * Specifies whether the volume is enabled for Azure VMware Solution (AVS) datastore purpose
     */
    avsDataStore?: pulumi.Input<string | enums.netapp.v20240301preview.AvsDataStore>;
    /**
     * Resource identifier used to identify the Backup.
     */
     ...
     *  Never - No client-driven data is pulled from cool tier to standard storage.
     */
    coolAccessRetrievalPolicy?: pulumi.Input<string | enums.netapp.v20240301preview.CoolAccessRetrievalPolicy>;
    /**
     * Specifies the number of days after which data that is not accessed by clients will be tiered.
     */
     ...
     * DataProtection type volumes include an object containing details of the replication
     */
    dataProtection?: pulumi.Input<inputs.netapp.v20240301preview.VolumePropertiesDataProtectionArgs>;
    /**
     * Default group quota for volume in KiBs. If isDefaultQuotaEnabled is set, the minimum value of 4 KiBs applies.
     */
     ...
     * Flag indicating whether subvolume operations are enabled on the volume
     */
    enableSubvolumes?: pulumi.Input<string | enums.netapp.v20240301preview.EnableSubvolumes>;
    /**
     * Source of key used to encrypt data in volume. Applicable if NetApp account has encryption.keySource = 'Microsoft.KeyVault'. Possible values (case-insensitive) are: 'Microsoft.NetApp, Microsoft.KeyVault'
     */
    encryptionKeySource?: pulumi.Input<string | enums.netapp.v20240301preview.EncryptionKeySource>;
    /**
     * Set of export policy rules
     */
    exportPolicy?: pulumi.Input<inputs.netapp.v20240301preview.VolumePropertiesExportPolicyArgs>;
    /**
     * Specifies if default quota is enabled for the volume.
     */
     ...
     * Language supported for volume.
     */
    language?: pulumi.Input<string | enums.netapp.v20240301preview.VolumeLanguage>;
    /**
     * Specifies whether LDAP is enabled or not for a given NFS volume.
     */
     ...
     * Network features available to the volume, or current state of update.
     */
    networkFeatures?: pulumi.Input<string | enums.netapp.v20240301preview.NetworkFeatures>;
    /**
     * Application specific placement rules for the particular volume
     */
    placementRules?: pulumi.Input<pulumi.Input<inputs.netapp.v20240301preview.PlacementKeyValuePairsArgs>[]>;
    /**
     ...
     * The security style of volume, default unix, defaults to ntfs for dual protocol or CIFS protocol
     */
    securityStyle?: pulumi.Input<string | enums.netapp.v20240301preview.SecurityStyle>;
    /**
     * The service level of the file system
     */
    serviceLevel?: pulumi.Input<string | enums.netapp.v20240301preview.ServiceLevel>;
    /**
     * Enables access-based enumeration share property for SMB Shares. Only applicable for SMB/DualProtocol volume
     */
    smbAccessBasedEnumeration?: pulumi.Input<string | enums.netapp.v20240301preview.SmbAccessBasedEnumeration>;
    /**
     * Enables continuously available share property for smb volume. Only applicable for SMB volume
     */
     ...
     * Enables non-browsable property for SMB Shares. Only applicable for SMB/DualProtocol volume
     */
    smbNonBrowsable?: pulumi.Input<string | enums.netapp.v20240301preview.SmbNonBrowsable>;
    /**
     * If enabled (true) the volume will contain a read-only snapshot directory which provides access to each of the volume's snapshots (defaults to true).
     */
