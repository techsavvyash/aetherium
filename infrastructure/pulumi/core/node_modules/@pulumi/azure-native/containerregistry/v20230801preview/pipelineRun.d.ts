...
export declare class PipelineRun extends pulumi.CustomResource {
     ...
     */
    readonly request: pulumi.Output<outputs.containerregistry.v20230801preview.PipelineRunRequestResponse | undefined>;
    /**
     * The response of a pipeline run.
     */
    readonly response: pulumi.Output<outputs.containerregistry.v20230801preview.PipelineRunResponseResponse>;
    /**
...
export interface PipelineRunArgs {
     ...
     * The request parameters for a pipeline run.
     */
    request?: pulumi.Input<inputs.containerregistry.v20230801preview.PipelineRunRequestArgs>;
    /**
