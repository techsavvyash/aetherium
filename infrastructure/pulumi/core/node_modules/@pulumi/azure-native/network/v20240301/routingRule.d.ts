...
export declare class RoutingRule extends pulumi.CustomResource {
     ...
     */
    readonly destination: pulumi.Output<outputs.network.v20240301.RoutingRuleRouteDestinationResponse>;
    /**
     ...
     */
    readonly nextHop: pulumi.Output<outputs.network.v20240301.RoutingRuleNextHopResponse>;
    /**
...
export interface RoutingRuleArgs {
     ...
     * Indicates the destination for this particular rule.
     */
    destination: pulumi.Input<inputs.network.v20240301.RoutingRuleRouteDestinationArgs>;
    /**
     ...
     * Indicates the next hop for this particular rule.
     */
    nextHop: pulumi.Input<inputs.network.v20240301.RoutingRuleNextHopArgs>;
    /**
