...
export declare class Transform extends pulumi.CustomResource {
     ...
     */
    readonly outputs: pulumi.Output<outputs.media.v20220701.TransformOutputResponse[]>;
    /**
     * The system metadata relating to this resource.
     */
    readonly systemData: pulumi.Output<outputs.media.v20220701.SystemDataResponse>;
    /**
...
export interface TransformArgs {
     ...
     * An array of one or more TransformOutputs that the Transform should generate.
     */
    outputs: pulumi.Input<pulumi.Input<inputs.media.v20220701.TransformOutputArgs>[]>;
    /**
