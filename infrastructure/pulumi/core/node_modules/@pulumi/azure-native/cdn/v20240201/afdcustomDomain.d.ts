...
export declare class AFDCustomDomain extends pulumi.CustomResource {
     ...
     */
    readonly azureDnsZone: pulumi.Output<outputs.cdn.v20240201.ResourceReferenceResponse | undefined>;
     ...
     */
    readonly preValidatedCustomDomainResourceId: pulumi.Output<outputs.cdn.v20240201.ResourceReferenceResponse | undefined>;
    /**
     ...
     */
    readonly tlsSettings: pulumi.Output<outputs.cdn.v20240201.AFDDomainHttpsParametersResponse | undefined>;
    /**
     * Resource type.
     */
     ...
     */
    readonly validationProperties: pulumi.Output<outputs.cdn.v20240201.DomainValidationPropertiesResponse>;
    /**
...
export interface AFDCustomDomainArgs {
     ...
     * Resource reference to the Azure DNS zone
     */
    azureDnsZone?: pulumi.Input<inputs.cdn.v20240201.ResourceReferenceArgs>;
    /**
     ...
     * Resource reference to the Azure resource where custom domain ownership was prevalidated
     */
    preValidatedCustomDomainResourceId?: pulumi.Input<inputs.cdn.v20240201.ResourceReferenceArgs>;
    /**
     ...
     * The configuration specifying how to enable HTTPS for the domain - using AzureFrontDoor managed certificate or user's own certificate. If not specified, enabling ssl uses AzureFrontDoor managed certificate by default.
     */
    tlsSettings?: pulumi.Input<inputs.cdn.v20240201.AFDDomainHttpsParametersArgs>;
}
