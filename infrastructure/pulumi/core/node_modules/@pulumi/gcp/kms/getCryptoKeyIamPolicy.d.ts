 ...
 * ```
 */
export declare function getCryptoKeyIamPolicyOutput(args: GetCryptoKeyIamPolicyOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetCryptoKeyIamPolicyResult>;
/**
 * A collection of arguments for invoking getCryptoKeyIamPolicy.
 */
