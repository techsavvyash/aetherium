...
export declare class ExpressRouteCircuitPeering extends pulumi.CustomResource {
     ...
     */
    readonly connections: pulumi.Output<outputs.network.v20230901.ExpressRouteCircuitConnectionResponse[] | undefined>;
    /**
     ...
     */
    readonly expressRouteConnection: pulumi.Output<outputs.network.v20230901.ExpressRouteConnectionIdResponse | undefined>;
    /**
     ...
     */
    readonly ipv6PeeringConfig: pulumi.Output<outputs.network.v20230901.Ipv6ExpressRouteCircuitPeeringConfigResponse | undefined>;
    /**
     ...
     */
    readonly microsoftPeeringConfig: pulumi.Output<outputs.network.v20230901.ExpressRouteCircuitPeeringConfigResponse | undefined>;
    /**
     ...
     */
    readonly peeredConnections: pulumi.Output<outputs.network.v20230901.PeerExpressRouteCircuitConnectionResponse[]>;
    /**
     * The peering type.
     */
     ...
     */
    readonly routeFilter: pulumi.Output<outputs.network.v20230901.SubResourceResponse | undefined>;
    /**
     * The secondary port.
     */
     ...
     */
    readonly stats: pulumi.Output<outputs.network.v20230901.ExpressRouteCircuitStatsResponse | undefined>;
    /**
...
export interface ExpressRouteCircuitPeeringArgs {
     ...
     */
    connections?: pulumi.Input<pulumi.Input<inputs.network.v20230901.ExpressRouteCircuitConnectionArgs>[]>;
    /**
     * The GatewayManager Etag.
     */
     ...
     * The reference to the RouteFilter resource.
     */
    routeFilter?: pulumi.Input<inputs.network.v20230901.SubResourceArgs>;
    /**
     * The secondary port.
     */
     ...
     * The peering stats of express route circuit.
     */
    stats?: pulumi.Input<inputs.network.v20230901.ExpressRouteCircuitStatsArgs>;
    /**
     * The VLAN ID.
     */
