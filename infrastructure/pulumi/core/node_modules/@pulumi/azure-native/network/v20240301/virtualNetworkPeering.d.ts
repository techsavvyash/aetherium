...
export declare class VirtualNetworkPeering extends pulumi.CustomResource {
     ...
     */
    readonly localAddressSpace: pulumi.Output<outputs.network.v20240301.AddressSpaceResponse | undefined>;
    /**
     ...
     */
    readonly localVirtualNetworkAddressSpace: pulumi.Output<outputs.network.v20240301.AddressSpaceResponse | undefined>;
    /**
     ...
     */
    readonly remoteAddressSpace: pulumi.Output<outputs.network.v20240301.AddressSpaceResponse | undefined>;
    /**
     * The reference to the remote virtual network's Bgp Communities.
     */
    readonly remoteBgpCommunities: pulumi.Output<outputs.network.v20240301.VirtualNetworkBgpCommunitiesResponse | undefined>;
    /**
     ...
     */
    readonly remoteVirtualNetwork: pulumi.Output<outputs.network.v20240301.SubResourceResponse | undefined>;
    /**
     * The reference to the current address space of the remote virtual network.
     */
    readonly remoteVirtualNetworkAddressSpace: pulumi.Output<outputs.network.v20240301.AddressSpaceResponse | undefined>;
    /**
     * The reference to the remote virtual network's encryption
     */
    readonly remoteVirtualNetworkEncryption: pulumi.Output<outputs.network.v20240301.VirtualNetworkEncryptionResponse>;
    /**
...
export interface VirtualNetworkPeeringArgs {
     ...
     * The local address space of the local virtual network that is peered.
     */
    localAddressSpace?: pulumi.Input<inputs.network.v20240301.AddressSpaceArgs>;
    /**
     * List of local subnet names that are subnet peered with remote virtual network.
     */
     ...
     * The current local address space of the local virtual network that is peered.
     */
    localVirtualNetworkAddressSpace?: pulumi.Input<inputs.network.v20240301.AddressSpaceArgs>;
    /**
     * The name of the resource that is unique within a resource group. This name can be used to access the resource.
     */
     ...
     * The status of the virtual network peering.
     */
    peeringState?: pulumi.Input<string | enums.network.v20240301.VirtualNetworkPeeringState>;
    /**
     * The peering sync status of the virtual network peering.
     */
    peeringSyncLevel?: pulumi.Input<string | enums.network.v20240301.VirtualNetworkPeeringLevel>;
    /**
     * The reference to the address space peered with the remote virtual network.
     */
    remoteAddressSpace?: pulumi.Input<inputs.network.v20240301.AddressSpaceArgs>;
    /**
     * The reference to the remote virtual network's Bgp Communities.
     */
    remoteBgpCommunities?: pulumi.Input<inputs.network.v20240301.VirtualNetworkBgpCommunitiesArgs>;
    /**
     * List of remote subnet names from remote virtual network that are subnet peered.
     */
     ...
     * The reference to the remote virtual network. The remote virtual network can be in the same or different region (preview). See here to register for the preview and learn more (https://docs.microsoft.com/en-us/azure/virtual-network/virtual-network-create-peering).
     */
    remoteVirtualNetwork?: pulumi.Input<inputs.network.v20240301.SubResourceArgs>;
    /**
     * The reference to the current address space of the remote virtual network.
     */
    remoteVirtualNetworkAddressSpace?: pulumi.Input<inputs.network.v20240301.AddressSpaceArgs>;
    /**
