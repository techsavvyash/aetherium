...
export declare class StartStopManagedInstanceSchedule extends pulumi.CustomResource {
     ...
     * Schedule list.
     */
    readonly scheduleList: pulumi.Output<outputs.sql.v20230201preview.ScheduleItemResponse[]>;
    /**
     * System data of the scheduled resource.
     */
    readonly systemData: pulumi.Output<outputs.sql.v20230201preview.SystemDataResponse>;
    /**
...
export interface StartStopManagedInstanceScheduleArgs {
     ...
     * Schedule list.
     */
    scheduleList: pulumi.Input<pulumi.Input<inputs.sql.v20230201preview.ScheduleItemArgs>[]>;
    /**
