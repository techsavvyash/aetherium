...
export interface GetVNetPeeringResult {
     ...
     */
    readonly databricksAddressSpace?: outputs.databricks.v20250301preview.AddressSpaceResponse;
    /**
     *  The remote virtual network should be in the same region. See here to learn more (https://docs.microsoft.com/en-us/azure/databricks/administration-guide/cloud-configurations/azure/vnet-peering).
     */
    readonly databricksVirtualNetwork?: outputs.databricks.v20250301preview.VirtualNetworkPeeringPropertiesFormatResponseDatabricksVirtualNetwork;
    /**
     * Resource ID.
     */
    readonly id: string;
     ...
     */
    readonly remoteAddressSpace?: outputs.databricks.v20250301preview.AddressSpaceResponse;
    /**
     *  The remote virtual network should be in the same region. See here to learn more (https://docs.microsoft.com/en-us/azure/databricks/administration-guide/cloud-configurations/azure/vnet-peering).
     */
    readonly remoteVirtualNetwork: outputs.databricks.v20250301preview.VirtualNetworkPeeringPropertiesFormatResponseRemoteVirtualNetwork;
    /**
