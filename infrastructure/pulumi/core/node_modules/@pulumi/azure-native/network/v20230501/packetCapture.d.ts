...
export declare class PacketCapture extends pulumi.CustomResource {
     ...
     */
    readonly filters: pulumi.Output<outputs.network.v20230501.PacketCaptureFilterResponse[] | undefined>;
    /**
     ...
     */
    readonly scope: pulumi.Output<outputs.network.v20230501.PacketCaptureMachineScopeResponse | undefined>;
    /**
     * The storage location for a packet capture session.
     */
    readonly storageLocation: pulumi.Output<outputs.network.v20230501.PacketCaptureStorageLocationResponse>;
    /**
...
export interface PacketCaptureArgs {
     ...
     * A list of packet capture filters.
     */
    filters?: pulumi.Input<pulumi.Input<inputs.network.v20230501.PacketCaptureFilterArgs>[]>;
    /**
     ...
     * A list of AzureVMSS instances which can be included or excluded to run packet capture. If both included and excluded are empty, then the packet capture will run on all instances of AzureVMSS.
     */
    scope?: pulumi.Input<inputs.network.v20230501.PacketCaptureMachineScopeArgs>;
    /**
     * The storage location for a packet capture session.
     */
    storageLocation: pulumi.Input<inputs.network.v20230501.PacketCaptureStorageLocationArgs>;
    /**
     * The ID of the targeted resource, only AzureVM and AzureVMSS as target type are currently supported.
     */
     ...
     * Target type of the resource provided.
     */
    targetType?: pulumi.Input<enums.network.v20230501.PacketCaptureTargetType>;
    /**
     * Maximum duration of the capture session in seconds.
     */
