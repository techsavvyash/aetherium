...
export declare class ManagedInstance extends pulumi.CustomResource {
     ...
     */
    readonly administrators: pulumi.Output<outputs.sql.v20230801preview.ManagedInstanceExternalAdministratorResponse | undefined>;
    /**
     ...
     */
    readonly identity: pulumi.Output<outputs.sql.v20230801preview.ResourceIdentityResponse | undefined>;
    /**
     ...
     */
    readonly privateEndpointConnections: pulumi.Output<outputs.sql.v20230801preview.ManagedInstancePecPropertyResponse[]>;
    /**
     ...
     */
    readonly servicePrincipal: pulumi.Output<outputs.sql.v20230801preview.ServicePrincipalResponse | undefined>;
    /**
     ...
     */
    readonly totalMemoryMB: pulumi.Output<number | undefined>;
    /**
     * Resource type.
     */
...
export interface ManagedInstanceArgs {
     ...
     * The Azure Active Directory administrator of the instance. This can only be used at instance create time. If used for instance update, it will be ignored or it will result in an error. For updates individual APIs will need to be used.
     */
    administrators?: pulumi.Input<inputs.sql.v20230801preview.ManagedInstanceExternalAdministratorArgs>;
    /**
     * The managed instance's authentication metadata lookup mode.
     */
    authenticationMetadata?: pulumi.Input<string | enums.sql.v20230801preview.AuthMetadataLookupModes>;
    /**
     * Collation of the managed instance.
     */
     ...
     * Specifies the internal format of instance databases specific to the SQL engine version.
     */
    databaseFormat?: pulumi.Input<string | enums.sql.v20230801preview.ManagedInstanceDatabaseFormat>;
    /**
     ...
     * Hybrid secondary usage. Possible values are 'Active' (default value) and 'Passive' (customer uses the secondary as Passive DR).
     */
    hybridSecondaryUsage?: pulumi.Input<string | enums.sql.v20230801preview.HybridSecondaryUsage>;
    /**
     * The Azure Active Directory identity of the managed instance.
     */
    identity?: pulumi.Input<inputs.sql.v20230801preview.ResourceIdentityArgs>;
    /**
     * The Id of the instance pool this managed server belongs to.
     */
     ...
     * The license type. Possible values are 'LicenseIncluded' (regular price inclusive of a new SQL license) and 'BasePrice' (discounted AHB price for bringing your own SQL licenses).
     */
    licenseType?: pulumi.Input<string | enums.sql.v20230801preview.ManagedInstanceLicenseType>;
    /**
     * Resource location.
     */
     ...
     */
    managedInstanceCreateMode?: pulumi.Input<string | enums.sql.v20230801preview.ManagedServerCreateMode>;
    /**
     ...
     * Weather or not Managed Instance is freemium.
     */
    pricingModel?: pulumi.Input<string | enums.sql.v20230801preview.FreemiumType>;
    /**
     * The resource id of a user assigned identity to be used by default.
     */
     ...
     * Connection type used for connecting to the instance.
     */
    proxyOverride?: pulumi.Input<string | enums.sql.v20230801preview.ManagedInstanceProxyOverride>;
    /**
     * Whether or not the public data endpoint is enabled.
     */
     ...
     * The storage account type to be used to store backups for this instance. The options are Local (LocallyRedundantStorage), Zone (ZoneRedundantStorage), Geo (GeoRedundantStorage) and GeoZone(GeoZoneRedundantStorage)
     */
    requestedBackupStorageRedundancy?: pulumi.Input<string | enums.sql.v20230801preview.BackupStorageRedundancy>;
    /**
     ...
     * The managed instance's service principal.
     */
    servicePrincipal?: pulumi.Input<inputs.sql.v20230801preview.ServicePrincipalArgs>;
    /**
     * Managed instance SKU. Allowed values for sku.name: GP_Gen5, GP_G8IM, GP_G8IH, BC_Gen5, BC_G8IM, BC_G8IH
     */
