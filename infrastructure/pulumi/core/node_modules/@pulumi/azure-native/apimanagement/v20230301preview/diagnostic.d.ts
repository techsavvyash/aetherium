...
export declare class Diagnostic extends pulumi.CustomResource {
     ...
     */
    readonly backend: pulumi.Output<outputs.apimanagement.v20230301preview.PipelineDiagnosticSettingsResponse | undefined>;
    /**
     * Diagnostic settings for incoming/outgoing HTTP messages to the Gateway.
     */
    readonly frontend: pulumi.Output<outputs.apimanagement.v20230301preview.PipelineDiagnosticSettingsResponse | undefined>;
    /**
     ...
     */
    readonly sampling: pulumi.Output<outputs.apimanagement.v20230301preview.SamplingSettingsResponse | undefined>;
    /**
...
export interface DiagnosticArgs {
     ...
     * Specifies for what type of messages sampling settings should not apply.
     */
    alwaysLog?: pulumi.Input<string | enums.apimanagement.v20230301preview.AlwaysLog>;
    /**
     * Diagnostic settings for incoming/outgoing HTTP messages to the Backend
     */
    backend?: pulumi.Input<inputs.apimanagement.v20230301preview.PipelineDiagnosticSettingsArgs>;
    /**
     ...
     * Diagnostic settings for incoming/outgoing HTTP messages to the Gateway.
     */
    frontend?: pulumi.Input<inputs.apimanagement.v20230301preview.PipelineDiagnosticSettingsArgs>;
    /**
     * Sets correlation protocol to use for Application Insights diagnostics.
     */
    httpCorrelationProtocol?: pulumi.Input<string | enums.apimanagement.v20230301preview.HttpCorrelationProtocol>;
    /**
     * Log the ClientIP. Default is false.
     */
     ...
     * The format of the Operation Name for Application Insights telemetries. Default is Name.
     */
    operationNameFormat?: pulumi.Input<string | enums.apimanagement.v20230301preview.OperationNameFormat>;
    /**
     ...
     * Sampling settings for Diagnostic.
     */
    sampling?: pulumi.Input<inputs.apimanagement.v20230301preview.SamplingSettingsArgs>;
    /**
     ...
     * The verbosity level applied to traces emitted by trace policies.
     */
    verbosity?: pulumi.Input<string | enums.apimanagement.v20230301preview.Verbosity>;
}
