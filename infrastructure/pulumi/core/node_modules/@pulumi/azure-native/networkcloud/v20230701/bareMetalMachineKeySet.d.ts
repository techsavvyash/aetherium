...
export declare class BareMetalMachineKeySet extends pulumi.CustomResource {
     ...
     */
    readonly userList: pulumi.Output<outputs.networkcloud.v20230701.KeySetUserResponse[]>;
    /**
     * The status evaluation of each user.
     */
    readonly userListStatus: pulumi.Output<outputs.networkcloud.v20230701.KeySetUserStatusResponse[]>;
    /**
...
export interface BareMetalMachineKeySetArgs {
     ...
     * The access level allowed for the users in this key set.
     */
    privilegeLevel: pulumi.Input<string | enums.networkcloud.v20230701.BareMetalMachineKeySetPrivilegeLevel>;
    /**
