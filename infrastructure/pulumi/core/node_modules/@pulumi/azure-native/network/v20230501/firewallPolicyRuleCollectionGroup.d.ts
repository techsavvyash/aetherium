...
export declare class FirewallPolicyRuleCollectionGroup extends pulumi.CustomResource {
     ...
     */
    readonly ruleCollections: pulumi.Output<(outputs.network.v20230501.FirewallPolicyFilterRuleCollectionResponse | outputs.network.v20230501.FirewallPolicyNatRuleCollectionResponse)[] | undefined>;
    /**
...
export interface FirewallPolicyRuleCollectionGroupArgs {
     ...
     * Group of Firewall Policy rule collections.
     */
    ruleCollections?: pulumi.Input<pulumi.Input<inputs.network.v20230501.FirewallPolicyFilterRuleCollectionArgs | inputs.network.v20230501.FirewallPolicyNatRuleCollectionArgs>[]>;
}
