...
export declare class StaticSite extends pulumi.CustomResource {
     ...
     */
    readonly buildProperties: pulumi.Output<outputs.web.v20231201.StaticSiteBuildPropertiesResponse | undefined>;
    /**
     ...
     */
    readonly databaseConnections: pulumi.Output<outputs.web.v20231201.DatabaseConnectionOverviewResponse[]>;
    /**
     ...
     */
    readonly identity: pulumi.Output<outputs.web.v20231201.ManagedServiceIdentityResponse | undefined>;
    /**
     ...
     */
    readonly linkedBackends: pulumi.Output<outputs.web.v20231201.StaticSiteLinkedBackendResponse[]>;
    /**
     * Resource Location.
     */
     ...
     */
    readonly privateEndpointConnections: pulumi.Output<outputs.web.v20231201.ResponseMessageEnvelopeRemotePrivateEndpointConnectionResponse[]>;
    /**
     ...
     */
    readonly sku: pulumi.Output<outputs.web.v20231201.SkuDescriptionResponse | undefined>;
    /**
     ...
     */
    readonly templateProperties: pulumi.Output<outputs.web.v20231201.StaticSiteTemplateOptionsResponse | undefined>;
    /**
     * Resource type.
     */
     ...
     */
    readonly userProvidedFunctionApps: pulumi.Output<outputs.web.v20231201.StaticSiteUserProvidedFunctionAppResponse[]>;
    /**
...
export interface StaticSiteArgs {
     ...
     * Build properties to configure on the repository.
     */
    buildProperties?: pulumi.Input<inputs.web.v20231201.StaticSiteBuildPropertiesArgs>;
    /**
     * State indicating the status of the enterprise grade CDN serving traffic to the static web app.
     */
    enterpriseGradeCdnStatus?: pulumi.Input<string | enums.web.v20231201.EnterpriseGradeCdnStatus>;
    /**
     * Managed service identity.
     */
     ...
     * State indicating whether staging environments are allowed or not allowed for a static web app.
     */
    stagingEnvironmentPolicy?: pulumi.Input<enums.web.v20231201.StagingEnvironmentPolicy>;
    /**
     * Resource tags.
     */
    tags?: pulumi.Input<{
     ...
     * Template options for generating a new repository.
     */
    templateProperties?: pulumi.Input<inputs.web.v20231201.StaticSiteTemplateOptionsArgs>;
}
