...
export interface ListWorkspaceKeysResult {
    ...
    readonly containerRegistryCredentials: outputs.machinelearningservices.v20240401.RegistryListCredentialsResultResponse;
    readonly notebookAccessKeys: outputs.machinelearningservices.v20240401.ListNotebookKeysResultResponse;
