...
exports.getNodeTypesOutput = exports.getNodeTypes = void 0;
 ...
 * ```
 */
function getNodeTypes(args, opts) {
    args = args || {};
 ...
 * ```
 */
function getNodeTypesOutput(args, opts) {
    return pulumi.output(args).apply((a) => getNodeTypes(a, opts));
}
exports.getNodeTypesOutput = getNodeTypesOutput;
//# sourceMappingURL=getNodeTypes.js.map