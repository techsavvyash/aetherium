...
exports.getKMSCryptoKeyVersionOutput = exports.getKMSCryptoKeyVersion = void 0;
 ...
 * ```
 */
function getKMSCryptoKeyVersion(args, opts) {
...
exports.getKMSCryptoKeyVersion = getKMSCryptoKeyVersion;
/**
 * Provides access to a Google Cloud Platform KMS CryptoKeyVersion. For more information see
 * [the official documentation](https://cloud.google.com/kms/docs/object-hierarchy#key_version)
 * and
 ...
 * ```
 */
function getKMSCryptoKeyVersionOutput(args, opts) {
    return pulumi.output(args).apply((a) => getKMSCryptoKeyVersion(a, opts));
}
exports.getKMSCryptoKeyVersionOutput = getKMSCryptoKeyVersionOutput;
//# sourceMappingURL=getKMSCryptoKeyVersion.js.map