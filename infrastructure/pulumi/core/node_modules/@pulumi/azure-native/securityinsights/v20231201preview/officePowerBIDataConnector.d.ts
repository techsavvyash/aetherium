...
export declare class OfficePowerBIDataConnector extends pulumi.CustomResource {
     ...
     */
    readonly dataTypes: pulumi.Output<outputs.securityinsights.v20231201preview.OfficePowerBIConnectorDataTypesResponse>;
    /**
...
export interface OfficePowerBIDataConnectorArgs {
     ...
     * The available data types for the connector.
     */
    dataTypes: pulumi.Input<inputs.securityinsights.v20231201preview.OfficePowerBIConnectorDataTypesArgs>;
    /**
     * The kind of the data connector
     * Expected value is 'OfficePowerBI'.
     */
