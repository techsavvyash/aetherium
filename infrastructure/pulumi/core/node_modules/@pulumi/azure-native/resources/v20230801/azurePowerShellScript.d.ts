...
export declare class AzurePowerShellScript extends pulumi.CustomResource {
     ...
     * Container settings.
     */
    readonly containerSettings: pulumi.Output<outputs.resources.v20230801.ContainerConfigurationResponse | undefined>;
    /**
     * The environment variables to pass over to the script.
     */
    readonly environmentVariables: pulumi.Output<outputs.resources.v20230801.EnvironmentVariableResponse[] | undefined>;
    /**
     ...
     */
    readonly identity: pulumi.Output<outputs.resources.v20230801.ManagedServiceIdentityResponse | undefined>;
    /**
     * Type of the script.
     ...
     */
    readonly status: pulumi.Output<outputs.resources.v20230801.ScriptStatusResponse>;
    /**
     * Storage Account settings.
     */
    readonly storageAccountSettings: pulumi.Output<outputs.resources.v20230801.StorageAccountConfigurationResponse | undefined>;
    /**
     ...
     */
    readonly systemData: pulumi.Output<outputs.resources.v20230801.SystemDataResponse>;
    /**
     * Resource tags.
     */
...
export interface AzurePowerShellScriptArgs {
     ...
     * The clean up preference when the script execution gets in a terminal state. Default setting is 'Always'.
     */
    cleanupPreference?: pulumi.Input<string | enums.resources.v20230801.CleanupOptions>;
    /**
     * Container settings.
     */
    containerSettings?: pulumi.Input<inputs.resources.v20230801.ContainerConfigurationArgs>;
    /**
     * The environment variables to pass over to the script.
     */
    environmentVariables?: pulumi.Input<pulumi.Input<inputs.resources.v20230801.EnvironmentVariableArgs>[]>;
    /**
     * Gets or sets how the deployment script should be forced to execute even if the script resource has not changed. Can be current time stamp or a GUID.
     */
     ...
     * Optional property. Managed identity to be used for this deployment script. Currently, only user-assigned MSI is supported.
     */
    identity?: pulumi.Input<inputs.resources.v20230801.ManagedServiceIdentityArgs>;
    /**
     * Type of the script.
     * Expected value is 'AzurePowerShell'.
     */
     ...
     * Storage Account settings.
     */
    storageAccountSettings?: pulumi.Input<inputs.resources.v20230801.StorageAccountConfigurationArgs>;
    /**
     * Supporting files for the external script.
     */
