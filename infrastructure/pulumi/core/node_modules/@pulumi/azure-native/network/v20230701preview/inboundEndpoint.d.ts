...
export declare class InboundEndpoint extends pulumi.CustomResource {
     ...
     */
    readonly ipConfigurations: pulumi.Output<outputs.network.v20230701preview.InboundEndpointIPConfigurationResponse[]>;
    /**
...
export interface InboundEndpointArgs {
     ...
     * IP configurations for the inbound endpoint.
     */
    ipConfigurations: pulumi.Input<pulumi.Input<inputs.network.v20230701preview.InboundEndpointIPConfigurationArgs>[]>;
    /**
     * The geo-location where the resource lives
     */
