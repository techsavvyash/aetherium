...
export declare class JobTargetGroup extends pulumi.CustomResource {
     ...
     */
    readonly members: pulumi.Output<outputs.sql.v20230201preview.JobTargetResponse[]>;
    /**
     * Resource name.
     */
...
export interface JobTargetGroupArgs {
     ...
     * Members of the target group.
     */
    members: pulumi.Input<pulumi.Input<inputs.sql.v20230201preview.JobTargetArgs>[]>;
    /**
