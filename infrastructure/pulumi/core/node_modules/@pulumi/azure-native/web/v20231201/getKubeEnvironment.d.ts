...
export interface GetKubeEnvironmentResult {
     ...
     * supported
     */
    readonly appLogsConfiguration?: outputs.web.v20231201.AppLogsConfigurationResponse;
    /**
     * Cluster configuration which determines the ARC cluster
     * components types. Eg: Choosing between BuildService kind,
     * FrontEnd Service ArtifactsStorageType etc.
     */
    readonly arcConfiguration?: outputs.web.v20231201.ArcConfigurationResponse;
    /**
     * Cluster configuration for Container Apps Environments to configure Dapr Instrumentation Key and VNET Configuration
     */
    readonly containerAppsConfiguration?: outputs.web.v20231201.ContainerAppsConfigurationResponse;
    /**
