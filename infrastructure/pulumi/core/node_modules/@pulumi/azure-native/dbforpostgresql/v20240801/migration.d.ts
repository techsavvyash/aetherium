...
export declare class Migration extends pulumi.CustomResource {
     ...
     */
    readonly currentStatus: pulumi.Output<outputs.dbforpostgresql.v20240801.MigrationStatusResponse>;
    /**
     ...
     */
    readonly sourceDbServerMetadata: pulumi.Output<outputs.dbforpostgresql.v20240801.DbServerMetadataResponse>;
    /**
     ...
     */
    readonly systemData: pulumi.Output<outputs.dbforpostgresql.v20240801.SystemDataResponse>;
    /**
     * Resource tags.
     */
     ...
     */
    readonly targetDbServerMetadata: pulumi.Output<outputs.dbforpostgresql.v20240801.DbServerMetadataResponse>;
    /**
...
export interface MigrationArgs {
     ...
     * To trigger cancel for entire migration we need to send this flag as True
     */
    cancel?: pulumi.Input<string | enums.dbforpostgresql.v20240801.CancelEnum>;
    /**
     * When you want to trigger cancel for specific databases send cancel flag as True and database names in this array
     */
     ...
     * To migrate roles and permissions we need to send this flag as True
     */
    migrateRoles?: pulumi.Input<string | enums.dbforpostgresql.v20240801.MigrateRolesEnum>;
    /**
     * ResourceId of the private endpoint migration instance
     */
     ...
     * There are two types of migration modes Online and Offline
     */
    migrationMode?: pulumi.Input<string | enums.dbforpostgresql.v20240801.MigrationMode>;
    /**
     ...
     * This indicates the supported Migration option for the migration
     */
    migrationOption?: pulumi.Input<string | enums.dbforpostgresql.v20240801.MigrationOption>;
    /**
     * End time in UTC for migration window
     */
     ...
     * Indicates whether the databases on the target server can be overwritten, if already present. If set to False, the migration workflow will wait for a confirmation, if it detects that the database already exists.
     */
    overwriteDbsInTarget?: pulumi.Input<string | enums.dbforpostgresql.v20240801.OverwriteDbsInTargetEnum>;
    /**
     ...
     */
    secretParameters?: pulumi.Input<inputs.dbforpostgresql.v20240801.MigrationSecretParametersArgs>;
    /**
     * Indicates whether to setup LogicalReplicationOnSourceDb, if needed
     */
    setupLogicalReplicationOnSourceDbIfNeeded?: pulumi.Input<string | enums.dbforpostgresql.v20240801.LogicalReplicationOnSourceDbEnum>;
    /**
     * Source server fully qualified domain name (FQDN) or IP address. It is a optional value, if customer provide it, migration service will always use it for connection
     */
     ...
     * migration source server type : OnPremises, AWS, GCP, AzureVM, PostgreSQLSingleServer, AWS_RDS, AWS_AURORA, AWS_EC2, GCP_CloudSQL, GCP_AlloyDB, GCP_Compute, or EDB
     */
    sourceType?: pulumi.Input<string | enums.dbforpostgresql.v20240801.SourceType>;
    /**
     * SSL modes for migration. Default SSL mode for PostgreSQLSingleServer is VerifyFull and Prefer for other source types
     */
    sslMode?: pulumi.Input<string | enums.dbforpostgresql.v20240801.SslMode>;
    /**
     * Indicates whether the data migration should start right away
     */
    startDataMigration?: pulumi.Input<string | enums.dbforpostgresql.v20240801.StartDataMigrationEnum>;
    /**
     ...
     * To trigger cutover for entire migration we need to send this flag as True
     */
    triggerCutover?: pulumi.Input<string | enums.dbforpostgresql.v20240801.TriggerCutoverEnum>;
}
