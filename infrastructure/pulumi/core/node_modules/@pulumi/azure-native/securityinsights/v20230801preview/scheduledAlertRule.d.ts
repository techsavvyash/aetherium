...
export declare class ScheduledAlertRule extends pulumi.CustomResource {
     ...
     */
    readonly alertDetailsOverride: pulumi.Output<outputs.securityinsights.v20230801preview.AlertDetailsOverrideResponse | undefined>;
    /**
     ...
     */
    readonly entityMappings: pulumi.Output<outputs.securityinsights.v20230801preview.EntityMappingResponse[] | undefined>;
    /**
     ...
     */
    readonly eventGroupingSettings: pulumi.Output<outputs.securityinsights.v20230801preview.EventGroupingSettingsResponse | undefined>;
    /**
     * The settings of the incidents that created from alerts triggered by this analytics rule
     */
    readonly incidentConfiguration: pulumi.Output<outputs.securityinsights.v20230801preview.IncidentConfigurationResponse | undefined>;
    /**
     ...
     */
    readonly sentinelEntitiesMappings: pulumi.Output<outputs.securityinsights.v20230801preview.SentinelEntityMappingResponse[] | undefined>;
    /**
...
export interface ScheduledAlertRuleArgs {
     ...
     * The alert details override settings
     */
    alertDetailsOverride?: pulumi.Input<inputs.securityinsights.v20230801preview.AlertDetailsOverrideArgs>;
    /**
     * The Name of the alert rule template used to create this rule.
     */
     ...
     * Array of the entity mappings of the alert rule
     */
    entityMappings?: pulumi.Input<pulumi.Input<inputs.securityinsights.v20230801preview.EntityMappingArgs>[]>;
    /**
     * The event grouping settings.
     */
    eventGroupingSettings?: pulumi.Input<inputs.securityinsights.v20230801preview.EventGroupingSettingsArgs>;
    /**
     * The settings of the incidents that created from alerts triggered by this analytics rule
     */
    incidentConfiguration?: pulumi.Input<inputs.securityinsights.v20230801preview.IncidentConfigurationArgs>;
    /**
     * The kind of the alert rule
     * Expected value is 'Scheduled'.
     */
     ...
     * Array of the sentinel entity mappings of the alert rule
     */
    sentinelEntitiesMappings?: pulumi.Input<pulumi.Input<inputs.securityinsights.v20230801preview.SentinelEntityMappingArgs>[]>;
    /**
     * The severity for alerts created by this alert rule.
     */
    severity: pulumi.Input<string | enums.securityinsights.v20230801preview.AlertSeverity>;
    /**
     * The suppression (in ISO 8601 duration format) to wait since last time this alert rule been triggered.
     */
     ...
     * The operation against the threshold that triggers alert rule.
     */
    triggerOperator: pulumi.Input<enums.securityinsights.v20230801preview.TriggerOperator>;
    /**
     * The threshold triggers this alert rule.
     */
