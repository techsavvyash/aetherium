...
export declare class OpenAI extends pulumi.CustomResource {
     ...
     */
    readonly properties: pulumi.Output<outputs.elastic.v20241001preview.OpenAIIntegrationPropertiesResponse>;
    /**
...
export interface OpenAIArgs {
     ...
     * Open AI Integration details.
     */
    properties?: pulumi.Input<inputs.elastic.v20241001preview.OpenAIIntegrationPropertiesArgs>;
    /**
