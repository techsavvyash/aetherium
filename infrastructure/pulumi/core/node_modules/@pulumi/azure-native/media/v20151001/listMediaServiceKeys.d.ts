 ...
 * Lists the keys for a Media Service.
 */
export declare function listMediaServiceKeysOutput(args: ListMediaServiceKeysOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<ListMediaServiceKeysResult>;
