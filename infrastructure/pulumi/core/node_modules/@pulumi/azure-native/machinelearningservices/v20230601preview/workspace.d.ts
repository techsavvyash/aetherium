...
export declare class Workspace extends pulumi.CustomResource {
    ...
    readonly encryption: pulumi.Output<outputs.machinelearningservices.v20230601preview.EncryptionPropertyResponse | undefined>;
    readonly existingWorkspaces: pulumi.Output<string[] | undefined>;
    /**
     * Settings for feature store type workspace.
     */
    readonly featureStoreSettings: pulumi.Output<outputs.machinelearningservices.v20230601preview.FeatureStoreSettingsResponse | undefined>;
    /**
     ...
     */
    readonly identity: pulumi.Output<outputs.machinelearningservices.v20230601preview.ManagedServiceIdentityResponse | undefined>;
    /**
     ...
     */
    readonly managedNetwork: pulumi.Output<outputs.machinelearningservices.v20230601preview.ManagedNetworkSettingsResponse | undefined>;
    /**
     ...
     */
    readonly notebookInfo: pulumi.Output<outputs.machinelearningservices.v20230601preview.NotebookResourceInfoResponse>;
    /**
     ...
     */
    readonly privateEndpointConnections: pulumi.Output<outputs.machinelearningservices.v20230601preview.PrivateEndpointConnectionResponse[]>;
    /**
     ...
     */
    readonly serviceManagedResourcesSettings: pulumi.Output<outputs.machinelearningservices.v20230601preview.ServiceManagedResourcesSettingsResponse | undefined>;
    /**
     ...
     */
    readonly sharedPrivateLinkResources: pulumi.Output<outputs.machinelearningservices.v20230601preview.SharedPrivateLinkResourceResponse[] | undefined>;
    /**
     * Optional. This field is required to be implemented by the RP because AML is supporting more than one tier
     */
    readonly sku: pulumi.Output<outputs.machinelearningservices.v20230601preview.SkuResponse | undefined>;
    /**
     ...
     */
    readonly systemData: pulumi.Output<outputs.machinelearningservices.v20230601preview.SystemDataResponse>;
    /**
     ...
     */
    readonly workspaceHubConfig: pulumi.Output<outputs.machinelearningservices.v20230601preview.WorkspaceHubConfigResponse | undefined>;
    /**
...
export interface WorkspaceArgs {
    ...
    encryption?: pulumi.Input<inputs.machinelearningservices.v20230601preview.EncryptionPropertyArgs>;
    existingWorkspaces?: pulumi.Input<pulumi.Input<string>[]>;
    /**
     * Settings for feature store type workspace.
     */
    featureStoreSettings?: pulumi.Input<inputs.machinelearningservices.v20230601preview.FeatureStoreSettingsArgs>;
    /**
     * The friendly name for this workspace. This name in mutable
     */
     ...
     * Managed Network settings for a machine learning workspace.
     */
    managedNetwork?: pulumi.Input<inputs.machinelearningservices.v20230601preview.ManagedNetworkSettingsArgs>;
    /**
     * The user assigned identity resource id that represents the workspace identity.
     */
     ...
     * Whether requests from Public Network are allowed.
     */
    publicNetworkAccess?: pulumi.Input<string | enums.machinelearningservices.v20230601preview.PublicNetworkAccessType>;
    /**
     ...
     * The service managed resource settings.
     */
    serviceManagedResourcesSettings?: pulumi.Input<inputs.machinelearningservices.v20230601preview.ServiceManagedResourcesSettingsArgs>;
    /**
     * The list of shared private link resources in this workspace.
     */
    sharedPrivateLinkResources?: pulumi.Input<pulumi.Input<inputs.machinelearningservices.v20230601preview.SharedPrivateLinkResourceArgs>[]>;
    /**
     * Optional. This field is required to be implemented by the RP because AML is supporting more than one tier
     */
     ...
     * WorkspaceHub's configuration object.
     */
    workspaceHubConfig?: pulumi.Input<inputs.machinelearningservices.v20230601preview.WorkspaceHubConfigArgs>;
    /**
