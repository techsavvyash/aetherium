...
export declare class EventHub extends pulumi.CustomResource {
     ...
     */
    readonly captureDescription: pulumi.Output<outputs.eventhub.v20240501preview.CaptureDescriptionResponse | undefined>;
    /**
     ...
     */
    readonly messageTimestampDescription: pulumi.Output<outputs.eventhub.v20240501preview.MessageTimestampDescriptionResponse | undefined>;
    /**
     ...
     */
    readonly retentionDescription: pulumi.Output<outputs.eventhub.v20240501preview.RetentionDescriptionResponse | undefined>;
    /**
...
export interface EventHubArgs {
     ...
     * Properties of capture description
     */
    captureDescription?: pulumi.Input<inputs.eventhub.v20240501preview.CaptureDescriptionArgs>;
    /**
     * The Event Hub name
     */
     ...
     * Event Hub retention settings
     */
    retentionDescription?: pulumi.Input<inputs.eventhub.v20240501preview.RetentionDescriptionArgs>;
    /**
     * Enumerates the possible values for the status of the Event Hub.
     */
    status?: pulumi.Input<enums.eventhub.v20240501preview.EntityStatus>;
    /**
     * Gets and Sets Metadata of User.
     */
