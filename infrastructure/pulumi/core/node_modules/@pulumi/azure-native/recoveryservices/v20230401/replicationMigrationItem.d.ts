...
export declare class ReplicationMigrationItem extends pulumi.CustomResource {
     ...
     */
    readonly properties: pulumi.Output<outputs.recoveryservices.v20230401.MigrationItemPropertiesResponse>;
    /**
     * Resource Type
     */
...
export interface ReplicationMigrationItemArgs {
     ...
     */
    properties: pulumi.Input<inputs.recoveryservices.v20230401.EnableMigrationInputPropertiesArgs>;
    /**
