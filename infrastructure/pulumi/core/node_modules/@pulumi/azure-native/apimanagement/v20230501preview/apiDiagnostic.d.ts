...
export declare class ApiDiagnostic extends pulumi.CustomResource {
     ...
     */
    readonly backend: pulumi.Output<outputs.apimanagement.v20230501preview.PipelineDiagnosticSettingsResponse | undefined>;
    /**
     * Diagnostic settings for incoming/outgoing HTTP messages to the Gateway.
     */
    readonly frontend: pulumi.Output<outputs.apimanagement.v20230501preview.PipelineDiagnosticSettingsResponse | undefined>;
    /**
     ...
     */
    readonly sampling: pulumi.Output<outputs.apimanagement.v20230501preview.SamplingSettingsResponse | undefined>;
    /**
...
export interface ApiDiagnosticArgs {
     ...
     * Specifies for what type of messages sampling settings should not apply.
     */
    alwaysLog?: pulumi.Input<string | enums.apimanagement.v20230501preview.AlwaysLog>;
    /**
     ...
     * Diagnostic settings for incoming/outgoing HTTP messages to the Backend
     */
    backend?: pulumi.Input<inputs.apimanagement.v20230501preview.PipelineDiagnosticSettingsArgs>;
    /**
     ...
     * Diagnostic settings for incoming/outgoing HTTP messages to the Gateway.
     */
    frontend?: pulumi.Input<inputs.apimanagement.v20230501preview.PipelineDiagnosticSettingsArgs>;
    /**
     * Sets correlation protocol to use for Application Insights diagnostics.
     */
    httpCorrelationProtocol?: pulumi.Input<string | enums.apimanagement.v20230501preview.HttpCorrelationProtocol>;
    /**
     * Log the ClientIP. Default is false.
     */
     ...
     * The format of the Operation Name for Application Insights telemetries. Default is Name.
     */
    operationNameFormat?: pulumi.Input<string | enums.apimanagement.v20230501preview.OperationNameFormat>;
    /**
     ...
     * Sampling settings for Diagnostic.
     */
    sampling?: pulumi.Input<inputs.apimanagement.v20230501preview.SamplingSettingsArgs>;
    /**
     ...
     * The verbosity level applied to traces emitted by trace policies.
     */
    verbosity?: pulumi.Input<string | enums.apimanagement.v20230501preview.Verbosity>;
}
