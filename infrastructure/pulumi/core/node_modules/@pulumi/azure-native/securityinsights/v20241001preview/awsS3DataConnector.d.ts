...
export declare class AwsS3DataConnector extends pulumi.CustomResource {
     ...
     */
    readonly dataTypes: pulumi.Output<outputs.securityinsights.v20241001preview.AwsS3DataConnectorDataTypesResponse>;
    /**
...
export interface AwsS3DataConnectorArgs {
     ...
     * The available data types for the connector.
     */
    dataTypes: pulumi.Input<inputs.securityinsights.v20241001preview.AwsS3DataConnectorDataTypesArgs>;
    /**
     * The logs destination table name in LogAnalytics.
     */
