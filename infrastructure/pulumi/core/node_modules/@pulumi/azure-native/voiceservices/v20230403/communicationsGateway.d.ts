...
export declare class CommunicationsGateway extends pulumi.CustomResource {
     ...
     */
    readonly apiBridge: pulumi.Output<any | undefined>;
    /**
     ...
     */
    readonly identity: pulumi.Output<outputs.voiceservices.v20230403.ManagedServiceIdentityResponse | undefined>;
    /**
     ...
     */
    readonly serviceLocations: pulumi.Output<outputs.voiceservices.v20230403.ServiceRegionPropertiesResponse[]>;
    /**
     ...
     */
    readonly systemData: pulumi.Output<outputs.voiceservices.v20230403.SystemDataResponse>;
    /**
     * Resource tags.
     */
...
export interface CommunicationsGatewayArgs {
     ...
     * The scope at which the auto-generated domain name can be re-used
     */
    autoGeneratedDomainNameLabelScope?: pulumi.Input<string | enums.voiceservices.v20230403.AutoGeneratedDomainNameLabelScope>;
    /**
     * Voice codecs to support
     */
    codecs: pulumi.Input<pulumi.Input<string | enums.voiceservices.v20230403.TeamsCodecs>[]>;
    /**
     ...
     * How to connect back to the operator network, e.g. MAPS
     */
    connectivity: pulumi.Input<string | enums.voiceservices.v20230403.Connectivity>;
    /**
     * How to handle 911 calls
     */
    e911Type: pulumi.Input<string | enums.voiceservices.v20230403.E911Type>;
    /**
     * A list of dial strings used for emergency calling.
     */
     ...
     * The managed service identities assigned to this resource.
     */
    identity?: pulumi.Input<inputs.voiceservices.v20230403.ManagedServiceIdentityArgs>;
    /**
     * Whether an integrated Mobile Control Point is in use.
     */
     ...
     * What platforms to support
     */
    platforms: pulumi.Input<pulumi.Input<string | enums.voiceservices.v20230403.CommunicationsPlatform>[]>;
    /**
     ...
     * The regions in which to deploy the resources needed for Teams Calling
     */
    serviceLocations: pulumi.Input<pulumi.Input<inputs.voiceservices.v20230403.ServiceRegionPropertiesArgs>[]>;
    /**
     * Resource tags.
     */
    tags?: pulumi.Input<{
