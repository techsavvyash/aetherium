...
export declare class GuestAgent extends pulumi.CustomResource {
     ...
     */
    readonly credentials: pulumi.Output<outputs.scvmm.v20240601.GuestCredentialResponse | undefined>;
    /**
     ...
     */
    readonly httpProxyConfig: pulumi.Output<outputs.scvmm.v20240601.HttpProxyConfigurationResponse | undefined>;
    /**
...
export interface GuestAgentArgs {
     ...
     * Username / Password Credentials to provision guest agent.
     */
    credentials?: pulumi.Input<inputs.scvmm.v20240601.GuestCredentialArgs>;
    /**
     * HTTP Proxy configuration for the VM.
     */
    httpProxyConfig?: pulumi.Input<inputs.scvmm.v20240601.HttpProxyConfigurationArgs>;
    /**
     * The resource id of the private link scope this machine is assigned to, if any.
     */
     ...
     * Gets or sets the guest agent provisioning action.
     */
    provisioningAction?: pulumi.Input<string | enums.scvmm.v20240601.ProvisioningAction>;
    /**
