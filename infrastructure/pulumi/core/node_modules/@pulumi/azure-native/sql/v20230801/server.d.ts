...
export declare class Server extends pulumi.CustomResource {
     ...
     */
    readonly administrators: pulumi.Output<outputs.sql.v20230801.ServerExternalAdministratorResponse | undefined>;
    /**
     ...
     */
    readonly privateEndpointConnections: pulumi.Output<outputs.sql.v20230801.ServerPrivateEndpointConnectionResponse[]>;
    /**
...
export interface ServerArgs {
     ...
     * The Azure Active Directory administrator of the server. This can only be used at server create time. If used for server update, it will be ignored or it will result in an error. For updates individual APIs will need to be used.
     */
    administrators?: pulumi.Input<inputs.sql.v20230801.ServerExternalAdministratorArgs>;
    /**
     * The Client id used for cross tenant CMK scenario
     */
     ...
     * Whether or not to enable IPv6 support for this server.  Value is optional but if passed in, must be 'Enabled' or 'Disabled'
     */
    isIPv6Enabled?: pulumi.Input<string | enums.sql.v20230801.ServerNetworkAccessFlag>;
    /**
     * A CMK URI of the key to use for encryption.
     */
     ...
     * Minimal TLS version. Allowed values: 'None', 1.0', '1.1', '1.2', '1.3'
     */
    minimalTlsVersion?: pulumi.Input<string | enums.sql.v20230801.MinimalTlsVersion>;
    /**
     * The resource id of a user assigned identity to be used by default.
     */
     ...
     * Whether or not public endpoint access is allowed for this server.  Value is optional but if passed in, must be 'Enabled' or 'Disabled' or 'SecuredByPerimeter'
     */
    publicNetworkAccess?: pulumi.Input<string | enums.sql.v20230801.ServerPublicNetworkAccessFlag>;
    /**
     ...
     * Whether or not to restrict outbound network access for this server.  Value is optional but if passed in, must be 'Enabled' or 'Disabled'
     */
    restrictOutboundNetworkAccess?: pulumi.Input<string | enums.sql.v20230801.ServerNetworkAccessFlag>;
    /**
