...
export declare class DiscoveredAsset extends pulumi.CustomResource {
     ...
     */
    readonly datasets: pulumi.Output<outputs.deviceregistry.v20240901preview.DiscoveredDatasetResponse[] | undefined>;
    /**
     ...
     */
    readonly defaultTopic: pulumi.Output<outputs.deviceregistry.v20240901preview.TopicResponse | undefined>;
    /**
     ...
     */
    readonly events: pulumi.Output<outputs.deviceregistry.v20240901preview.DiscoveredEventResponse[] | undefined>;
    /**
     * The extended location.
     */
    readonly extendedLocation: pulumi.Output<outputs.deviceregistry.v20240901preview.ExtendedLocationResponse>;
    /**
     ...
     */
    readonly systemData: pulumi.Output<outputs.deviceregistry.v20240901preview.SystemDataResponse>;
    /**
     * Resource tags.
     */
...
export interface DiscoveredAssetArgs {
     ...
     * Array of datasets that are part of the asset. Each dataset spec describes the data points that make up the set.
     */
    datasets?: pulumi.Input<pulumi.Input<inputs.deviceregistry.v20240901preview.DiscoveredDatasetArgs>[]>;
    /**
     * Stringified JSON that contains connector-specific default configuration for all datasets. Each dataset can have its own configuration that overrides the default settings here.
     */
     ...
     * Array of events that are part of the asset. Each event can have per-event configuration.
     */
    events?: pulumi.Input<pulumi.Input<inputs.deviceregistry.v20240901preview.DiscoveredEventArgs>[]>;
    /**
     * The extended location.
     */
