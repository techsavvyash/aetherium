...
export declare class ReplicationProtectedItem extends pulumi.CustomResource {
     ...
     * The custom data.
     */
    readonly properties: pulumi.Output<outputs.recoveryservices.v20230401.ReplicationProtectedItemPropertiesResponse>;
    /**
     * Resource Type
     */
...
export interface ReplicationProtectedItemArgs {
     ...
     */
    properties?: pulumi.Input<inputs.recoveryservices.v20230401.EnableProtectionInputPropertiesArgs>;
    /**
