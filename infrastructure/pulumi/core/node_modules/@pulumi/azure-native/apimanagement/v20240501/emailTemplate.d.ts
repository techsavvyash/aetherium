...
export declare class EmailTemplate extends pulumi.CustomResource {
     ...
     */
    readonly parameters: pulumi.Output<outputs.apimanagement.v20240501.EmailTemplateParametersContractPropertiesResponse[] | undefined>;
    /**
...
export interface EmailTemplateArgs {
     ...
     * Email Template Parameter values.
     */
    parameters?: pulumi.Input<pulumi.Input<inputs.apimanagement.v20240501.EmailTemplateParametersContractPropertiesArgs>[]>;
    /**
