...
export declare class AFDCustomDomain extends pulumi.CustomResource {
     ...
     */
    readonly azureDnsZone: pulumi.Output<outputs.cdn.v20240501preview.ResourceReferenceResponse | undefined>;
     ...
     */
    readonly mtlsSettings: pulumi.Output<outputs.cdn.v20240501preview.AFDDomainMtlsParametersResponse | undefined>;
    /**
     * Resource name.
     */
     ...
     */
    readonly preValidatedCustomDomainResourceId: pulumi.Output<outputs.cdn.v20240501preview.ResourceReferenceResponse | undefined>;
    /**
     ...
     */
    readonly referencedRoutePaths: pulumi.Output<outputs.cdn.v20240501preview.AFDDomainReferencedRoutePathResponse[]>;
    /**
     ...
     */
    readonly tlsSettings: pulumi.Output<outputs.cdn.v20240501preview.AFDDomainHttpsParametersResponse | undefined>;
    /**
     * Resource type.
     */
     ...
     */
    readonly validationProperties: pulumi.Output<outputs.cdn.v20240501preview.DomainValidationPropertiesResponse>;
    /**
...
export interface AFDCustomDomainArgs {
     ...
     * Resource reference to the Azure DNS zone
     */
    azureDnsZone?: pulumi.Input<inputs.cdn.v20240501preview.ResourceReferenceArgs>;
    /**
     ...
     * The configuration specifying how to enable mutual TLS for the domain, including specifying allowed FQDN and which server certificate(s) to use.
     */
    mtlsSettings?: pulumi.Input<inputs.cdn.v20240501preview.AFDDomainMtlsParametersArgs>;
    /**
     * Resource reference to the Azure resource where custom domain ownership was prevalidated
     */
    preValidatedCustomDomainResourceId?: pulumi.Input<inputs.cdn.v20240501preview.ResourceReferenceArgs>;
    /**
     ...
     * The configuration specifying how to enable HTTPS for the domain - using AzureFrontDoor managed certificate or user's own certificate. If not specified, enabling ssl uses AzureFrontDoor managed certificate by default.
     */
    tlsSettings?: pulumi.Input<inputs.cdn.v20240501preview.AFDDomainHttpsParametersArgs>;
}
