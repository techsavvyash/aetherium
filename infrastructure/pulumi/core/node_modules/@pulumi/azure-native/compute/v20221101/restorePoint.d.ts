...
export declare class RestorePoint extends pulumi.CustomResource {
     ...
     */
    readonly excludeDisks: pulumi.Output<outputs.compute.v20221101.ApiEntityReferenceResponse[] | undefined>;
    /**
     * The restore point instance view.
     */
    readonly instanceView: pulumi.Output<outputs.compute.v20221101.RestorePointInstanceViewResponse>;
    /**
     * Resource name
     */
     ...
     */
    readonly sourceMetadata: pulumi.Output<outputs.compute.v20221101.RestorePointSourceMetadataResponse>;
    /**
     * Resource Id of the source restore point from which a copy needs to be created.
     */
    readonly sourceRestorePoint: pulumi.Output<outputs.compute.v20221101.ApiEntityReferenceResponse | undefined>;
    /**
...
export interface RestorePointArgs {
     ...
     * ConsistencyMode of the RestorePoint. Can be specified in the input while creating a restore point. For now, only CrashConsistent is accepted as a valid input. Please refer to https://aka.ms/RestorePoints for more details.
     */
    consistencyMode?: pulumi.Input<string | enums.compute.v20221101.ConsistencyModeTypes>;
    /**
     * List of disk resource ids that the customer wishes to exclude from the restore point. If no disks are specified, all disks will be included.
     */
    excludeDisks?: pulumi.Input<pulumi.Input<inputs.compute.v20221101.ApiEntityReferenceArgs>[]>;
    /**
     ...
     * Resource Id of the source restore point from which a copy needs to be created.
     */
    sourceRestorePoint?: pulumi.Input<inputs.compute.v20221101.ApiEntityReferenceArgs>;
    /**
     * Gets the creation time of the restore point.
     */
