 ...
 */
export declare class PurviewAuditDataConnector extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): PurviewAuditDataConnector;
    /**
     ...
     */
    static isInstance(obj: any): obj is PurviewAuditDataConnector;
    /**
     * The connector definition name (the dataConnectorDefinition resource id).
     */
    readonly connectorDefinitionName: pulumi.Output<string | undefined>;
    /**
     * The available data types for the connector.
     */
    readonly dataTypes: pulumi.Output<outputs.securityinsights.v20241001preview.PurviewAuditConnectorDataTypesResponse>;
    /**
     ...
     */
    readonly kind: pulumi.Output<"PurviewAudit">;
    /**
