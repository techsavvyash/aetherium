...
export declare class CustomIPPrefix extends pulumi.CustomResource {
     ...
     */
    readonly childCustomIpPrefixes: pulumi.Output<outputs.network.v20230501.SubResourceResponse[]>;
    /**
     ...
     */
    readonly customIpPrefixParent: pulumi.Output<outputs.network.v20230501.SubResourceResponse | undefined>;
    /**
     ...
     */
    readonly publicIpPrefixes: pulumi.Output<outputs.network.v20230501.SubResourceResponse[]>;
    /**
...
export interface CustomIPPrefixArgs {
     ...
     * The commissioned state of the Custom IP Prefix.
     */
    commissionedState?: pulumi.Input<string | enums.network.v20230501.CommissionedState>;
    /**
     ...
     * The Parent CustomIpPrefix for IPv6 /64 CustomIpPrefix.
     */
    customIpPrefixParent?: pulumi.Input<inputs.network.v20230501.SubResourceArgs>;
    /**
     * Whether to do express route advertise.
     */
     ...
     * The Geo for CIDR advertising. Should be an Geo code.
     */
    geo?: pulumi.Input<string | enums.network.v20230501.Geo>;
    /**
     * Resource ID.
     */
     ...
     * Type of custom IP prefix. Should be Singular, Parent, or Child.
     */
    prefixType?: pulumi.Input<string | enums.network.v20230501.CustomIpPrefixType>;
    /**
