...
export declare class ExpressRoutePort extends pulumi.CustomResource {
     ...
     */
    readonly circuits: pulumi.Output<outputs.network.v20230401.SubResourceResponse[]>;
    /**
     ...
     */
    readonly links: pulumi.Output<outputs.network.v20230401.ExpressRouteLinkResponse[] | undefined>;
    /**
     * Resource location.
     */
...
export interface ExpressRoutePortArgs {
     ...
     * The billing type of the ExpressRoutePort resource.
     */
    billingType?: pulumi.Input<string | enums.network.v20230401.ExpressRoutePortsBillingType>;
    /**
     * Encapsulation method on physical ports.
     */
    encapsulation?: pulumi.Input<string | enums.network.v20230401.ExpressRoutePortsEncapsulation>;
    /**
     ...
     * The set of physical links of the ExpressRoutePort resource.
     */
    links?: pulumi.Input<pulumi.Input<inputs.network.v20230401.ExpressRouteLinkArgs>[]>;
    /**
     * Resource location.
     */
