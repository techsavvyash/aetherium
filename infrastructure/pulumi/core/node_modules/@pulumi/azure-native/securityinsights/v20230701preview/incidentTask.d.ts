...
export declare class IncidentTask extends pulumi.CustomResource {
     ...
     */
    readonly createdBy: pulumi.Output<outputs.securityinsights.v20230701preview.ClientInfoResponse | undefined>;
    /**
     ...
     * Information on the client (user or application) that made some action
     */
    readonly lastModifiedBy: pulumi.Output<outputs.securityinsights.v20230701preview.ClientInfoResponse | undefined>;
    /**
...
export interface IncidentTaskArgs {
     ...
     * Information on the client (user or application) that made some action
     */
    createdBy?: pulumi.Input<inputs.securityinsights.v20230701preview.ClientInfoArgs>;
    /**
     * The description of the task
     */
     ...
     * Information on the client (user or application) that made some action
     */
    lastModifiedBy?: pulumi.Input<inputs.securityinsights.v20230701preview.ClientInfoArgs>;
    /**
     * The name of the resource group. The name is case insensitive.
     */
    resourceGroupName: pulumi.Input<string>;
    status: pulumi.Input<string | enums.securityinsights.v20230701preview.IncidentTaskStatus>;
    /**
     * The title of the task
     */
