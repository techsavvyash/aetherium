...
export declare class Budget extends pulumi.CustomResource {
     ...
     *  Supported for CategoryType(s): Cost.
     */
    readonly currentSpend: pulumi.Output<outputs.costmanagement.v20241001preview.CurrentSpendResponse>;
    /**
     ...
     */
    readonly filter: pulumi.Output<outputs.costmanagement.v20241001preview.BudgetFilterResponse | undefined>;
    /**
     * The forecasted cost which is being tracked for a budget.
     *
     *  Supported for CategoryType(s): Cost.
     */
    readonly forecastSpend: pulumi.Output<outputs.costmanagement.v20241001preview.ForecastSpendResponse>;
    /**
     * Resource name.
     */
    ...
    readonly notifications: pulumi.Output<{
        [key: string]: outputs.costmanagement.v20241001preview.NotificationResponse;
    } | undefined>;
    /**
     ...
     *  Required for CategoryType(s): Cost, ReservationUtilization.
     */
    readonly timePeriod: pulumi.Output<outputs.costmanagement.v20241001preview.BudgetTimePeriodResponse>;
    /**
     * Resource type.
     */
...
export interface BudgetArgs {
     ...
     * - 'ReservationUtilization' defines a Reservation Utilization Alert Rule.
     */
    category: pulumi.Input<string | enums.costmanagement.v20241001preview.CategoryType>;
    /**
     * eTag of the resource. To handle concurrent update scenario, this field will be used to determine whether the user is updating the latest version or not.
     */
     ...
     *  Supported for CategoryType(s): Cost, ReservationUtilization.
     */
    filter?: pulumi.Input<inputs.costmanagement.v20241001preview.BudgetFilterArgs>;
    /**
     * Dictionary of notifications associated with the budget.
     *
     *  Supported for CategoryType(s): Cost, ReservationUtilization.
    ...
    notifications?: pulumi.Input<{
        [key: string]: pulumi.Input<inputs.costmanagement.v20241001preview.NotificationArgs>;
    }>;
    /**
     ...
     *  Required for CategoryType(s): Cost, ReservationUtilization.
     */
    timeGrain: pulumi.Input<string | enums.costmanagement.v20241001preview.TimeGrainType>;
    /**
     * The time period that defines the active period of the budget. The budget will evaluate data on or after the startDate and will expire on the endDate.
     *
     *  Supported for CategoryType(s): Cost, ReservationUtilization.
     ...
     *  Required for CategoryType(s): Cost, ReservationUtilization.
     */
    timePeriod: pulumi.Input<inputs.costmanagement.v20241001preview.BudgetTimePeriodArgs>;
}
