...
export declare class WebAppSourceControlSlot extends pulumi.CustomResource {
     ...
     */
    readonly gitHubActionConfiguration: pulumi.Output<outputs.web.v20240401.GitHubActionConfigurationResponse | undefined>;
    /**
...
export interface WebAppSourceControlSlotArgs {
     ...
     * If GitHub Action is selected, than the associated configuration.
     */
    gitHubActionConfiguration?: pulumi.Input<inputs.web.v20240401.GitHubActionConfigurationArgs>;
    /**
     * <code>true</code> if this is deployed via GitHub action.
     */
