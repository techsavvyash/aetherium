...
export declare class WebAppSourceControl extends pulumi.CustomResource {
     ...
     */
    readonly gitHubActionConfiguration: pulumi.Output<outputs.web.v20230101.GitHubActionConfigurationResponse | undefined>;
    /**
...
export interface WebAppSourceControlArgs {
     ...
     * If GitHub Action is selected, than the associated configuration.
     */
    gitHubActionConfiguration?: pulumi.Input<inputs.web.v20230101.GitHubActionConfigurationArgs>;
    /**
     * <code>true</code> if this is deployed via GitHub action.
     */
