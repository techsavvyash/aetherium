...
export declare class VirtualHubBgpConnection extends pulumi.CustomResource {
     ...
     */
    readonly hubVirtualNetworkConnection: pulumi.Output<outputs.network.v20240101.SubResourceResponse | undefined>;
    /**
...
export interface VirtualHubBgpConnectionArgs {
     ...
     * The reference to the HubVirtualNetworkConnection resource.
     */
    hubVirtualNetworkConnection?: pulumi.Input<inputs.network.v20240101.SubResourceArgs>;
    /**
     * Resource ID.
     */
