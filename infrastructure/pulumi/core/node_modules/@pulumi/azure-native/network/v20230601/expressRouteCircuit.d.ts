...
export declare class ExpressRouteCircuit extends pulumi.CustomResource {
     ...
     */
    readonly authorizations: pulumi.Output<outputs.network.v20230601.ExpressRouteCircuitAuthorizationResponse[] | undefined>;
    /**
     ...
     */
    readonly expressRoutePort: pulumi.Output<outputs.network.v20230601.SubResourceResponse | undefined>;
    /**
     ...
     */
    readonly peerings: pulumi.Output<outputs.network.v20230601.ExpressRouteCircuitPeeringResponse[] | undefined>;
    /**
     ...
     */
    readonly serviceProviderProperties: pulumi.Output<outputs.network.v20230601.ExpressRouteCircuitServiceProviderPropertiesResponse | undefined>;
    /**
     ...
     * The SKU.
     */
    readonly sku: pulumi.Output<outputs.network.v20230601.ExpressRouteCircuitSkuResponse | undefined>;
    /**
...
export interface ExpressRouteCircuitArgs {
     ...
     */
    authorizations?: pulumi.Input<pulumi.Input<inputs.network.v20230601.ExpressRouteCircuitAuthorizationArgs>[]>;
    /**
     * The bandwidth of the circuit when the circuit is provisioned on an ExpressRoutePort resource.
     */
     ...
     * The reference to the ExpressRoutePort resource when the circuit is provisioned on an ExpressRoutePort resource.
     */
    expressRoutePort?: pulumi.Input<inputs.network.v20230601.SubResourceArgs>;
    /**
     * The GatewayManager Etag.
     */
     ...
     * These are also available as standalone resources. Do not mix inline and standalone resource as they will conflict with each other, leading to resources deletion.
     */
    peerings?: pulumi.Input<pulumi.Input<inputs.network.v20230601.ExpressRouteCircuitPeeringArgs>[]>;
    /**
     ...
     * The ServiceProviderProperties.
     */
    serviceProviderProperties?: pulumi.Input<inputs.network.v20230601.ExpressRouteCircuitServiceProviderPropertiesArgs>;
    /**
     * The ServiceProviderProvisioningState state of the resource.
     */
    serviceProviderProvisioningState?: pulumi.Input<string | enums.network.v20230601.ServiceProviderProvisioningState>;
    /**
     * The SKU.
     */
    sku?: pulumi.Input<inputs.network.v20230601.ExpressRouteCircuitSkuArgs>;
    /**
     * Resource tags.
     */
    tags?: pulumi.Input<{
