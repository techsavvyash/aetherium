...
export interface GetUpdateRunResult {
     ...
     */
    readonly managedClusterUpdate: outputs.containerservice.v20231015.ManagedClusterUpdateResponse;
    /**
     ...
     */
    readonly status: outputs.containerservice.v20231015.UpdateRunStatusResponse;
    /**
     * The strategy defines the order in which the clusters will be updated.
     * If not set, all members will be updated sequentially. The UpdateRun status will show a single UpdateStage and a single UpdateGroup targeting all members.
     * The strategy of the UpdateRun can be modified until the run is started.
     */
    readonly strategy?: outputs.containerservice.v20231015.UpdateRunStrategyResponse;
    /**
     * Azure Resource Manager metadata containing createdBy and modifiedBy information.
     */
    readonly systemData: outputs.containerservice.v20231015.SystemDataResponse;
    /**
