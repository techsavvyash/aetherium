...
export declare class ScheduledAlertRule extends pulumi.CustomResource {
     ...
     */
    readonly alertDetailsOverride: pulumi.Output<outputs.securityinsights.v20231101.AlertDetailsOverrideResponse | undefined>;
    /**
     ...
     */
    readonly entityMappings: pulumi.Output<outputs.securityinsights.v20231101.EntityMappingResponse[] | undefined>;
    /**
     ...
     */
    readonly eventGroupingSettings: pulumi.Output<outputs.securityinsights.v20231101.EventGroupingSettingsResponse | undefined>;
    /**
     * The settings of the incidents that created from alerts triggered by this analytics rule
     */
    readonly incidentConfiguration: pulumi.Output<outputs.securityinsights.v20231101.IncidentConfigurationResponse | undefined>;
    /**
     ...
     */
    readonly systemData: pulumi.Output<outputs.securityinsights.v20231101.SystemDataResponse>;
    /**
...
export interface ScheduledAlertRuleArgs {
     ...
     * The alert details override settings
     */
    alertDetailsOverride?: pulumi.Input<inputs.securityinsights.v20231101.AlertDetailsOverrideArgs>;
    /**
     * The Name of the alert rule template used to create this rule.
     */
     ...
     * Array of the entity mappings of the alert rule
     */
    entityMappings?: pulumi.Input<pulumi.Input<inputs.securityinsights.v20231101.EntityMappingArgs>[]>;
    /**
     * The event grouping settings.
     */
    eventGroupingSettings?: pulumi.Input<inputs.securityinsights.v20231101.EventGroupingSettingsArgs>;
    /**
     * The settings of the incidents that created from alerts triggered by this analytics rule
     */
    incidentConfiguration?: pulumi.Input<inputs.securityinsights.v20231101.IncidentConfigurationArgs>;
    /**
     * The kind of the alert rule
     * Expected value is 'Scheduled'.
     */
     ...
     * The severity for alerts created by this alert rule.
     */
    severity: pulumi.Input<string | enums.securityinsights.v20231101.AlertSeverity>;
    /**
     * The suppression (in ISO 8601 duration format) to wait since last time this alert rule been triggered.
     */
     ...
     * The tactics of the alert rule
     */
    tactics?: pulumi.Input<pulumi.Input<string | enums.securityinsights.v20231101.AttackTactic>[]>;
    /**
     * The techniques of the alert rule
     */
     ...
     * The operation against the threshold that triggers alert rule.
     */
    triggerOperator: pulumi.Input<enums.securityinsights.v20231101.TriggerOperator>;
    /**
     * The threshold triggers this alert rule.
     */
