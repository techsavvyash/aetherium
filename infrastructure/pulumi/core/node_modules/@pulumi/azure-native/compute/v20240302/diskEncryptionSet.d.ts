...
export declare class DiskEncryptionSet extends pulumi.CustomResource {
     ...
     */
    readonly activeKey: pulumi.Output<outputs.compute.v20240302.KeyForDiskEncryptionSetResponse | undefined>;
    /**
     * The error that was encountered during auto-key rotation. If an error is present, then auto-key rotation will not be attempted until the error on this disk encryption set is fixed.
     */
    readonly autoKeyRotationError: pulumi.Output<outputs.compute.v20240302.ApiErrorResponse>;
    /**
     ...
     */
    readonly identity: pulumi.Output<outputs.compute.v20240302.EncryptionSetIdentityResponse | undefined>;
    /**
     ...
     */
    readonly previousKeys: pulumi.Output<outputs.compute.v20240302.KeyForDiskEncryptionSetResponse[]>;
    /**
...
export interface DiskEncryptionSetArgs {
     ...
     * The key vault key which is currently used by this disk encryption set.
     */
    activeKey?: pulumi.Input<inputs.compute.v20240302.KeyForDiskEncryptionSetArgs>;
    /**
     ...
     * The type of key used to encrypt the data of the disk.
     */
    encryptionType?: pulumi.Input<string | enums.compute.v20240302.DiskEncryptionSetType>;
    /**
     * Multi-tenant application client id to access key vault in a different tenant. Setting the value to 'None' will clear the property.
     */
     ...
     * The managed identity for the disk encryption set. It should be given permission on the key vault before it can be used to encrypt disks.
     */
    identity?: pulumi.Input<inputs.compute.v20240302.EncryptionSetIdentityArgs>;
    /**
     * Resource location
     */
