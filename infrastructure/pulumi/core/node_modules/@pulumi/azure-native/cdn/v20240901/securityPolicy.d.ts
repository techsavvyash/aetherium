...
export declare class SecurityPolicy extends pulumi.CustomResource {
     ...
     */
    readonly parameters: pulumi.Output<outputs.cdn.v20240901.SecurityPolicyWebApplicationFirewallParametersResponse | undefined>;
    /**
...
export interface SecurityPolicyArgs {
     ...
     * object which contains security policy parameters
     */
    parameters?: pulumi.Input<inputs.cdn.v20240901.SecurityPolicyWebApplicationFirewallParametersArgs>;
    /**
