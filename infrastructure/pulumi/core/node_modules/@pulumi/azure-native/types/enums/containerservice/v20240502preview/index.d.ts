export declare const AddonAutoscaling: {
    /**
...
export declare const AutoUpgradeNodeImageSelectionType: {
    /**
...
export declare const ClusterServiceLoadBalancerHealthProbeMode: {
    /**
     * Each External Traffic Policy Cluster service will have its own health probe targeting service nodePort.
     */
    readonly ServiceNodePort: "ServiceNodePort";
    /**
...
export declare const ManagedClusterUpgradeType: {
     ...
     */
    readonly NodeImageOnly: "NodeImageOnly";
    /**
     ...
     */
    readonly ControlPlaneOnly: "ControlPlaneOnly";
};
/**
...
export declare const NodeImageSelectionType: {
    /**
     * Use the latest image version when upgrading nodes. Clusters may use different image versions (e.g., 'AKSUbuntu-1804gen2containerd-2021.10.12' and 'AKSUbuntu-1804gen2containerd-2021.10.19') because, for example, the latest available version is different in different regions.
     */
    readonly Latest: "Latest";
...
export declare const NodeProvisioningMode: {
    /**
...
export declare const OSSKU: {
     ...
     */
    readonly WindowsAnnual: "WindowsAnnual";
};
/**
...
export declare const PodIPAllocationMode: {
    /**
     ...
     */
    readonly DynamicIndividual: "DynamicIndividual";
    /**
...
export declare const PodLinkLocalAccess: {
    /**
 ...
 */
export type PodLinkLocalAccess = (typeof PodLinkLocalAccess)[keyof typeof PodLinkLocalAccess];
...
export declare const UndrainableNodeBehavior: {
    /**
