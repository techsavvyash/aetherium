...
export declare class ScheduledAlertRule extends pulumi.CustomResource {
     ...
     */
    readonly alertDetailsOverride: pulumi.Output<outputs.securityinsights.v20230601preview.AlertDetailsOverrideResponse | undefined>;
    /**
     ...
     */
    readonly entityMappings: pulumi.Output<outputs.securityinsights.v20230601preview.EntityMappingResponse[] | undefined>;
    /**
     ...
     */
    readonly eventGroupingSettings: pulumi.Output<outputs.securityinsights.v20230601preview.EventGroupingSettingsResponse | undefined>;
    /**
     * The settings of the incidents that created from alerts triggered by this analytics rule
     */
    readonly incidentConfiguration: pulumi.Output<outputs.securityinsights.v20230601preview.IncidentConfigurationResponse | undefined>;
    /**
     ...
     */
    readonly sentinelEntitiesMappings: pulumi.Output<outputs.securityinsights.v20230601preview.SentinelEntityMappingResponse[] | undefined>;
    /**
...
export interface ScheduledAlertRuleArgs {
     ...
     * The alert details override settings
     */
    alertDetailsOverride?: pulumi.Input<inputs.securityinsights.v20230601preview.AlertDetailsOverrideArgs>;
    /**
     * The Name of the alert rule template used to create this rule.
     */
     ...
     * Array of the entity mappings of the alert rule
     */
    entityMappings?: pulumi.Input<pulumi.Input<inputs.securityinsights.v20230601preview.EntityMappingArgs>[]>;
    /**
     * The event grouping settings.
     */
    eventGroupingSettings?: pulumi.Input<inputs.securityinsights.v20230601preview.EventGroupingSettingsArgs>;
    /**
     * The settings of the incidents that created from alerts triggered by this analytics rule
     */
    incidentConfiguration?: pulumi.Input<inputs.securityinsights.v20230601preview.IncidentConfigurationArgs>;
    /**
     * The kind of the alert rule
     * Expected value is 'Scheduled'.
     */
     ...
     * Array of the sentinel entity mappings of the alert rule
     */
    sentinelEntitiesMappings?: pulumi.Input<pulumi.Input<inputs.securityinsights.v20230601preview.SentinelEntityMappingArgs>[]>;
    /**
     * The severity for alerts created by this alert rule.
     */
    severity: pulumi.Input<string | enums.securityinsights.v20230601preview.AlertSeverity>;
    /**
     * The suppression (in ISO 8601 duration format) to wait since last time this alert rule been triggered.
     */
     ...
     * The operation against the threshold that triggers alert rule.
     */
    triggerOperator: pulumi.Input<enums.securityinsights.v20230601preview.TriggerOperator>;
    /**
     * The threshold triggers this alert rule.
     */
