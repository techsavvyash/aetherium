...
export declare class ProjectEnvironmentType extends pulumi.CustomResource {
     ...
     */
    readonly creatorRoleAssignment: pulumi.Output<outputs.devcenter.v20230801preview.ProjectEnvironmentTypeUpdatePropertiesResponseCreatorRoleAssignment | undefined>;
    /**
     ...
     */
    readonly identity: pulumi.Output<outputs.devcenter.v20230801preview.ManagedServiceIdentityResponse | undefined>;
    /**
     ...
     */
    readonly systemData: pulumi.Output<outputs.devcenter.v20230801preview.SystemDataResponse>;
    /**
     * Resource tags.
     */
    ...
    readonly userRoleAssignments: pulumi.Output<{
        [key: string]: outputs.devcenter.v20230801preview.UserRoleAssignmentResponse;
    } | undefined>;
    /**
...
export interface ProjectEnvironmentTypeArgs {
     ...
     * The role definition assigned to the environment creator on backing resources.
     */
    creatorRoleAssignment?: pulumi.Input<inputs.devcenter.v20230801preview.ProjectEnvironmentTypeUpdatePropertiesCreatorRoleAssignmentArgs>;
    /**
     * Id of a subscription that the environment type will be mapped to. The environment's resources will be deployed into this subscription.
     */
     ...
     * Managed identity properties
     */
    identity?: pulumi.Input<inputs.devcenter.v20230801preview.ManagedServiceIdentityArgs>;
    /**
     * The geo-location for the environment type
     */
     ...
     * Defines whether this Environment Type can be used in this Project.
     */
    status?: pulumi.Input<string | enums.devcenter.v20230801preview.EnvironmentTypeEnableStatus>;
    /**
     * Resource tags.
     */
    tags?: pulumi.Input<{
    ...
    userRoleAssignments?: pulumi.Input<{
        [key: string]: pulumi.Input<inputs.devcenter.v20230801preview.UserRoleAssignmentArgs>;
    }>;
}
