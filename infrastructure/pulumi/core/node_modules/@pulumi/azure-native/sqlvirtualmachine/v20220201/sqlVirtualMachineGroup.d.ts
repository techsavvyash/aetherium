...
export declare class SqlVirtualMachineGroup extends pulumi.CustomResource {
     ...
     */
    readonly wsfcDomainProfile: pulumi.Output<outputs.sqlvirtualmachine.v20220201.WsfcDomainProfileResponse | undefined>;
    /**
...
export interface SqlVirtualMachineGroupArgs {
     ...
     * SQL image sku.
     */
    sqlImageSku?: pulumi.Input<string | enums.sqlvirtualmachine.v20220201.SqlVmGroupImageSku>;
    /**
     ...
     * Cluster Active Directory domain profile.
     */
    wsfcDomainProfile?: pulumi.Input<inputs.sqlvirtualmachine.v20220201.WsfcDomainProfileArgs>;
}
