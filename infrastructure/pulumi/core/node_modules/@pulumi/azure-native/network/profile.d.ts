...
export declare class Profile extends pulumi.CustomResource {
     ...
     */
    readonly dnsConfig: pulumi.Output<outputs.network.DnsConfigResponse | undefined>;
    /**
     * The list of endpoints in the Traffic Manager profile.
     */
    readonly endpoints: pulumi.Output<outputs.network.EndpointResponse[] | undefined>;
    /**
     ...
     */
    readonly monitorConfig: pulumi.Output<outputs.network.MonitorConfigResponse | undefined>;
    /**
...
export interface ProfileArgs {
     ...
     * The list of allowed endpoint record types.
     */
    allowedEndpointRecordTypes?: pulumi.Input<pulumi.Input<string | enums.network.AllowedEndpointRecordType>[]>;
    /**
     * The DNS settings of the Traffic Manager profile.
     */
    dnsConfig?: pulumi.Input<inputs.network.DnsConfigArgs>;
    /**
     * The list of endpoints in the Traffic Manager profile.
     * These are also available as standalone resources. Do not mix inline and standalone resource as they will conflict with each other, leading to resources deletion.
     */
    endpoints?: pulumi.Input<pulumi.Input<inputs.network.EndpointArgs>[]>;
    /**
     ...
     * The endpoint monitoring settings of the Traffic Manager profile.
     */
    monitorConfig?: pulumi.Input<inputs.network.MonitorConfigArgs>;
    /**
     * The name of the resource
     */
     ...
     * The traffic routing method of the Traffic Manager profile.
     */
    trafficRoutingMethod?: pulumi.Input<string | enums.network.TrafficRoutingMethod>;
    /**
     * Indicates whether Traffic View is 'Enabled' or 'Disabled' for the Traffic Manager profile. Null, indicates 'Disabled'. Enabling this feature will increase the cost of the Traffic Manage profile.
     */
    trafficViewEnrollmentStatus?: pulumi.Input<string | enums.network.TrafficViewEnrollmentStatus>;
    /**
     * The type of the resource. Ex- Microsoft.Network/trafficManagerProfiles.
     */
