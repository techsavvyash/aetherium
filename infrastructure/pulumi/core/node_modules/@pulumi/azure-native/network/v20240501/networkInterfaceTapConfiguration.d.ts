...
export declare class NetworkInterfaceTapConfiguration extends pulumi.CustomResource {
     ...
     */
    readonly virtualNetworkTap: pulumi.Output<outputs.network.v20240501.VirtualNetworkTapResponse | undefined>;
    /**
...
export interface NetworkInterfaceTapConfigurationArgs {
     ...
     * The reference to the Virtual Network Tap resource.
     */
    virtualNetworkTap?: pulumi.Input<inputs.network.v20240501.VirtualNetworkTapArgs>;
}
