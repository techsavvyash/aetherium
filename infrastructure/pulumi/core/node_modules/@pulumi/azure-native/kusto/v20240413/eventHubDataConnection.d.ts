...
export interface EventHubDataConnectionArgs {
     ...
     * The event hub messages compression type
     */
    compression?: pulumi.Input<string | enums.kusto.v20240413.Compression>;
    /**
     * The event hub consumer group.
     */
     ...
     * The data format of the message. Optionally the data format can be added to each message.
     */
    dataFormat?: pulumi.Input<string | enums.kusto.v20240413.EventHubDataFormat>;
    /**
     ...
     * Indication for database routing information from the data connection, by default only database routing information is allowed
     */
    databaseRouting?: pulumi.Input<string | enums.kusto.v20240413.DatabaseRouting>;
    /**
     * The resource ID of the event hub to be used to create a data connection.
     */
