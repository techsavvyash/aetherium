...
export interface GetDiskEncryptionSetResult {
     ...
     */
    readonly activeKey?: outputs.compute.v20231002.KeyForDiskEncryptionSetResponse;
    /**
     * The error that was encountered during auto-key rotation. If an error is present, then auto-key rotation will not be attempted until the error on this disk encryption set is fixed.
     */
    readonly autoKeyRotationError: outputs.compute.v20231002.ApiErrorResponse;
    /**
     ...
     */
    readonly identity?: outputs.compute.v20231002.EncryptionSetIdentityResponse;
    /**
     ...
     */
    readonly previousKeys: outputs.compute.v20231002.KeyForDiskEncryptionSetResponse[];
    /**
