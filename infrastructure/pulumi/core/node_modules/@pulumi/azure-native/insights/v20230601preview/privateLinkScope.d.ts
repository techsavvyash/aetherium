...
export declare class PrivateLinkScope extends pulumi.CustomResource {
     ...
     */
    readonly accessModeSettings: pulumi.Output<outputs.insights.v20230601preview.AccessModeSettingsResponse>;
    /**
     ...
     */
    readonly privateEndpointConnections: pulumi.Output<outputs.insights.v20230601preview.PrivateEndpointConnectionResponse[]>;
    /**
     ...
     * System data
     */
    readonly systemData: pulumi.Output<outputs.insights.v20230601preview.SystemDataResponse>;
    /**
     * Resource tags.
     */
...
export interface PrivateLinkScopeArgs {
     ...
     * Access mode settings
     */
    accessModeSettings: pulumi.Input<inputs.insights.v20230601preview.AccessModeSettingsArgs>;
    /**
     * The geo-location where the resource lives
     */
