...
export declare class RegistryEnvironmentVersion extends pulumi.CustomResource {
     ...
     */
    readonly environmentVersionProperties: pulumi.Output<outputs.machinelearningservices.v20240401.EnvironmentVersionResponse>;
    /**
...
export interface RegistryEnvironmentVersionArgs {
     ...
     * [Required] Additional attributes of the entity.
     */
    environmentVersionProperties: pulumi.Input<inputs.machinelearningservices.v20240401.EnvironmentVersionArgs>;
    /**
