...
export declare class AgentPool extends pulumi.CustomResource {
     ...
     */
    readonly artifactStreamingProfile: pulumi.Output<outputs.containerservice.v20231002preview.AgentPoolArtifactStreamingProfileResponse | undefined>;
    /**
     ...
     */
    readonly gpuProfile: pulumi.Output<outputs.containerservice.v20231002preview.AgentPoolGPUProfileResponse | undefined>;
    /**
     ...
     */
    readonly kubeletConfig: pulumi.Output<outputs.containerservice.v20231002preview.KubeletConfigResponse | undefined>;
    /**
     ...
     */
    readonly linuxOSConfig: pulumi.Output<outputs.containerservice.v20231002preview.LinuxOSConfigResponse | undefined>;
    /**
     ...
     */
    readonly networkProfile: pulumi.Output<outputs.containerservice.v20231002preview.AgentPoolNetworkProfileResponse | undefined>;
    /**
     ...
     */
    readonly powerState: pulumi.Output<outputs.containerservice.v20231002preview.PowerStateResponse | undefined>;
    /**
     ...
     */
    readonly securityProfile: pulumi.Output<outputs.containerservice.v20231002preview.AgentPoolSecurityProfileResponse | undefined>;
    /**
     ...
     */
    readonly upgradeSettings: pulumi.Output<outputs.containerservice.v20231002preview.AgentPoolUpgradeSettingsResponse | undefined>;
    /**
     * The status of nodes in a VirtualMachines agent pool.
     */
    readonly virtualMachineNodesStatus: pulumi.Output<outputs.containerservice.v20231002preview.VirtualMachineNodesResponse[] | undefined>;
    /**
     * Specifications on VirtualMachines agent pool.
     */
    readonly virtualMachinesProfile: pulumi.Output<outputs.containerservice.v20231002preview.VirtualMachinesProfileResponse | undefined>;
    /**
     ...
     */
    readonly windowsProfile: pulumi.Output<outputs.containerservice.v20231002preview.AgentPoolWindowsProfileResponse | undefined>;
    /**
...
export interface AgentPoolArgs {
     ...
     * Configuration for using artifact streaming on AKS.
     */
    artifactStreamingProfile?: pulumi.Input<inputs.containerservice.v20231002preview.AgentPoolArtifactStreamingProfileArgs>;
    /**
     * The list of Availability zones to use for nodes. This can only be specified if the AgentPoolType property is 'VirtualMachineScaleSets'.
     */
     ...
     * GPUInstanceProfile to be used to specify GPU MIG instance profile for supported GPU VM SKU.
     */
    gpuInstanceProfile?: pulumi.Input<string | enums.containerservice.v20231002preview.GPUInstanceProfile>;
    /**
     * The GPU settings of an agent pool.
     */
    gpuProfile?: pulumi.Input<inputs.containerservice.v20231002preview.AgentPoolGPUProfileArgs>;
    /**
     * This is of the form: /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/hostGroups/{hostGroupName}. For more information see [Azure dedicated hosts](https://docs.microsoft.com/azure/virtual-machines/dedicated-hosts).
     */
     ...
     * The Kubelet configuration on the agent pool nodes.
     */
    kubeletConfig?: pulumi.Input<inputs.containerservice.v20231002preview.KubeletConfigArgs>;
    /**
     * Determines the placement of emptyDir volumes, container runtime data root, and Kubelet ephemeral storage.
     */
    kubeletDiskType?: pulumi.Input<string | enums.containerservice.v20231002preview.KubeletDiskType>;
    /**
     * The OS configuration of Linux agent nodes.
     */
    linuxOSConfig?: pulumi.Input<inputs.containerservice.v20231002preview.LinuxOSConfigArgs>;
    /**
     * The maximum number of nodes for auto-scaling
     */
     ...
     * A cluster must have at least one 'System' Agent Pool at all times. For additional information on agent pool restrictions and best practices, see: https://docs.microsoft.com/azure/aks/use-system-pools
     */
    mode?: pulumi.Input<string | enums.containerservice.v20231002preview.AgentPoolMode>;
    /**
     * Network-related settings of an agent pool.
     */
    networkProfile?: pulumi.Input<inputs.containerservice.v20231002preview.AgentPoolNetworkProfileArgs>;
    /**
     * These taints will not be reconciled by AKS and can be removed with a kubectl call. This field can be modified after node pool is created, but nodes will not be recreated with new taints until another operation that requires recreation (e.g. node image upgrade) happens. These taints allow for required configuration to run before the node is ready to accept workloads, for example 'key1=value1:NoSchedule' that then can be removed with `kubectl taint nodes node1 key1=value1:NoSchedule-`
     */
     ...
     * The default is 'Ephemeral' if the VM supports it and has a cache disk larger than the requested OSDiskSizeGB. Otherwise, defaults to 'Managed'. May not be changed after creation. For more information see [Ephemeral OS](https://docs.microsoft.com/azure/aks/cluster-configuration#ephemeral-os).
     */
    osDiskType?: pulumi.Input<string | enums.containerservice.v20231002preview.OSDiskType>;
    /**
     * Specifies the OS SKU used by the agent pool. If not specified, the default is Ubuntu if OSType=Linux or Windows2019 if OSType=Windows. And the default Windows OSSKU will be changed to Windows2022 after Windows2019 is deprecated.
     */
    osSKU?: pulumi.Input<string | enums.containerservice.v20231002preview.OSSKU>;
    /**
     * The operating system type. The default is Linux.
     */
    osType?: pulumi.Input<string | enums.containerservice.v20231002preview.OSType>;
    /**
     * If omitted, pod IPs are statically assigned on the node subnet (see vnetSubnetID for more details). This is of the form: /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/virtualNetworks/{virtualNetworkName}/subnets/{subnetName}
     */
     ...
     * When an Agent Pool is first created it is initially Running. The Agent Pool can be stopped by setting this field to Stopped. A stopped Agent Pool stops all of its VMs and does not accrue billing charges. An Agent Pool can only be stopped if it is Running and provisioning state is Succeeded
     */
    powerState?: pulumi.Input<inputs.containerservice.v20231002preview.PowerStateArgs>;
    /**
     * The ID for Proximity Placement Group.
     */
     ...
     * This also effects the cluster autoscaler behavior. If not specified, it defaults to Delete.
     */
    scaleDownMode?: pulumi.Input<string | enums.containerservice.v20231002preview.ScaleDownMode>;
    /**
     * This cannot be specified unless the scaleSetPriority is 'Spot'. If not specified, the default is 'Delete'.
     */
    scaleSetEvictionPolicy?: pulumi.Input<string | enums.containerservice.v20231002preview.ScaleSetEvictionPolicy>;
    /**
     * The Virtual Machine Scale Set priority. If not specified, the default is 'Regular'.
     */
    scaleSetPriority?: pulumi.Input<string | enums.containerservice.v20231002preview.ScaleSetPriority>;
    /**
     * The security settings of an agent pool.
     */
    securityProfile?: pulumi.Input<inputs.containerservice.v20231002preview.AgentPoolSecurityProfileArgs>;
    /**
     * Possible values are any decimal value greater than zero or -1 which indicates the willingness to pay any on-demand price. For more details on spot pricing, see [spot VMs pricing](https://docs.microsoft.com/azure/virtual-machines/spot-vms#pricing)
     */
     ...
     */
    type?: pulumi.Input<string | enums.containerservice.v20231002preview.AgentPoolType>;
    /**
     * Settings for upgrading the agentpool
     */
    upgradeSettings?: pulumi.Input<inputs.containerservice.v20231002preview.AgentPoolUpgradeSettingsArgs>;
    /**
     * The status of nodes in a VirtualMachines agent pool.
     */
    virtualMachineNodesStatus?: pulumi.Input<pulumi.Input<inputs.containerservice.v20231002preview.VirtualMachineNodesArgs>[]>;
    /**
     * Specifications on VirtualMachines agent pool.
     */
    virtualMachinesProfile?: pulumi.Input<inputs.containerservice.v20231002preview.VirtualMachinesProfileArgs>;
    /**
     * VM size availability varies by region. If a node contains insufficient compute resources (memory, cpu, etc) pods might fail to run correctly. For more details on restricted VM sizes, see: https://docs.microsoft.com/azure/aks/quotas-skus-regions
     */
     ...
     * The Windows agent pool's specific profile.
     */
    windowsProfile?: pulumi.Input<inputs.containerservice.v20231002preview.AgentPoolWindowsProfileArgs>;
    /**
     * Determines the type of workload a node can run.
     */
    workloadRuntime?: pulumi.Input<string | enums.containerservice.v20231002preview.WorkloadRuntime>;
}
