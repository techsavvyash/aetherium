...
export declare class ConnectedCluster extends pulumi.CustomResource {
     ...
     */
    readonly aadProfile: pulumi.Output<outputs.kubernetes.v20231101preview.AadProfileResponse | undefined>;
    /**
     ...
     */
    readonly arcAgentProfile: pulumi.Output<outputs.kubernetes.v20231101preview.ArcAgentProfileResponse | undefined>;
    /**
     ...
     */
    readonly identity: pulumi.Output<outputs.kubernetes.v20231101preview.ConnectedClusterIdentityResponse>;
    /**
     ...
     */
    readonly systemData: pulumi.Output<outputs.kubernetes.v20231101preview.SystemDataResponse>;
    /**
     * Resource tags.
     */
...
export interface ConnectedClusterArgs {
     ...
     * AAD profile for the connected cluster.
     */
    aadProfile?: pulumi.Input<inputs.kubernetes.v20231101preview.AadProfileArgs>;
    /**
     * Base64 encoded public certificate used by the agent to do the initial handshake to the backend services in Azure.
     */
     ...
     * Arc agentry configuration for the provisioned cluster.
     */
    arcAgentProfile?: pulumi.Input<inputs.kubernetes.v20231101preview.ArcAgentProfileArgs>;
    /**
     * Indicates whether Azure Hybrid Benefit is opted in
     */
    azureHybridBenefit?: pulumi.Input<string | enums.kubernetes.v20231101preview.AzureHybridBenefit>;
    /**
     ...
     * The identity of the connected cluster.
     */
    identity: pulumi.Input<inputs.kubernetes.v20231101preview.ConnectedClusterIdentityArgs>;
    /**
     * The infrastructure on which the Kubernetes cluster represented by this connected cluster is running on.
     */
     ...
     * The kind of connected cluster.
     */
    kind?: pulumi.Input<string | enums.kubernetes.v20231101preview.ConnectedClusterKind>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * Property which describes the state of private link on a connected cluster resource.
     */
    privateLinkState?: pulumi.Input<string | enums.kubernetes.v20231101preview.PrivateLinkState>;
    /**
     * Provisioning state of the connected cluster resource.
     */
    provisioningState?: pulumi.Input<string | enums.kubernetes.v20231101preview.ProvisioningState>;
    /**
