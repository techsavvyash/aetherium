...
export declare class SavedSearch extends pulumi.CustomResource {
     ...
     */
    readonly tags: pulumi.Output<outputs.operationalinsights.v20230901.TagResponse[] | undefined>;
    /**
...
export interface SavedSearchArgs {
     ...
     * The tags attached to the saved search.
     */
    tags?: pulumi.Input<pulumi.Input<inputs.operationalinsights.v20230901.TagArgs>[]>;
    /**
     * The version number of the query language. The current version is 2 and is the default.
     */
