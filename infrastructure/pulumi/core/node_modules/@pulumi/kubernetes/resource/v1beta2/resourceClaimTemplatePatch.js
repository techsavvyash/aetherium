...
class ResourceClaimTemplatePatch extends pulumi.CustomResource {
    ...
    constructor(name, args, opts) {
        ...
        const aliasOpts = { aliases: [{ type: "kubernetes:resource.k8s.io/v1alpha1:ResourceClaimTemplatePatch" }, { type: "kubernetes:resource.k8s.io/v1alpha2:ResourceClaimTemplatePatch" }, { type: "kubernetes:resource.k8s.io/v1alpha3:ResourceClaimTemplatePatch" }, { type: "kubernetes:resource.k8s.io/v1beta1:ResourceClaimTemplatePatch" }] };
...
/** @internal */
ResourceClaimTemplatePatch.__pulumiType = 'kubernetes:resource.k8s.io/v1beta2:ResourceClaimTemplatePatch';
