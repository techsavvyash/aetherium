 ...
 * Gets a single custom entity store assignment by name for the provided subscription and resource group.
 */
export declare function getCustomEntityStoreAssignmentOutput(args: GetCustomEntityStoreAssignmentOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetCustomEntityStoreAssignmentResult>;
