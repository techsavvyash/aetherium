...
export declare class IntegrationRuntime extends pulumi.CustomResource {
     ...
     */
    readonly properties: pulumi.Output<outputs.datafactory.v20180601.ManagedIntegrationRuntimeResponse | outputs.datafactory.v20180601.SelfHostedIntegrationRuntimeResponse>;
    /**
     * The resource type.
     */
...
export interface IntegrationRuntimeArgs {
     ...
     * Integration runtime properties.
     */
    properties: pulumi.Input<inputs.datafactory.v20180601.ManagedIntegrationRuntimeArgs | inputs.datafactory.v20180601.SelfHostedIntegrationRuntimeArgs>;
    /**
