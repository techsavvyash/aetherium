...
export declare class Incident extends pulumi.CustomResource {
     ...
     */
    readonly additionalData: pulumi.Output<outputs.securityinsights.v20250101preview.IncidentAdditionalDataResponse>;
    /**
     ...
     */
    readonly labels: pulumi.Output<outputs.securityinsights.v20250101preview.IncidentLabelResponse[] | undefined>;
    /**
     ...
     */
    readonly owner: pulumi.Output<outputs.securityinsights.v20250101preview.IncidentOwnerInfoResponse | undefined>;
    /**
     ...
     */
    readonly teamInformation: pulumi.Output<outputs.securityinsights.v20250101preview.TeamInformationResponse | undefined>;
    /**
...
export interface IncidentArgs {
     ...
     * The reason the incident was closed
     */
    classification?: pulumi.Input<string | enums.securityinsights.v20250101preview.IncidentClassification>;
    /**
     * Describes the reason the incident was closed
     */
     ...
     * The classification reason the incident was closed with
     */
    classificationReason?: pulumi.Input<string | enums.securityinsights.v20250101preview.IncidentClassificationReason>;
    /**
     * The description of the incident
     */
     ...
     * List of labels relevant to this incident
     */
    labels?: pulumi.Input<pulumi.Input<inputs.securityinsights.v20250101preview.IncidentLabelArgs>[]>;
    /**
     * The time of the last activity in the incident
     */
     ...
     * Describes a user that the incident is assigned to
     */
    owner?: pulumi.Input<inputs.securityinsights.v20250101preview.IncidentOwnerInfoArgs>;
    /**
     ...
     * The severity of the incident
     */
    severity: pulumi.Input<string | enums.securityinsights.v20250101preview.IncidentSeverity>;
    /**
     * The status of the incident
     */
    status: pulumi.Input<string | enums.securityinsights.v20250101preview.IncidentStatus>;
    /**
     * The title of the incident
     */
