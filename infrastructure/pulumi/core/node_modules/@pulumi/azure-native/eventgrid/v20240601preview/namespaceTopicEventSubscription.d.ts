...
export declare class NamespaceTopicEventSubscription extends pulumi.CustomResource {
     ...
     */
    readonly deliveryConfiguration: pulumi.Output<outputs.eventgrid.v20240601preview.DeliveryConfigurationResponse | undefined>;
    /**
     ...
     */
    readonly filtersConfiguration: pulumi.Output<outputs.eventgrid.v20240601preview.FiltersConfigurationResponse | undefined>;
    /**
...
export interface NamespaceTopicEventSubscriptionArgs {
     ...
     * Information about the delivery configuration of the event subscription.
     */
    deliveryConfiguration?: pulumi.Input<inputs.eventgrid.v20240601preview.DeliveryConfigurationArgs>;
    /**
     * The event delivery schema for the event subscription.
     */
    eventDeliverySchema?: pulumi.Input<string | enums.eventgrid.v20240601preview.DeliverySchema>;
    /**
     ...
     * Information about the filter for the event subscription.
     */
    filtersConfiguration?: pulumi.Input<inputs.eventgrid.v20240601preview.FiltersConfigurationArgs>;
    /**
