...
export declare class StorageInsightConfig extends pulumi.CustomResource {
     ...
     */
    readonly status: pulumi.Output<outputs.operationalinsights.v20250201.StorageInsightStatusResponse>;
    /**
     * The storage account connection details
     */
    readonly storageAccount: pulumi.Output<outputs.operationalinsights.v20250201.StorageAccountResponse>;
    /**
...
export interface StorageInsightConfigArgs {
     ...
     * The storage account connection details
     */
    storageAccount: pulumi.Input<inputs.operationalinsights.v20250201.StorageAccountArgs>;
    /**
