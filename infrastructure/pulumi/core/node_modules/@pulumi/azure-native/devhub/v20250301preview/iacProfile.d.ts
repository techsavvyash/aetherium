...
export declare class IacProfile extends pulumi.CustomResource {
    ...
    readonly stages: pulumi.Output<outputs.devhub.v20250301preview.StagePropertiesResponse[] | undefined>;
    /**
     ...
     */
    readonly systemData: pulumi.Output<outputs.devhub.v20250301preview.SystemDataResponse>;
    /**
     * Resource tags.
     */
    ...
    readonly templates: pulumi.Output<outputs.devhub.v20250301preview.IacTemplatePropertiesResponse[] | undefined>;
    /**
...
export interface IacProfileArgs {
    ...
    stages?: pulumi.Input<pulumi.Input<inputs.devhub.v20250301preview.StagePropertiesArgs>[]>;
    /**
     * Terraform Storage Account Name
     */
    ...
    templates?: pulumi.Input<pulumi.Input<inputs.devhub.v20250301preview.IacTemplatePropertiesArgs>[]>;
}
