 ...
 * ```
 */
export declare function getFunctionIamPolicyOutput(args: GetFunctionIamPolicyOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetFunctionIamPolicyResult>;
/**
 * A collection of arguments for invoking getFunctionIamPolicy.
 */
