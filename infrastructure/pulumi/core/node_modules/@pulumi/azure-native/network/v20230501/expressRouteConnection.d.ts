...
export declare class ExpressRouteConnection extends pulumi.CustomResource {
     ...
     */
    readonly expressRouteCircuitPeering: pulumi.Output<outputs.network.v20230501.ExpressRouteCircuitPeeringIdResponse>;
    /**
...
export interface ExpressRouteConnectionArgs {
     ...
     * The ExpressRoute circuit peering.
     */
    expressRouteCircuitPeering: pulumi.Input<inputs.network.v20230501.ExpressRouteCircuitPeeringIdArgs>;
    /**
     * Enable FastPath to vWan Firewall hub.
     */
