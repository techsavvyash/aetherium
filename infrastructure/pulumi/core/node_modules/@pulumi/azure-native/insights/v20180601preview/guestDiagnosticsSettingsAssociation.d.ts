 ...
 */
export declare class GuestDiagnosticsSettingsAssociation extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): GuestDiagnosticsSettingsAssociation;
    /**
     ...
     */
    static isInstance(obj: any): obj is GuestDiagnosticsSettingsAssociation;
    /**
     * The guest diagnostic settings name.
     */
    readonly guestDiagnosticSettingsName: pulumi.Output<string>;
    /**
     * Resource location
     */
