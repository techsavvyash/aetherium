...
export declare class DnsSecurityRule extends pulumi.CustomResource {
     ...
     */
    readonly action: pulumi.Output<outputs.network.DnsSecurityRuleActionResponse>;
    /**
     * DNS resolver policy domains lists that the DNS security rule applies to.
     */
    readonly dnsResolverDomainLists: pulumi.Output<outputs.network.SubResourceResponse[]>;
    /**
