...
export declare class ProductWiki extends pulumi.CustomResource {
     ...
     */
    readonly documents: pulumi.Output<outputs.apimanagement.v20240601preview.WikiDocumentationContractResponse[] | undefined>;
    /**
...
export interface ProductWikiArgs {
     ...
     * Collection wiki documents included into this wiki.
     */
    documents?: pulumi.Input<pulumi.Input<inputs.apimanagement.v20240601preview.WikiDocumentationContractArgs>[]>;
    /**
