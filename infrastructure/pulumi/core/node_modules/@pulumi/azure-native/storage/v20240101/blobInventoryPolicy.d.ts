...
export declare class BlobInventoryPolicy extends pulumi.CustomResource {
     ...
     */
    readonly policy: pulumi.Output<outputs.storage.v20240101.BlobInventoryPolicySchemaResponse>;
    /**
...
export interface BlobInventoryPolicyArgs {
     ...
     * The storage account blob inventory policy object. It is composed of policy rules.
     */
    policy: pulumi.Input<inputs.storage.v20240101.BlobInventoryPolicySchemaArgs>;
    /**
