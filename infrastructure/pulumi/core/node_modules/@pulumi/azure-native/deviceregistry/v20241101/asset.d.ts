...
export declare class Asset extends pulumi.CustomResource {
     ...
     */
    readonly datasets: pulumi.Output<outputs.deviceregistry.v20241101.DatasetResponse[] | undefined>;
    /**
     ...
     */
    readonly defaultTopic: pulumi.Output<outputs.deviceregistry.v20241101.TopicResponse | undefined>;
    /**
     ...
     */
    readonly events: pulumi.Output<outputs.deviceregistry.v20241101.EventResponse[] | undefined>;
    /**
     * The extended location.
     */
    readonly extendedLocation: pulumi.Output<outputs.deviceregistry.v20241101.ExtendedLocationResponse>;
    /**
     ...
     */
    readonly status: pulumi.Output<outputs.deviceregistry.v20241101.AssetStatusResponse>;
    /**
     * Azure Resource Manager metadata containing createdBy and modifiedBy information.
     */
    readonly systemData: pulumi.Output<outputs.deviceregistry.v20241101.SystemDataResponse>;
    /**
     * Resource tags.
     */
...
export interface AssetArgs {
     ...
     * Array of datasets that are part of the asset. Each dataset describes the data points that make up the set.
     */
    datasets?: pulumi.Input<pulumi.Input<inputs.deviceregistry.v20241101.DatasetArgs>[]>;
    /**
     * Stringified JSON that contains connector-specific default configuration for all datasets. Each dataset can have its own configuration that overrides the default settings here.
     */
     ...
     * Object that describes the default topic information for the asset.
     */
    defaultTopic?: pulumi.Input<inputs.deviceregistry.v20241101.TopicArgs>;
    /**
     * Human-readable description of the asset.
     */
     ...
     * Array of events that are part of the asset. Each event can have per-event configuration.
     */
    events?: pulumi.Input<pulumi.Input<inputs.deviceregistry.v20241101.EventArgs>[]>;
    /**
     * The extended location.
     */
