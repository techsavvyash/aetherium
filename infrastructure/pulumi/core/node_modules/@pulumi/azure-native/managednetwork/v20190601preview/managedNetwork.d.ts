...
export declare class ManagedNetwork extends pulumi.CustomResource {
     ...
     */
    readonly connectivity: pulumi.Output<outputs.managednetwork.v20190601preview.ConnectivityCollectionResponse>;
    /**
     ...
     */
    readonly scope: pulumi.Output<outputs.managednetwork.v20190601preview.ScopeResponse | undefined>;
    /**
     * Resource tags
     */
...
export interface ManagedNetworkArgs {
     ...
     * The collection of management groups, subscriptions, virtual networks, and subnets by the Managed Network. This is a read-only property that is reflective of all ScopeAssignments for this Managed Network
     */
    scope?: pulumi.Input<inputs.managednetwork.v20190601preview.ScopeArgs>;
    /**
     * Resource tags
     */
    tags?: pulumi.Input<{
