...
export declare class TiTaxiiDataConnector extends pulumi.CustomResource {
     ...
     */
    readonly dataTypes: pulumi.Output<outputs.securityinsights.v20231001preview.TiTaxiiDataConnectorDataTypesResponse>;
    /**
...
export interface TiTaxiiDataConnectorArgs {
     ...
     * The available data types for Threat Intelligence TAXII data connector.
     */
    dataTypes: pulumi.Input<inputs.securityinsights.v20231001preview.TiTaxiiDataConnectorDataTypesArgs>;
    /**
     * The friendly name for the TAXII server.
     */
     ...
     * The polling frequency for the TAXII server.
     */
    pollingFrequency: pulumi.Input<string | enums.securityinsights.v20231001preview.PollingFrequency>;
    /**
