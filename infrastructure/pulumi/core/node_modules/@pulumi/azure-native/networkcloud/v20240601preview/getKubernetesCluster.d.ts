...
export interface GetKubernetesClusterResult {
     ...
     */
    readonly aadConfiguration?: outputs.networkcloud.v20240601preview.AadConfigurationResponse;
    /**
     ...
     */
    readonly administratorConfiguration?: outputs.networkcloud.v20240601preview.AdministratorConfigurationResponse;
    /**
     ...
     */
    readonly availableUpgrades: outputs.networkcloud.v20240601preview.AvailableUpgradeResponse[];
    /**
     ...
     */
    readonly controlPlaneNodeConfiguration: outputs.networkcloud.v20240601preview.ControlPlaneNodeConfigurationResponse;
    /**
     ...
     */
    readonly featureStatuses: outputs.networkcloud.v20240601preview.FeatureStatusResponse[];
    /**
     ...
     */
    readonly initialAgentPoolConfigurations: outputs.networkcloud.v20240601preview.InitialAgentPoolConfigurationResponse[];
    /**
     ...
     */
    readonly networkConfiguration: outputs.networkcloud.v20240601preview.NetworkConfigurationResponse;
    /**
     * The details of the nodes in this cluster.
     */
    readonly nodes: outputs.networkcloud.v20240601preview.KubernetesClusterNodeResponse[];
    /**
