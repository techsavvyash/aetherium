...
export interface GetAttachedDataNetworkResult {
     ...
     */
    readonly naptConfiguration?: outputs.mobilenetwork.v20240401.NaptConfigurationResponse;
    /**
     ...
     */
    readonly userPlaneDataInterface: outputs.mobilenetwork.v20240401.InterfacePropertiesResponse;
}
/**
 * Gets information about the specified attached data network.
 */
export declare function getAttachedDataNetworkOutput(args: GetAttachedDataNetworkOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAttachedDataNetworkResult>;
