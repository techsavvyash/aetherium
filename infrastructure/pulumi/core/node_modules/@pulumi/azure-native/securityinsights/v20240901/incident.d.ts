...
export declare class Incident extends pulumi.CustomResource {
     ...
     */
    readonly additionalData: pulumi.Output<outputs.securityinsights.v20240901.IncidentAdditionalDataResponse>;
    /**
     ...
     */
    readonly labels: pulumi.Output<outputs.securityinsights.v20240901.IncidentLabelResponse[] | undefined>;
    /**
     ...
     */
    readonly owner: pulumi.Output<outputs.securityinsights.v20240901.IncidentOwnerInfoResponse | undefined>;
    /**
...
export interface IncidentArgs {
     ...
     * The reason the incident was closed
     */
    classification?: pulumi.Input<string | enums.securityinsights.v20240901.IncidentClassification>;
    /**
     * Describes the reason the incident was closed
     */
     ...
     * The classification reason the incident was closed with
     */
    classificationReason?: pulumi.Input<string | enums.securityinsights.v20240901.IncidentClassificationReason>;
    /**
     * The description of the incident
     */
     ...
     * List of labels relevant to this incident
     */
    labels?: pulumi.Input<pulumi.Input<inputs.securityinsights.v20240901.IncidentLabelArgs>[]>;
    /**
     * The time of the last activity in the incident
     */
     ...
     * Describes a user that the incident is assigned to
     */
    owner?: pulumi.Input<inputs.securityinsights.v20240901.IncidentOwnerInfoArgs>;
    /**
     ...
     * The severity of the incident
     */
    severity: pulumi.Input<string | enums.securityinsights.v20240901.IncidentSeverity>;
    /**
     * The status of the incident
     */
    status: pulumi.Input<string | enums.securityinsights.v20240901.IncidentStatus>;
    /**
     * The title of the incident
     */
