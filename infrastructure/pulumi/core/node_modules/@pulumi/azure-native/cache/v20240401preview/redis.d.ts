...
export declare class Redis extends pulumi.CustomResource {
     ...
     */
    readonly accessKeys: pulumi.Output<outputs.cache.v20240401preview.RedisAccessKeysResponse>;
    /**
     ...
     */
    readonly identity: pulumi.Output<outputs.cache.v20240401preview.ManagedServiceIdentityResponse | undefined>;
    /**
     * List of the Redis instances associated with the cache
     */
    readonly instances: pulumi.Output<outputs.cache.v20240401preview.RedisInstanceDetailsResponse[]>;
    /**
     * List of the linked servers associated with the cache
     */
    readonly linkedServers: pulumi.Output<outputs.cache.v20240401preview.RedisLinkedServerResponse[]>;
    /**
     ...
     */
    readonly privateEndpointConnections: pulumi.Output<outputs.cache.v20240401preview.PrivateEndpointConnectionResponse[]>;
    /**
     ...
     */
    readonly redisConfiguration: pulumi.Output<outputs.cache.v20240401preview.RedisCommonPropertiesResponseRedisConfiguration | undefined>;
    /**
     ...
     */
    readonly sku: pulumi.Output<outputs.cache.v20240401preview.SkuResponse>;
    /**
     * Redis SSL port.
     */
...
export interface RedisArgs {
     ...
     * The identity of the resource.
     */
    identity?: pulumi.Input<inputs.cache.v20240401preview.ManagedServiceIdentityArgs>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * Optional: requires clients to use a specified TLS version (or higher) to connect (e,g, '1.0', '1.1', '1.2')
     */
    minimumTlsVersion?: pulumi.Input<string | enums.cache.v20240401preview.TlsVersion>;
    /**
     ...
     * Whether or not public endpoint access is allowed for this cache.  Value is optional but if passed in, must be 'Enabled' or 'Disabled'. If 'Disabled', private endpoints are the exclusive access method. Default value is 'Enabled'
     */
    publicNetworkAccess?: pulumi.Input<string | enums.cache.v20240401preview.PublicNetworkAccess>;
    /**
     * All Redis Settings. Few possible keys: rdb-backup-enabled,rdb-storage-connection-string,rdb-backup-frequency,maxmemory-delta, maxmemory-policy,notify-keyspace-events, aof-backup-enabled, aof-storage-connection-string-0, aof-storage-connection-string-1 etc.
     */
    redisConfiguration?: pulumi.Input<inputs.cache.v20240401preview.RedisCommonPropertiesRedisConfigurationArgs>;
    /**
     * Redis version. This should be in the form 'major[.minor]' (only 'major' is required) or the value 'latest' which refers to the latest stable Redis version that is available. Supported versions: 4.0, 6.0 (latest). Default value is 'latest'.
     */
     ...
     * The SKU of the Redis cache to deploy.
     */
    sku: pulumi.Input<inputs.cache.v20240401preview.SkuArgs>;
    /**
     * Static IP address. Optionally, may be specified when deploying a Redis cache inside an existing Azure Virtual Network; auto assigned by default.
     */
     ...
     * Optional: Specifies the update channel for the monthly Redis updates your Redis Cache will receive. Caches using 'Preview' update channel get latest Redis updates at least 4 weeks ahead of 'Stable' channel caches. Default value is 'Stable'.
     */
    updateChannel?: pulumi.Input<string | enums.cache.v20240401preview.UpdateChannel>;
    /**
     * Optional: Specifies how availability zones are allocated to the Redis cache. 'Automatic' enables zone redundancy and Azure will select zones based on regional availability and capacity. 'UserDefined' will select availability zones passed in by you using the 'zones' parameter. 'NoZones' will produce a non-zonal cache. If 'zonalAllocation' is not passed, it will be set to 'UserDefined' when zones are passed in, otherwise, will be set to 'NoZones'
     */
    zonalAllocationPolicy?: pulumi.Input<string | enums.cache.v20240401preview.ZonalAllocationPolicy>;
    /**
     * A list of availability zones denoting where the resource needs to come from.
     */
