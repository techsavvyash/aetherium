 ...
 * Get regional availability information for each size category configured under a lab account
 */
export declare function getLabAccountRegionalAvailabilityOutput(args: GetLabAccountRegionalAvailabilityOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetLabAccountRegionalAvailabilityResult>;
