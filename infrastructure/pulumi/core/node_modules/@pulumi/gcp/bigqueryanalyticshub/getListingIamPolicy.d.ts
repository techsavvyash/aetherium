 ...
 * ```
 */
export declare function getListingIamPolicyOutput(args: GetListingIamPolicyOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetListingIamPolicyResult>;
/**
 * A collection of arguments for invoking getListingIamPolicy.
 */
