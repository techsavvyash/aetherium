...
export declare class VpnGateway extends pulumi.CustomResource {
     ...
     */
    readonly connections: pulumi.Output<outputs.network.v20230401.VpnConnectionResponse[] | undefined>;
    /**
     ...
     */
    readonly ipConfigurations: pulumi.Output<outputs.network.v20230401.VpnGatewayIpConfigurationResponse[]>;
    /**
     ...
     */
    readonly natRules: pulumi.Output<outputs.network.v20230401.VpnGatewayNatRuleResponse[] | undefined>;
    /**
...
export interface VpnGatewayArgs {
     ...
     */
    connections?: pulumi.Input<pulumi.Input<inputs.network.v20230401.VpnConnectionArgs>[]>;
    /**
     * Enable BGP routes translation for NAT on this VpnGateway.
     */
     ...
     * These are also available as standalone resources. Do not mix inline and standalone resource as they will conflict with each other, leading to resources deletion.
     */
    natRules?: pulumi.Input<pulumi.Input<inputs.network.v20230401.VpnGatewayNatRuleArgs>[]>;
    /**
