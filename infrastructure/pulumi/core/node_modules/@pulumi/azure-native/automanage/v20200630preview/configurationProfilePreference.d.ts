 ...
 */
export declare class ConfigurationProfilePreference extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ConfigurationProfilePreference;
    /**
     ...
     */
    static isInstance(obj: any): obj is ConfigurationProfilePreference;
    /**
     ...
     */
    readonly properties: pulumi.Output<outputs.automanage.v20200630preview.ConfigurationProfilePreferencePropertiesResponse>;
    /**
     * Resource tags.
     */
...
export interface ConfigurationProfilePreferenceArgs {
     ...
     * Properties of the configuration profile preference.
     */
    properties?: pulumi.Input<inputs.automanage.v20200630preview.ConfigurationProfilePreferencePropertiesArgs>;
    /**
