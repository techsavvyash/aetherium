...
export declare class WebService extends pulumi.CustomResource {
     ...
     */
    readonly properties: pulumi.Output<outputs.machinelearning.WebServicePropertiesForGraphResponse>;
    /**
...
export interface WebServiceArgs {
     ...
     * Contains the property payload that describes the web service.
     */
    properties: pulumi.Input<inputs.machinelearning.WebServicePropertiesForGraphArgs>;
    /**
