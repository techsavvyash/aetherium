...
export declare class RoleManagementPolicy extends pulumi.CustomResource {
     ...
     */
    readonly lastModifiedBy: pulumi.Output<outputs.authorization.v20201001preview.PrincipalResponse>;
    /**
     ...
     */
    readonly policyProperties: pulumi.Output<outputs.authorization.v20201001preview.PolicyPropertiesResponse>;
    /**
