...
export declare class PolicyExemption extends pulumi.CustomResource {
     ...
     */
    readonly resourceSelectors: pulumi.Output<outputs.authorization.v20241201preview.ResourceSelectorResponse[] | undefined>;
    /**
     * Azure Resource Manager metadata containing createdBy and modifiedBy information.
     */
    readonly systemData: pulumi.Output<outputs.authorization.v20241201preview.SystemDataResponse>;
    /**
...
export interface PolicyExemptionArgs {
     ...
     * The option whether validate the exemption is at or under the assignment scope.
     */
    assignmentScopeValidation?: pulumi.Input<string | enums.authorization.v20241201preview.AssignmentScopeValidation>;
    /**
     * The description of the policy exemption.
     */
     ...
     * The policy exemption category. Possible values are Waiver and Mitigated.
     */
    exemptionCategory: pulumi.Input<string | enums.authorization.v20241201preview.ExemptionCategory>;
    /**
     * The expiration date and time (in UTC ISO 8601 format yyyy-MM-ddTHH:mm:ssZ) of the policy exemption.
     */
     ...
     * The resource selector list to filter policies by resource properties.
     */
    resourceSelectors?: pulumi.Input<pulumi.Input<inputs.authorization.v20241201preview.ResourceSelectorArgs>[]>;
    /**
