...
export declare const ContentSafetyLevel: {
 ...
 */
export type ContentSafetyLevel = (typeof ContentSafetyLevel)[keyof typeof ContentSafetyLevel];
...
export declare const DataGenerationTaskType: {
    /**
 ...
 */
export type DataGenerationTaskType = (typeof DataGenerationTaskType)[keyof typeof DataGenerationTaskType];
export declare const DataGenerationType: {
    /**
     * Label Generation by Teacher Model Inferencing
     */
    readonly LabelGeneration: "LabelGeneration";
    /**
 ...
 */
export type DataGenerationType = (typeof DataGenerationType)[keyof typeof DataGenerationType];
...
export declare const DefaultActionType: {
    readonly Deny: "Deny";
...
export declare const VulnerabilityRisk: {
 ...
 */
export type VulnerabilityRisk = (typeof VulnerabilityRisk)[keyof typeof VulnerabilityRisk];
