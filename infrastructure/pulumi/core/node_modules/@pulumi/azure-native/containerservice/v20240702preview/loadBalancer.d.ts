...
export declare class LoadBalancer extends pulumi.CustomResource {
     ...
     */
    readonly nodeSelector: pulumi.Output<outputs.containerservice.v20240702preview.LabelSelectorResponse | undefined>;
    /**
     ...
     */
    readonly serviceLabelSelector: pulumi.Output<outputs.containerservice.v20240702preview.LabelSelectorResponse | undefined>;
    /**
     * Services created in namespaces that match the selector can be placed on this load balancer.
     */
    readonly serviceNamespaceSelector: pulumi.Output<outputs.containerservice.v20240702preview.LabelSelectorResponse | undefined>;
    /**
...
export interface LoadBalancerArgs {
     ...
     * Nodes that match this selector will be possible members of this load balancer.
     */
    nodeSelector?: pulumi.Input<inputs.containerservice.v20240702preview.LabelSelectorArgs>;
    /**
     * Required field. A string value that must specify the ID of an existing agent pool. All nodes in the given pool will always be added to this load balancer. This agent pool must have at least one node and minCount>=1 for autoscaling operations. An agent pool can only be the primary pool for a single load balancer.
     */
     ...
     * Only services that must match this selector can be placed on this load balancer.
     */
    serviceLabelSelector?: pulumi.Input<inputs.containerservice.v20240702preview.LabelSelectorArgs>;
    /**
     * Services created in namespaces that match the selector can be placed on this load balancer.
     */
    serviceNamespaceSelector?: pulumi.Input<inputs.containerservice.v20240702preview.LabelSelectorArgs>;
}
