...
export declare class NodeType extends pulumi.CustomResource {
     ...
     */
    readonly additionalDataDisks: pulumi.Output<outputs.servicefabric.v20230701preview.VmssDataDiskResponse[] | undefined>;
    /**
     * The range of ports from which cluster assigned port to Service Fabric applications.
     */
    readonly applicationPorts: pulumi.Output<outputs.servicefabric.v20230701preview.EndpointRangeDescriptionResponse | undefined>;
    /**
     ...
     */
    readonly ephemeralPorts: pulumi.Output<outputs.servicefabric.v20230701preview.EndpointRangeDescriptionResponse | undefined>;
    /**
     ...
     */
    readonly frontendConfigurations: pulumi.Output<outputs.servicefabric.v20230701preview.FrontendConfigurationResponse[] | undefined>;
    /**
     ...
     * The node type sku.
     */
    readonly sku: pulumi.Output<outputs.servicefabric.v20230701preview.NodeTypeSkuResponse | undefined>;
    /**
     ...
     */
    readonly vmExtensions: pulumi.Output<outputs.servicefabric.v20230701preview.VMSSExtensionResponse[] | undefined>;
    /**
     ...
     */
    readonly vmImagePlan: pulumi.Output<outputs.servicefabric.v20230701preview.VmImagePlanResponse | undefined>;
    /**
     ...
     */
    readonly vmManagedIdentity: pulumi.Output<outputs.servicefabric.v20230701preview.VmManagedIdentityResponse | undefined>;
    /**
     * The secrets to install in the virtual machines.
     */
    readonly vmSecrets: pulumi.Output<outputs.servicefabric.v20230701preview.VaultSecretGroupResponse[] | undefined>;
    /**
...
export interface NodeTypeArgs {
     ...
     * Additional managed data disks.
     */
    additionalDataDisks?: pulumi.Input<pulumi.Input<inputs.servicefabric.v20230701preview.VmssDataDiskArgs>[]>;
    /**
     * The range of ports from which cluster assigned port to Service Fabric applications.
     */
    applicationPorts?: pulumi.Input<inputs.servicefabric.v20230701preview.EndpointRangeDescriptionArgs>;
    /**
     * The capacity tags applied to the nodes in the node type, the cluster resource manager uses these tags to understand how much resource a node has.
     */
     ...
     * Managed data disk type. Specifies the storage account type for the managed disk
     */
    dataDiskType?: pulumi.Input<string | enums.servicefabric.v20230701preview.DiskType>;
    /**
     * Specifies the resource id of the DSCP configuration to apply to the node type network interface.
     */
     ...
     * The range of ephemeral ports that nodes in this node type should be configured with.
     */
    ephemeralPorts?: pulumi.Input<inputs.servicefabric.v20230701preview.EndpointRangeDescriptionArgs>;
    /**
     * Specifies the eviction policy for virtual machines in a SPOT node type. Default is Delete.
     */
    evictionPolicy?: pulumi.Input<string | enums.servicefabric.v20230701preview.EvictionPolicyType>;
    /**
     * Indicates the node type uses its own frontend configurations instead of the default one for the cluster. This setting can only be specified for non-primary node types and can not be added or removed after the node type is created.
     */
    frontendConfigurations?: pulumi.Input<pulumi.Input<inputs.servicefabric.v20230701preview.FrontendConfigurationArgs>[]>;
    /**
     * Specifies the full host group resource Id. This property is used for deploying on azure dedicated hosts.
     */
     ...
     * Specifies the security type of the nodeType. Only TrustedLaunch is currently supported
     */
    securityType?: pulumi.Input<string | enums.servicefabric.v20230701preview.SecurityType>;
    /**
     * Specifies the service artifact reference id used to set same image version for all virtual machines in the scale set when using 'latest' image version.
     */
     ...
     * The node type sku.
     */
    sku?: pulumi.Input<inputs.servicefabric.v20230701preview.NodeTypeSkuArgs>;
    /**
     * Indicates the time duration after which the platform will not try to restore the VMSS SPOT instances specified as ISO 8601.
     */
     ...
     * Set of extensions that should be installed onto the virtual machines.
     */
    vmExtensions?: pulumi.Input<pulumi.Input<inputs.servicefabric.v20230701preview.VMSSExtensionArgs>[]>;
    /**
     * The offer type of the Azure Virtual Machines Marketplace image. For example, UbuntuServer or WindowsServer.
     */
     ...
     * Specifies information about the marketplace image used to create the virtual machine. This element is only used for marketplace images. Before you can use a marketplace image from an API, you must enable the image for programmatic use. In the Azure portal, find the marketplace image that you want to use and then click Want to deploy programmatically, Get Started ->. Enter any required information and then click Save.
     */
    vmImagePlan?: pulumi.Input<inputs.servicefabric.v20230701preview.VmImagePlanArgs>;
    /**
     * The publisher of the Azure Virtual Machines Marketplace image. For example, Canonical or MicrosoftWindowsServer.
     */
     ...
     * Identities to assign to the virtual machine scale set under the node type.
     */
    vmManagedIdentity?: pulumi.Input<inputs.servicefabric.v20230701preview.VmManagedIdentityArgs>;
    /**
     * The secrets to install in the virtual machines.
     */
    vmSecrets?: pulumi.Input<pulumi.Input<inputs.servicefabric.v20230701preview.VaultSecretGroupArgs>[]>;
    /**
     * Specifies the actions to be performed on the vms before bootstrapping the service fabric runtime.
     */
    vmSetupActions?: pulumi.Input<pulumi.Input<string | enums.servicefabric.v20230701preview.VmSetupAction>[]>;
    /**
     * Indicates the resource id of the vm shared galleries image. This parameter is used for custom vm image.
     */
