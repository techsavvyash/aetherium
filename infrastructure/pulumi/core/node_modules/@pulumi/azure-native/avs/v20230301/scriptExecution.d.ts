...
export declare class ScriptExecution extends pulumi.CustomResource {
     ...
     */
    readonly hiddenParameters: pulumi.Output<(outputs.avs.v20230301.PSCredentialExecutionParameterResponse | outputs.avs.v20230301.ScriptSecureStringExecutionParameterResponse | outputs.avs.v20230301.ScriptStringExecutionParameterResponse)[] | undefined>;
    /**
     ...
     */
    readonly parameters: pulumi.Output<(outputs.avs.v20230301.PSCredentialExecutionParameterResponse | outputs.avs.v20230301.ScriptSecureStringExecutionParameterResponse | outputs.avs.v20230301.ScriptStringExecutionParameterResponse)[] | undefined>;
    /**
...
export interface ScriptExecutionArgs {
     ...
     * Parameters that will be hidden/not visible to ARM, such as passwords and credentials
     */
    hiddenParameters?: pulumi.Input<pulumi.Input<inputs.avs.v20230301.PSCredentialExecutionParameterArgs | inputs.avs.v20230301.ScriptSecureStringExecutionParameterArgs | inputs.avs.v20230301.ScriptStringExecutionParameterArgs>[]>;
    /**
     * User-defined dictionary.
     */
     ...
     * Parameters the script will accept
     */
    parameters?: pulumi.Input<pulumi.Input<inputs.avs.v20230301.PSCredentialExecutionParameterArgs | inputs.avs.v20230301.ScriptSecureStringExecutionParameterArgs | inputs.avs.v20230301.ScriptStringExecutionParameterArgs>[]>;
    /**
