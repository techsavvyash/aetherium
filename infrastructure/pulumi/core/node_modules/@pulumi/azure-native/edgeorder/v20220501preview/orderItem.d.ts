...
export declare class OrderItem extends pulumi.CustomResource {
     ...
     */
    readonly addressDetails: pulumi.Output<outputs.edgeorder.v20220501preview.AddressDetailsResponse>;
    /**
     ...
     */
    readonly orderItemDetails: pulumi.Output<outputs.edgeorder.v20220501preview.OrderItemDetailsResponse>;
    /**
     ...
     */
    readonly systemData: pulumi.Output<outputs.edgeorder.v20220501preview.SystemDataResponse>;
    /**
     * Resource tags.
     */
...
export interface OrderItemArgs {
     ...
     * Represents shipping and return address for order item.
     */
    addressDetails: pulumi.Input<inputs.edgeorder.v20220501preview.AddressDetailsArgs>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * Represents order item details.
     */
    orderItemDetails: pulumi.Input<inputs.edgeorder.v20220501preview.OrderItemDetailsArgs>;
    /**
