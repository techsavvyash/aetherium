...
export declare class SharedPrivateLinkResource extends pulumi.CustomResource {
     ...
     */
    readonly properties: pulumi.Output<outputs.search.v20220901.SharedPrivateLinkResourcePropertiesResponse>;
    /**
...
export interface SharedPrivateLinkResourceArgs {
     ...
     * Describes the properties of a Shared Private Link Resource managed by the Azure Cognitive Search service.
     */
    properties?: pulumi.Input<inputs.search.v20220901.SharedPrivateLinkResourcePropertiesArgs>;
    /**
